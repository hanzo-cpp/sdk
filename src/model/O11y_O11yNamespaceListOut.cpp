...
O11y_O11yNamespaceListOut::O11y_O11yNamespaceListOut()
{
    m_DataIsSet = false;
...
void O11y_O11yNamespaceListOut::validate()
{
    // TODO: implement validation
}

web::json::value O11y_O11yNamespaceListOut::toJson() const
{
...
bool O11y_O11yNamespaceListOut::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("data"))))
    {
        ...
        {
            std::shared_ptr<O11y_NamespaceListResponse> refVal_setData;
...
void O11y_O11yNamespaceListOut::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool O11y_O11yNamespaceListOut::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<O11y_NamespaceListResponse> O11y_O11yNamespaceListOut::getData() const
{
    return m_Data;
}


void O11y_O11yNamespaceListOut::setData(const std::shared_ptr<O11y_NamespaceListResponse>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool O11y_O11yNamespaceListOut::dataIsSet() const
{
    return m_DataIsSet;
}

void O11y_O11yNamespaceListOut::unsetData()
{
    m_DataIsSet = false;
}
utility::string_t O11y_O11yNamespaceListOut::getStatus() const
{
    return m_Status;
}


void O11y_O11yNamespaceListOut::setStatus(const utility::string_t& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool O11y_O11yNamespaceListOut::statusIsSet() const
{
    return m_StatusIsSet;
}

void O11y_O11yNamespaceListOut::unsetStatus()
{
    m_StatusIsSet = false;
}

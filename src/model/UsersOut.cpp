...
void UsersOut::validate()
{
    // TODO: implement validation
}

web::json::value UsersOut::toJson() const
{
...
bool UsersOut::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("data"))))
    {
        ...
        {
            std::vector<std::shared_ptr<OperatorUser>> refVal_setData;
...
void UsersOut::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool UsersOut::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::vector<std::shared_ptr<OperatorUser>> UsersOut::getData() const
{
    return m_Data;
}


void UsersOut::setData(const std::vector<std::shared_ptr<OperatorUser>>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool UsersOut::dataIsSet() const
{
    return m_DataIsSet;
}

void UsersOut::unsetData()
{
    m_DataIsSet = false;
}
utility::string_t UsersOut::getMsg() const
{
    return m_Msg;
}


void UsersOut::setMsg(const utility::string_t& value)
{
    m_Msg = value;
    m_MsgIsSet = true;
}

bool UsersOut::msgIsSet() const
{
    return m_MsgIsSet;
}

void UsersOut::unsetMsg()
{
    m_MsgIsSet = false;
}
utility::string_t UsersOut::getStatus() const
{
    return m_Status;
}


void UsersOut::setStatus(const utility::string_t& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool UsersOut::statusIsSet() const
{
    return m_StatusIsSet;
}

void UsersOut::unsetStatus()
{
    m_StatusIsSet = false;
}
int32_t UsersOut::getTotal() const
{
    return m_Total;
}


void UsersOut::setTotal(int32_t value)
{
    m_Total = value;
    m_TotalIsSet = true;
}

bool UsersOut::totalIsSet() const
{
    return m_TotalIsSet;
}

void UsersOut::unsetTotal()
{
    m_TotalIsSet = false;
}

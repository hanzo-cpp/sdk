...
void Iam_Role::validate()
{
    // TODO: implement validation
}

web::json::value Iam_Role::toJson() const
{
...
bool Iam_Role::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Iam_Role::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Iam_Role::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::datetime Iam_Role::getCreatedAt() const
{
    return m_CreatedAt;
}


void Iam_Role::setCreatedAt(const utility::datetime& value)
{
    m_CreatedAt = value;
    m_CreatedAtIsSet = true;
}

bool Iam_Role::createdAtIsSet() const
{
    return m_CreatedAtIsSet;
}

void Iam_Role::unsetCreatedAt()
{
    m_CreatedAtIsSet = false;
}
utility::string_t Iam_Role::getCreatedTime() const
{
    return m_CreatedTime;
}


void Iam_Role::setCreatedTime(const utility::string_t& value)
{
    m_CreatedTime = value;
    m_CreatedTimeIsSet = true;
}

bool Iam_Role::createdTimeIsSet() const
{
    return m_CreatedTimeIsSet;
}

void Iam_Role::unsetCreatedTime()
{
    m_CreatedTimeIsSet = false;
}
bool Iam_Role::isDeleted() const
{
    return m_Deleted;
}


void Iam_Role::setDeleted(bool value)
{
    m_Deleted = value;
    m_DeletedIsSet = true;
}

bool Iam_Role::deletedIsSet() const
{
    return m_DeletedIsSet;
}

void Iam_Role::unsetDeleted()
{
    m_DeletedIsSet = false;
}
utility::string_t Iam_Role::getDescription() const
{
    return m_Description;
}


void Iam_Role::setDescription(const utility::string_t& value)
{
    m_Description = value;
    m_DescriptionIsSet = true;
}

bool Iam_Role::descriptionIsSet() const
{
    return m_DescriptionIsSet;
}

void Iam_Role::unsetDescription()
{
    m_DescriptionIsSet = false;
}
utility::string_t Iam_Role::getDisplayName() const
{
    return m_DisplayName;
}


void Iam_Role::setDisplayName(const utility::string_t& value)
{
    m_DisplayName = value;
    m_DisplayNameIsSet = true;
}

bool Iam_Role::displayNameIsSet() const
{
    return m_DisplayNameIsSet;
}

void Iam_Role::unsetDisplayName()
{
    m_DisplayNameIsSet = false;
}
std::vector<utility::string_t> Iam_Role::getDomains() const
{
    return m_Domains;
}


void Iam_Role::setDomains(const std::vector<utility::string_t>& value)
{
    m_Domains = value;
    m_DomainsIsSet = true;
}

bool Iam_Role::domainsIsSet() const
{
    return m_DomainsIsSet;
}

void Iam_Role::unsetDomains()
{
    m_DomainsIsSet = false;
}
std::vector<utility::string_t> Iam_Role::getGroups() const
{
    return m_Groups;
}


void Iam_Role::setGroups(const std::vector<utility::string_t>& value)
{
    m_Groups = value;
    m_GroupsIsSet = true;
}

bool Iam_Role::groupsIsSet() const
{
    return m_GroupsIsSet;
}

void Iam_Role::unsetGroups()
{
    m_GroupsIsSet = false;
}
utility::string_t Iam_Role::getId() const
{
    return m_Id;
}


void Iam_Role::setId(const utility::string_t& value)
{
    m_Id = value;
    m_IdIsSet = true;
}

bool Iam_Role::idIsSet() const
{
    return m_IdIsSet;
}

void Iam_Role::unsetId()
{
    m_IdIsSet = false;
}
bool Iam_Role::isIsEnabled() const
{
    return m_IsEnabled;
}


void Iam_Role::setIsEnabled(bool value)
{
    m_IsEnabled = value;
    m_IsEnabledIsSet = true;
}

bool Iam_Role::isEnabledIsSet() const
{
    return m_IsEnabledIsSet;
}

void Iam_Role::unsetIsEnabled()
{
    m_IsEnabledIsSet = false;
}
utility::string_t Iam_Role::getName() const
{
    return m_Name;
}


void Iam_Role::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool Iam_Role::nameIsSet() const
{
    return m_NameIsSet;
}

void Iam_Role::unsetName()
{
    m_NameIsSet = false;
}
utility::string_t Iam_Role::getOwner() const
{
    return m_Owner;
}


void Iam_Role::setOwner(const utility::string_t& value)
{
    m_Owner = value;
    m_OwnerIsSet = true;
}

bool Iam_Role::ownerIsSet() const
{
    return m_OwnerIsSet;
}

void Iam_Role::unsetOwner()
{
    m_OwnerIsSet = false;
}
std::vector<utility::string_t> Iam_Role::getRoles() const
{
    return m_Roles;
}


void Iam_Role::setRoles(const std::vector<utility::string_t>& value)
{
    m_Roles = value;
    m_RolesIsSet = true;
}

bool Iam_Role::rolesIsSet() const
{
    return m_RolesIsSet;
}

void Iam_Role::unsetRoles()
{
    m_RolesIsSet = false;
}
utility::datetime Iam_Role::getUpdatedAt() const
{
    return m_UpdatedAt;
}


void Iam_Role::setUpdatedAt(const utility::datetime& value)
{
    m_UpdatedAt = value;
    m_UpdatedAtIsSet = true;
}

bool Iam_Role::updatedAtIsSet() const
{
    return m_UpdatedAtIsSet;
}

void Iam_Role::unsetUpdatedAt()
{
    m_UpdatedAtIsSet = false;
}
std::vector<utility::string_t> Iam_Role::getUsers() const
{
    return m_Users;
}


void Iam_Role::setUsers(const std::vector<utility::string_t>& value)
{
    m_Users = value;
    m_UsersIsSet = true;
}

bool Iam_Role::usersIsSet() const
{
    return m_UsersIsSet;
}

void Iam_Role::unsetUsers()
{
    m_UsersIsSet = false;
}

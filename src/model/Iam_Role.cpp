...
std::vector<utility::string_t> Iam_Role::getTeams() const
{
    return m_Teams;
}


void Iam_Role::setTeams(const std::vector<utility::string_t>& value)
{
    m_Teams = value;
    m_TeamsIsSet = true;
}

bool Iam_Role::teamsIsSet() const
{
    return m_TeamsIsSet;
}

void Iam_Role::unsetTeams()
{
    m_TeamsIsSet = false;
}

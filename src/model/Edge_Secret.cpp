...
void Edge_Secret::validate()
{
    // TODO: implement validation
}

web::json::value Edge_Secret::toJson() const
{
...
bool Edge_Secret::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Edge_Secret::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Edge_Secret::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t Edge_Secret::getName() const
{
    return m_Name;
}


void Edge_Secret::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool Edge_Secret::nameIsSet() const
{
    return m_NameIsSet;
}

void Edge_Secret::unsetName()
{
    m_NameIsSet = false;
}
utility::string_t Edge_Secret::getValue() const
{
    return m_Value;
}


void Edge_Secret::setValue(const utility::string_t& value)
{
    m_Value = value;
    m_ValueIsSet = true;
}

bool Edge_Secret::valueIsSet() const
{
    return m_ValueIsSet;
}

void Edge_Secret::unsetValue()
{
    m_ValueIsSet = false;
}
utility::datetime Edge_Secret::getCreatedAt() const
{
    return m_Created_at;
}


void Edge_Secret::setCreatedAt(const utility::datetime& value)
{
    m_Created_at = value;
    m_Created_atIsSet = true;
}

bool Edge_Secret::createdAtIsSet() const
{
    return m_Created_atIsSet;
}

void Edge_Secret::unsetCreated_at()
{
    m_Created_atIsSet = false;
}
utility::datetime Edge_Secret::getUpdatedAt() const
{
    return m_Updated_at;
}


void Edge_Secret::setUpdatedAt(const utility::datetime& value)
{
    m_Updated_at = value;
    m_Updated_atIsSet = true;
}

bool Edge_Secret::updatedAtIsSet() const
{
    return m_Updated_atIsSet;
}

void Edge_Secret::unsetUpdated_at()
{
    m_Updated_atIsSet = false;
}

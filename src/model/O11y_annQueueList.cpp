...
O11y_annQueueList::O11y_annQueueList()
{
    m_DataIsSet = false;
    m_MetaIsSet = false;
}
...
void O11y_annQueueList::validate()
{
    // TODO: implement validation
}

web::json::value O11y_annQueueList::toJson() const
{
...
bool O11y_annQueueList::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("data"))))
    {
        ...
        {
            std::vector<std::shared_ptr<O11y_annQueueView>> refVal_setData;
...
void O11y_annQueueList::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool O11y_annQueueList::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::vector<std::shared_ptr<O11y_annQueueView>> O11y_annQueueList::getData() const
{
    return m_Data;
}


void O11y_annQueueList::setData(const std::vector<std::shared_ptr<O11y_annQueueView>>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool O11y_annQueueList::dataIsSet() const
{
    return m_DataIsSet;
}

void O11y_annQueueList::unsetData()
{
    m_DataIsSet = false;
}
std::shared_ptr<O11y_listMeta> O11y_annQueueList::getMeta() const
{
    return m_Meta;
}


void O11y_annQueueList::setMeta(const std::shared_ptr<O11y_listMeta>& value)
{
    m_Meta = value;
    m_MetaIsSet = true;
}

bool O11y_annQueueList::metaIsSet() const
{
    return m_MetaIsSet;
}

void O11y_annQueueList::unsetMeta()
{
    m_MetaIsSet = false;
}

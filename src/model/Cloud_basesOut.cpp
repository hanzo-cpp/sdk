...
void Cloud_basesOut::validate()
{
    // TODO: implement validation
}

web::json::value Cloud_basesOut::toJson() const
{
...
bool Cloud_basesOut::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("data"))))
    {
        ...
        {
            std::vector<std::shared_ptr<Cloud_baseInstance>> refVal_setData;
...
void Cloud_basesOut::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Cloud_basesOut::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::vector<std::shared_ptr<Cloud_baseInstance>> Cloud_basesOut::getData() const
{
    return m_Data;
}


void Cloud_basesOut::setData(const std::vector<std::shared_ptr<Cloud_baseInstance>>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool Cloud_basesOut::dataIsSet() const
{
    return m_DataIsSet;
}

void Cloud_basesOut::unsetData()
{
    m_DataIsSet = false;
}
utility::string_t Cloud_basesOut::getMsg() const
{
    return m_Msg;
}


void Cloud_basesOut::setMsg(const utility::string_t& value)
{
    m_Msg = value;
    m_MsgIsSet = true;
}

bool Cloud_basesOut::msgIsSet() const
{
    return m_MsgIsSet;
}

void Cloud_basesOut::unsetMsg()
{
    m_MsgIsSet = false;
}
utility::string_t Cloud_basesOut::getStatus() const
{
    return m_Status;
}


void Cloud_basesOut::setStatus(const utility::string_t& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool Cloud_basesOut::statusIsSet() const
{
    return m_StatusIsSet;
}

void Cloud_basesOut::unsetStatus()
{
    m_StatusIsSet = false;
}
int32_t Cloud_basesOut::getTotal() const
{
    return m_Total;
}


void Cloud_basesOut::setTotal(int32_t value)
{
    m_Total = value;
    m_TotalIsSet = true;
}

bool Cloud_basesOut::totalIsSet() const
{
    return m_TotalIsSet;
}

void Cloud_basesOut::unsetTotal()
{
    m_TotalIsSet = false;
}

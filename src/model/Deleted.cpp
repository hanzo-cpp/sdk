...
void Deleted::validate()
{
    // TODO: implement validation
}

web::json::value Deleted::toJson() const
{
...
bool Deleted::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Deleted::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Deleted::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t Deleted::getDeleted() const
{
    return m_Deleted;
}


void Deleted::setDeleted(const utility::string_t& value)
{
    m_Deleted = value;
    m_DeletedIsSet = true;
}

bool Deleted::deletedIsSet() const
{
    return m_DeletedIsSet;
}

void Deleted::unsetDeleted()
{
    m_DeletedIsSet = false;
}

...
int64_t O11y_O11yLLMTracesPage::getLimit() const
{
    return m_Limit;
}


void O11y_O11yLLMTracesPage::setLimit(int64_t value)
{
    m_Limit = value;
    m_LimitIsSet = true;
}
...
int64_t O11y_O11yLLMTracesPage::getOffset() const
{
    return m_Offset;
}


void O11y_O11yLLMTracesPage::setOffset(int64_t value)
{
    m_Offset = value;
    m_OffsetIsSet = true;
}

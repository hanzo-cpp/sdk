...
O11y_O11yApdexSetOut::O11y_O11yApdexSetOut()
{
    m_DataIsSet = false;
...
void O11y_O11yApdexSetOut::validate()
{
    // TODO: implement validation
}

web::json::value O11y_O11yApdexSetOut::toJson() const
{
...
bool O11y_O11yApdexSetOut::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("data"))))
    {
        ...
        {
            std::shared_ptr<O11y_O11yMessage> refVal_setData;
...
void O11y_O11yApdexSetOut::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool O11y_O11yApdexSetOut::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<O11y_O11yMessage> O11y_O11yApdexSetOut::getData() const
{
    return m_Data;
}


void O11y_O11yApdexSetOut::setData(const std::shared_ptr<O11y_O11yMessage>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool O11y_O11yApdexSetOut::dataIsSet() const
{
    return m_DataIsSet;
}

void O11y_O11yApdexSetOut::unsetData()
{
    m_DataIsSet = false;
}
utility::string_t O11y_O11yApdexSetOut::getStatus() const
{
    return m_Status;
}


void O11y_O11yApdexSetOut::setStatus(const utility::string_t& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool O11y_O11yApdexSetOut::statusIsSet() const
{
    return m_StatusIsSet;
}

void O11y_O11yApdexSetOut::unsetStatus()
{
    m_StatusIsSet = false;
}

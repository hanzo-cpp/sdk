...
void GrantsOut::validate()
{
    // TODO: implement validation
}

web::json::value GrantsOut::toJson() const
{
...
bool GrantsOut::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("data"))))
    {
        ...
        {
            std::vector<std::shared_ptr<GrantRow>> refVal_setData;
...
void GrantsOut::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool GrantsOut::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::vector<std::shared_ptr<GrantRow>> GrantsOut::getData() const
{
    return m_Data;
}


void GrantsOut::setData(const std::vector<std::shared_ptr<GrantRow>>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool GrantsOut::dataIsSet() const
{
    return m_DataIsSet;
}

void GrantsOut::unsetData()
{
    m_DataIsSet = false;
}
utility::string_t GrantsOut::getMsg() const
{
    return m_Msg;
}


void GrantsOut::setMsg(const utility::string_t& value)
{
    m_Msg = value;
    m_MsgIsSet = true;
}

bool GrantsOut::msgIsSet() const
{
    return m_MsgIsSet;
}

void GrantsOut::unsetMsg()
{
    m_MsgIsSet = false;
}
utility::string_t GrantsOut::getStatus() const
{
    return m_Status;
}


void GrantsOut::setStatus(const utility::string_t& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool GrantsOut::statusIsSet() const
{
    return m_StatusIsSet;
}

void GrantsOut::unsetStatus()
{
    m_StatusIsSet = false;
}
int32_t GrantsOut::getTotal() const
{
    return m_Total;
}


void GrantsOut::setTotal(int32_t value)
{
    m_Total = value;
    m_TotalIsSet = true;
}

bool GrantsOut::totalIsSet() const
{
    return m_TotalIsSet;
}

void GrantsOut::unsetTotal()
{
    m_TotalIsSet = false;
}

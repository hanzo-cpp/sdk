...
void DefsOut::validate()
{
    // TODO: implement validation
}

web::json::value DefsOut::toJson() const
{
...
bool DefsOut::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("data"))))
    {
        ...
        {
            std::vector<std::shared_ptr<DefRow>> refVal_setData;
...
void DefsOut::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool DefsOut::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::vector<std::shared_ptr<DefRow>> DefsOut::getData() const
{
    return m_Data;
}


void DefsOut::setData(const std::vector<std::shared_ptr<DefRow>>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool DefsOut::dataIsSet() const
{
    return m_DataIsSet;
}

void DefsOut::unsetData()
{
    m_DataIsSet = false;
}

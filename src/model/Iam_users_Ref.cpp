...
void Iam_users_Ref::validate()
{
    // TODO: implement validation
}

web::json::value Iam_users_Ref::toJson() const
{
...
bool Iam_users_Ref::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Iam_users_Ref::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Iam_users_Ref::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t Iam_users_Ref::getName() const
{
    return m_Name;
}


void Iam_users_Ref::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool Iam_users_Ref::nameIsSet() const
{
    return m_NameIsSet;
}

void Iam_users_Ref::unsetName()
{
    m_NameIsSet = false;
}
utility::string_t Iam_users_Ref::getOwner() const
{
    return m_Owner;
}


void Iam_users_Ref::setOwner(const utility::string_t& value)
{
    m_Owner = value;
    m_OwnerIsSet = true;
}

bool Iam_users_Ref::ownerIsSet() const
{
    return m_OwnerIsSet;
}

void Iam_users_Ref::unsetOwner()
{
    m_OwnerIsSet = false;
}

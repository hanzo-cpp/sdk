...
void ReloadIn::validate()
{
    // TODO: implement validation
}

web::json::value ReloadIn::toJson() const
{
...
bool ReloadIn::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void ReloadIn::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ReloadIn::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t ReloadIn::getName() const
{
    return m_Name;
}


void ReloadIn::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool ReloadIn::nameIsSet() const
{
    return m_NameIsSet;
}

void ReloadIn::unsetName()
{
    m_NameIsSet = false;
}
utility::string_t ReloadIn::getScope() const
{
    return m_Scope;
}


void ReloadIn::setScope(const utility::string_t& value)
{
    m_Scope = value;
    m_ScopeIsSet = true;
}

bool ReloadIn::scopeIsSet() const
{
    return m_ScopeIsSet;
}

void ReloadIn::unsetScope()
{
    m_ScopeIsSet = false;
}
utility::string_t ReloadIn::getSum() const
{
    return m_Sum;
}


void ReloadIn::setSum(const utility::string_t& value)
{
    m_Sum = value;
    m_SumIsSet = true;
}

bool ReloadIn::sumIsSet() const
{
    return m_SumIsSet;
}

void ReloadIn::unsetSum()
{
    m_SumIsSet = false;
}
utility::string_t ReloadIn::getUrl() const
{
    return m_Url;
}


void ReloadIn::setUrl(const utility::string_t& value)
{
    m_Url = value;
    m_UrlIsSet = true;
}

bool ReloadIn::urlIsSet() const
{
    return m_UrlIsSet;
}

void ReloadIn::unsetUrl()
{
    m_UrlIsSet = false;
}
utility::string_t ReloadIn::getVersion() const
{
    return m_Version;
}


void ReloadIn::setVersion(const utility::string_t& value)
{
    m_Version = value;
    m_VersionIsSet = true;
}

bool ReloadIn::versionIsSet() const
{
    return m_VersionIsSet;
}

void ReloadIn::unsetVersion()
{
    m_VersionIsSet = false;
}

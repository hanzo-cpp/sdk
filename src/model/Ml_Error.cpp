...
#include "hanzo/model/Ml_Error.h"
...
void Ml_Error::validate()
{
    // TODO: implement validation
}

web::json::value Ml_Error::toJson() const
{
...
bool Ml_Error::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Ml_Error::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Ml_Error::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t Ml_Error::getError() const
{
    return m_Error;
}


void Ml_Error::setError(const utility::string_t& value)
{
    m_Error = value;
    m_ErrorIsSet = true;
}

bool Ml_Error::errorIsSet() const
{
    return m_ErrorIsSet;
}

void Ml_Error::unsetError()
{
    m_ErrorIsSet = false;
}
int32_t Ml_Error::getCode() const
{
    return m_Code;
}


void Ml_Error::setCode(int32_t value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool Ml_Error::codeIsSet() const
{
    return m_CodeIsSet;
}

void Ml_Error::unsetCode()
{
    m_CodeIsSet = false;
}

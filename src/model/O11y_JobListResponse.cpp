...
#include "hanzo/model/O11y_JobListResponse.h"

namespace hanzo {
namespace model {

O11y_JobListResponse::O11y_JobListResponse()
{
...
void O11y_JobListResponse::validate()
{
    // TODO: implement validation
}

web::json::value O11y_JobListResponse::toJson() const
{
...
bool O11y_JobListResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("records"))))
    {
        ...
        {
            std::vector<std::shared_ptr<O11y_JobListRecord>> refVal_setRecords;
...
void O11y_JobListResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool O11y_JobListResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::vector<std::shared_ptr<O11y_JobListRecord>> O11y_JobListResponse::getRecords() const
{
    return m_Records;
}


void O11y_JobListResponse::setRecords(const std::vector<std::shared_ptr<O11y_JobListRecord>>& value)
{
    m_Records = value;
    m_RecordsIsSet = true;
}

bool O11y_JobListResponse::recordsIsSet() const
{
    return m_RecordsIsSet;
}

void O11y_JobListResponse::unsetRecords()
{
    m_RecordsIsSet = false;
}
int32_t O11y_JobListResponse::getTotal() const
{
    return m_Total;
}


void O11y_JobListResponse::setTotal(int32_t value)
{
    m_Total = value;
    m_TotalIsSet = true;
}

bool O11y_JobListResponse::totalIsSet() const
{
    return m_TotalIsSet;
}

void O11y_JobListResponse::unsetTotal()
{
    m_TotalIsSet = false;
}
utility::string_t O11y_JobListResponse::getType() const
{
    return m_Type;
}


void O11y_JobListResponse::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool O11y_JobListResponse::typeIsSet() const
{
    return m_TypeIsSet;
}

void O11y_JobListResponse::unsetType()
{
    m_TypeIsSet = false;
}

...
Cloud_iamRowsOut::Cloud_iamRowsOut()
{
    m_DataIsSet = false;
...
void Cloud_iamRowsOut::validate()
{
    // TODO: implement validation
}

web::json::value Cloud_iamRowsOut::toJson() const
{
...
bool Cloud_iamRowsOut::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Cloud_iamRowsOut::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Cloud_iamRowsOut::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<Object> Cloud_iamRowsOut::getData() const
{
    return m_Data;
}


void Cloud_iamRowsOut::setData(const std::shared_ptr<Object>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool Cloud_iamRowsOut::dataIsSet() const
{
    return m_DataIsSet;
}

void Cloud_iamRowsOut::unsetData()
{
    m_DataIsSet = false;
}
utility::string_t Cloud_iamRowsOut::getMsg() const
{
    return m_Msg;
}


void Cloud_iamRowsOut::setMsg(const utility::string_t& value)
{
    m_Msg = value;
    m_MsgIsSet = true;
}

bool Cloud_iamRowsOut::msgIsSet() const
{
    return m_MsgIsSet;
}

void Cloud_iamRowsOut::unsetMsg()
{
    m_MsgIsSet = false;
}
utility::string_t Cloud_iamRowsOut::getStatus() const
{
    return m_Status;
}


void Cloud_iamRowsOut::setStatus(const utility::string_t& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool Cloud_iamRowsOut::statusIsSet() const
{
    return m_StatusIsSet;
}

void Cloud_iamRowsOut::unsetStatus()
{
    m_StatusIsSet = false;
}
int32_t Cloud_iamRowsOut::getTotal() const
{
    return m_Total;
}


void Cloud_iamRowsOut::setTotal(int32_t value)
{
    m_Total = value;
    m_TotalIsSet = true;
}

bool Cloud_iamRowsOut::totalIsSet() const
{
    return m_TotalIsSet;
}

void Cloud_iamRowsOut::unsetTotal()
{
    m_TotalIsSet = false;
}

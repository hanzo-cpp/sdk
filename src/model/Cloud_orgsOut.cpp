...
void Cloud_orgsOut::validate()
{
    // TODO: implement validation
}

web::json::value Cloud_orgsOut::toJson() const
{
...
bool Cloud_orgsOut::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("data"))))
    {
        ...
        {
            std::vector<std::shared_ptr<Cloud_orgRow>> refVal_setData;
...
void Cloud_orgsOut::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Cloud_orgsOut::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::vector<std::shared_ptr<Cloud_orgRow>> Cloud_orgsOut::getData() const
{
    return m_Data;
}


void Cloud_orgsOut::setData(const std::vector<std::shared_ptr<Cloud_orgRow>>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool Cloud_orgsOut::dataIsSet() const
{
    return m_DataIsSet;
}

void Cloud_orgsOut::unsetData()
{
    m_DataIsSet = false;
}
utility::string_t Cloud_orgsOut::getMsg() const
{
    return m_Msg;
}


void Cloud_orgsOut::setMsg(const utility::string_t& value)
{
    m_Msg = value;
    m_MsgIsSet = true;
}

bool Cloud_orgsOut::msgIsSet() const
{
    return m_MsgIsSet;
}

void Cloud_orgsOut::unsetMsg()
{
    m_MsgIsSet = false;
}
utility::string_t Cloud_orgsOut::getStatus() const
{
    return m_Status;
}


void Cloud_orgsOut::setStatus(const utility::string_t& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool Cloud_orgsOut::statusIsSet() const
{
    return m_StatusIsSet;
}

void Cloud_orgsOut::unsetStatus()
{
    m_StatusIsSet = false;
}
int32_t Cloud_orgsOut::getTotal() const
{
    return m_Total;
}


void Cloud_orgsOut::setTotal(int32_t value)
{
    m_Total = value;
    m_TotalIsSet = true;
}

bool Cloud_orgsOut::totalIsSet() const
{
    return m_TotalIsSet;
}

void Cloud_orgsOut::unsetTotal()
{
    m_TotalIsSet = false;
}

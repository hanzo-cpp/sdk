...
O11y_O11yDowntimeSchedulesOut::O11y_O11yDowntimeSchedulesOut()
{
    m_DataIsSet = false;
...
void O11y_O11yDowntimeSchedulesOut::validate()
{
    // TODO: implement validation
}

web::json::value O11y_O11yDowntimeSchedulesOut::toJson() const
{
...
bool O11y_O11yDowntimeSchedulesOut::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void O11y_O11yDowntimeSchedulesOut::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool O11y_O11yDowntimeSchedulesOut::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::vector<std::shared_ptr<AnyType>> O11y_O11yDowntimeSchedulesOut::getData() const
{
    return m_Data;
}


void O11y_O11yDowntimeSchedulesOut::setData(const std::vector<std::shared_ptr<AnyType>>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool O11y_O11yDowntimeSchedulesOut::dataIsSet() const
{
    return m_DataIsSet;
}

void O11y_O11yDowntimeSchedulesOut::unsetData()
{
    m_DataIsSet = false;
}
utility::string_t O11y_O11yDowntimeSchedulesOut::getStatus() const
{
    return m_Status;
}


void O11y_O11yDowntimeSchedulesOut::setStatus(const utility::string_t& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool O11y_O11yDowntimeSchedulesOut::statusIsSet() const
{
    return m_StatusIsSet;
}

void O11y_O11yDowntimeSchedulesOut::unsetStatus()
{
    m_StatusIsSet = false;
}

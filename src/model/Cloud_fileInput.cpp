...
Cloud_fileInput::Cloud_fileInput()
{
...
void Cloud_fileInput::validate()
{
    // TODO: implement validation
}

web::json::value Cloud_fileInput::toJson() const
{
...
bool Cloud_fileInput::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Cloud_fileInput::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Cloud_fileInput::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t Cloud_fileInput::getContent() const
{
    return m_Content;
}


void Cloud_fileInput::setContent(const utility::string_t& value)
{
    m_Content = value;
    m_ContentIsSet = true;
}

bool Cloud_fileInput::contentIsSet() const
{
    return m_ContentIsSet;
}

void Cloud_fileInput::unsetContent()
{
    m_ContentIsSet = false;
}
utility::string_t Cloud_fileInput::getPath() const
{
    return m_Path;
}


void Cloud_fileInput::setPath(const utility::string_t& value)
{
    m_Path = value;
    m_PathIsSet = true;
}

bool Cloud_fileInput::pathIsSet() const
{
    return m_PathIsSet;
}

void Cloud_fileInput::unsetPath()
{
    m_PathIsSet = false;
}

...
void AnalyticsOut::validate()
{
    // TODO: implement validation
}

web::json::value AnalyticsOut::toJson() const
{
...
bool AnalyticsOut::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("data"))))
    {
        ...
        {
            std::shared_ptr<AnalyticsData> refVal_setData;
...
void AnalyticsOut::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool AnalyticsOut::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<AnalyticsData> AnalyticsOut::getData() const
{
    return m_Data;
}


void AnalyticsOut::setData(const std::shared_ptr<AnalyticsData>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool AnalyticsOut::dataIsSet() const
{
    return m_DataIsSet;
}

void AnalyticsOut::unsetData()
{
    m_DataIsSet = false;
}
utility::string_t AnalyticsOut::getMsg() const
{
    return m_Msg;
}


void AnalyticsOut::setMsg(const utility::string_t& value)
{
    m_Msg = value;
    m_MsgIsSet = true;
}

bool AnalyticsOut::msgIsSet() const
{
    return m_MsgIsSet;
}

void AnalyticsOut::unsetMsg()
{
    m_MsgIsSet = false;
}
utility::string_t AnalyticsOut::getStatus() const
{
    return m_Status;
}


void AnalyticsOut::setStatus(const utility::string_t& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool AnalyticsOut::statusIsSet() const
{
    return m_StatusIsSet;
}

void AnalyticsOut::unsetStatus()
{
    m_StatusIsSet = false;
}

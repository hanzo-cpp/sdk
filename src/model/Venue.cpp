...
web::json::value Venue::toJson() const
{
...
bool Venue::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Venue::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Venue::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t Venue::getName() const
{
    return m_Name;
}


void Venue::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool Venue::nameIsSet() const
{
    return m_NameIsSet;
}

void Venue::unsetName()
{
    m_NameIsSet = false;
}
bool Venue::isReady() const
{
    return m_Ready;
}


void Venue::setReady(bool value)
{
    m_Ready = value;
    m_ReadyIsSet = true;
}

bool Venue::readyIsSet() const
{
    return m_ReadyIsSet;
}

void Venue::unsetReady()
{
    m_ReadyIsSet = false;
}
utility::string_t Venue::getWs() const
{
    return m_Ws;
}


void Venue::setWs(const utility::string_t& value)
{
    m_Ws = value;
    m_WsIsSet = true;
}

bool Venue::wsIsSet() const
{
    return m_WsIsSet;
}

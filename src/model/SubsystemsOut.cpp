...
void SubsystemsOut::validate()
{
    // TODO: implement validation
}

web::json::value SubsystemsOut::toJson() const
{
...
bool SubsystemsOut::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("data"))))
    {
        ...
        {
            std::shared_ptr<SubsystemBoard> refVal_setData;
...
void SubsystemsOut::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool SubsystemsOut::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<SubsystemBoard> SubsystemsOut::getData() const
{
    return m_Data;
}


void SubsystemsOut::setData(const std::shared_ptr<SubsystemBoard>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool SubsystemsOut::dataIsSet() const
{
    return m_DataIsSet;
}

void SubsystemsOut::unsetData()
{
    m_DataIsSet = false;
}
utility::string_t SubsystemsOut::getMsg() const
{
    return m_Msg;
}


void SubsystemsOut::setMsg(const utility::string_t& value)
{
    m_Msg = value;
    m_MsgIsSet = true;
}

bool SubsystemsOut::msgIsSet() const
{
    return m_MsgIsSet;
}

void SubsystemsOut::unsetMsg()
{
    m_MsgIsSet = false;
}
utility::string_t SubsystemsOut::getStatus() const
{
    return m_Status;
}


void SubsystemsOut::setStatus(const utility::string_t& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool SubsystemsOut::statusIsSet() const
{
    return m_StatusIsSet;
}

void SubsystemsOut::unsetStatus()
{
    m_StatusIsSet = false;
}

...
O11y_O11yCreatedOut::O11y_O11yCreatedOut()
{
    m_DataIsSet = false;
...
void O11y_O11yCreatedOut::validate()
{
    // TODO: implement validation
}

web::json::value O11y_O11yCreatedOut::toJson() const
{
...
bool O11y_O11yCreatedOut::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void O11y_O11yCreatedOut::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool O11y_O11yCreatedOut::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<O11y_O11yCreated> O11y_O11yCreatedOut::getData() const
{
    return m_Data;
}


void O11y_O11yCreatedOut::setData(const std::shared_ptr<O11y_O11yCreated>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool O11y_O11yCreatedOut::dataIsSet() const
{
    return m_DataIsSet;
}

void O11y_O11yCreatedOut::unsetData()
{
    m_DataIsSet = false;
}
utility::string_t O11y_O11yCreatedOut::getStatus() const
{
    return m_Status;
}


void O11y_O11yCreatedOut::setStatus(const utility::string_t& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool O11y_O11yCreatedOut::statusIsSet() const
{
    return m_StatusIsSet;
}

void O11y_O11yCreatedOut::unsetStatus()
{
    m_StatusIsSet = false;
}

...
void AccountsUsage::validate()
{
    // TODO: implement validation
}

web::json::value AccountsUsage::toJson() const
{
...
bool AccountsUsage::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void AccountsUsage::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool AccountsUsage::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::vector<std::shared_ptr<RoutedUsage>> AccountsUsage::getAccounts() const
{
    return m_Accounts;
}


void AccountsUsage::setAccounts(const std::vector<std::shared_ptr<RoutedUsage>>& value)
{
    m_Accounts = value;
    m_AccountsIsSet = true;
}

bool AccountsUsage::accountsIsSet() const
{
    return m_AccountsIsSet;
}

void AccountsUsage::unsetAccounts()
{
    m_AccountsIsSet = false;
}
utility::string_t AccountsUsage::getScope() const
{
    return m_Scope;
}


void AccountsUsage::setScope(const utility::string_t& value)
{
    m_Scope = value;
    m_ScopeIsSet = true;
}

bool AccountsUsage::scopeIsSet() const
{
    return m_ScopeIsSet;
}

void AccountsUsage::unsetScope()
{
    m_ScopeIsSet = false;
}
utility::string_t AccountsUsage::getSource() const
{
    return m_Source;
}


void AccountsUsage::setSource(const utility::string_t& value)
{
    m_Source = value;
    m_SourceIsSet = true;
}

bool AccountsUsage::sourceIsSet() const
{
    return m_SourceIsSet;
}

void AccountsUsage::unsetSource()
{
    m_SourceIsSet = false;
}
std::shared_ptr<AccountsTotal> AccountsUsage::getTotal() const
{
    return m_Total;
}


void AccountsUsage::setTotal(const std::shared_ptr<AccountsTotal>& value)
{
    m_Total = value;
    m_TotalIsSet = true;
}

bool AccountsUsage::totalIsSet() const
{
    return m_TotalIsSet;
}

void AccountsUsage::unsetTotal()
{
    m_TotalIsSet = false;
}

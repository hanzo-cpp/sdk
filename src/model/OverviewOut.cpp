...
void OverviewOut::validate()
{
    // TODO: implement validation
}

web::json::value OverviewOut::toJson() const
{
...
bool OverviewOut::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("data"))))
    {
        ...
        {
            std::shared_ptr<OverviewData> refVal_setData;
...
void OverviewOut::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool OverviewOut::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<OverviewData> OverviewOut::getData() const
{
    return m_Data;
}


void OverviewOut::setData(const std::shared_ptr<OverviewData>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool OverviewOut::dataIsSet() const
{
    return m_DataIsSet;
}

void OverviewOut::unsetData()
{
    m_DataIsSet = false;
}
utility::string_t OverviewOut::getMsg() const
{
    return m_Msg;
}


void OverviewOut::setMsg(const utility::string_t& value)
{
    m_Msg = value;
    m_MsgIsSet = true;
}

bool OverviewOut::msgIsSet() const
{
    return m_MsgIsSet;
}

void OverviewOut::unsetMsg()
{
    m_MsgIsSet = false;
}
utility::string_t OverviewOut::getStatus() const
{
    return m_Status;
}


void OverviewOut::setStatus(const utility::string_t& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool OverviewOut::statusIsSet() const
{
    return m_StatusIsSet;
}

void OverviewOut::unsetStatus()
{
    m_StatusIsSet = false;
}

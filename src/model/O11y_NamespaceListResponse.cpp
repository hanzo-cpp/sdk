...
#include "hanzo/model/O11y_NamespaceListResponse.h"
...
void O11y_NamespaceListResponse::validate()
{
    // TODO: implement validation
}

web::json::value O11y_NamespaceListResponse::toJson() const
{
...
bool O11y_NamespaceListResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("records"))))
    {
        ...
        {
            std::vector<std::shared_ptr<O11y_NamespaceListRecord>> refVal_setRecords;
...
void O11y_NamespaceListResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool O11y_NamespaceListResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::vector<std::shared_ptr<O11y_NamespaceListRecord>> O11y_NamespaceListResponse::getRecords() const
{
    return m_Records;
}


void O11y_NamespaceListResponse::setRecords(const std::vector<std::shared_ptr<O11y_NamespaceListRecord>>& value)
{
    m_Records = value;
    m_RecordsIsSet = true;
}

bool O11y_NamespaceListResponse::recordsIsSet() const
{
    return m_RecordsIsSet;
}

void O11y_NamespaceListResponse::unsetRecords()
{
    m_RecordsIsSet = false;
}
...
bool O11y_NamespaceListResponse::totalIsSet() const
{
    return m_TotalIsSet;
}

void O11y_NamespaceListResponse::unsetTotal()
{
    m_TotalIsSet = false;
}
utility::string_t O11y_NamespaceListResponse::getType() const
{
    return m_Type;
}


void O11y_NamespaceListResponse::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool O11y_NamespaceListResponse::typeIsSet() const
{
    return m_TypeIsSet;
}

void O11y_NamespaceListResponse::unsetType()
{
    m_TypeIsSet = false;
}

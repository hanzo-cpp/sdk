...
void AdminBook::validate()
{
    // TODO: implement validation
}

web::json::value AdminBook::toJson() const
{
...
bool AdminBook::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("data"))))
    {
        ...
        {
            std::shared_ptr<AdminBookData> refVal_setData;
...
void AdminBook::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool AdminBook::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<AdminBookData> AdminBook::getData() const
{
    return m_Data;
}


void AdminBook::setData(const std::shared_ptr<AdminBookData>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool AdminBook::dataIsSet() const
{
    return m_DataIsSet;
}

void AdminBook::unsetData()
{
    m_DataIsSet = false;
}
utility::string_t AdminBook::getMsg() const
{
    return m_Msg;
}


void AdminBook::setMsg(const utility::string_t& value)
{
    m_Msg = value;
    m_MsgIsSet = true;
}

bool AdminBook::msgIsSet() const
{
    return m_MsgIsSet;
}

void AdminBook::unsetMsg()
{
    m_MsgIsSet = false;
}
utility::string_t AdminBook::getStatus() const
{
    return m_Status;
}


void AdminBook::setStatus(const utility::string_t& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool AdminBook::statusIsSet() const
{
    return m_StatusIsSet;
}

void AdminBook::unsetStatus()
{
    m_StatusIsSet = false;
}

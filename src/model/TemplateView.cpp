...
void TemplateView::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool TemplateView::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t TemplateView::getCategory() const
{
    return m_Category;
}


void TemplateView::setCategory(const utility::string_t& value)
{
    m_Category = value;
    m_CategoryIsSet = true;
}

bool TemplateView::categoryIsSet() const
{
    return m_CategoryIsSet;
}

void TemplateView::unsetCategory()
{
    m_CategoryIsSet = false;
}
bool TemplateView::isCounselReview() const
{
    return m_CounselReview;
}


void TemplateView::setCounselReview(bool value)
{
    m_CounselReview = value;
    m_CounselReviewIsSet = true;
}

bool TemplateView::counselReviewIsSet() const
{
    return m_CounselReviewIsSet;
}

void TemplateView::unsetCounselReview()
{
    m_CounselReviewIsSet = false;
}
std::vector<std::shared_ptr<Field>> TemplateView::getFields() const
{
    return m_Fields;
}


void TemplateView::setFields(const std::vector<std::shared_ptr<Field>>& value)
{
    m_Fields = value;
    m_FieldsIsSet = true;
}

bool TemplateView::fieldsIsSet() const
{
    return m_FieldsIsSet;
}

void TemplateView::unsetFields()
{
    m_FieldsIsSet = false;
}
utility::string_t TemplateView::getId() const
{
    return m_Id;
}


void TemplateView::setId(const utility::string_t& value)
{
    m_Id = value;
    m_IdIsSet = true;
}

bool TemplateView::idIsSet() const
{
    return m_IdIsSet;
}

void TemplateView::unsetId()
{
    m_IdIsSet = false;
}
utility::string_t TemplateView::getOrigin() const
{
    return m_Origin;
}


void TemplateView::setOrigin(const utility::string_t& value)
{
    m_Origin = value;
    m_OriginIsSet = true;
}

bool TemplateView::originIsSet() const
{
    return m_OriginIsSet;
}

void TemplateView::unsetOrigin()
{
    m_OriginIsSet = false;
}
utility::string_t TemplateView::getTitle() const
{
    return m_Title;
}


void TemplateView::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool TemplateView::titleIsSet() const
{
    return m_TitleIsSet;
}

void TemplateView::unsetTitle()
{
    m_TitleIsSet = false;
}
...
bool TemplateView::versionIsSet() const
{
    return m_VersionIsSet;
}

void TemplateView::unsetVersion()
{
    m_VersionIsSet = false;
}

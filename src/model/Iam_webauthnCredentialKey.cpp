...
Iam_webauthnCredentialKey::Iam_webauthnCredentialKey()
{
...
void Iam_webauthnCredentialKey::validate()
{
    // TODO: implement validation
}

web::json::value Iam_webauthnCredentialKey::toJson() const
{
...
bool Iam_webauthnCredentialKey::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Iam_webauthnCredentialKey::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Iam_webauthnCredentialKey::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t Iam_webauthnCredentialKey::getName() const
{
    return m_Name;
}


void Iam_webauthnCredentialKey::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool Iam_webauthnCredentialKey::nameIsSet() const
{
    return m_NameIsSet;
}

void Iam_webauthnCredentialKey::unsetName()
{
    m_NameIsSet = false;
}
utility::string_t Iam_webauthnCredentialKey::getOwner() const
{
    return m_Owner;
}


void Iam_webauthnCredentialKey::setOwner(const utility::string_t& value)
{
    m_Owner = value;
    m_OwnerIsSet = true;
}

bool Iam_webauthnCredentialKey::ownerIsSet() const
{
    return m_OwnerIsSet;
}

void Iam_webauthnCredentialKey::unsetOwner()
{
    m_OwnerIsSet = false;
}

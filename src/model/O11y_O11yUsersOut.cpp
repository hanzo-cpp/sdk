...
O11y_O11yUsersOut::O11y_O11yUsersOut()
{
    m_DataIsSet = false;
...
void O11y_O11yUsersOut::validate()
{
    // TODO: implement validation
}

web::json::value O11y_O11yUsersOut::toJson() const
{
...
bool O11y_O11yUsersOut::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("data"))))
    {
        ...
        {
            std::vector<std::shared_ptr<O11y_O11yUser>> refVal_setData;
...
void O11y_O11yUsersOut::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool O11y_O11yUsersOut::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::vector<std::shared_ptr<O11y_O11yUser>> O11y_O11yUsersOut::getData() const
{
    return m_Data;
}


void O11y_O11yUsersOut::setData(const std::vector<std::shared_ptr<O11y_O11yUser>>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool O11y_O11yUsersOut::dataIsSet() const
{
    return m_DataIsSet;
}

void O11y_O11yUsersOut::unsetData()
{
    m_DataIsSet = false;
}
utility::string_t O11y_O11yUsersOut::getStatus() const
{
    return m_Status;
}


void O11y_O11yUsersOut::setStatus(const utility::string_t& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool O11y_O11yUsersOut::statusIsSet() const
{
    return m_StatusIsSet;
}

void O11y_O11yUsersOut::unsetStatus()
{
    m_StatusIsSet = false;
}

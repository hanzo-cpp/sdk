...
Cloud_TotalView::Cloud_TotalView()
{
...
void Cloud_TotalView::validate()
{
    // TODO: implement validation
}

web::json::value Cloud_TotalView::toJson() const
{
...
bool Cloud_TotalView::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Cloud_TotalView::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Cloud_TotalView::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t Cloud_TotalView::getConfidence() const
{
    return m_Confidence;
}


void Cloud_TotalView::setConfidence(const utility::string_t& value)
{
    m_Confidence = value;
    m_ConfidenceIsSet = true;
}

bool Cloud_TotalView::confidenceIsSet() const
{
    return m_ConfidenceIsSet;
}

void Cloud_TotalView::unsetConfidence()
{
    m_ConfidenceIsSet = false;
}
int32_t Cloud_TotalView::getCostCents() const
{
    return m_CostCents;
}


void Cloud_TotalView::setCostCents(int32_t value)
{
    m_CostCents = value;
    m_CostCentsIsSet = true;
}

bool Cloud_TotalView::costCentsIsSet() const
{
    return m_CostCentsIsSet;
}

void Cloud_TotalView::unsetCostCents()
{
    m_CostCentsIsSet = false;
}
utility::string_t Cloud_TotalView::getProvider() const
{
    return m_Provider;
}


void Cloud_TotalView::setProvider(const utility::string_t& value)
{
    m_Provider = value;
    m_ProviderIsSet = true;
}

bool Cloud_TotalView::providerIsSet() const
{
    return m_ProviderIsSet;
}

void Cloud_TotalView::unsetProvider()
{
    m_ProviderIsSet = false;
}
int32_t Cloud_TotalView::getRequests() const
{
    return m_Requests;
}


void Cloud_TotalView::setRequests(int32_t value)
{
    m_Requests = value;
    m_RequestsIsSet = true;
}

bool Cloud_TotalView::requestsIsSet() const
{
    return m_RequestsIsSet;
}

void Cloud_TotalView::unsetRequests()
{
    m_RequestsIsSet = false;
}
utility::string_t Cloud_TotalView::getScope() const
{
    return m_Scope;
}


void Cloud_TotalView::setScope(const utility::string_t& value)
{
    m_Scope = value;
    m_ScopeIsSet = true;
}

bool Cloud_TotalView::scopeIsSet() const
{
    return m_ScopeIsSet;
}

void Cloud_TotalView::unsetScope()
{
    m_ScopeIsSet = false;
}
utility::string_t Cloud_TotalView::getSource() const
{
    return m_Source;
}


void Cloud_TotalView::setSource(const utility::string_t& value)
{
    m_Source = value;
    m_SourceIsSet = true;
}

bool Cloud_TotalView::sourceIsSet() const
{
    return m_SourceIsSet;
}

void Cloud_TotalView::unsetSource()
{
    m_SourceIsSet = false;
}
int32_t Cloud_TotalView::getTokens() const
{
    return m_Tokens;
}


void Cloud_TotalView::setTokens(int32_t value)
{
    m_Tokens = value;
    m_TokensIsSet = true;
}

bool Cloud_TotalView::tokensIsSet() const
{
    return m_TokensIsSet;
}

void Cloud_TotalView::unsetTokens()
{
    m_TokensIsSet = false;
}
double Cloud_TotalView::getUsedPct() const
{
    return m_UsedPct;
}


void Cloud_TotalView::setUsedPct(double value)
{
    m_UsedPct = value;
    m_UsedPctIsSet = true;
}

bool Cloud_TotalView::usedPctIsSet() const
{
    return m_UsedPctIsSet;
}

void Cloud_TotalView::unsetUsedPct()
{
    m_UsedPctIsSet = false;
}
utility::string_t Cloud_TotalView::getWindow() const
{
    return m_Window;
}


void Cloud_TotalView::setWindow(const utility::string_t& value)
{
    m_Window = value;
    m_WindowIsSet = true;
}

bool Cloud_TotalView::windowIsSet() const
{
    return m_WindowIsSet;
}

void Cloud_TotalView::unsetWindow()
{
    m_WindowIsSet = false;
}
int32_t Cloud_TotalView::getWindows() const
{
    return m_Windows;
}


void Cloud_TotalView::setWindows(int32_t value)
{
    m_Windows = value;
    m_WindowsIsSet = true;
}

bool Cloud_TotalView::windowsIsSet() const
{
    return m_WindowsIsSet;
}

void Cloud_TotalView::unsetWindows()
{
    m_WindowsIsSet = false;
}

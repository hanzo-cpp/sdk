...
void AimetricsOut::validate()
{
    // TODO: implement validation
}

web::json::value AimetricsOut::toJson() const
{
...
bool AimetricsOut::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("data"))))
    {
        ...
        {
            std::shared_ptr<AiMetrics> refVal_setData;
...
void AimetricsOut::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool AimetricsOut::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<AiMetrics> AimetricsOut::getData() const
{
    return m_Data;
}


void AimetricsOut::setData(const std::shared_ptr<AiMetrics>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool AimetricsOut::dataIsSet() const
{
    return m_DataIsSet;
}

void AimetricsOut::unsetData()
{
    m_DataIsSet = false;
}
utility::string_t AimetricsOut::getMsg() const
{
    return m_Msg;
}


void AimetricsOut::setMsg(const utility::string_t& value)
{
    m_Msg = value;
    m_MsgIsSet = true;
}

bool AimetricsOut::msgIsSet() const
{
    return m_MsgIsSet;
}

void AimetricsOut::unsetMsg()
{
    m_MsgIsSet = false;
}
utility::string_t AimetricsOut::getStatus() const
{
    return m_Status;
}


void AimetricsOut::setStatus(const utility::string_t& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool AimetricsOut::statusIsSet() const
{
    return m_StatusIsSet;
}

void AimetricsOut::unsetStatus()
{
    m_StatusIsSet = false;
}

...
void SeriesPoint::validate()
{
    // TODO: implement validation
}

web::json::value SeriesPoint::toJson() const
{
...
bool SeriesPoint::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void SeriesPoint::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool SeriesPoint::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t SeriesPoint::getT() const
{
    return m_t;
}


void SeriesPoint::setT(const utility::string_t& value)
{
    m_t = value;
    m_tIsSet = true;
}

bool SeriesPoint::TIsSet() const
{
    return m_tIsSet;
}

void SeriesPoint::unsett()
{
    m_tIsSet = false;
}
...
bool SeriesPoint::VIsSet() const
{
    return m_vIsSet;
}

void SeriesPoint::unsetv()
{
    m_vIsSet = false;
}

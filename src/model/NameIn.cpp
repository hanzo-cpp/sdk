...
void NameIn::validate()
{
    // TODO: implement validation
}

web::json::value NameIn::toJson() const
{
...
bool NameIn::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void NameIn::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool NameIn::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t NameIn::getName() const
{
    return m_Name;
}


void NameIn::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool NameIn::nameIsSet() const
{
    return m_NameIsSet;
}

void NameIn::unsetName()
{
    m_NameIsSet = false;
}
utility::string_t NameIn::getScope() const
{
    return m_Scope;
}


void NameIn::setScope(const utility::string_t& value)
{
    m_Scope = value;
    m_ScopeIsSet = true;
}

bool NameIn::scopeIsSet() const
{
    return m_ScopeIsSet;
}

void NameIn::unsetScope()
{
    m_ScopeIsSet = false;
}

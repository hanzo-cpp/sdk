...
O11y_O11yAttributeValuesOut::O11y_O11yAttributeValuesOut()
{
    m_DataIsSet = false;
...
void O11y_O11yAttributeValuesOut::validate()
{
    // TODO: implement validation
}

web::json::value O11y_O11yAttributeValuesOut::toJson() const
{
...
bool O11y_O11yAttributeValuesOut::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void O11y_O11yAttributeValuesOut::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool O11y_O11yAttributeValuesOut::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<O11y_FilterAttributeValueResponse> O11y_O11yAttributeValuesOut::getData() const
{
    return m_Data;
}


void O11y_O11yAttributeValuesOut::setData(const std::shared_ptr<O11y_FilterAttributeValueResponse>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool O11y_O11yAttributeValuesOut::dataIsSet() const
{
    return m_DataIsSet;
}

void O11y_O11yAttributeValuesOut::unsetData()
{
    m_DataIsSet = false;
}
utility::string_t O11y_O11yAttributeValuesOut::getStatus() const
{
    return m_Status;
}


void O11y_O11yAttributeValuesOut::setStatus(const utility::string_t& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool O11y_O11yAttributeValuesOut::statusIsSet() const
{
    return m_StatusIsSet;
}

void O11y_O11yAttributeValuesOut::unsetStatus()
{
    m_StatusIsSet = false;
}

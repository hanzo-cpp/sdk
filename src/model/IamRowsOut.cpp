...
void IamRowsOut::validate()
{
    // TODO: implement validation
}

web::json::value IamRowsOut::toJson() const
{
...
bool IamRowsOut::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void IamRowsOut::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool IamRowsOut::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<Object> IamRowsOut::getData() const
{
    return m_Data;
}


void IamRowsOut::setData(const std::shared_ptr<Object>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool IamRowsOut::dataIsSet() const
{
    return m_DataIsSet;
}

void IamRowsOut::unsetData()
{
    m_DataIsSet = false;
}
utility::string_t IamRowsOut::getMsg() const
{
    return m_Msg;
}


void IamRowsOut::setMsg(const utility::string_t& value)
{
    m_Msg = value;
    m_MsgIsSet = true;
}

bool IamRowsOut::msgIsSet() const
{
    return m_MsgIsSet;
}

void IamRowsOut::unsetMsg()
{
    m_MsgIsSet = false;
}
utility::string_t IamRowsOut::getStatus() const
{
    return m_Status;
}


void IamRowsOut::setStatus(const utility::string_t& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool IamRowsOut::statusIsSet() const
{
    return m_StatusIsSet;
}

void IamRowsOut::unsetStatus()
{
    m_StatusIsSet = false;
}
int32_t IamRowsOut::getTotal() const
{
    return m_Total;
}


void IamRowsOut::setTotal(int32_t value)
{
    m_Total = value;
    m_TotalIsSet = true;
}

bool IamRowsOut::totalIsSet() const
{
    return m_TotalIsSet;
}

void IamRowsOut::unsetTotal()
{
    m_TotalIsSet = false;
}

...
int64_t DataroomRoom::getCreatedAt() const
{
    return m_CreatedAt;
}


void DataroomRoom::setCreatedAt(int64_t value)
{
    m_CreatedAt = value;
...
int64_t DataroomRoom::getUpdatedAt() const
{
    return m_UpdatedAt;
}


void DataroomRoom::setUpdatedAt(int64_t value)
{
    m_UpdatedAt = value;

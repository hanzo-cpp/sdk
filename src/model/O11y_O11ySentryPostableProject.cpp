...
O11y_O11ySentryPostableProject::O11y_O11ySentryPostableProject()
{
...
void O11y_O11ySentryPostableProject::validate()
{
    // TODO: implement validation
}

web::json::value O11y_O11ySentryPostableProject::toJson() const
{
...
bool O11y_O11ySentryPostableProject::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void O11y_O11ySentryPostableProject::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool O11y_O11ySentryPostableProject::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t O11y_O11ySentryPostableProject::getName() const
{
    return m_Name;
}


void O11y_O11ySentryPostableProject::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool O11y_O11ySentryPostableProject::nameIsSet() const
{
    return m_NameIsSet;
}

void O11y_O11ySentryPostableProject::unsetName()
{
    m_NameIsSet = false;
}
utility::string_t O11y_O11ySentryPostableProject::getPlatform() const
{
    return m_Platform;
}


void O11y_O11ySentryPostableProject::setPlatform(const utility::string_t& value)
{
    m_Platform = value;
    m_PlatformIsSet = true;
}

bool O11y_O11ySentryPostableProject::platformIsSet() const
{
    return m_PlatformIsSet;
}

void O11y_O11ySentryPostableProject::unsetPlatform()
{
    m_PlatformIsSet = false;
}
utility::string_t O11y_O11ySentryPostableProject::getSlug() const
{
    return m_Slug;
}


void O11y_O11ySentryPostableProject::setSlug(const utility::string_t& value)
{
    m_Slug = value;
    m_SlugIsSet = true;
}

bool O11y_O11ySentryPostableProject::slugIsSet() const
{
    return m_SlugIsSet;
}

void O11y_O11ySentryPostableProject::unsetSlug()
{
    m_SlugIsSet = false;
}

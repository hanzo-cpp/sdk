...
#include "hanzo/model/O11y_GettableTestRule.h"
...
void O11y_GettableTestRule::validate()
{
    // TODO: implement validation
}

web::json::value O11y_GettableTestRule::toJson() const
{
...
bool O11y_GettableTestRule::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void O11y_GettableTestRule::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool O11y_GettableTestRule::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
bool O11y_GettableTestRule::alertCountIsSet() const
{
    return m_AlertCountIsSet;
}

void O11y_GettableTestRule::unsetAlertCount()
{
    m_AlertCountIsSet = false;
}
utility::string_t O11y_GettableTestRule::getMessage() const
{
    return m_Message;
}


void O11y_GettableTestRule::setMessage(const utility::string_t& value)
{
    m_Message = value;
    m_MessageIsSet = true;
}

bool O11y_GettableTestRule::messageIsSet() const
{
    return m_MessageIsSet;
}

void O11y_GettableTestRule::unsetMessage()
{
    m_MessageIsSet = false;
}

...
void Iam_Workspace::validate()
{
    // TODO: implement validation
}

web::json::value Iam_Workspace::toJson() const
{
...
bool Iam_Workspace::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Iam_Workspace::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Iam_Workspace::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t Iam_Workspace::getBucket() const
{
    return m_Bucket;
}


void Iam_Workspace::setBucket(const utility::string_t& value)
{
    m_Bucket = value;
    m_BucketIsSet = true;
}

bool Iam_Workspace::bucketIsSet() const
{
    return m_BucketIsSet;
}

void Iam_Workspace::unsetBucket()
{
    m_BucketIsSet = false;
}
utility::datetime Iam_Workspace::getCreatedAt() const
{
    return m_CreatedAt;
}


void Iam_Workspace::setCreatedAt(const utility::datetime& value)
{
    m_CreatedAt = value;
    m_CreatedAtIsSet = true;
}

bool Iam_Workspace::createdAtIsSet() const
{
    return m_CreatedAtIsSet;
}

void Iam_Workspace::unsetCreatedAt()
{
    m_CreatedAtIsSet = false;
}
utility::string_t Iam_Workspace::getCreatedTime() const
{
    return m_CreatedTime;
}


void Iam_Workspace::setCreatedTime(const utility::string_t& value)
{
    m_CreatedTime = value;
    m_CreatedTimeIsSet = true;
}

bool Iam_Workspace::createdTimeIsSet() const
{
    return m_CreatedTimeIsSet;
}

void Iam_Workspace::unsetCreatedTime()
{
    m_CreatedTimeIsSet = false;
}
bool Iam_Workspace::isDeleted() const
{
    return m_Deleted;
}


void Iam_Workspace::setDeleted(bool value)
{
    m_Deleted = value;
    m_DeletedIsSet = true;
}

bool Iam_Workspace::deletedIsSet() const
{
    return m_DeletedIsSet;
}

void Iam_Workspace::unsetDeleted()
{
    m_DeletedIsSet = false;
}
utility::string_t Iam_Workspace::getDescription() const
{
    return m_Description;
}


void Iam_Workspace::setDescription(const utility::string_t& value)
{
    m_Description = value;
    m_DescriptionIsSet = true;
}

bool Iam_Workspace::descriptionIsSet() const
{
    return m_DescriptionIsSet;
}

void Iam_Workspace::unsetDescription()
{
    m_DescriptionIsSet = false;
}
utility::string_t Iam_Workspace::getDisplayName() const
{
    return m_DisplayName;
}


void Iam_Workspace::setDisplayName(const utility::string_t& value)
{
    m_DisplayName = value;
    m_DisplayNameIsSet = true;
}

bool Iam_Workspace::displayNameIsSet() const
{
    return m_DisplayNameIsSet;
}

void Iam_Workspace::unsetDisplayName()
{
    m_DisplayNameIsSet = false;
}
utility::string_t Iam_Workspace::getId() const
{
    return m_Id;
}


void Iam_Workspace::setId(const utility::string_t& value)
{
    m_Id = value;
    m_IdIsSet = true;
}

bool Iam_Workspace::idIsSet() const
{
    return m_IdIsSet;
}

void Iam_Workspace::unsetId()
{
    m_IdIsSet = false;
}
bool Iam_Workspace::isIsDefault() const
{
    return m_IsDefault;
}


void Iam_Workspace::setIsDefault(bool value)
{
    m_IsDefault = value;
    m_IsDefaultIsSet = true;
}

bool Iam_Workspace::isDefaultIsSet() const
{
    return m_IsDefaultIsSet;
}

void Iam_Workspace::unsetIsDefault()
{
    m_IsDefaultIsSet = false;
}
utility::string_t Iam_Workspace::getMetadata() const
{
    return m_Metadata;
}


void Iam_Workspace::setMetadata(const utility::string_t& value)
{
    m_Metadata = value;
    m_MetadataIsSet = true;
}

bool Iam_Workspace::metadataIsSet() const
{
    return m_MetadataIsSet;
}

void Iam_Workspace::unsetMetadata()
{
    m_MetadataIsSet = false;
}
utility::string_t Iam_Workspace::getName() const
{
    return m_Name;
}


void Iam_Workspace::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool Iam_Workspace::nameIsSet() const
{
    return m_NameIsSet;
}

void Iam_Workspace::unsetName()
{
    m_NameIsSet = false;
}
utility::string_t Iam_Workspace::getOrganization() const
{
    return m_Organization;
}


void Iam_Workspace::setOrganization(const utility::string_t& value)
{
    m_Organization = value;
    m_OrganizationIsSet = true;
}

bool Iam_Workspace::organizationIsSet() const
{
    return m_OrganizationIsSet;
}

void Iam_Workspace::unsetOrganization()
{
    m_OrganizationIsSet = false;
}
utility::string_t Iam_Workspace::getOwner() const
{
    return m_Owner;
}


void Iam_Workspace::setOwner(const utility::string_t& value)
{
    m_Owner = value;
    m_OwnerIsSet = true;
}

bool Iam_Workspace::ownerIsSet() const
{
    return m_OwnerIsSet;
}

void Iam_Workspace::unsetOwner()
{
    m_OwnerIsSet = false;
}
std::vector<utility::string_t> Iam_Workspace::getTags() const
{
    return m_Tags;
}


void Iam_Workspace::setTags(const std::vector<utility::string_t>& value)
{
    m_Tags = value;
    m_TagsIsSet = true;
}

bool Iam_Workspace::tagsIsSet() const
{
    return m_TagsIsSet;
}

void Iam_Workspace::unsetTags()
{
    m_TagsIsSet = false;
}
utility::datetime Iam_Workspace::getUpdatedAt() const
{
    return m_UpdatedAt;
}


void Iam_Workspace::setUpdatedAt(const utility::datetime& value)
{
    m_UpdatedAt = value;
    m_UpdatedAtIsSet = true;
}

bool Iam_Workspace::updatedAtIsSet() const
{
    return m_UpdatedAtIsSet;
}

void Iam_Workspace::unsetUpdatedAt()
{
    m_UpdatedAtIsSet = false;
}

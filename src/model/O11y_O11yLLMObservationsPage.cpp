...
#include "hanzo/model/O11y_O11yLLMObservationsPage.h"
...
void O11y_O11yLLMObservationsPage::validate()
{
    // TODO: implement validation
}

web::json::value O11y_O11yLLMObservationsPage::toJson() const
{
...
bool O11y_O11yLLMObservationsPage::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("items"))))
    {
        ...
        {
            std::vector<std::shared_ptr<O11y_O11yLLMObservation>> refVal_setItems;
...
void O11y_O11yLLMObservationsPage::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool O11y_O11yLLMObservationsPage::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::vector<std::shared_ptr<O11y_O11yLLMObservation>> O11y_O11yLLMObservationsPage::getItems() const
{
    return m_Items;
}


void O11y_O11yLLMObservationsPage::setItems(const std::vector<std::shared_ptr<O11y_O11yLLMObservation>>& value)
{
    m_Items = value;
    m_ItemsIsSet = true;
}

bool O11y_O11yLLMObservationsPage::itemsIsSet() const
{
    return m_ItemsIsSet;
}

void O11y_O11yLLMObservationsPage::unsetItems()
{
    m_ItemsIsSet = false;
}
...
bool O11y_O11yLLMObservationsPage::limitIsSet() const
{
    return m_LimitIsSet;
}

void O11y_O11yLLMObservationsPage::unsetLimit()
{
    m_LimitIsSet = false;
}
...
bool O11y_O11yLLMObservationsPage::offsetIsSet() const
{
    return m_OffsetIsSet;
}

void O11y_O11yLLMObservationsPage::unsetOffset()
{
    m_OffsetIsSet = false;
}

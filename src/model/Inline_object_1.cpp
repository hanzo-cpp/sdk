...
utility::string_t Inline_object_1::getError() const
{
    return m_Error;
}


void Inline_object_1::setError(const utility::string_t& value)
{
    m_Error = value;
    m_ErrorIsSet = true;
}

bool Inline_object_1::errorIsSet() const
{
    return m_ErrorIsSet;
}

void Inline_object_1::unsetError()
{
    m_ErrorIsSet = false;
}
int32_t Inline_object_1::getCode() const
{
    return m_Code;
}


void Inline_object_1::setCode(int32_t value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool Inline_object_1::codeIsSet() const
{
    return m_CodeIsSet;
}

void Inline_object_1::unsetCode()
{
    m_CodeIsSet = false;
}

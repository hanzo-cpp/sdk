...
void UpdateEndpointIn::validate()
{
    // TODO: implement validation
}

web::json::value UpdateEndpointIn::toJson() const
{
...
bool UpdateEndpointIn::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void UpdateEndpointIn::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool UpdateEndpointIn::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t UpdateEndpointIn::getDescription() const
{
    return m_Description;
}


void UpdateEndpointIn::setDescription(const utility::string_t& value)
{
    m_Description = value;
    m_DescriptionIsSet = true;
}

bool UpdateEndpointIn::descriptionIsSet() const
{
    return m_DescriptionIsSet;
}

void UpdateEndpointIn::unsetDescription()
{
    m_DescriptionIsSet = false;
}
std::vector<utility::string_t> UpdateEndpointIn::getEvents() const
{
    return m_Events;
}


void UpdateEndpointIn::setEvents(const std::vector<utility::string_t>& value)
{
    m_Events = value;
    m_EventsIsSet = true;
}

bool UpdateEndpointIn::eventsIsSet() const
{
    return m_EventsIsSet;
}

void UpdateEndpointIn::unsetEvents()
{
    m_EventsIsSet = false;
}
utility::string_t UpdateEndpointIn::getStatus() const
{
    return m_Status;
}


void UpdateEndpointIn::setStatus(const utility::string_t& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool UpdateEndpointIn::statusIsSet() const
{
    return m_StatusIsSet;
}

void UpdateEndpointIn::unsetStatus()
{
    m_StatusIsSet = false;
}
utility::string_t UpdateEndpointIn::getUrl() const
{
    return m_Url;
}


void UpdateEndpointIn::setUrl(const utility::string_t& value)
{
    m_Url = value;
    m_UrlIsSet = true;
}

bool UpdateEndpointIn::urlIsSet() const
{
    return m_UrlIsSet;
}

void UpdateEndpointIn::unsetUrl()
{
    m_UrlIsSet = false;
}

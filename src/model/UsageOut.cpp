...
void UsageOut::validate()
{
    // TODO: implement validation
}

web::json::value UsageOut::toJson() const
{
...
bool UsageOut::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("data"))))
    {
        ...
        {
            std::shared_ptr<UsageData> refVal_setData;
...
void UsageOut::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool UsageOut::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<UsageData> UsageOut::getData() const
{
    return m_Data;
}


void UsageOut::setData(const std::shared_ptr<UsageData>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool UsageOut::dataIsSet() const
{
    return m_DataIsSet;
}

void UsageOut::unsetData()
{
    m_DataIsSet = false;
}
utility::string_t UsageOut::getMsg() const
{
    return m_Msg;
}


void UsageOut::setMsg(const utility::string_t& value)
{
    m_Msg = value;
    m_MsgIsSet = true;
}

bool UsageOut::msgIsSet() const
{
    return m_MsgIsSet;
}

void UsageOut::unsetMsg()
{
    m_MsgIsSet = false;
}
utility::string_t UsageOut::getStatus() const
{
    return m_Status;
}


void UsageOut::setStatus(const utility::string_t& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool UsageOut::statusIsSet() const
{
    return m_StatusIsSet;
}

void UsageOut::unsetStatus()
{
    m_StatusIsSet = false;
}

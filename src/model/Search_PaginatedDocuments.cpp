...
Search_PaginatedDocuments::Search_PaginatedDocuments()
{
...
void Search_PaginatedDocuments::validate()
{
    // TODO: implement validation
}

web::json::value Search_PaginatedDocuments::toJson() const
{
...
bool Search_PaginatedDocuments::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("results"))))
    {
        ...
        {
            std::vector<std::shared_ptr<Object>> refVal_setResults;
...
void Search_PaginatedDocuments::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Search_PaginatedDocuments::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::vector<std::shared_ptr<Object>> Search_PaginatedDocuments::getResults() const
{
    return m_Results;
}


void Search_PaginatedDocuments::setResults(const std::vector<std::shared_ptr<Object>>& value)
{
    m_Results = value;
    m_ResultsIsSet = true;
}

bool Search_PaginatedDocuments::resultsIsSet() const
{
    return m_ResultsIsSet;
}

void Search_PaginatedDocuments::unsetResults()
{
    m_ResultsIsSet = false;
}
int32_t Search_PaginatedDocuments::getOffset() const
{
    return m_Offset;
}


void Search_PaginatedDocuments::setOffset(int32_t value)
{
    m_Offset = value;
    m_OffsetIsSet = true;
}

bool Search_PaginatedDocuments::offsetIsSet() const
{
    return m_OffsetIsSet;
}

void Search_PaginatedDocuments::unsetOffset()
{
    m_OffsetIsSet = false;
}
int32_t Search_PaginatedDocuments::getLimit() const
{
    return m_Limit;
}


void Search_PaginatedDocuments::setLimit(int32_t value)
{
    m_Limit = value;
    m_LimitIsSet = true;
}

bool Search_PaginatedDocuments::limitIsSet() const
{
    return m_LimitIsSet;
}

void Search_PaginatedDocuments::unsetLimit()
{
    m_LimitIsSet = false;
}
int32_t Search_PaginatedDocuments::getTotal() const
{
    return m_Total;
}


void Search_PaginatedDocuments::setTotal(int32_t value)
{
    m_Total = value;
    m_TotalIsSet = true;
}

bool Search_PaginatedDocuments::totalIsSet() const
{
    return m_TotalIsSet;
}

void Search_PaginatedDocuments::unsetTotal()
{
    m_TotalIsSet = false;
}

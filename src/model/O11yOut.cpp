...
void O11yOut::validate()
{
    // TODO: implement validation
}

web::json::value O11yOut::toJson() const
{
...
bool O11yOut::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("data"))))
    {
        ...
        {
            std::shared_ptr<O11yGlobal> refVal_setData;
...
void O11yOut::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool O11yOut::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<O11yGlobal> O11yOut::getData() const
{
    return m_Data;
}


void O11yOut::setData(const std::shared_ptr<O11yGlobal>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool O11yOut::dataIsSet() const
{
    return m_DataIsSet;
}

void O11yOut::unsetData()
{
    m_DataIsSet = false;
}
utility::string_t O11yOut::getMsg() const
{
    return m_Msg;
}


void O11yOut::setMsg(const utility::string_t& value)
{
    m_Msg = value;
    m_MsgIsSet = true;
}

bool O11yOut::msgIsSet() const
{
    return m_MsgIsSet;
}

void O11yOut::unsetMsg()
{
    m_MsgIsSet = false;
}
utility::string_t O11yOut::getStatus() const
{
    return m_Status;
}


void O11yOut::setStatus(const utility::string_t& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool O11yOut::statusIsSet() const
{
    return m_StatusIsSet;
}

void O11yOut::unsetStatus()
{
    m_StatusIsSet = false;
}

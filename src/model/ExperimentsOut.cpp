...
void ExperimentsOut::validate()
{
    // TODO: implement validation
}

web::json::value ExperimentsOut::toJson() const
{
...
bool ExperimentsOut::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("data"))))
    {
        ...
        {
            std::vector<std::shared_ptr<Experiment>> refVal_setData;
...
void ExperimentsOut::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ExperimentsOut::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::vector<std::shared_ptr<Experiment>> ExperimentsOut::getData() const
{
    return m_Data;
}


void ExperimentsOut::setData(const std::vector<std::shared_ptr<Experiment>>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool ExperimentsOut::dataIsSet() const
{
    return m_DataIsSet;
}

void ExperimentsOut::unsetData()
{
    m_DataIsSet = false;
}
int32_t ExperimentsOut::getTotal() const
{
    return m_Total;
}


void ExperimentsOut::setTotal(int32_t value)
{
    m_Total = value;
    m_TotalIsSet = true;
}

bool ExperimentsOut::totalIsSet() const
{
    return m_TotalIsSet;
}

void ExperimentsOut::unsetTotal()
{
    m_TotalIsSet = false;
}

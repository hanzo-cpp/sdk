...
#include "hanzo/model/Framework_Role.h"
...
void Framework_Role::validate()
{
    // TODO: implement validation
}

web::json::value Framework_Role::toJson() const
{
...
bool Framework_Role::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Framework_Role::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Framework_Role::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t Framework_Role::getUser() const
{
    return m_User;
}


void Framework_Role::setUser(const utility::string_t& value)
{
    m_User = value;
    m_UserIsSet = true;
}

bool Framework_Role::userIsSet() const
{
    return m_UserIsSet;
}

void Framework_Role::unsetUser()
{
    m_UserIsSet = false;
}
utility::string_t Framework_Role::getRole() const
{
    return m_Role;
}


void Framework_Role::setRole(const utility::string_t& value)
{
    m_Role = value;
    m_RoleIsSet = true;
}

bool Framework_Role::roleIsSet() const
{
    return m_RoleIsSet;
}

void Framework_Role::unsetRole()
{
    m_RoleIsSet = false;
}

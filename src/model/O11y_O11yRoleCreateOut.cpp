...
O11y_O11yRoleCreateOut::O11y_O11yRoleCreateOut()
{
    m_DataIsSet = false;
...
void O11y_O11yRoleCreateOut::validate()
{
    // TODO: implement validation
}

web::json::value O11y_O11yRoleCreateOut::toJson() const
{
...
bool O11y_O11yRoleCreateOut::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void O11y_O11yRoleCreateOut::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool O11y_O11yRoleCreateOut::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<O11y_O11yCreated> O11y_O11yRoleCreateOut::getData() const
{
    return m_Data;
}


void O11y_O11yRoleCreateOut::setData(const std::shared_ptr<O11y_O11yCreated>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool O11y_O11yRoleCreateOut::dataIsSet() const
{
    return m_DataIsSet;
}

void O11y_O11yRoleCreateOut::unsetData()
{
    m_DataIsSet = false;
}
utility::string_t O11y_O11yRoleCreateOut::getStatus() const
{
    return m_Status;
}


void O11y_O11yRoleCreateOut::setStatus(const utility::string_t& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool O11y_O11yRoleCreateOut::statusIsSet() const
{
    return m_StatusIsSet;
}

void O11y_O11yRoleCreateOut::unsetStatus()
{
    m_StatusIsSet = false;
}

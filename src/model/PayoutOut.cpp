...
void PayoutOut::validate()
{
    // TODO: implement validation
}

web::json::value PayoutOut::toJson() const
{
...
bool PayoutOut::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("data"))))
    {
        ...
        {
            std::shared_ptr<Settlement> refVal_setData;
...
void PayoutOut::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool PayoutOut::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<Settlement> PayoutOut::getData() const
{
    return m_Data;
}


void PayoutOut::setData(const std::shared_ptr<Settlement>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool PayoutOut::dataIsSet() const
{
    return m_DataIsSet;
}

void PayoutOut::unsetData()
{
    m_DataIsSet = false;
}
utility::string_t PayoutOut::getMsg() const
{
    return m_Msg;
}


void PayoutOut::setMsg(const utility::string_t& value)
{
    m_Msg = value;
    m_MsgIsSet = true;
}

bool PayoutOut::msgIsSet() const
{
    return m_MsgIsSet;
}

void PayoutOut::unsetMsg()
{
    m_MsgIsSet = false;
}
utility::string_t PayoutOut::getStatus() const
{
    return m_Status;
}


void PayoutOut::setStatus(const utility::string_t& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool PayoutOut::statusIsSet() const
{
    return m_StatusIsSet;
}

void PayoutOut::unsetStatus()
{
    m_StatusIsSet = false;
}

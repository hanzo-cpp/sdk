...
O11y_O11yClusterListOut::O11y_O11yClusterListOut()
{
    m_DataIsSet = false;
...
void O11y_O11yClusterListOut::validate()
{
    // TODO: implement validation
}

web::json::value O11y_O11yClusterListOut::toJson() const
{
...
bool O11y_O11yClusterListOut::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("data"))))
    {
        ...
        {
            std::shared_ptr<O11y_ClusterListResponse> refVal_setData;
...
void O11y_O11yClusterListOut::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool O11y_O11yClusterListOut::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<O11y_ClusterListResponse> O11y_O11yClusterListOut::getData() const
{
    return m_Data;
}


void O11y_O11yClusterListOut::setData(const std::shared_ptr<O11y_ClusterListResponse>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool O11y_O11yClusterListOut::dataIsSet() const
{
    return m_DataIsSet;
}

void O11y_O11yClusterListOut::unsetData()
{
    m_DataIsSet = false;
}
utility::string_t O11y_O11yClusterListOut::getStatus() const
{
    return m_Status;
}


void O11y_O11yClusterListOut::setStatus(const utility::string_t& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool O11y_O11yClusterListOut::statusIsSet() const
{
    return m_StatusIsSet;
}

void O11y_O11yClusterListOut::unsetStatus()
{
    m_StatusIsSet = false;
}

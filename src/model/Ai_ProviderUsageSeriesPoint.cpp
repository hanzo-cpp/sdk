...
Ai_ProviderUsageSeriesPoint::Ai_ProviderUsageSeriesPoint()
{
    m_Requests = 0;
...
void Ai_ProviderUsageSeriesPoint::validate()
{
    // TODO: implement validation
}

web::json::value Ai_ProviderUsageSeriesPoint::toJson() const
{
...
bool Ai_ProviderUsageSeriesPoint::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Ai_ProviderUsageSeriesPoint::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Ai_ProviderUsageSeriesPoint::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
int32_t Ai_ProviderUsageSeriesPoint::getRequests() const
{
    return m_Requests;
}


void Ai_ProviderUsageSeriesPoint::setRequests(int32_t value)
{
    m_Requests = value;
    m_RequestsIsSet = true;
}

bool Ai_ProviderUsageSeriesPoint::requestsIsSet() const
{
    return m_RequestsIsSet;
}

void Ai_ProviderUsageSeriesPoint::unsetRequests()
{
    m_RequestsIsSet = false;
}
int32_t Ai_ProviderUsageSeriesPoint::getSpendCents() const
{
    return m_SpendCents;
}


void Ai_ProviderUsageSeriesPoint::setSpendCents(int32_t value)
{
    m_SpendCents = value;
    m_SpendCentsIsSet = true;
}

bool Ai_ProviderUsageSeriesPoint::spendCentsIsSet() const
{
    return m_SpendCentsIsSet;
}

void Ai_ProviderUsageSeriesPoint::unsetSpendCents()
{
    m_SpendCentsIsSet = false;
}
utility::string_t Ai_ProviderUsageSeriesPoint::getT() const
{
    return m_t;
}


void Ai_ProviderUsageSeriesPoint::setT(const utility::string_t& value)
{
    m_t = value;
    m_tIsSet = true;
}

bool Ai_ProviderUsageSeriesPoint::TIsSet() const
{
    return m_tIsSet;
}

void Ai_ProviderUsageSeriesPoint::unsett()
{
    m_tIsSet = false;
}
int32_t Ai_ProviderUsageSeriesPoint::getTokens() const
{
    return m_Tokens;
}


void Ai_ProviderUsageSeriesPoint::setTokens(int32_t value)
{
    m_Tokens = value;
    m_TokensIsSet = true;
}

bool Ai_ProviderUsageSeriesPoint::tokensIsSet() const
{
    return m_TokensIsSet;
}

void Ai_ProviderUsageSeriesPoint::unsetTokens()
{
    m_TokensIsSet = false;
}

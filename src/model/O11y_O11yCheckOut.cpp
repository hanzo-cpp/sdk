...
O11y_O11yCheckOut::O11y_O11yCheckOut()
{
    m_DataIsSet = false;
...
void O11y_O11yCheckOut::validate()
{
    // TODO: implement validation
}

web::json::value O11y_O11yCheckOut::toJson() const
{
...
bool O11y_O11yCheckOut::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("data"))))
    {
        ...
        {
            std::vector<std::shared_ptr<O11y_O11yTransactionResult>> refVal_setData;
...
void O11y_O11yCheckOut::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool O11y_O11yCheckOut::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::vector<std::shared_ptr<O11y_O11yTransactionResult>> O11y_O11yCheckOut::getData() const
{
    return m_Data;
}


void O11y_O11yCheckOut::setData(const std::vector<std::shared_ptr<O11y_O11yTransactionResult>>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool O11y_O11yCheckOut::dataIsSet() const
{
    return m_DataIsSet;
}

void O11y_O11yCheckOut::unsetData()
{
    m_DataIsSet = false;
}
utility::string_t O11y_O11yCheckOut::getStatus() const
{
    return m_Status;
}


void O11y_O11yCheckOut::setStatus(const utility::string_t& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool O11y_O11yCheckOut::statusIsSet() const
{
    return m_StatusIsSet;
}

void O11y_O11yCheckOut::unsetStatus()
{
    m_StatusIsSet = false;
}

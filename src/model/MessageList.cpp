...
void MessageList::validate()
{
    // TODO: implement validation
}

web::json::value MessageList::toJson() const
{
...
bool MessageList::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("data"))))
    {
        ...
        {
            std::vector<std::shared_ptr<SMS>> refVal_setData;
...
void MessageList::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool MessageList::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::vector<std::shared_ptr<SMS>> MessageList::getData() const
{
    return m_Data;
}


void MessageList::setData(const std::vector<std::shared_ptr<SMS>>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool MessageList::dataIsSet() const
{
    return m_DataIsSet;
}

void MessageList::unsetData()
{
    m_DataIsSet = false;
}

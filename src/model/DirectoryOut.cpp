...
void DirectoryOut::validate()
{
    // TODO: implement validation
}

web::json::value DirectoryOut::toJson() const
{
...
bool DirectoryOut::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("data"))))
    {
        ...
        {
            std::shared_ptr<DirectoryData> refVal_setData;
...
void DirectoryOut::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool DirectoryOut::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<DirectoryData> DirectoryOut::getData() const
{
    return m_Data;
}


void DirectoryOut::setData(const std::shared_ptr<DirectoryData>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool DirectoryOut::dataIsSet() const
{
    return m_DataIsSet;
}

void DirectoryOut::unsetData()
{
    m_DataIsSet = false;
}
utility::string_t DirectoryOut::getMsg() const
{
    return m_Msg;
}


void DirectoryOut::setMsg(const utility::string_t& value)
{
    m_Msg = value;
    m_MsgIsSet = true;
}

bool DirectoryOut::msgIsSet() const
{
    return m_MsgIsSet;
}

void DirectoryOut::unsetMsg()
{
    m_MsgIsSet = false;
}
utility::string_t DirectoryOut::getStatus() const
{
    return m_Status;
}


void DirectoryOut::setStatus(const utility::string_t& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool DirectoryOut::statusIsSet() const
{
    return m_StatusIsSet;
}

void DirectoryOut::unsetStatus()
{
    m_StatusIsSet = false;
}

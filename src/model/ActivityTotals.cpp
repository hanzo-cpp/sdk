...
#include "hanzo/model/ActivityTotals.h"
...
void ActivityTotals::validate()
{
    // TODO: implement validation
}

web::json::value ActivityTotals::toJson() const
{
...
bool ActivityTotals::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void ActivityTotals::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ActivityTotals::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
bool ActivityTotals::activeDaysIsSet() const
{
    return m_ActiveDaysIsSet;
}

void ActivityTotals::unsetActiveDays()
{
    m_ActiveDaysIsSet = false;
}
...
bool ActivityTotals::costCentsIsSet() const
{
    return m_CostCentsIsSet;
}

void ActivityTotals::unsetCostCents()
{
    m_CostCentsIsSet = false;
}
...
bool ActivityTotals::maxRequestsIsSet() const
{
    return m_MaxRequestsIsSet;
}

void ActivityTotals::unsetMaxRequests()
{
    m_MaxRequestsIsSet = false;
}
...
bool ActivityTotals::maxTokensIsSet() const
{
    return m_MaxTokensIsSet;
}

void ActivityTotals::unsetMaxTokens()
{
    m_MaxTokensIsSet = false;
}
...
bool ActivityTotals::requestsIsSet() const
{
    return m_RequestsIsSet;
}

void ActivityTotals::unsetRequests()
{
    m_RequestsIsSet = false;
}
...
bool ActivityTotals::tokensIsSet() const
{
    return m_TokensIsSet;
}

void ActivityTotals::unsetTokens()
{
    m_TokensIsSet = false;
}

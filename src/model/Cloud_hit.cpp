...
void Cloud_hit::validate()
{
    // TODO: implement validation
}

web::json::value Cloud_hit::toJson() const
{
...
bool Cloud_hit::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Cloud_hit::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Cloud_hit::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t Cloud_hit::getDoctype() const
{
    return m_Doctype;
}


void Cloud_hit::setDoctype(const utility::string_t& value)
{
    m_Doctype = value;
    m_DoctypeIsSet = true;
}

bool Cloud_hit::doctypeIsSet() const
{
    return m_DoctypeIsSet;
}

void Cloud_hit::unsetDoctype()
{
    m_DoctypeIsSet = false;
}
utility::string_t Cloud_hit::getName() const
{
    return m_Name;
}


void Cloud_hit::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool Cloud_hit::nameIsSet() const
{
    return m_NameIsSet;
}

void Cloud_hit::unsetName()
{
    m_NameIsSet = false;
}
utility::string_t Cloud_hit::getProject() const
{
    return m_Project;
}


void Cloud_hit::setProject(const utility::string_t& value)
{
    m_Project = value;
    m_ProjectIsSet = true;
}

bool Cloud_hit::projectIsSet() const
{
    return m_ProjectIsSet;
}

void Cloud_hit::unsetProject()
{
    m_ProjectIsSet = false;
}
utility::string_t Cloud_hit::getProvider() const
{
    return m_Provider;
}


void Cloud_hit::setProvider(const utility::string_t& value)
{
    m_Provider = value;
    m_ProviderIsSet = true;
}

bool Cloud_hit::providerIsSet() const
{
    return m_ProviderIsSet;
}

void Cloud_hit::unsetProvider()
{
    m_ProviderIsSet = false;
}
double Cloud_hit::getScore() const
{
    return m_Score;
}


void Cloud_hit::setScore(double value)
{
    m_Score = value;
    m_ScoreIsSet = true;
}

bool Cloud_hit::scoreIsSet() const
{
    return m_ScoreIsSet;
}

void Cloud_hit::unsetScore()
{
    m_ScoreIsSet = false;
}
utility::string_t Cloud_hit::getTitle() const
{
    return m_Title;
}


void Cloud_hit::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool Cloud_hit::titleIsSet() const
{
    return m_TitleIsSet;
}

void Cloud_hit::unsetTitle()
{
    m_TitleIsSet = false;
}
utility::string_t Cloud_hit::getUrl() const
{
    return m_Url;
}


void Cloud_hit::setUrl(const utility::string_t& value)
{
    m_Url = value;
    m_UrlIsSet = true;
}

bool Cloud_hit::urlIsSet() const
{
    return m_UrlIsSet;
}

void Cloud_hit::unsetUrl()
{
    m_UrlIsSet = false;
}

...
void DriveIn::validate()
{
    // TODO: implement validation
}

web::json::value DriveIn::toJson() const
{
...
bool DriveIn::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void DriveIn::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool DriveIn::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t DriveIn::getName() const
{
    return m_Name;
}


void DriveIn::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool DriveIn::nameIsSet() const
{
    return m_NameIsSet;
}

void DriveIn::unsetName()
{
    m_NameIsSet = false;
}
utility::string_t DriveIn::getSpace() const
{
    return m_Space;
}


void DriveIn::setSpace(const utility::string_t& value)
{
    m_Space = value;
    m_SpaceIsSet = true;
}

bool DriveIn::spaceIsSet() const
{
    return m_SpaceIsSet;
}

void DriveIn::unsetSpace()
{
    m_SpaceIsSet = false;
}

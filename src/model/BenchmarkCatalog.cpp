...
void BenchmarkCatalog::validate()
{
    // TODO: implement validation
}

web::json::value BenchmarkCatalog::toJson() const
{
...
bool BenchmarkCatalog::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("data"))))
    {
        ...
        {
            std::vector<std::shared_ptr<Benchmark>> refVal_setData;
...
void BenchmarkCatalog::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool BenchmarkCatalog::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::vector<std::shared_ptr<Benchmark>> BenchmarkCatalog::getData() const
{
    return m_Data;
}


void BenchmarkCatalog::setData(const std::vector<std::shared_ptr<Benchmark>>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool BenchmarkCatalog::dataIsSet() const
{
    return m_DataIsSet;
}

void BenchmarkCatalog::unsetData()
{
    m_DataIsSet = false;
}
int32_t BenchmarkCatalog::getTotal() const
{
    return m_Total;
}


void BenchmarkCatalog::setTotal(int32_t value)
{
    m_Total = value;
    m_TotalIsSet = true;
}

bool BenchmarkCatalog::totalIsSet() const
{
    return m_TotalIsSet;
}

void BenchmarkCatalog::unsetTotal()
{
    m_TotalIsSet = false;
}

...
void MoneyOut::validate()
{
    // TODO: implement validation
}

web::json::value MoneyOut::toJson() const
{
...
bool MoneyOut::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("data"))))
    {
        ...
        {
            std::shared_ptr<MoneyBoard> refVal_setData;
...
void MoneyOut::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool MoneyOut::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<MoneyBoard> MoneyOut::getData() const
{
    return m_Data;
}


void MoneyOut::setData(const std::shared_ptr<MoneyBoard>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool MoneyOut::dataIsSet() const
{
    return m_DataIsSet;
}

void MoneyOut::unsetData()
{
    m_DataIsSet = false;
}
utility::string_t MoneyOut::getMsg() const
{
    return m_Msg;
}


void MoneyOut::setMsg(const utility::string_t& value)
{
    m_Msg = value;
    m_MsgIsSet = true;
}

bool MoneyOut::msgIsSet() const
{
    return m_MsgIsSet;
}

void MoneyOut::unsetMsg()
{
    m_MsgIsSet = false;
}
utility::string_t MoneyOut::getStatus() const
{
    return m_Status;
}


void MoneyOut::setStatus(const utility::string_t& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool MoneyOut::statusIsSet() const
{
    return m_StatusIsSet;
}

void MoneyOut::unsetStatus()
{
    m_StatusIsSet = false;
}

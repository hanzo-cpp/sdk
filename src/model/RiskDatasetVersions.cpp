...
RiskDatasetVersions::RiskDatasetVersions()
{
    m_ItemsIsSet = false;
...
void RiskDatasetVersions::validate()
{
    // TODO: implement validation
}

web::json::value RiskDatasetVersions::toJson() const
{
...
bool RiskDatasetVersions::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("items"))))
    {
        ...
        {
            std::vector<std::shared_ptr<RiskDataset>> refVal_setItems;
...
void RiskDatasetVersions::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool RiskDatasetVersions::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::vector<std::shared_ptr<RiskDataset>> RiskDatasetVersions::getItems() const
{
    return m_Items;
}


void RiskDatasetVersions::setItems(const std::vector<std::shared_ptr<RiskDataset>>& value)
{
    m_Items = value;
    m_ItemsIsSet = true;
}

bool RiskDatasetVersions::itemsIsSet() const
{
    return m_ItemsIsSet;
}

void RiskDatasetVersions::unsetItems()
{
    m_ItemsIsSet = false;
}
utility::string_t RiskDatasetVersions::getName() const
{
    return m_Name;
}


void RiskDatasetVersions::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool RiskDatasetVersions::nameIsSet() const
{
    return m_NameIsSet;
}

void RiskDatasetVersions::unsetName()
{
    m_NameIsSet = false;
}

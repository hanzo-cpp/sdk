...
O11y_O11yCreatedLimitOut::O11y_O11yCreatedLimitOut()
{
    m_DataIsSet = false;
...
void O11y_O11yCreatedLimitOut::validate()
{
    // TODO: implement validation
}

web::json::value O11y_O11yCreatedLimitOut::toJson() const
{
...
bool O11y_O11yCreatedLimitOut::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("data"))))
    {
        ...
        {
            std::shared_ptr<O11y_GettableCreatedIngestionKeyLimit> refVal_setData;
...
void O11y_O11yCreatedLimitOut::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool O11y_O11yCreatedLimitOut::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<O11y_GettableCreatedIngestionKeyLimit> O11y_O11yCreatedLimitOut::getData() const
{
    return m_Data;
}


void O11y_O11yCreatedLimitOut::setData(const std::shared_ptr<O11y_GettableCreatedIngestionKeyLimit>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool O11y_O11yCreatedLimitOut::dataIsSet() const
{
    return m_DataIsSet;
}

void O11y_O11yCreatedLimitOut::unsetData()
{
    m_DataIsSet = false;
}
utility::string_t O11y_O11yCreatedLimitOut::getStatus() const
{
    return m_Status;
}


void O11y_O11yCreatedLimitOut::setStatus(const utility::string_t& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool O11y_O11yCreatedLimitOut::statusIsSet() const
{
    return m_StatusIsSet;
}

void O11y_O11yCreatedLimitOut::unsetStatus()
{
    m_StatusIsSet = false;
}

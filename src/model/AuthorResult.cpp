...
void AuthorResult::validate()
{
    // TODO: implement validation
}

web::json::value AuthorResult::toJson() const
{
...
bool AuthorResult::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("data"))))
    {
        ...
        {
            std::shared_ptr<AuthorData> refVal_setData;
...
void AuthorResult::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool AuthorResult::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<AuthorData> AuthorResult::getData() const
{
    return m_Data;
}


void AuthorResult::setData(const std::shared_ptr<AuthorData>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool AuthorResult::dataIsSet() const
{
    return m_DataIsSet;
}

void AuthorResult::unsetData()
{
    m_DataIsSet = false;
}
utility::string_t AuthorResult::getMsg() const
{
    return m_Msg;
}


void AuthorResult::setMsg(const utility::string_t& value)
{
    m_Msg = value;
    m_MsgIsSet = true;
}

bool AuthorResult::msgIsSet() const
{
    return m_MsgIsSet;
}

void AuthorResult::unsetMsg()
{
    m_MsgIsSet = false;
}
utility::string_t AuthorResult::getStatus() const
{
    return m_Status;
}


void AuthorResult::setStatus(const utility::string_t& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool AuthorResult::statusIsSet() const
{
    return m_StatusIsSet;
}

void AuthorResult::unsetStatus()
{
    m_StatusIsSet = false;
}

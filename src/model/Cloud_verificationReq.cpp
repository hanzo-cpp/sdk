...
Cloud_verificationReq::Cloud_verificationReq()
{
...
void Cloud_verificationReq::validate()
{
    // TODO: implement validation
}

web::json::value Cloud_verificationReq::toJson() const
{
...
bool Cloud_verificationReq::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Cloud_verificationReq::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Cloud_verificationReq::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t Cloud_verificationReq::getEmail() const
{
    return m_Email;
}


void Cloud_verificationReq::setEmail(const utility::string_t& value)
{
    m_Email = value;
    m_EmailIsSet = true;
}

bool Cloud_verificationReq::emailIsSet() const
{
    return m_EmailIsSet;
}

void Cloud_verificationReq::unsetEmail()
{
    m_EmailIsSet = false;
}
utility::string_t Cloud_verificationReq::getKind() const
{
    return m_Kind;
}


void Cloud_verificationReq::setKind(const utility::string_t& value)
{
    m_Kind = value;
    m_KindIsSet = true;
}

bool Cloud_verificationReq::kindIsSet() const
{
    return m_KindIsSet;
}

void Cloud_verificationReq::unsetKind()
{
    m_KindIsSet = false;
}
utility::string_t Cloud_verificationReq::getName() const
{
    return m_Name;
}


void Cloud_verificationReq::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool Cloud_verificationReq::nameIsSet() const
{
    return m_NameIsSet;
}

void Cloud_verificationReq::unsetName()
{
    m_NameIsSet = false;
}
utility::string_t Cloud_verificationReq::getRef() const
{
    return m_Ref;
}


void Cloud_verificationReq::setRef(const utility::string_t& value)
{
    m_Ref = value;
    m_RefIsSet = true;
}

bool Cloud_verificationReq::refIsSet() const
{
    return m_RefIsSet;
}

void Cloud_verificationReq::unsetRef()
{
    m_RefIsSet = false;
}
utility::string_t Cloud_verificationReq::getSubjectId() const
{
    return m_SubjectId;
}


void Cloud_verificationReq::setSubjectId(const utility::string_t& value)
{
    m_SubjectId = value;
    m_SubjectIdIsSet = true;
}

bool Cloud_verificationReq::subjectIdIsSet() const
{
    return m_SubjectIdIsSet;
}

void Cloud_verificationReq::unsetSubjectId()
{
    m_SubjectIdIsSet = false;
}

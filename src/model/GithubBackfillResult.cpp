...
void GithubBackfillResult::validate()
{
    // TODO: implement validation
}

web::json::value GithubBackfillResult::toJson() const
{
...
bool GithubBackfillResult::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void GithubBackfillResult::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool GithubBackfillResult::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
bool GithubBackfillResult::createdIsSet() const
{
    return m_CreatedIsSet;
}

void GithubBackfillResult::unsetCreated()
{
    m_CreatedIsSet = false;
}
...
bool GithubBackfillResult::failedIsSet() const
{
    return m_FailedIsSet;
}

void GithubBackfillResult::unsetFailed()
{
    m_FailedIsSet = false;
}
...
bool GithubBackfillResult::issuesIsSet() const
{
    return m_IssuesIsSet;
}

void GithubBackfillResult::unsetIssues()
{
    m_IssuesIsSet = false;
}
...
bool GithubBackfillResult::reposIsSet() const
{
    return m_ReposIsSet;
}

void GithubBackfillResult::unsetRepos()
{
    m_ReposIsSet = false;
}
bool GithubBackfillResult::isTruncated() const
{
    return m_Truncated;
}


void GithubBackfillResult::setTruncated(bool value)
{
    m_Truncated = value;
    m_TruncatedIsSet = true;
}

bool GithubBackfillResult::truncatedIsSet() const
{
    return m_TruncatedIsSet;
}

void GithubBackfillResult::unsetTruncated()
{
    m_TruncatedIsSet = false;
}
...
bool GithubBackfillResult::updatedIsSet() const
{
    return m_UpdatedIsSet;
}

void GithubBackfillResult::unsetUpdated()
{
    m_UpdatedIsSet = false;
}

...
void Breakdown::validate()
{
    // TODO: implement validation
}

web::json::value Breakdown::toJson() const
{
...
bool Breakdown::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("items"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<BreakdownRow>> refVal_setItems;
...
void Breakdown::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Breakdown::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
bool Breakdown::isAvailable() const
{
    return m_Available;
}


void Breakdown::setAvailable(bool value)
{
    m_Available = value;
    m_AvailableIsSet = true;
}

bool Breakdown::availableIsSet() const
{
    return m_AvailableIsSet;
}

void Breakdown::unsetAvailable()
{
    m_AvailableIsSet = false;
}
std::vector<std::shared_ptr<BreakdownRow>> Breakdown::getItems() const
{
    return m_Items;
}


void Breakdown::setItems(const std::vector<std::shared_ptr<BreakdownRow>>& value)
{
    m_Items = value;
    m_ItemsIsSet = true;
}

bool Breakdown::itemsIsSet() const
{
    return m_ItemsIsSet;
}

void Breakdown::unsetItems()
{
    m_ItemsIsSet = false;
}
utility::string_t Breakdown::getReason() const
{
    return m_Reason;
}


void Breakdown::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool Breakdown::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void Breakdown::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t Breakdown::getSource() const
{
    return m_Source;
}


void Breakdown::setSource(const utility::string_t& value)
{
    m_Source = value;
    m_SourceIsSet = true;
}

bool Breakdown::sourceIsSet() const
{
    return m_SourceIsSet;
}

void Breakdown::unsetSource()
{
    m_SourceIsSet = false;
}

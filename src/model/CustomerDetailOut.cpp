...
CustomerDetailOut::CustomerDetailOut()
{
    m_DataIsSet = false;
...
void CustomerDetailOut::validate()
{
    // TODO: implement validation
}

web::json::value CustomerDetailOut::toJson() const
{
...
bool CustomerDetailOut::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("data"))))
    {
        ...
        {
            std::shared_ptr<CustomerDetailData> refVal_setData;
...
void CustomerDetailOut::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CustomerDetailOut::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<CustomerDetailData> CustomerDetailOut::getData() const
{
    return m_Data;
}


void CustomerDetailOut::setData(const std::shared_ptr<CustomerDetailData>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool CustomerDetailOut::dataIsSet() const
{
    return m_DataIsSet;
}

void CustomerDetailOut::unsetData()
{
    m_DataIsSet = false;
}
utility::string_t CustomerDetailOut::getMsg() const
{
    return m_Msg;
}


void CustomerDetailOut::setMsg(const utility::string_t& value)
{
    m_Msg = value;
    m_MsgIsSet = true;
}

bool CustomerDetailOut::msgIsSet() const
{
    return m_MsgIsSet;
}

void CustomerDetailOut::unsetMsg()
{
    m_MsgIsSet = false;
}
utility::string_t CustomerDetailOut::getStatus() const
{
    return m_Status;
}


void CustomerDetailOut::setStatus(const utility::string_t& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool CustomerDetailOut::statusIsSet() const
{
    return m_StatusIsSet;
}

void CustomerDetailOut::unsetStatus()
{
    m_StatusIsSet = false;
}

...
void GrantOut::validate()
{
    // TODO: implement validation
}

web::json::value GrantOut::toJson() const
{
...
bool GrantOut::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void GrantOut::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool GrantOut::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
int32_t GrantOut::getUpdated() const
{
    return m_Updated;
}


void GrantOut::setUpdated(int32_t value)
{
    m_Updated = value;
    m_UpdatedIsSet = true;
}

bool GrantOut::updatedIsSet() const
{
    return m_UpdatedIsSet;
}

void GrantOut::unsetUpdated()
{
    m_UpdatedIsSet = false;
}

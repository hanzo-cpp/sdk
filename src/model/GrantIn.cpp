...
void GrantIn::validate()
{
    // TODO: implement validation
}

web::json::value GrantIn::toJson() const
{
...
bool GrantIn::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void GrantIn::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool GrantIn::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
int32_t GrantIn::getAmountCents() const
{
    return m_AmountCents;
}


void GrantIn::setAmountCents(int32_t value)
{
    m_AmountCents = value;
    m_AmountCentsIsSet = true;
}

bool GrantIn::amountCentsIsSet() const
{
    return m_AmountCentsIsSet;
}

void GrantIn::unsetAmountCents()
{
    m_AmountCentsIsSet = false;
}
utility::string_t GrantIn::getCurrency() const
{
    return m_Currency;
}


void GrantIn::setCurrency(const utility::string_t& value)
{
    m_Currency = value;
    m_CurrencyIsSet = true;
}

bool GrantIn::currencyIsSet() const
{
    return m_CurrencyIsSet;
}

void GrantIn::unsetCurrency()
{
    m_CurrencyIsSet = false;
}
utility::string_t GrantIn::getOrg() const
{
    return m_Org;
}


void GrantIn::setOrg(const utility::string_t& value)
{
    m_Org = value;
    m_OrgIsSet = true;
}

bool GrantIn::orgIsSet() const
{
    return m_OrgIsSet;
}

void GrantIn::unsetOrg()
{
    m_OrgIsSet = false;
}
utility::string_t GrantIn::getReason() const
{
    return m_Reason;
}


void GrantIn::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool GrantIn::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void GrantIn::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t GrantIn::getSource() const
{
    return m_Source;
}


void GrantIn::setSource(const utility::string_t& value)
{
    m_Source = value;
    m_SourceIsSet = true;
}

bool GrantIn::sourceIsSet() const
{
    return m_SourceIsSet;
}

void GrantIn::unsetSource()
{
    m_SourceIsSet = false;
}
utility::string_t GrantIn::getUser() const
{
    return m_User;
}


void GrantIn::setUser(const utility::string_t& value)
{
    m_User = value;
    m_UserIsSet = true;
}

bool GrantIn::userIsSet() const
{
    return m_UserIsSet;
}

void GrantIn::unsetUser()
{
    m_UserIsSet = false;
}

...
void AccreditationDecision::validate()
{
    // TODO: implement validation
}

web::json::value AccreditationDecision::toJson() const
{
...
bool AccreditationDecision::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void AccreditationDecision::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool AccreditationDecision::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t AccreditationDecision::getId() const
{
    return m_Id;
}


void AccreditationDecision::setId(const utility::string_t& value)
{
    m_Id = value;
    m_IdIsSet = true;
}

bool AccreditationDecision::idIsSet() const
{
    return m_IdIsSet;
}

void AccreditationDecision::unsetId()
{
    m_IdIsSet = false;
}
utility::string_t AccreditationDecision::getStatus() const
{
    return m_Status;
}


void AccreditationDecision::setStatus(const utility::string_t& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool AccreditationDecision::statusIsSet() const
{
    return m_StatusIsSet;
}

void AccreditationDecision::unsetStatus()
{
    m_StatusIsSet = false;
}

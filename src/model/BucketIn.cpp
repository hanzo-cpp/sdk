...
void BucketIn::validate()
{
    // TODO: implement validation
}

web::json::value BucketIn::toJson() const
{
...
bool BucketIn::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void BucketIn::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool BucketIn::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t BucketIn::getName() const
{
    return m_Name;
}


void BucketIn::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool BucketIn::nameIsSet() const
{
    return m_NameIsSet;
}

void BucketIn::unsetName()
{
    m_NameIsSet = false;
}

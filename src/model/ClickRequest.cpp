...
void ClickRequest::validate()
{
    // TODO: implement validation
}

web::json::value ClickRequest::toJson() const
{
...
bool ClickRequest::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void ClickRequest::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ClickRequest::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t ClickRequest::getCode() const
{
    return m_Code;
}


void ClickRequest::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool ClickRequest::codeIsSet() const
{
    return m_CodeIsSet;
}

void ClickRequest::unsetCode()
{
    m_CodeIsSet = false;
}

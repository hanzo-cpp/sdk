...
#include "hanzo/model/Cloud_PropSpec.h"

namespace hanzo {
namespace model {

Cloud_PropSpec::Cloud_PropSpec()
{
...
void Cloud_PropSpec::validate()
{
    // TODO: implement validation
}

web::json::value Cloud_PropSpec::toJson() const
{
...
bool Cloud_PropSpec::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Cloud_PropSpec::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Cloud_PropSpec::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t Cloud_PropSpec::getDescription() const
{
    return m_Description;
}


void Cloud_PropSpec::setDescription(const utility::string_t& value)
{
    m_Description = value;
    m_DescriptionIsSet = true;
}

bool Cloud_PropSpec::descriptionIsSet() const
{
    return m_DescriptionIsSet;
}

void Cloud_PropSpec::unsetDescription()
{
    m_DescriptionIsSet = false;
}
utility::string_t Cloud_PropSpec::getDisplayName() const
{
    return m_DisplayName;
}


void Cloud_PropSpec::setDisplayName(const utility::string_t& value)
{
    m_DisplayName = value;
    m_DisplayNameIsSet = true;
}

bool Cloud_PropSpec::displayNameIsSet() const
{
    return m_DisplayNameIsSet;
}

void Cloud_PropSpec::unsetDisplayName()
{
    m_DisplayNameIsSet = false;
}
utility::string_t Cloud_PropSpec::getName() const
{
    return m_Name;
}


void Cloud_PropSpec::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool Cloud_PropSpec::nameIsSet() const
{
    return m_NameIsSet;
}

void Cloud_PropSpec::unsetName()
{
    m_NameIsSet = false;
}
bool Cloud_PropSpec::isRequired() const
{
    return m_Required;
}


void Cloud_PropSpec::setRequired(bool value)
{
    m_Required = value;
    m_RequiredIsSet = true;
}

bool Cloud_PropSpec::requiredIsSet() const
{
    return m_RequiredIsSet;
}

void Cloud_PropSpec::unsetRequired()
{
    m_RequiredIsSet = false;
}
utility::string_t Cloud_PropSpec::getType() const
{
    return m_Type;
}


void Cloud_PropSpec::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool Cloud_PropSpec::typeIsSet() const
{
    return m_TypeIsSet;
}

void Cloud_PropSpec::unsetType()
{
    m_TypeIsSet = false;
}

...
web::json::value MeOut::toJson() const
{
...
bool MeOut::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("data"))))
    {
        ...
        {
            std::shared_ptr<AdminMe> refVal_setData;
...
void MeOut::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool MeOut::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<AdminMe> MeOut::getData() const
{
    return m_Data;
}


void MeOut::setData(const std::shared_ptr<AdminMe>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool MeOut::dataIsSet() const
{
    return m_DataIsSet;
}

void MeOut::unsetData()
{
    m_DataIsSet = false;
}
utility::string_t MeOut::getMsg() const
{
    return m_Msg;
}


void MeOut::setMsg(const utility::string_t& value)
{
    m_Msg = value;
    m_MsgIsSet = true;
}

bool MeOut::msgIsSet() const
{
    return m_MsgIsSet;
}
...
utility::string_t MeOut::getStatus() const
{
    return m_Status;
}


void MeOut::setStatus(const utility::string_t& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool MeOut::statusIsSet() const
{
    return m_StatusIsSet;
}

void MeOut::unsetStatus()
{
    m_StatusIsSet = false;
}

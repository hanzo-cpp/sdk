...
void CaptableOptions::validate()
{
    // TODO: implement validation
}

web::json::value CaptableOptions::toJson() const
{
...
bool CaptableOptions::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("data"))))
    {
        ...
        {
            std::vector<std::shared_ptr<CaptableOption>> refVal_setData;
...
void CaptableOptions::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CaptableOptions::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::vector<std::shared_ptr<CaptableOption>> CaptableOptions::getData() const
{
    return m_Data;
}


void CaptableOptions::setData(const std::vector<std::shared_ptr<CaptableOption>>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool CaptableOptions::dataIsSet() const
{
    return m_DataIsSet;
}

void CaptableOptions::unsetData()
{
    m_DataIsSet = false;
}

...
void SignerOut::validate()
{
    // TODO: implement validation
}

web::json::value SignerOut::toJson() const
{
...
bool SignerOut::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("data"))))
    {
        ...
        {
            std::shared_ptr<SignerData> refVal_setData;
...
void SignerOut::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool SignerOut::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<SignerData> SignerOut::getData() const
{
    return m_Data;
}


void SignerOut::setData(const std::shared_ptr<SignerData>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool SignerOut::dataIsSet() const
{
    return m_DataIsSet;
}

void SignerOut::unsetData()
{
    m_DataIsSet = false;
}
utility::string_t SignerOut::getMsg() const
{
    return m_Msg;
}


void SignerOut::setMsg(const utility::string_t& value)
{
    m_Msg = value;
    m_MsgIsSet = true;
}

bool SignerOut::msgIsSet() const
{
    return m_MsgIsSet;
}

void SignerOut::unsetMsg()
{
    m_MsgIsSet = false;
}
utility::string_t SignerOut::getStatus() const
{
    return m_Status;
}


void SignerOut::setStatus(const utility::string_t& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool SignerOut::statusIsSet() const
{
    return m_StatusIsSet;
}

void SignerOut::unsetStatus()
{
    m_StatusIsSet = false;
}

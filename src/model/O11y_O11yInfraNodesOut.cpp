...
O11y_O11yInfraNodesOut::O11y_O11yInfraNodesOut()
{
    m_DataIsSet = false;
...
void O11y_O11yInfraNodesOut::validate()
{
    // TODO: implement validation
}

web::json::value O11y_O11yInfraNodesOut::toJson() const
{
...
bool O11y_O11yInfraNodesOut::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("data"))))
    {
        ...
        {
            std::shared_ptr<O11y_Nodes> refVal_setData;
...
void O11y_O11yInfraNodesOut::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool O11y_O11yInfraNodesOut::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<O11y_Nodes> O11y_O11yInfraNodesOut::getData() const
{
    return m_Data;
}


void O11y_O11yInfraNodesOut::setData(const std::shared_ptr<O11y_Nodes>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool O11y_O11yInfraNodesOut::dataIsSet() const
{
    return m_DataIsSet;
}

void O11y_O11yInfraNodesOut::unsetData()
{
    m_DataIsSet = false;
}
utility::string_t O11y_O11yInfraNodesOut::getStatus() const
{
    return m_Status;
}


void O11y_O11yInfraNodesOut::setStatus(const utility::string_t& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool O11y_O11yInfraNodesOut::statusIsSet() const
{
    return m_StatusIsSet;
}

void O11y_O11yInfraNodesOut::unsetStatus()
{
    m_StatusIsSet = false;
}

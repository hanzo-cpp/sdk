...
void AnchorOut::validate()
{
    // TODO: implement validation
}

web::json::value AnchorOut::toJson() const
{
...
bool AnchorOut::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("data"))))
    {
        ...
        {
            std::shared_ptr<AnchorData> refVal_setData;
...
void AnchorOut::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool AnchorOut::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<AnchorData> AnchorOut::getData() const
{
    return m_Data;
}


void AnchorOut::setData(const std::shared_ptr<AnchorData>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool AnchorOut::dataIsSet() const
{
    return m_DataIsSet;
}

void AnchorOut::unsetData()
{
    m_DataIsSet = false;
}
utility::string_t AnchorOut::getMsg() const
{
    return m_Msg;
}


void AnchorOut::setMsg(const utility::string_t& value)
{
    m_Msg = value;
    m_MsgIsSet = true;
}

bool AnchorOut::msgIsSet() const
{
    return m_MsgIsSet;
}

void AnchorOut::unsetMsg()
{
    m_MsgIsSet = false;
}
utility::string_t AnchorOut::getStatus() const
{
    return m_Status;
}


void AnchorOut::setStatus(const utility::string_t& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool AnchorOut::statusIsSet() const
{
    return m_StatusIsSet;
}

void AnchorOut::unsetStatus()
{
    m_StatusIsSet = false;
}

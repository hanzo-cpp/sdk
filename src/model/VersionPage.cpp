...
void VersionPage::validate()
{
    // TODO: implement validation
}

web::json::value VersionPage::toJson() const
{
...
bool VersionPage::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("data"))))
    {
        ...
        {
            std::vector<std::shared_ptr<FlowVersion>> refVal_setData;
...
void VersionPage::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool VersionPage::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::vector<std::shared_ptr<FlowVersion>> VersionPage::getData() const
{
    return m_Data;
}


void VersionPage::setData(const std::vector<std::shared_ptr<FlowVersion>>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool VersionPage::dataIsSet() const
{
    return m_DataIsSet;
}

void VersionPage::unsetData()
{
    m_DataIsSet = false;
}

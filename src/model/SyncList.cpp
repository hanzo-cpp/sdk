...
void SyncList::validate()
{
    // TODO: implement validation
}

web::json::value SyncList::toJson() const
{
...
bool SyncList::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("data"))))
    {
        ...
        {
            std::vector<std::shared_ptr<SyncView>> refVal_setData;
...
void SyncList::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool SyncList::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::vector<std::shared_ptr<SyncView>> SyncList::getData() const
{
    return m_Data;
}


void SyncList::setData(const std::vector<std::shared_ptr<SyncView>>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool SyncList::dataIsSet() const
{
    return m_DataIsSet;
}

void SyncList::unsetData()
{
    m_DataIsSet = false;
}

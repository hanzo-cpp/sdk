...
void BackfillOut::validate()
{
    // TODO: implement validation
}

web::json::value BackfillOut::toJson() const
{
...
bool BackfillOut::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("data"))))
    {
        ...
        {
            std::shared_ptr<Backfilled> refVal_setData;
...
void BackfillOut::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool BackfillOut::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<Backfilled> BackfillOut::getData() const
{
    return m_Data;
}


void BackfillOut::setData(const std::shared_ptr<Backfilled>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool BackfillOut::dataIsSet() const
{
    return m_DataIsSet;
}

void BackfillOut::unsetData()
{
    m_DataIsSet = false;
}
utility::string_t BackfillOut::getMsg() const
{
    return m_Msg;
}


void BackfillOut::setMsg(const utility::string_t& value)
{
    m_Msg = value;
    m_MsgIsSet = true;
}

bool BackfillOut::msgIsSet() const
{
    return m_MsgIsSet;
}

void BackfillOut::unsetMsg()
{
    m_MsgIsSet = false;
}
utility::string_t BackfillOut::getStatus() const
{
    return m_Status;
}


void BackfillOut::setStatus(const utility::string_t& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool BackfillOut::statusIsSet() const
{
    return m_StatusIsSet;
}

void BackfillOut::unsetStatus()
{
    m_StatusIsSet = false;
}

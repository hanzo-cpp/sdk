...
void FinanceOut::validate()
{
    // TODO: implement validation
}

web::json::value FinanceOut::toJson() const
{
...
bool FinanceOut::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("data"))))
    {
        ...
        {
            std::shared_ptr<FinanceData> refVal_setData;
...
void FinanceOut::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool FinanceOut::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<FinanceData> FinanceOut::getData() const
{
    return m_Data;
}


void FinanceOut::setData(const std::shared_ptr<FinanceData>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool FinanceOut::dataIsSet() const
{
    return m_DataIsSet;
}

void FinanceOut::unsetData()
{
    m_DataIsSet = false;
}
utility::string_t FinanceOut::getMsg() const
{
    return m_Msg;
}


void FinanceOut::setMsg(const utility::string_t& value)
{
    m_Msg = value;
    m_MsgIsSet = true;
}

bool FinanceOut::msgIsSet() const
{
    return m_MsgIsSet;
}

void FinanceOut::unsetMsg()
{
    m_MsgIsSet = false;
}
utility::string_t FinanceOut::getStatus() const
{
    return m_Status;
}


void FinanceOut::setStatus(const utility::string_t& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool FinanceOut::statusIsSet() const
{
    return m_StatusIsSet;
}

void FinanceOut::unsetStatus()
{
    m_StatusIsSet = false;
}

...
CaptableSummaryCompany::CaptableSummaryCompany()
{
...
void CaptableSummaryCompany::validate()
{
    // TODO: implement validation
}

web::json::value CaptableSummaryCompany::toJson() const
{
...
bool CaptableSummaryCompany::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void CaptableSummaryCompany::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CaptableSummaryCompany::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t CaptableSummaryCompany::getId() const
{
    return m_Id;
}


void CaptableSummaryCompany::setId(const utility::string_t& value)
{
    m_Id = value;
    m_IdIsSet = true;
}

bool CaptableSummaryCompany::idIsSet() const
{
    return m_IdIsSet;
}

void CaptableSummaryCompany::unsetId()
{
    m_IdIsSet = false;
}
utility::string_t CaptableSummaryCompany::getName() const
{
    return m_Name;
}


void CaptableSummaryCompany::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool CaptableSummaryCompany::nameIsSet() const
{
    return m_NameIsSet;
}

void CaptableSummaryCompany::unsetName()
{
    m_NameIsSet = false;
}

...
void CustomersOut::validate()
{
    // TODO: implement validation
}

web::json::value CustomersOut::toJson() const
{
...
bool CustomersOut::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("data"))))
    {
        ...
        {
            std::vector<std::shared_ptr<CustomerRow>> refVal_setData;
...
void CustomersOut::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CustomersOut::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::vector<std::shared_ptr<CustomerRow>> CustomersOut::getData() const
{
    return m_Data;
}


void CustomersOut::setData(const std::vector<std::shared_ptr<CustomerRow>>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool CustomersOut::dataIsSet() const
{
    return m_DataIsSet;
}

void CustomersOut::unsetData()
{
    m_DataIsSet = false;
}
utility::string_t CustomersOut::getMsg() const
{
    return m_Msg;
}


void CustomersOut::setMsg(const utility::string_t& value)
{
    m_Msg = value;
    m_MsgIsSet = true;
}

bool CustomersOut::msgIsSet() const
{
    return m_MsgIsSet;
}

void CustomersOut::unsetMsg()
{
    m_MsgIsSet = false;
}
utility::string_t CustomersOut::getStatus() const
{
    return m_Status;
}


void CustomersOut::setStatus(const utility::string_t& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool CustomersOut::statusIsSet() const
{
    return m_StatusIsSet;
}

void CustomersOut::unsetStatus()
{
    m_StatusIsSet = false;
}
int32_t CustomersOut::getTotal() const
{
    return m_Total;
}


void CustomersOut::setTotal(int32_t value)
{
    m_Total = value;
    m_TotalIsSet = true;
}

bool CustomersOut::totalIsSet() const
{
    return m_TotalIsSet;
}

void CustomersOut::unsetTotal()
{
    m_TotalIsSet = false;
}

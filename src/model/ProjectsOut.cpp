...
void ProjectsOut::validate()
{
    // TODO: implement validation
}

web::json::value ProjectsOut::toJson() const
{
...
bool ProjectsOut::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("data"))))
    {
        ...
        {
            std::vector<std::shared_ptr<ProjectSummary>> refVal_setData;
...
void ProjectsOut::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ProjectsOut::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::vector<std::shared_ptr<ProjectSummary>> ProjectsOut::getData() const
{
    return m_Data;
}


void ProjectsOut::setData(const std::vector<std::shared_ptr<ProjectSummary>>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool ProjectsOut::dataIsSet() const
{
    return m_DataIsSet;
}

void ProjectsOut::unsetData()
{
    m_DataIsSet = false;
}
int32_t ProjectsOut::getTotal() const
{
    return m_Total;
}


void ProjectsOut::setTotal(int32_t value)
{
    m_Total = value;
    m_TotalIsSet = true;
}

bool ProjectsOut::totalIsSet() const
{
    return m_TotalIsSet;
}

void ProjectsOut::unsetTotal()
{
    m_TotalIsSet = false;
}

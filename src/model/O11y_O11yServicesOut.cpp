...
O11y_O11yServicesOut::O11y_O11yServicesOut()
{
    m_DataIsSet = false;
...
void O11y_O11yServicesOut::validate()
{
    // TODO: implement validation
}

web::json::value O11y_O11yServicesOut::toJson() const
{
...
bool O11y_O11yServicesOut::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("data"))))
    {
        ...
        {
            std::vector<std::shared_ptr<O11y_O11yService>> refVal_setData;
...
void O11y_O11yServicesOut::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool O11y_O11yServicesOut::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::vector<std::shared_ptr<O11y_O11yService>> O11y_O11yServicesOut::getData() const
{
    return m_Data;
}


void O11y_O11yServicesOut::setData(const std::vector<std::shared_ptr<O11y_O11yService>>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool O11y_O11yServicesOut::dataIsSet() const
{
    return m_DataIsSet;
}

void O11y_O11yServicesOut::unsetData()
{
    m_DataIsSet = false;
}
utility::string_t O11y_O11yServicesOut::getStatus() const
{
    return m_Status;
}


void O11y_O11yServicesOut::setStatus(const utility::string_t& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool O11y_O11yServicesOut::statusIsSet() const
{
    return m_StatusIsSet;
}

void O11y_O11yServicesOut::unsetStatus()
{
    m_StatusIsSet = false;
}

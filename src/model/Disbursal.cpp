...
void Disbursal::validate()
{
    // TODO: implement validation
}

web::json::value Disbursal::toJson() const
{
...
bool Disbursal::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Disbursal::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Disbursal::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
int32_t Disbursal::getAmountCents() const
{
    return m_AmountCents;
}


void Disbursal::setAmountCents(int32_t value)
{
    m_AmountCents = value;
    m_AmountCentsIsSet = true;
}

bool Disbursal::amountCentsIsSet() const
{
    return m_AmountCentsIsSet;
}

void Disbursal::unsetAmountCents()
{
    m_AmountCentsIsSet = false;
}
utility::string_t Disbursal::getId() const
{
    return m_Id;
}


void Disbursal::setId(const utility::string_t& value)
{
    m_Id = value;
    m_IdIsSet = true;
}

bool Disbursal::idIsSet() const
{
    return m_IdIsSet;
}

void Disbursal::unsetId()
{
    m_IdIsSet = false;
}
utility::string_t Disbursal::getMethod() const
{
    return m_Method;
}


void Disbursal::setMethod(const utility::string_t& value)
{
    m_Method = value;
    m_MethodIsSet = true;
}

bool Disbursal::methodIsSet() const
{
    return m_MethodIsSet;
}

void Disbursal::unsetMethod()
{
    m_MethodIsSet = false;
}
utility::string_t Disbursal::getReference() const
{
    return m_Reference;
}


void Disbursal::setReference(const utility::string_t& value)
{
    m_Reference = value;
    m_ReferenceIsSet = true;
}

bool Disbursal::referenceIsSet() const
{
    return m_ReferenceIsSet;
}

void Disbursal::unsetReference()
{
    m_ReferenceIsSet = false;
}

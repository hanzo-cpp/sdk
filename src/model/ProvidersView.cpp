...
void ProvidersView::validate()
{
    // TODO: implement validation
}

web::json::value ProvidersView::toJson() const
{
...
bool ProvidersView::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("providers"))))
    {
        ...
        {
            std::vector<std::shared_ptr<ProviderCard>> refVal_setProviders;
...
void ProvidersView::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ProvidersView::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::vector<std::shared_ptr<ProviderCard>> ProvidersView::getProviders() const
{
    return m_Providers;
}


void ProvidersView::setProviders(const std::vector<std::shared_ptr<ProviderCard>>& value)
{
    m_Providers = value;
    m_ProvidersIsSet = true;
}

bool ProvidersView::providersIsSet() const
{
    return m_ProvidersIsSet;
}

void ProvidersView::unsetProviders()
{
    m_ProvidersIsSet = false;
}

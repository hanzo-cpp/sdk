...
void SocialAccounts::validate()
{
    // TODO: implement validation
}

web::json::value SocialAccounts::toJson() const
{
...
bool SocialAccounts::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("data"))))
    {
        ...
        {
            std::vector<std::shared_ptr<SocialAccount>> refVal_setData;
...
void SocialAccounts::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool SocialAccounts::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::vector<std::shared_ptr<SocialAccount>> SocialAccounts::getData() const
{
    return m_Data;
}


void SocialAccounts::setData(const std::vector<std::shared_ptr<SocialAccount>>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool SocialAccounts::dataIsSet() const
{
    return m_DataIsSet;
}

void SocialAccounts::unsetData()
{
    m_DataIsSet = false;
}

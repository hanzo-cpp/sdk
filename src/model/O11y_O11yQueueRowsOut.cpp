...
O11y_O11yQueueRowsOut::O11y_O11yQueueRowsOut()
{
    m_DataIsSet = false;
...
void O11y_O11yQueueRowsOut::validate()
{
    // TODO: implement validation
}

web::json::value O11y_O11yQueueRowsOut::toJson() const
{
...
bool O11y_O11yQueueRowsOut::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("data"))))
    {
        ...
        {
            std::vector<std::shared_ptr<O11y_O11yQueueRow>> refVal_setData;
...
void O11y_O11yQueueRowsOut::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool O11y_O11yQueueRowsOut::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::vector<std::shared_ptr<O11y_O11yQueueRow>> O11y_O11yQueueRowsOut::getData() const
{
    return m_Data;
}


void O11y_O11yQueueRowsOut::setData(const std::vector<std::shared_ptr<O11y_O11yQueueRow>>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool O11y_O11yQueueRowsOut::dataIsSet() const
{
    return m_DataIsSet;
}

void O11y_O11yQueueRowsOut::unsetData()
{
    m_DataIsSet = false;
}
utility::string_t O11y_O11yQueueRowsOut::getStatus() const
{
    return m_Status;
}


void O11y_O11yQueueRowsOut::setStatus(const utility::string_t& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool O11y_O11yQueueRowsOut::statusIsSet() const
{
    return m_StatusIsSet;
}

void O11y_O11yQueueRowsOut::unsetStatus()
{
    m_StatusIsSet = false;
}

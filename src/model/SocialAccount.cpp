...
int64_t SocialAccount::getCreatedAt() const
{
    return m_CreatedAt;
}


void SocialAccount::setCreatedAt(int64_t value)
{
    m_CreatedAt = value;
...
int64_t SocialAccount::getUpdatedAt() const
{
    return m_UpdatedAt;
}


void SocialAccount::setUpdatedAt(int64_t value)
{
    m_UpdatedAt = value;

...
void FlagsOut::validate()
{
    // TODO: implement validation
}

web::json::value FlagsOut::toJson() const
{
...
bool FlagsOut::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("data"))))
    {
        ...
        {
            std::shared_ptr<BoardView> refVal_setData;
...
void FlagsOut::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool FlagsOut::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<BoardView> FlagsOut::getData() const
{
    return m_Data;
}


void FlagsOut::setData(const std::shared_ptr<BoardView>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool FlagsOut::dataIsSet() const
{
    return m_DataIsSet;
}

void FlagsOut::unsetData()
{
    m_DataIsSet = false;
}
utility::string_t FlagsOut::getMsg() const
{
    return m_Msg;
}


void FlagsOut::setMsg(const utility::string_t& value)
{
    m_Msg = value;
    m_MsgIsSet = true;
}

bool FlagsOut::msgIsSet() const
{
    return m_MsgIsSet;
}

void FlagsOut::unsetMsg()
{
    m_MsgIsSet = false;
}
utility::string_t FlagsOut::getStatus() const
{
    return m_Status;
}


void FlagsOut::setStatus(const utility::string_t& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool FlagsOut::statusIsSet() const
{
    return m_StatusIsSet;
}

void FlagsOut::unsetStatus()
{
    m_StatusIsSet = false;
}

...
void BasisResult::validate()
{
    // TODO: implement validation
}

web::json::value BasisResult::toJson() const
{
...
bool BasisResult::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void BasisResult::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool BasisResult::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::map<utility::string_t, std::shared_ptr<Object>> BasisResult::getData() const
{
    return m_Data;
}


void BasisResult::setData(const std::map<utility::string_t, std::shared_ptr<Object>>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool BasisResult::dataIsSet() const
{
    return m_DataIsSet;
}

void BasisResult::unsetData()
{
    m_DataIsSet = false;
}
utility::string_t BasisResult::getMsg() const
{
    return m_Msg;
}


void BasisResult::setMsg(const utility::string_t& value)
{
    m_Msg = value;
    m_MsgIsSet = true;
}

bool BasisResult::msgIsSet() const
{
    return m_MsgIsSet;
}

void BasisResult::unsetMsg()
{
    m_MsgIsSet = false;
}
utility::string_t BasisResult::getStatus() const
{
    return m_Status;
}


void BasisResult::setStatus(const utility::string_t& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool BasisResult::statusIsSet() const
{
    return m_StatusIsSet;
}

void BasisResult::unsetStatus()
{
    m_StatusIsSet = false;
}

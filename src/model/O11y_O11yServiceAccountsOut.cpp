...
O11y_O11yServiceAccountsOut::O11y_O11yServiceAccountsOut()
{
    m_DataIsSet = false;
...
void O11y_O11yServiceAccountsOut::validate()
{
    // TODO: implement validation
}

web::json::value O11y_O11yServiceAccountsOut::toJson() const
{
...
bool O11y_O11yServiceAccountsOut::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("data"))))
    {
        ...
        {
            std::vector<std::shared_ptr<O11y_O11yServiceAccount>> refVal_setData;
...
void O11y_O11yServiceAccountsOut::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool O11y_O11yServiceAccountsOut::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::vector<std::shared_ptr<O11y_O11yServiceAccount>> O11y_O11yServiceAccountsOut::getData() const
{
    return m_Data;
}


void O11y_O11yServiceAccountsOut::setData(const std::vector<std::shared_ptr<O11y_O11yServiceAccount>>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool O11y_O11yServiceAccountsOut::dataIsSet() const
{
    return m_DataIsSet;
}

void O11y_O11yServiceAccountsOut::unsetData()
{
    m_DataIsSet = false;
}
utility::string_t O11y_O11yServiceAccountsOut::getStatus() const
{
    return m_Status;
}


void O11y_O11yServiceAccountsOut::setStatus(const utility::string_t& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool O11y_O11yServiceAccountsOut::statusIsSet() const
{
    return m_StatusIsSet;
}

void O11y_O11yServiceAccountsOut::unsetStatus()
{
    m_StatusIsSet = false;
}

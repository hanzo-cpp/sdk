...
O11y_O11yTraceFlamegraphOut::O11y_O11yTraceFlamegraphOut()
{
    m_DataIsSet = false;
...
void O11y_O11yTraceFlamegraphOut::validate()
{
    // TODO: implement validation
}

web::json::value O11y_O11yTraceFlamegraphOut::toJson() const
{
...
bool O11y_O11yTraceFlamegraphOut::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("data"))))
    {
        ...
        {
            std::shared_ptr<O11y_GettableFlamegraphTrace> refVal_setData;
...
void O11y_O11yTraceFlamegraphOut::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool O11y_O11yTraceFlamegraphOut::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<O11y_GettableFlamegraphTrace> O11y_O11yTraceFlamegraphOut::getData() const
{
    return m_Data;
}


void O11y_O11yTraceFlamegraphOut::setData(const std::shared_ptr<O11y_GettableFlamegraphTrace>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool O11y_O11yTraceFlamegraphOut::dataIsSet() const
{
    return m_DataIsSet;
}

void O11y_O11yTraceFlamegraphOut::unsetData()
{
    m_DataIsSet = false;
}
utility::string_t O11y_O11yTraceFlamegraphOut::getStatus() const
{
    return m_Status;
}


void O11y_O11yTraceFlamegraphOut::setStatus(const utility::string_t& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool O11y_O11yTraceFlamegraphOut::statusIsSet() const
{
    return m_StatusIsSet;
}

void O11y_O11yTraceFlamegraphOut::unsetStatus()
{
    m_StatusIsSet = false;
}

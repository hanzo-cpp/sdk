...
O11y_O11yFunnelsOut::O11y_O11yFunnelsOut()
{
    m_DataIsSet = false;
...
void O11y_O11yFunnelsOut::validate()
{
    // TODO: implement validation
}

web::json::value O11y_O11yFunnelsOut::toJson() const
{
...
bool O11y_O11yFunnelsOut::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("data"))))
    {
        ...
        {
            std::vector<std::shared_ptr<O11y_GettableFunnel>> refVal_setData;
...
void O11y_O11yFunnelsOut::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool O11y_O11yFunnelsOut::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::vector<std::shared_ptr<O11y_GettableFunnel>> O11y_O11yFunnelsOut::getData() const
{
    return m_Data;
}


void O11y_O11yFunnelsOut::setData(const std::vector<std::shared_ptr<O11y_GettableFunnel>>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool O11y_O11yFunnelsOut::dataIsSet() const
{
    return m_DataIsSet;
}

void O11y_O11yFunnelsOut::unsetData()
{
    m_DataIsSet = false;
}
utility::string_t O11y_O11yFunnelsOut::getStatus() const
{
    return m_Status;
}


void O11y_O11yFunnelsOut::setStatus(const utility::string_t& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool O11y_O11yFunnelsOut::statusIsSet() const
{
    return m_StatusIsSet;
}

void O11y_O11yFunnelsOut::unsetStatus()
{
    m_StatusIsSet = false;
}

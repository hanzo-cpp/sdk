...
int64_t O11y_LimitMetricValue::getCount() const
{
    return m_Count;
}


void O11y_LimitMetricValue::setCount(int64_t value)
{
    m_Count = value;
    m_CountIsSet = true;
}
...
int64_t O11y_LimitMetricValue::getSize() const
{
    return m_Size;
}


void O11y_LimitMetricValue::setSize(int64_t value)
{
    m_Size = value;
    m_SizeIsSet = true;
}

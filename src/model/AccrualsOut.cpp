...
void AccrualsOut::validate()
{
    // TODO: implement validation
}

web::json::value AccrualsOut::toJson() const
{
...
bool AccrualsOut::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("data"))))
    {
        ...
        {
            std::shared_ptr<Accruals> refVal_setData;
...
void AccrualsOut::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool AccrualsOut::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<Accruals> AccrualsOut::getData() const
{
    return m_Data;
}


void AccrualsOut::setData(const std::shared_ptr<Accruals>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool AccrualsOut::dataIsSet() const
{
    return m_DataIsSet;
}

void AccrualsOut::unsetData()
{
    m_DataIsSet = false;
}
utility::string_t AccrualsOut::getMsg() const
{
    return m_Msg;
}


void AccrualsOut::setMsg(const utility::string_t& value)
{
    m_Msg = value;
    m_MsgIsSet = true;
}

bool AccrualsOut::msgIsSet() const
{
    return m_MsgIsSet;
}

void AccrualsOut::unsetMsg()
{
    m_MsgIsSet = false;
}
utility::string_t AccrualsOut::getStatus() const
{
    return m_Status;
}


void AccrualsOut::setStatus(const utility::string_t& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool AccrualsOut::statusIsSet() const
{
    return m_StatusIsSet;
}

void AccrualsOut::unsetStatus()
{
    m_StatusIsSet = false;
}

...
O11y_O11yRolesOut::O11y_O11yRolesOut()
{
    m_DataIsSet = false;
...
void O11y_O11yRolesOut::validate()
{
    // TODO: implement validation
}

web::json::value O11y_O11yRolesOut::toJson() const
{
...
bool O11y_O11yRolesOut::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void O11y_O11yRolesOut::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool O11y_O11yRolesOut::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::vector<std::shared_ptr<O11y_O11yRole>> O11y_O11yRolesOut::getData() const
{
    return m_Data;
}


void O11y_O11yRolesOut::setData(const std::vector<std::shared_ptr<O11y_O11yRole>>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool O11y_O11yRolesOut::dataIsSet() const
{
    return m_DataIsSet;
}

void O11y_O11yRolesOut::unsetData()
{
    m_DataIsSet = false;
}
utility::string_t O11y_O11yRolesOut::getStatus() const
{
    return m_Status;
}


void O11y_O11yRolesOut::setStatus(const utility::string_t& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool O11y_O11yRolesOut::statusIsSet() const
{
    return m_StatusIsSet;
}

void O11y_O11yRolesOut::unsetStatus()
{
    m_StatusIsSet = false;
}

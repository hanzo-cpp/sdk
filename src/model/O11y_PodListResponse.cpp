...
#include "hanzo/model/O11y_PodListResponse.h"

namespace hanzo {
namespace model {

O11y_PodListResponse::O11y_PodListResponse()
{
...
void O11y_PodListResponse::validate()
{
    // TODO: implement validation
}

web::json::value O11y_PodListResponse::toJson() const
{
...
bool O11y_PodListResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("records"))))
    {
        ...
        {
            std::vector<std::shared_ptr<O11y_PodListRecord>> refVal_setRecords;
...
void O11y_PodListResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool O11y_PodListResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::vector<std::shared_ptr<O11y_PodListRecord>> O11y_PodListResponse::getRecords() const
{
    return m_Records;
}


void O11y_PodListResponse::setRecords(const std::vector<std::shared_ptr<O11y_PodListRecord>>& value)
{
    m_Records = value;
    m_RecordsIsSet = true;
}

bool O11y_PodListResponse::recordsIsSet() const
{
    return m_RecordsIsSet;
}

void O11y_PodListResponse::unsetRecords()
{
    m_RecordsIsSet = false;
}
int32_t O11y_PodListResponse::getTotal() const
{
    return m_Total;
}


void O11y_PodListResponse::setTotal(int32_t value)
{
    m_Total = value;
    m_TotalIsSet = true;
}

bool O11y_PodListResponse::totalIsSet() const
{
    return m_TotalIsSet;
}

void O11y_PodListResponse::unsetTotal()
{
    m_TotalIsSet = false;
}
utility::string_t O11y_PodListResponse::getType() const
{
    return m_Type;
}


void O11y_PodListResponse::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool O11y_PodListResponse::typeIsSet() const
{
    return m_TypeIsSet;
}

void O11y_PodListResponse::unsetType()
{
    m_TypeIsSet = false;
}

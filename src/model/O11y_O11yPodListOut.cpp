...
O11y_O11yPodListOut::O11y_O11yPodListOut()
{
    m_DataIsSet = false;
...
void O11y_O11yPodListOut::validate()
{
    // TODO: implement validation
}

web::json::value O11y_O11yPodListOut::toJson() const
{
...
bool O11y_O11yPodListOut::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("data"))))
    {
        ...
        {
            std::shared_ptr<O11y_PodListResponse> refVal_setData;
...
void O11y_O11yPodListOut::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool O11y_O11yPodListOut::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<O11y_PodListResponse> O11y_O11yPodListOut::getData() const
{
    return m_Data;
}


void O11y_O11yPodListOut::setData(const std::shared_ptr<O11y_PodListResponse>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool O11y_O11yPodListOut::dataIsSet() const
{
    return m_DataIsSet;
}

void O11y_O11yPodListOut::unsetData()
{
    m_DataIsSet = false;
}
utility::string_t O11y_O11yPodListOut::getStatus() const
{
    return m_Status;
}


void O11y_O11yPodListOut::setStatus(const utility::string_t& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool O11y_O11yPodListOut::statusIsSet() const
{
    return m_StatusIsSet;
}

void O11y_O11yPodListOut::unsetStatus()
{
    m_StatusIsSet = false;
}

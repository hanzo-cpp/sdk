...
SubscriptionsOut::SubscriptionsOut()
{
    m_DataIsSet = false;
...
void SubscriptionsOut::validate()
{
    // TODO: implement validation
}

web::json::value SubscriptionsOut::toJson() const
{
...
bool SubscriptionsOut::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("data"))))
    {
        ...
        {
            std::vector<std::shared_ptr<SubscriptionRow>> refVal_setData;
...
void SubscriptionsOut::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool SubscriptionsOut::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::vector<std::shared_ptr<SubscriptionRow>> SubscriptionsOut::getData() const
{
    return m_Data;
}


void SubscriptionsOut::setData(const std::vector<std::shared_ptr<SubscriptionRow>>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool SubscriptionsOut::dataIsSet() const
{
    return m_DataIsSet;
}

void SubscriptionsOut::unsetData()
{
    m_DataIsSet = false;
}
utility::string_t SubscriptionsOut::getMsg() const
{
    return m_Msg;
}


void SubscriptionsOut::setMsg(const utility::string_t& value)
{
    m_Msg = value;
    m_MsgIsSet = true;
}

bool SubscriptionsOut::msgIsSet() const
{
    return m_MsgIsSet;
}

void SubscriptionsOut::unsetMsg()
{
    m_MsgIsSet = false;
}
utility::string_t SubscriptionsOut::getStatus() const
{
    return m_Status;
}


void SubscriptionsOut::setStatus(const utility::string_t& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool SubscriptionsOut::statusIsSet() const
{
    return m_StatusIsSet;
}

void SubscriptionsOut::unsetStatus()
{
    m_StatusIsSet = false;
}
int32_t SubscriptionsOut::getTotal() const
{
    return m_Total;
}


void SubscriptionsOut::setTotal(int32_t value)
{
    m_Total = value;
    m_TotalIsSet = true;
}

bool SubscriptionsOut::totalIsSet() const
{
    return m_TotalIsSet;
}

void SubscriptionsOut::unsetTotal()
{
    m_TotalIsSet = false;
}

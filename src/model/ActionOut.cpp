...
void ActionOut::validate()
{
    // TODO: implement validation
}

web::json::value ActionOut::toJson() const
{
...
bool ActionOut::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("data"))))
    {
        ...
        {
            std::vector<std::shared_ptr<Result>> refVal_setData;
...
void ActionOut::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ActionOut::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::vector<std::shared_ptr<Result>> ActionOut::getData() const
{
    return m_Data;
}


void ActionOut::setData(const std::vector<std::shared_ptr<Result>>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool ActionOut::dataIsSet() const
{
    return m_DataIsSet;
}

void ActionOut::unsetData()
{
    m_DataIsSet = false;
}
utility::string_t ActionOut::getMsg() const
{
    return m_Msg;
}


void ActionOut::setMsg(const utility::string_t& value)
{
    m_Msg = value;
    m_MsgIsSet = true;
}

bool ActionOut::msgIsSet() const
{
    return m_MsgIsSet;
}

void ActionOut::unsetMsg()
{
    m_MsgIsSet = false;
}
utility::string_t ActionOut::getStatus() const
{
    return m_Status;
}


void ActionOut::setStatus(const utility::string_t& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool ActionOut::statusIsSet() const
{
    return m_StatusIsSet;
}

void ActionOut::unsetStatus()
{
    m_StatusIsSet = false;
}

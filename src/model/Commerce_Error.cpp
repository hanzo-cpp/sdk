...
void Commerce_Error::validate()
{
    // TODO: implement validation
}

web::json::value Commerce_Error::toJson() const
{
...
bool Commerce_Error::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Commerce_Error::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Commerce_Error::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t Commerce_Error::getError() const
{
    return m_Error;
}


void Commerce_Error::setError(const utility::string_t& value)
{
    m_Error = value;
    m_ErrorIsSet = true;
}

bool Commerce_Error::errorIsSet() const
{
    return m_ErrorIsSet;
}

void Commerce_Error::unsetError()
{
    m_ErrorIsSet = false;
}
utility::string_t Commerce_Error::getMessage() const
{
    return m_Message;
}


void Commerce_Error::setMessage(const utility::string_t& value)
{
    m_Message = value;
    m_MessageIsSet = true;
}

bool Commerce_Error::messageIsSet() const
{
    return m_MessageIsSet;
}

void Commerce_Error::unsetMessage()
{
    m_MessageIsSet = false;
}
int32_t Commerce_Error::getCode() const
{
    return m_Code;
}


void Commerce_Error::setCode(int32_t value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool Commerce_Error::codeIsSet() const
{
    return m_CodeIsSet;
}

void Commerce_Error::unsetCode()
{
    m_CodeIsSet = false;
}

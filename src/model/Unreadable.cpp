...
void Unreadable::validate()
{
    // TODO: implement validation
}

web::json::value Unreadable::toJson() const
{
...
bool Unreadable::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Unreadable::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Unreadable::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t Unreadable::getReason() const
{
    return m_Reason;
}


void Unreadable::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool Unreadable::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void Unreadable::unsetReason()
{
    m_ReasonIsSet = false;
}

...
void ClaimRequest::validate()
{
    // TODO: implement validation
}

web::json::value ClaimRequest::toJson() const
{
...
bool ClaimRequest::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void ClaimRequest::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ClaimRequest::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t ClaimRequest::getCode() const
{
    return m_Code;
}


void ClaimRequest::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool ClaimRequest::codeIsSet() const
{
    return m_CodeIsSet;
}

void ClaimRequest::unsetCode()
{
    m_CodeIsSet = false;
}

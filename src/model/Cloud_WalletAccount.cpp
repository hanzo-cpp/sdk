...
Cloud_WalletAccount::Cloud_WalletAccount()
{
    m_CreatedAt = 0;
...
void Cloud_WalletAccount::validate()
{
    // TODO: implement validation
}

web::json::value Cloud_WalletAccount::toJson() const
{
...
bool Cloud_WalletAccount::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Cloud_WalletAccount::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Cloud_WalletAccount::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
int32_t Cloud_WalletAccount::getCreatedAt() const
{
    return m_CreatedAt;
}


void Cloud_WalletAccount::setCreatedAt(int32_t value)
{
    m_CreatedAt = value;
    m_CreatedAtIsSet = true;
}

bool Cloud_WalletAccount::createdAtIsSet() const
{
    return m_CreatedAtIsSet;
}

void Cloud_WalletAccount::unsetCreatedAt()
{
    m_CreatedAtIsSet = false;
}
utility::string_t Cloud_WalletAccount::getId() const
{
    return m_Id;
}


void Cloud_WalletAccount::setId(const utility::string_t& value)
{
    m_Id = value;
    m_IdIsSet = true;
}

bool Cloud_WalletAccount::idIsSet() const
{
    return m_IdIsSet;
}

void Cloud_WalletAccount::unsetId()
{
    m_IdIsSet = false;
}
utility::string_t Cloud_WalletAccount::getName() const
{
    return m_Name;
}


void Cloud_WalletAccount::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool Cloud_WalletAccount::nameIsSet() const
{
    return m_NameIsSet;
}

void Cloud_WalletAccount::unsetName()
{
    m_NameIsSet = false;
}
utility::string_t Cloud_WalletAccount::getOrg() const
{
    return m_Org;
}


void Cloud_WalletAccount::setOrg(const utility::string_t& value)
{
    m_Org = value;
    m_OrgIsSet = true;
}

bool Cloud_WalletAccount::orgIsSet() const
{
    return m_OrgIsSet;
}

void Cloud_WalletAccount::unsetOrg()
{
    m_OrgIsSet = false;
}

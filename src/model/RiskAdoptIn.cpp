...
void RiskAdoptIn::validate()
{
    // TODO: implement validation
}

web::json::value RiskAdoptIn::toJson() const
{
...
bool RiskAdoptIn::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void RiskAdoptIn::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool RiskAdoptIn::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t RiskAdoptIn::getAddress() const
{
    return m_Address;
}


void RiskAdoptIn::setAddress(const utility::string_t& value)
{
    m_Address = value;
    m_AddressIsSet = true;
}

bool RiskAdoptIn::addressIsSet() const
{
    return m_AddressIsSet;
}

void RiskAdoptIn::unsetAddress()
{
    m_AddressIsSet = false;
}

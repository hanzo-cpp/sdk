...
void AccessOut::validate()
{
    // TODO: implement validation
}

web::json::value AccessOut::toJson() const
{
...
bool AccessOut::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("data"))))
    {
        ...
        {
            std::shared_ptr<AccessChange> refVal_setData;
...
void AccessOut::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool AccessOut::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<AccessChange> AccessOut::getData() const
{
    return m_Data;
}


void AccessOut::setData(const std::shared_ptr<AccessChange>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool AccessOut::dataIsSet() const
{
    return m_DataIsSet;
}

void AccessOut::unsetData()
{
    m_DataIsSet = false;
}
utility::string_t AccessOut::getMsg() const
{
    return m_Msg;
}


void AccessOut::setMsg(const utility::string_t& value)
{
    m_Msg = value;
    m_MsgIsSet = true;
}

bool AccessOut::msgIsSet() const
{
    return m_MsgIsSet;
}

void AccessOut::unsetMsg()
{
    m_MsgIsSet = false;
}
utility::string_t AccessOut::getStatus() const
{
    return m_Status;
}


void AccessOut::setStatus(const utility::string_t& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool AccessOut::statusIsSet() const
{
    return m_StatusIsSet;
}

void AccessOut::unsetStatus()
{
    m_StatusIsSet = false;
}

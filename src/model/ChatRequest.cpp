...
void ChatRequest::validate()
{
    // TODO: implement validation
}

web::json::value ChatRequest::toJson() const
{
...
bool ChatRequest::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void ChatRequest::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ChatRequest::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t ChatRequest::getMessage() const
{
    return m_Message;
}


void ChatRequest::setMessage(const utility::string_t& value)
{
    m_Message = value;
    m_MessageIsSet = true;
}

bool ChatRequest::messageIsSet() const
{
    return m_MessageIsSet;
}

void ChatRequest::unsetMessage()
{
    m_MessageIsSet = false;
}

...
void O11y_PodCountByPhase::validate()
{
    // TODO: implement validation
}

web::json::value O11y_PodCountByPhase::toJson() const
{
...
bool O11y_PodCountByPhase::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void O11y_PodCountByPhase::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool O11y_PodCountByPhase::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
bool O11y_PodCountByPhase::failedIsSet() const
{
    return m_FailedIsSet;
}

void O11y_PodCountByPhase::unsetFailed()
{
    m_FailedIsSet = false;
}
...
bool O11y_PodCountByPhase::pendingIsSet() const
{
    return m_PendingIsSet;
}

void O11y_PodCountByPhase::unsetPending()
{
    m_PendingIsSet = false;
}
...
bool O11y_PodCountByPhase::runningIsSet() const
{
    return m_RunningIsSet;
}

void O11y_PodCountByPhase::unsetRunning()
{
    m_RunningIsSet = false;
}
...
bool O11y_PodCountByPhase::succeededIsSet() const
{
    return m_SucceededIsSet;
}

void O11y_PodCountByPhase::unsetSucceeded()
{
    m_SucceededIsSet = false;
}
...
bool O11y_PodCountByPhase::unknownIsSet() const
{
    return m_UnknownIsSet;
}

void O11y_PodCountByPhase::unsetUnknown()
{
    m_UnknownIsSet = false;
}

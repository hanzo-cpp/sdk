...
O11y_O11yTokenOut::O11y_O11yTokenOut()
{
    m_DataIsSet = false;
...
void O11y_O11yTokenOut::validate()
{
    // TODO: implement validation
}

web::json::value O11y_O11yTokenOut::toJson() const
{
...
bool O11y_O11yTokenOut::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("data"))))
    {
        ...
        {
            std::shared_ptr<O11y_O11yToken> refVal_setData;
...
void O11y_O11yTokenOut::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool O11y_O11yTokenOut::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<O11y_O11yToken> O11y_O11yTokenOut::getData() const
{
    return m_Data;
}


void O11y_O11yTokenOut::setData(const std::shared_ptr<O11y_O11yToken>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool O11y_O11yTokenOut::dataIsSet() const
{
    return m_DataIsSet;
}

void O11y_O11yTokenOut::unsetData()
{
    m_DataIsSet = false;
}
utility::string_t O11y_O11yTokenOut::getStatus() const
{
    return m_Status;
}


void O11y_O11yTokenOut::setStatus(const utility::string_t& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool O11y_O11yTokenOut::statusIsSet() const
{
    return m_StatusIsSet;
}

void O11y_O11yTokenOut::unsetStatus()
{
    m_StatusIsSet = false;
}

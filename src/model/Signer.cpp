...
void Signer::validate()
{
    // TODO: implement validation
}

web::json::value Signer::toJson() const
{
...
bool Signer::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Signer::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Signer::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t Signer::getEmail() const
{
    return m_Email;
}


void Signer::setEmail(const utility::string_t& value)
{
    m_Email = value;
    m_EmailIsSet = true;
}

bool Signer::emailIsSet() const
{
    return m_EmailIsSet;
}

void Signer::unsetEmail()
{
    m_EmailIsSet = false;
}
utility::string_t Signer::getName() const
{
    return m_Name;
}


void Signer::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool Signer::nameIsSet() const
{
    return m_NameIsSet;
}

void Signer::unsetName()
{
    m_NameIsSet = false;
}

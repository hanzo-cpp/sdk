...
Search_PaginatedIndexes::Search_PaginatedIndexes()
{
...
void Search_PaginatedIndexes::validate()
{
    // TODO: implement validation
}

web::json::value Search_PaginatedIndexes::toJson() const
{
...
bool Search_PaginatedIndexes::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("results"))))
    {
        ...
        {
            std::vector<std::shared_ptr<Search_IndexView>> refVal_setResults;
...
void Search_PaginatedIndexes::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Search_PaginatedIndexes::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::vector<std::shared_ptr<Search_IndexView>> Search_PaginatedIndexes::getResults() const
{
    return m_Results;
}


void Search_PaginatedIndexes::setResults(const std::vector<std::shared_ptr<Search_IndexView>>& value)
{
    m_Results = value;
    m_ResultsIsSet = true;
}

bool Search_PaginatedIndexes::resultsIsSet() const
{
    return m_ResultsIsSet;
}

void Search_PaginatedIndexes::unsetResults()
{
    m_ResultsIsSet = false;
}
int32_t Search_PaginatedIndexes::getOffset() const
{
    return m_Offset;
}


void Search_PaginatedIndexes::setOffset(int32_t value)
{
    m_Offset = value;
    m_OffsetIsSet = true;
}

bool Search_PaginatedIndexes::offsetIsSet() const
{
    return m_OffsetIsSet;
}

void Search_PaginatedIndexes::unsetOffset()
{
    m_OffsetIsSet = false;
}
int32_t Search_PaginatedIndexes::getLimit() const
{
    return m_Limit;
}


void Search_PaginatedIndexes::setLimit(int32_t value)
{
    m_Limit = value;
    m_LimitIsSet = true;
}

bool Search_PaginatedIndexes::limitIsSet() const
{
    return m_LimitIsSet;
}

void Search_PaginatedIndexes::unsetLimit()
{
    m_LimitIsSet = false;
}
int32_t Search_PaginatedIndexes::getTotal() const
{
    return m_Total;
}


void Search_PaginatedIndexes::setTotal(int32_t value)
{
    m_Total = value;
    m_TotalIsSet = true;
}

bool Search_PaginatedIndexes::totalIsSet() const
{
    return m_TotalIsSet;
}

void Search_PaginatedIndexes::unsetTotal()
{
    m_TotalIsSet = false;
}

...
O11y_O11yChannelOut::O11y_O11yChannelOut()
{
    m_DataIsSet = false;
...
void O11y_O11yChannelOut::validate()
{
    // TODO: implement validation
}

web::json::value O11y_O11yChannelOut::toJson() const
{
...
bool O11y_O11yChannelOut::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("data"))))
    {
        ...
        {
            std::shared_ptr<O11y_Channel> refVal_setData;
...
void O11y_O11yChannelOut::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool O11y_O11yChannelOut::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<O11y_Channel> O11y_O11yChannelOut::getData() const
{
    return m_Data;
}


void O11y_O11yChannelOut::setData(const std::shared_ptr<O11y_Channel>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool O11y_O11yChannelOut::dataIsSet() const
{
    return m_DataIsSet;
}

void O11y_O11yChannelOut::unsetData()
{
    m_DataIsSet = false;
}
utility::string_t O11y_O11yChannelOut::getStatus() const
{
    return m_Status;
}


void O11y_O11yChannelOut::setStatus(const utility::string_t& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool O11y_O11yChannelOut::statusIsSet() const
{
    return m_StatusIsSet;
}

void O11y_O11yChannelOut::unsetStatus()
{
    m_StatusIsSet = false;
}

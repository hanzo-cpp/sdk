...
Cloud_promptReq::Cloud_promptReq()
{
    m_LabelsIsSet = false;
...
void Cloud_promptReq::validate()
{
    // TODO: implement validation
}

web::json::value Cloud_promptReq::toJson() const
{
...
bool Cloud_promptReq::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Cloud_promptReq::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Cloud_promptReq::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::vector<utility::string_t> Cloud_promptReq::getLabels() const
{
    return m_Labels;
}


void Cloud_promptReq::setLabels(const std::vector<utility::string_t>& value)
{
    m_Labels = value;
    m_LabelsIsSet = true;
}

bool Cloud_promptReq::labelsIsSet() const
{
    return m_LabelsIsSet;
}

void Cloud_promptReq::unsetLabels()
{
    m_LabelsIsSet = false;
}
utility::string_t Cloud_promptReq::getName() const
{
    return m_Name;
}


void Cloud_promptReq::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool Cloud_promptReq::nameIsSet() const
{
    return m_NameIsSet;
}

void Cloud_promptReq::unsetName()
{
    m_NameIsSet = false;
}
utility::string_t Cloud_promptReq::getPrompt() const
{
    return m_Prompt;
}


void Cloud_promptReq::setPrompt(const utility::string_t& value)
{
    m_Prompt = value;
    m_PromptIsSet = true;
}

bool Cloud_promptReq::promptIsSet() const
{
    return m_PromptIsSet;
}

void Cloud_promptReq::unsetPrompt()
{
    m_PromptIsSet = false;
}
std::vector<utility::string_t> Cloud_promptReq::getTags() const
{
    return m_Tags;
}


void Cloud_promptReq::setTags(const std::vector<utility::string_t>& value)
{
    m_Tags = value;
    m_TagsIsSet = true;
}

bool Cloud_promptReq::tagsIsSet() const
{
    return m_TagsIsSet;
}

void Cloud_promptReq::unsetTags()
{
    m_TagsIsSet = false;
}
utility::string_t Cloud_promptReq::getType() const
{
    return m_Type;
}


void Cloud_promptReq::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool Cloud_promptReq::typeIsSet() const
{
    return m_TypeIsSet;
}

void Cloud_promptReq::unsetType()
{
    m_TypeIsSet = false;
}

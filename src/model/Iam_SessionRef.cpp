...
void Iam_SessionRef::validate()
{
    // TODO: implement validation
}

web::json::value Iam_SessionRef::toJson() const
{
...
bool Iam_SessionRef::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Iam_SessionRef::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Iam_SessionRef::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t Iam_SessionRef::getApplication() const
{
    return m_Application;
}


void Iam_SessionRef::setApplication(const utility::string_t& value)
{
    m_Application = value;
    m_ApplicationIsSet = true;
}

bool Iam_SessionRef::applicationIsSet() const
{
    return m_ApplicationIsSet;
}

void Iam_SessionRef::unsetApplication()
{
    m_ApplicationIsSet = false;
}
utility::string_t Iam_SessionRef::getName() const
{
    return m_Name;
}


void Iam_SessionRef::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool Iam_SessionRef::nameIsSet() const
{
    return m_NameIsSet;
}

void Iam_SessionRef::unsetName()
{
    m_NameIsSet = false;
}
utility::string_t Iam_SessionRef::getOwner() const
{
    return m_Owner;
}


void Iam_SessionRef::setOwner(const utility::string_t& value)
{
    m_Owner = value;
    m_OwnerIsSet = true;
}

bool Iam_SessionRef::ownerIsSet() const
{
    return m_OwnerIsSet;
}

void Iam_SessionRef::unsetOwner()
{
    m_OwnerIsSet = false;
}

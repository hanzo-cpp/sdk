...
void SweepEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value SweepEnvelope::toJson() const
{
...
bool SweepEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("data"))))
    {
        ...
        {
            std::shared_ptr<SweepResult> refVal_setData;
...
void SweepEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool SweepEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<SweepResult> SweepEnvelope::getData() const
{
    return m_Data;
}


void SweepEnvelope::setData(const std::shared_ptr<SweepResult>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool SweepEnvelope::dataIsSet() const
{
    return m_DataIsSet;
}

void SweepEnvelope::unsetData()
{
    m_DataIsSet = false;
}
utility::string_t SweepEnvelope::getMsg() const
{
    return m_Msg;
}


void SweepEnvelope::setMsg(const utility::string_t& value)
{
    m_Msg = value;
    m_MsgIsSet = true;
}

bool SweepEnvelope::msgIsSet() const
{
    return m_MsgIsSet;
}

void SweepEnvelope::unsetMsg()
{
    m_MsgIsSet = false;
}
utility::string_t SweepEnvelope::getStatus() const
{
    return m_Status;
}


void SweepEnvelope::setStatus(const utility::string_t& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool SweepEnvelope::statusIsSet() const
{
    return m_StatusIsSet;
}

void SweepEnvelope::unsetStatus()
{
    m_StatusIsSet = false;
}

...
O11y_O11yFeaturesOut::O11y_O11yFeaturesOut()
{
    m_DataIsSet = false;
...
void O11y_O11yFeaturesOut::validate()
{
    // TODO: implement validation
}

web::json::value O11y_O11yFeaturesOut::toJson() const
{
...
bool O11y_O11yFeaturesOut::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("data"))))
    {
        ...
        {
            std::vector<std::shared_ptr<O11y_O11yFeature>> refVal_setData;
...
void O11y_O11yFeaturesOut::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool O11y_O11yFeaturesOut::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::vector<std::shared_ptr<O11y_O11yFeature>> O11y_O11yFeaturesOut::getData() const
{
    return m_Data;
}


void O11y_O11yFeaturesOut::setData(const std::vector<std::shared_ptr<O11y_O11yFeature>>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool O11y_O11yFeaturesOut::dataIsSet() const
{
    return m_DataIsSet;
}

void O11y_O11yFeaturesOut::unsetData()
{
    m_DataIsSet = false;
}
utility::string_t O11y_O11yFeaturesOut::getStatus() const
{
    return m_Status;
}


void O11y_O11yFeaturesOut::setStatus(const utility::string_t& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool O11y_O11yFeaturesOut::statusIsSet() const
{
    return m_StatusIsSet;
}

void O11y_O11yFeaturesOut::unsetStatus()
{
    m_StatusIsSet = false;
}

...
O11y_O11yLicensesOut::O11y_O11yLicensesOut()
{
    m_DataIsSet = false;
...
void O11y_O11yLicensesOut::validate()
{
    // TODO: implement validation
}

web::json::value O11y_O11yLicensesOut::toJson() const
{
...
bool O11y_O11yLicensesOut::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void O11y_O11yLicensesOut::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool O11y_O11yLicensesOut::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::vector<std::shared_ptr<Object>> O11y_O11yLicensesOut::getData() const
{
    return m_Data;
}


void O11y_O11yLicensesOut::setData(const std::vector<std::shared_ptr<Object>>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool O11y_O11yLicensesOut::dataIsSet() const
{
    return m_DataIsSet;
}

void O11y_O11yLicensesOut::unsetData()
{
    m_DataIsSet = false;
}
utility::string_t O11y_O11yLicensesOut::getStatus() const
{
    return m_Status;
}


void O11y_O11yLicensesOut::setStatus(const utility::string_t& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool O11y_O11yLicensesOut::statusIsSet() const
{
    return m_StatusIsSet;
}

void O11y_O11yLicensesOut::unsetStatus()
{
    m_StatusIsSet = false;
}

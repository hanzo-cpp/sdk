...
web::json::value Scan::toJson() const
{
...
bool Scan::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Scan::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Scan::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t Scan::getContent() const
{
    return m_Content;
}


void Scan::setContent(const utility::string_t& value)
{
    m_Content = value;
    m_ContentIsSet = true;
}

bool Scan::contentIsSet() const
{
    return m_ContentIsSet;
}

void Scan::unsetContent()
{
    m_ContentIsSet = false;
}
utility::string_t Scan::getPath() const
{
    return m_Path;
}


void Scan::setPath(const utility::string_t& value)
{
    m_Path = value;
    m_PathIsSet = true;
}

bool Scan::pathIsSet() const
{
    return m_PathIsSet;
}

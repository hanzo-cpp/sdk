...
void MutationOut::validate()
{
    // TODO: implement validation
}

web::json::value MutationOut::toJson() const
{
...
bool MutationOut::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void MutationOut::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool MutationOut::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<Object> MutationOut::getData() const
{
    return m_Data;
}


void MutationOut::setData(const std::shared_ptr<Object>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool MutationOut::dataIsSet() const
{
    return m_DataIsSet;
}

void MutationOut::unsetData()
{
    m_DataIsSet = false;
}
utility::string_t MutationOut::getMsg() const
{
    return m_Msg;
}


void MutationOut::setMsg(const utility::string_t& value)
{
    m_Msg = value;
    m_MsgIsSet = true;
}

bool MutationOut::msgIsSet() const
{
    return m_MsgIsSet;
}

void MutationOut::unsetMsg()
{
    m_MsgIsSet = false;
}
utility::string_t MutationOut::getStatus() const
{
    return m_Status;
}


void MutationOut::setStatus(const utility::string_t& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool MutationOut::statusIsSet() const
{
    return m_StatusIsSet;
}

void MutationOut::unsetStatus()
{
    m_StatusIsSet = false;
}

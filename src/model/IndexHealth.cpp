...
void IndexHealth::validate()
{
    // TODO: implement validation
}

web::json::value IndexHealth::toJson() const
{
...
bool IndexHealth::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void IndexHealth::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool IndexHealth::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t IndexHealth::getStatus() const
{
    return m_Status;
}


void IndexHealth::setStatus(const utility::string_t& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool IndexHealth::statusIsSet() const
{
    return m_StatusIsSet;
}

void IndexHealth::unsetStatus()
{
    m_StatusIsSet = false;
}

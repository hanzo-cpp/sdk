...
void LinearBackfillIn::validate()
{
    // TODO: implement validation
}

web::json::value LinearBackfillIn::toJson() const
{
...
bool LinearBackfillIn::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void LinearBackfillIn::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool LinearBackfillIn::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t LinearBackfillIn::getState() const
{
    return m_State;
}


void LinearBackfillIn::setState(const utility::string_t& value)
{
    m_State = value;
    m_StateIsSet = true;
}

bool LinearBackfillIn::stateIsSet() const
{
    return m_StateIsSet;
}

void LinearBackfillIn::unsetState()
{
    m_StateIsSet = false;
}

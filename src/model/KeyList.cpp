...
void KeyList::validate()
{
    // TODO: implement validation
}

web::json::value KeyList::toJson() const
{
...
bool KeyList::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("data"))))
    {
        ...
        {
            std::vector<std::shared_ptr<KeyView>> refVal_setData;
...
void KeyList::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool KeyList::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::vector<std::shared_ptr<KeyView>> KeyList::getData() const
{
    return m_Data;
}


void KeyList::setData(const std::vector<std::shared_ptr<KeyView>>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool KeyList::dataIsSet() const
{
    return m_DataIsSet;
}

void KeyList::unsetData()
{
    m_DataIsSet = false;
}

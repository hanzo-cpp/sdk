...
void AffiliateOut::validate()
{
    // TODO: implement validation
}

web::json::value AffiliateOut::toJson() const
{
...
bool AffiliateOut::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("data"))))
    {
        ...
        {
            std::shared_ptr<AffiliateData> refVal_setData;
...
void AffiliateOut::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool AffiliateOut::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<AffiliateData> AffiliateOut::getData() const
{
    return m_Data;
}


void AffiliateOut::setData(const std::shared_ptr<AffiliateData>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool AffiliateOut::dataIsSet() const
{
    return m_DataIsSet;
}

void AffiliateOut::unsetData()
{
    m_DataIsSet = false;
}
utility::string_t AffiliateOut::getMsg() const
{
    return m_Msg;
}


void AffiliateOut::setMsg(const utility::string_t& value)
{
    m_Msg = value;
    m_MsgIsSet = true;
}

bool AffiliateOut::msgIsSet() const
{
    return m_MsgIsSet;
}

void AffiliateOut::unsetMsg()
{
    m_MsgIsSet = false;
}
utility::string_t AffiliateOut::getStatus() const
{
    return m_Status;
}


void AffiliateOut::setStatus(const utility::string_t& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool AffiliateOut::statusIsSet() const
{
    return m_StatusIsSet;
}

void AffiliateOut::unsetStatus()
{
    m_StatusIsSet = false;
}

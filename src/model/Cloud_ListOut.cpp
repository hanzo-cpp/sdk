...
void Cloud_ListOut::validate()
{
    // TODO: implement validation
}

web::json::value Cloud_ListOut::toJson() const
{
...
bool Cloud_ListOut::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("data"))))
    {
        ...
        {
            std::vector<std::shared_ptr<Cloud_Host>> refVal_setData;
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("drift"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<Cloud_Drift>> refVal_setDrift;
...
void Cloud_ListOut::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Cloud_ListOut::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::vector<std::shared_ptr<Cloud_Host>> Cloud_ListOut::getData() const
{
    return m_Data;
}


void Cloud_ListOut::setData(const std::vector<std::shared_ptr<Cloud_Host>>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool Cloud_ListOut::dataIsSet() const
{
    return m_DataIsSet;
}

void Cloud_ListOut::unsetData()
{
    m_DataIsSet = false;
}
std::vector<std::shared_ptr<Cloud_Drift>> Cloud_ListOut::getDrift() const
{
    return m_Drift;
}


void Cloud_ListOut::setDrift(const std::vector<std::shared_ptr<Cloud_Drift>>& value)
{
    m_Drift = value;
    m_DriftIsSet = true;
}

bool Cloud_ListOut::driftIsSet() const
{
    return m_DriftIsSet;
}

void Cloud_ListOut::unsetDrift()
{
    m_DriftIsSet = false;
}
utility::string_t Cloud_ListOut::getMsg() const
{
    return m_Msg;
}


void Cloud_ListOut::setMsg(const utility::string_t& value)
{
    m_Msg = value;
    m_MsgIsSet = true;
}

bool Cloud_ListOut::msgIsSet() const
{
    return m_MsgIsSet;
}

void Cloud_ListOut::unsetMsg()
{
    m_MsgIsSet = false;
}
utility::string_t Cloud_ListOut::getStatus() const
{
    return m_Status;
}


void Cloud_ListOut::setStatus(const utility::string_t& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool Cloud_ListOut::statusIsSet() const
{
    return m_StatusIsSet;
}

void Cloud_ListOut::unsetStatus()
{
    m_StatusIsSet = false;
}
int32_t Cloud_ListOut::getTotal() const
{
    return m_Total;
}


void Cloud_ListOut::setTotal(int32_t value)
{
    m_Total = value;
    m_TotalIsSet = true;
}

bool Cloud_ListOut::totalIsSet() const
{
    return m_TotalIsSet;
}

void Cloud_ListOut::unsetTotal()
{
    m_TotalIsSet = false;
}

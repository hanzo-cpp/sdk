...
void Cloud_Audience::validate()
{
    // TODO: implement validation
}

web::json::value Cloud_Audience::toJson() const
{
...
bool Cloud_Audience::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Cloud_Audience::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Cloud_Audience::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
int32_t Cloud_Audience::getCreatedAt() const
{
    return m_CreatedAt;
}


void Cloud_Audience::setCreatedAt(int32_t value)
{
    m_CreatedAt = value;
    m_CreatedAtIsSet = true;
}

bool Cloud_Audience::createdAtIsSet() const
{
    return m_CreatedAtIsSet;
}

void Cloud_Audience::unsetCreatedAt()
{
    m_CreatedAtIsSet = false;
}
utility::string_t Cloud_Audience::getEvent() const
{
    return m_Event;
}


void Cloud_Audience::setEvent(const utility::string_t& value)
{
    m_Event = value;
    m_EventIsSet = true;
}

bool Cloud_Audience::eventIsSet() const
{
    return m_EventIsSet;
}

void Cloud_Audience::unsetEvent()
{
    m_EventIsSet = false;
}
utility::string_t Cloud_Audience::getId() const
{
    return m_Id;
}


void Cloud_Audience::setId(const utility::string_t& value)
{
    m_Id = value;
    m_IdIsSet = true;
}

bool Cloud_Audience::idIsSet() const
{
    return m_IdIsSet;
}

void Cloud_Audience::unsetId()
{
    m_IdIsSet = false;
}
utility::string_t Cloud_Audience::getName() const
{
    return m_Name;
}


void Cloud_Audience::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool Cloud_Audience::nameIsSet() const
{
    return m_NameIsSet;
}

void Cloud_Audience::unsetName()
{
    m_NameIsSet = false;
}
int32_t Cloud_Audience::getUpdatedAt() const
{
    return m_UpdatedAt;
}


void Cloud_Audience::setUpdatedAt(int32_t value)
{
    m_UpdatedAt = value;
    m_UpdatedAtIsSet = true;
}

bool Cloud_Audience::updatedAtIsSet() const
{
    return m_UpdatedAtIsSet;
}

void Cloud_Audience::unsetUpdatedAt()
{
    m_UpdatedAtIsSet = false;
}
int32_t Cloud_Audience::getWindowDays() const
{
    return m_WindowDays;
}


void Cloud_Audience::setWindowDays(int32_t value)
{
    m_WindowDays = value;
    m_WindowDaysIsSet = true;
}

bool Cloud_Audience::windowDaysIsSet() const
{
    return m_WindowDaysIsSet;
}

void Cloud_Audience::unsetWindowDays()
{
    m_WindowDaysIsSet = false;
}

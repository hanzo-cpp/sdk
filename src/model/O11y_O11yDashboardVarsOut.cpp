...
O11y_O11yDashboardVarsOut::O11y_O11yDashboardVarsOut()
{
    m_DataIsSet = false;
...
void O11y_O11yDashboardVarsOut::validate()
{
    // TODO: implement validation
}

web::json::value O11y_O11yDashboardVarsOut::toJson() const
{
...
bool O11y_O11yDashboardVarsOut::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("data"))))
    {
        ...
        {
            std::shared_ptr<O11y_O11yDashboardVarValues> refVal_setData;
...
void O11y_O11yDashboardVarsOut::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool O11y_O11yDashboardVarsOut::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<O11y_O11yDashboardVarValues> O11y_O11yDashboardVarsOut::getData() const
{
    return m_Data;
}


void O11y_O11yDashboardVarsOut::setData(const std::shared_ptr<O11y_O11yDashboardVarValues>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool O11y_O11yDashboardVarsOut::dataIsSet() const
{
    return m_DataIsSet;
}

void O11y_O11yDashboardVarsOut::unsetData()
{
    m_DataIsSet = false;
}
utility::string_t O11y_O11yDashboardVarsOut::getStatus() const
{
    return m_Status;
}


void O11y_O11yDashboardVarsOut::setStatus(const utility::string_t& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool O11y_O11yDashboardVarsOut::statusIsSet() const
{
    return m_StatusIsSet;
}

void O11y_O11yDashboardVarsOut::unsetStatus()
{
    m_StatusIsSet = false;
}

...
VolumeSnapshotOut::VolumeSnapshotOut()
{
    m_DataIsSet = false;
...
void VolumeSnapshotOut::validate()
{
    // TODO: implement validation
}

web::json::value VolumeSnapshotOut::toJson() const
{
...
bool VolumeSnapshotOut::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("data"))))
    {
        ...
        {
            std::shared_ptr<Digitalocean_Snapshot> refVal_setData;
...
void VolumeSnapshotOut::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool VolumeSnapshotOut::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<Digitalocean_Snapshot> VolumeSnapshotOut::getData() const
{
    return m_Data;
}


void VolumeSnapshotOut::setData(const std::shared_ptr<Digitalocean_Snapshot>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool VolumeSnapshotOut::dataIsSet() const
{
    return m_DataIsSet;
}

void VolumeSnapshotOut::unsetData()
{
    m_DataIsSet = false;
}
utility::string_t VolumeSnapshotOut::getMsg() const
{
    return m_Msg;
}


void VolumeSnapshotOut::setMsg(const utility::string_t& value)
{
    m_Msg = value;
    m_MsgIsSet = true;
}

bool VolumeSnapshotOut::msgIsSet() const
{
    return m_MsgIsSet;
}

void VolumeSnapshotOut::unsetMsg()
{
    m_MsgIsSet = false;
}
utility::string_t VolumeSnapshotOut::getStatus() const
{
    return m_Status;
}


void VolumeSnapshotOut::setStatus(const utility::string_t& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool VolumeSnapshotOut::statusIsSet() const
{
    return m_StatusIsSet;
}

void VolumeSnapshotOut::unsetStatus()
{
    m_StatusIsSet = false;
}

...
void SocialPosts::validate()
{
    // TODO: implement validation
}

web::json::value SocialPosts::toJson() const
{
...
bool SocialPosts::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("data"))))
    {
        ...
        {
            std::vector<std::shared_ptr<SocialPost>> refVal_setData;
...
void SocialPosts::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool SocialPosts::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::vector<std::shared_ptr<SocialPost>> SocialPosts::getData() const
{
    return m_Data;
}


void SocialPosts::setData(const std::vector<std::shared_ptr<SocialPost>>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool SocialPosts::dataIsSet() const
{
    return m_DataIsSet;
}

void SocialPosts::unsetData()
{
    m_DataIsSet = false;
}

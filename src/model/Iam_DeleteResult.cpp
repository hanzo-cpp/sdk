...
Iam_DeleteResult::Iam_DeleteResult()
{
    m_Deleted = false;
...
void Iam_DeleteResult::validate()
{
    // TODO: implement validation
}

web::json::value Iam_DeleteResult::toJson() const
{
...
bool Iam_DeleteResult::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Iam_DeleteResult::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Iam_DeleteResult::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
bool Iam_DeleteResult::isDeleted() const
{
    return m_Deleted;
}


void Iam_DeleteResult::setDeleted(bool value)
{
    m_Deleted = value;
    m_DeletedIsSet = true;
}

bool Iam_DeleteResult::deletedIsSet() const
{
    return m_DeletedIsSet;
}

void Iam_DeleteResult::unsetDeleted()
{
    m_DeletedIsSet = false;
}

...
#include "hanzo/model/O11y_VolumeListResponse.h"

namespace hanzo {
namespace model {

O11y_VolumeListResponse::O11y_VolumeListResponse()
{
...
void O11y_VolumeListResponse::validate()
{
    // TODO: implement validation
}

web::json::value O11y_VolumeListResponse::toJson() const
{
...
bool O11y_VolumeListResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("records"))))
    {
        ...
        {
            std::vector<std::shared_ptr<O11y_VolumeListRecord>> refVal_setRecords;
...
void O11y_VolumeListResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool O11y_VolumeListResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::vector<std::shared_ptr<O11y_VolumeListRecord>> O11y_VolumeListResponse::getRecords() const
{
    return m_Records;
}


void O11y_VolumeListResponse::setRecords(const std::vector<std::shared_ptr<O11y_VolumeListRecord>>& value)
{
    m_Records = value;
    m_RecordsIsSet = true;
}

bool O11y_VolumeListResponse::recordsIsSet() const
{
    return m_RecordsIsSet;
}

void O11y_VolumeListResponse::unsetRecords()
{
    m_RecordsIsSet = false;
}
int32_t O11y_VolumeListResponse::getTotal() const
{
    return m_Total;
}


void O11y_VolumeListResponse::setTotal(int32_t value)
{
    m_Total = value;
    m_TotalIsSet = true;
}

bool O11y_VolumeListResponse::totalIsSet() const
{
    return m_TotalIsSet;
}

void O11y_VolumeListResponse::unsetTotal()
{
    m_TotalIsSet = false;
}
utility::string_t O11y_VolumeListResponse::getType() const
{
    return m_Type;
}


void O11y_VolumeListResponse::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool O11y_VolumeListResponse::typeIsSet() const
{
    return m_TypeIsSet;
}

void O11y_VolumeListResponse::unsetType()
{
    m_TypeIsSet = false;
}

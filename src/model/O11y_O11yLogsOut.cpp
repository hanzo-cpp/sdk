...
O11y_O11yLogsOut::O11y_O11yLogsOut()
{
    m_DataIsSet = false;
...
void O11y_O11yLogsOut::validate()
{
    // TODO: implement validation
}

web::json::value O11y_O11yLogsOut::toJson() const
{
...
bool O11y_O11yLogsOut::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void O11y_O11yLogsOut::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool O11y_O11yLogsOut::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<O11y_O11yEvents> O11y_O11yLogsOut::getData() const
{
    return m_Data;
}


void O11y_O11yLogsOut::setData(const std::shared_ptr<O11y_O11yEvents>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool O11y_O11yLogsOut::dataIsSet() const
{
    return m_DataIsSet;
}

void O11y_O11yLogsOut::unsetData()
{
    m_DataIsSet = false;
}
utility::string_t O11y_O11yLogsOut::getStatus() const
{
    return m_Status;
}


void O11y_O11yLogsOut::setStatus(const utility::string_t& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool O11y_O11yLogsOut::statusIsSet() const
{
    return m_StatusIsSet;
}

void O11y_O11yLogsOut::unsetStatus()
{
    m_StatusIsSet = false;
}

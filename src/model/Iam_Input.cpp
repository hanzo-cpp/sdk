...
void Iam_Input::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Iam_Input::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
void Iam_Input::setCreatedTime(const utility::string_t& value)
{
    m_CreatedTime = value;
    m_CreatedTimeIsSet = true;
}

bool Iam_Input::createdTimeIsSet() const
{
    return m_CreatedTimeIsSet;
}

void Iam_Input::unsetCreatedTime()
{
    m_CreatedTimeIsSet = false;
}
...
void Iam_Input::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool Iam_Input::nameIsSet() const
{
    return m_NameIsSet;
}
...
void Iam_Input::setOrganization(const utility::string_t& value)
{
    m_Organization = value;
    m_OrganizationIsSet = true;
}

bool Iam_Input::organizationIsSet() const
{
    return m_OrganizationIsSet;
}

void Iam_Input::unsetOrganization()
{
    m_OrganizationIsSet = false;
}
utility::string_t Iam_Input::getOwner() const
{
    return m_Owner;
}


void Iam_Input::setOwner(const utility::string_t& value)
{
    m_Owner = value;
    m_OwnerIsSet = true;
}

bool Iam_Input::ownerIsSet() const
{
    return m_OwnerIsSet;
}

void Iam_Input::unsetOwner()
{
    m_OwnerIsSet = false;
}

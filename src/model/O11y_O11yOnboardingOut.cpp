...
O11y_O11yOnboardingOut::O11y_O11yOnboardingOut()
{
    m_DataIsSet = false;
...
void O11y_O11yOnboardingOut::validate()
{
    // TODO: implement validation
}

web::json::value O11y_O11yOnboardingOut::toJson() const
{
...
bool O11y_O11yOnboardingOut::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("data"))))
    {
        ...
        {
            std::shared_ptr<O11y_O11yK8sOnboarding> refVal_setData;
...
void O11y_O11yOnboardingOut::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool O11y_O11yOnboardingOut::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<O11y_O11yK8sOnboarding> O11y_O11yOnboardingOut::getData() const
{
    return m_Data;
}


void O11y_O11yOnboardingOut::setData(const std::shared_ptr<O11y_O11yK8sOnboarding>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool O11y_O11yOnboardingOut::dataIsSet() const
{
    return m_DataIsSet;
}

void O11y_O11yOnboardingOut::unsetData()
{
    m_DataIsSet = false;
}
utility::string_t O11y_O11yOnboardingOut::getStatus() const
{
    return m_Status;
}


void O11y_O11yOnboardingOut::setStatus(const utility::string_t& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool O11y_O11yOnboardingOut::statusIsSet() const
{
    return m_StatusIsSet;
}

void O11y_O11yOnboardingOut::unsetStatus()
{
    m_StatusIsSet = false;
}

...
O11y_O11yFieldValuesOut::O11y_O11yFieldValuesOut()
{
    m_DataIsSet = false;
...
void O11y_O11yFieldValuesOut::validate()
{
    // TODO: implement validation
}

web::json::value O11y_O11yFieldValuesOut::toJson() const
{
...
bool O11y_O11yFieldValuesOut::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void O11y_O11yFieldValuesOut::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool O11y_O11yFieldValuesOut::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<O11y_GettableFieldValues> O11y_O11yFieldValuesOut::getData() const
{
    return m_Data;
}


void O11y_O11yFieldValuesOut::setData(const std::shared_ptr<O11y_GettableFieldValues>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool O11y_O11yFieldValuesOut::dataIsSet() const
{
    return m_DataIsSet;
}

void O11y_O11yFieldValuesOut::unsetData()
{
    m_DataIsSet = false;
}
utility::string_t O11y_O11yFieldValuesOut::getStatus() const
{
    return m_Status;
}


void O11y_O11yFieldValuesOut::setStatus(const utility::string_t& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool O11y_O11yFieldValuesOut::statusIsSet() const
{
    return m_StatusIsSet;
}

void O11y_O11yFieldValuesOut::unsetStatus()
{
    m_StatusIsSet = false;
}

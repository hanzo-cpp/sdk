...
void AutoCreate::validate()
{
    // TODO: implement validation
}

web::json::value AutoCreate::toJson() const
{
...
bool AutoCreate::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void AutoCreate::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool AutoCreate::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<AnyType> AutoCreate::getData() const
{
    return m_Data.get();
}


void AutoCreate::setData(const std::shared_ptr<AnyType>& value)
{
    m_Data = value;
}

bool AutoCreate::dataIsSet() const
{
    return m_Data.has_value();
}

void AutoCreate::unsetData()
{
    m_Data.reset();
}
utility::string_t AutoCreate::getName() const
{
    return m_Name;
}


void AutoCreate::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool AutoCreate::nameIsSet() const
{
    return m_NameIsSet;
}

void AutoCreate::unsetName()
{
    m_NameIsSet = false;
}

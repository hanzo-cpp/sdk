...
void SpaceItem::validate()
{
    // TODO: implement validation
}

web::json::value SpaceItem::toJson() const
{
...
bool SpaceItem::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void SpaceItem::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool SpaceItem::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
int32_t SpaceItem::getCreatedAt() const
{
    return m_CreatedAt;
}


void SpaceItem::setCreatedAt(int32_t value)
{
    m_CreatedAt = value;
    m_CreatedAtIsSet = true;
}

bool SpaceItem::createdAtIsSet() const
{
    return m_CreatedAtIsSet;
}

void SpaceItem::unsetCreatedAt()
{
    m_CreatedAtIsSet = false;
}
utility::string_t SpaceItem::getName() const
{
    return m_Name;
}


void SpaceItem::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool SpaceItem::nameIsSet() const
{
    return m_NameIsSet;
}

void SpaceItem::unsetName()
{
    m_NameIsSet = false;
}

...
void PullList::validate()
{
    // TODO: implement validation
}

web::json::value PullList::toJson() const
{
...
bool PullList::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("data"))))
    {
        ...
        {
            std::vector<std::shared_ptr<PullView>> refVal_setData;
...
void PullList::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool PullList::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::vector<std::shared_ptr<PullView>> PullList::getData() const
{
    return m_Data;
}


void PullList::setData(const std::vector<std::shared_ptr<PullView>>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool PullList::dataIsSet() const
{
    return m_DataIsSet;
}

void PullList::unsetData()
{
    m_DataIsSet = false;
}

...
int64_t Registration::getCreatedAt() const
{
    return m_CreatedAt;
}


void Registration::setCreatedAt(int64_t value)
{
    m_CreatedAt = value;
...
int64_t Registration::getUpdatedAt() const
{
    return m_UpdatedAt;
}


void Registration::setUpdatedAt(int64_t value)
{
    m_UpdatedAt = value;

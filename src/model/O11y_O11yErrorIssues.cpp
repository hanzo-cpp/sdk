...
O11y_O11yErrorIssues::O11y_O11yErrorIssues()
{
    m_ItemsIsSet = false;
    m_Limit = 0;
    m_LimitIsSet = false;
...
void O11y_O11yErrorIssues::validate()
{
    // TODO: implement validation
}

web::json::value O11y_O11yErrorIssues::toJson() const
{
...
bool O11y_O11yErrorIssues::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("items"))))
    {
        ...
        {
            std::vector<std::shared_ptr<O11y_O11yErrorIssue>> refVal_setItems;
...
void O11y_O11yErrorIssues::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool O11y_O11yErrorIssues::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::vector<std::shared_ptr<O11y_O11yErrorIssue>> O11y_O11yErrorIssues::getItems() const
{
    return m_Items;
}


void O11y_O11yErrorIssues::setItems(const std::vector<std::shared_ptr<O11y_O11yErrorIssue>>& value)
{
    m_Items = value;
    m_ItemsIsSet = true;
}

bool O11y_O11yErrorIssues::itemsIsSet() const
{
    return m_ItemsIsSet;
}

void O11y_O11yErrorIssues::unsetItems()
{
    m_ItemsIsSet = false;
}
int32_t O11y_O11yErrorIssues::getLimit() const
{
    return m_Limit;
}


void O11y_O11yErrorIssues::setLimit(int32_t value)
{
    m_Limit = value;
    m_LimitIsSet = true;
}

bool O11y_O11yErrorIssues::limitIsSet() const
{
    return m_LimitIsSet;
}

void O11y_O11yErrorIssues::unsetLimit()
{
    m_LimitIsSet = false;
}
int32_t O11y_O11yErrorIssues::getOffset() const
{
    return m_Offset;
}


void O11y_O11yErrorIssues::setOffset(int32_t value)
{
    m_Offset = value;
    m_OffsetIsSet = true;
}

bool O11y_O11yErrorIssues::offsetIsSet() const
{
    return m_OffsetIsSet;
}

void O11y_O11yErrorIssues::unsetOffset()
{
    m_OffsetIsSet = false;
}
int32_t O11y_O11yErrorIssues::getTotal() const
{
    return m_Total;
}


void O11y_O11yErrorIssues::setTotal(int32_t value)
{
    m_Total = value;
    m_TotalIsSet = true;
}

bool O11y_O11yErrorIssues::totalIsSet() const
{
    return m_TotalIsSet;
}

void O11y_O11yErrorIssues::unsetTotal()
{
    m_TotalIsSet = false;
}

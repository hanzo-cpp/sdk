...
int64_t O11y_O11yErrorIssues::getLimit() const
{
    return m_Limit;
}


void O11y_O11yErrorIssues::setLimit(int64_t value)
{
    m_Limit = value;
    m_LimitIsSet = true;
}
...
int64_t O11y_O11yErrorIssues::getOffset() const
{
    return m_Offset;
}


void O11y_O11yErrorIssues::setOffset(int64_t value)
{
    m_Offset = value;
    m_OffsetIsSet = true;
}
...
int64_t O11y_O11yErrorIssues::getTotal() const
{
    return m_Total;
}


void O11y_O11yErrorIssues::setTotal(int64_t value)
{
    m_Total = value;
    m_TotalIsSet = true;
}

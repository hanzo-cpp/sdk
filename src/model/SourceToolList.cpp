...
void SourceToolList::validate()
{
    // TODO: implement validation
}

web::json::value SourceToolList::toJson() const
{
...
bool SourceToolList::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void SourceToolList::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool SourceToolList::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t SourceToolList::getSource() const
{
    return m_Source;
}


void SourceToolList::setSource(const utility::string_t& value)
{
    m_Source = value;
    m_SourceIsSet = true;
}

bool SourceToolList::sourceIsSet() const
{
    return m_SourceIsSet;
}

void SourceToolList::unsetSource()
{
    m_SourceIsSet = false;
}
std::vector<std::shared_ptr<Tool>> SourceToolList::getTools() const
{
    return m_Tools;
}


void SourceToolList::setTools(const std::vector<std::shared_ptr<Tool>>& value)
{
    m_Tools = value;
    m_ToolsIsSet = true;
}

bool SourceToolList::toolsIsSet() const
{
    return m_ToolsIsSet;
}

void SourceToolList::unsetTools()
{
    m_ToolsIsSet = false;
}

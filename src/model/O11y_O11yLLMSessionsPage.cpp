...
#include "hanzo/model/O11y_O11yLLMSessionsPage.h"

namespace hanzo {
namespace model {

O11y_O11yLLMSessionsPage::O11y_O11yLLMSessionsPage()
{
    m_ItemsIsSet = false;
    m_Limit = 0;
    m_LimitIsSet = false;
...
void O11y_O11yLLMSessionsPage::validate()
{
    // TODO: implement validation
}

web::json::value O11y_O11yLLMSessionsPage::toJson() const
{
...
bool O11y_O11yLLMSessionsPage::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("items"))))
    {
        ...
        {
            std::vector<std::shared_ptr<O11y_O11yLLMSession>> refVal_setItems;
...
void O11y_O11yLLMSessionsPage::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool O11y_O11yLLMSessionsPage::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::vector<std::shared_ptr<O11y_O11yLLMSession>> O11y_O11yLLMSessionsPage::getItems() const
{
    return m_Items;
}


void O11y_O11yLLMSessionsPage::setItems(const std::vector<std::shared_ptr<O11y_O11yLLMSession>>& value)
{
    m_Items = value;
    m_ItemsIsSet = true;
}

bool O11y_O11yLLMSessionsPage::itemsIsSet() const
{
    return m_ItemsIsSet;
}

void O11y_O11yLLMSessionsPage::unsetItems()
{
    m_ItemsIsSet = false;
}
int32_t O11y_O11yLLMSessionsPage::getLimit() const
{
    return m_Limit;
}


void O11y_O11yLLMSessionsPage::setLimit(int32_t value)
{
    m_Limit = value;
    m_LimitIsSet = true;
}

bool O11y_O11yLLMSessionsPage::limitIsSet() const
{
    return m_LimitIsSet;
}

void O11y_O11yLLMSessionsPage::unsetLimit()
{
    m_LimitIsSet = false;
}
int32_t O11y_O11yLLMSessionsPage::getOffset() const
{
    return m_Offset;
}


void O11y_O11yLLMSessionsPage::setOffset(int32_t value)
{
    m_Offset = value;
    m_OffsetIsSet = true;
}

bool O11y_O11yLLMSessionsPage::offsetIsSet() const
{
    return m_OffsetIsSet;
}

void O11y_O11yLLMSessionsPage::unsetOffset()
{
    m_OffsetIsSet = false;
}

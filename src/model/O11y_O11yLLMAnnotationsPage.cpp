...
#include "hanzo/model/O11y_O11yLLMAnnotationsPage.h"
...
void O11y_O11yLLMAnnotationsPage::validate()
{
    // TODO: implement validation
}

web::json::value O11y_O11yLLMAnnotationsPage::toJson() const
{
...
bool O11y_O11yLLMAnnotationsPage::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("items"))))
    {
        ...
        {
            std::vector<std::shared_ptr<O11y_O11yLLMAnnotation>> refVal_setItems;
...
void O11y_O11yLLMAnnotationsPage::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool O11y_O11yLLMAnnotationsPage::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::vector<std::shared_ptr<O11y_O11yLLMAnnotation>> O11y_O11yLLMAnnotationsPage::getItems() const
{
    return m_Items;
}


void O11y_O11yLLMAnnotationsPage::setItems(const std::vector<std::shared_ptr<O11y_O11yLLMAnnotation>>& value)
{
    m_Items = value;
    m_ItemsIsSet = true;
}

bool O11y_O11yLLMAnnotationsPage::itemsIsSet() const
{
    return m_ItemsIsSet;
}

void O11y_O11yLLMAnnotationsPage::unsetItems()
{
    m_ItemsIsSet = false;
}
...
bool O11y_O11yLLMAnnotationsPage::limitIsSet() const
{
    return m_LimitIsSet;
}

void O11y_O11yLLMAnnotationsPage::unsetLimit()
{
    m_LimitIsSet = false;
}
...
bool O11y_O11yLLMAnnotationsPage::offsetIsSet() const
{
    return m_OffsetIsSet;
}

void O11y_O11yLLMAnnotationsPage::unsetOffset()
{
    m_OffsetIsSet = false;
}
...
bool O11y_O11yLLMAnnotationsPage::totalIsSet() const
{
    return m_TotalIsSet;
}

void O11y_O11yLLMAnnotationsPage::unsetTotal()
{
    m_TotalIsSet = false;
}

...
void DeletedOut::validate()
{
    // TODO: implement validation
}

web::json::value DeletedOut::toJson() const
{
...
bool DeletedOut::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void DeletedOut::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool DeletedOut::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t DeletedOut::getDeleted() const
{
    return m_Deleted;
}


void DeletedOut::setDeleted(const utility::string_t& value)
{
    m_Deleted = value;
    m_DeletedIsSet = true;
}

bool DeletedOut::deletedIsSet() const
{
    return m_DeletedIsSet;
}

void DeletedOut::unsetDeleted()
{
    m_DeletedIsSet = false;
}

...
void PresetList::validate()
{
    // TODO: implement validation
}

web::json::value PresetList::toJson() const
{
...
bool PresetList::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("data"))))
    {
        ...
        {
            std::vector<std::shared_ptr<Preset>> refVal_setData;
...
void PresetList::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool PresetList::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::vector<std::shared_ptr<Preset>> PresetList::getData() const
{
    return m_Data;
}


void PresetList::setData(const std::vector<std::shared_ptr<Preset>>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool PresetList::dataIsSet() const
{
    return m_DataIsSet;
}

void PresetList::unsetData()
{
    m_DataIsSet = false;
}

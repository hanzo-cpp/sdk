...
void PolicyOut::validate()
{
    // TODO: implement validation
}

web::json::value PolicyOut::toJson() const
{
...
bool PolicyOut::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("data"))))
    {
        ...
        {
            std::shared_ptr<PolicyData> refVal_setData;
...
void PolicyOut::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool PolicyOut::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<PolicyData> PolicyOut::getData() const
{
    return m_Data;
}


void PolicyOut::setData(const std::shared_ptr<PolicyData>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool PolicyOut::dataIsSet() const
{
    return m_DataIsSet;
}

void PolicyOut::unsetData()
{
    m_DataIsSet = false;
}
utility::string_t PolicyOut::getMsg() const
{
    return m_Msg;
}


void PolicyOut::setMsg(const utility::string_t& value)
{
    m_Msg = value;
    m_MsgIsSet = true;
}

bool PolicyOut::msgIsSet() const
{
    return m_MsgIsSet;
}

void PolicyOut::unsetMsg()
{
    m_MsgIsSet = false;
}
utility::string_t PolicyOut::getStatus() const
{
    return m_Status;
}


void PolicyOut::setStatus(const utility::string_t& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool PolicyOut::statusIsSet() const
{
    return m_StatusIsSet;
}

void PolicyOut::unsetStatus()
{
    m_StatusIsSet = false;
}

...
void ComputeOut::validate()
{
    // TODO: implement validation
}

web::json::value ComputeOut::toJson() const
{
...
bool ComputeOut::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("data"))))
    {
        ...
        {
            std::vector<std::shared_ptr<ComputeLeaf>> refVal_setData;
...
void ComputeOut::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ComputeOut::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::vector<std::shared_ptr<ComputeLeaf>> ComputeOut::getData() const
{
    return m_Data;
}


void ComputeOut::setData(const std::vector<std::shared_ptr<ComputeLeaf>>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool ComputeOut::dataIsSet() const
{
    return m_DataIsSet;
}

void ComputeOut::unsetData()
{
    m_DataIsSet = false;
}
utility::string_t ComputeOut::getMsg() const
{
    return m_Msg;
}


void ComputeOut::setMsg(const utility::string_t& value)
{
    m_Msg = value;
    m_MsgIsSet = true;
}

bool ComputeOut::msgIsSet() const
{
    return m_MsgIsSet;
}

void ComputeOut::unsetMsg()
{
    m_MsgIsSet = false;
}
utility::string_t ComputeOut::getStatus() const
{
    return m_Status;
}


void ComputeOut::setStatus(const utility::string_t& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool ComputeOut::statusIsSet() const
{
    return m_StatusIsSet;
}

void ComputeOut::unsetStatus()
{
    m_StatusIsSet = false;
}
int32_t ComputeOut::getTotal() const
{
    return m_Total;
}


void ComputeOut::setTotal(int32_t value)
{
    m_Total = value;
    m_TotalIsSet = true;
}

bool ComputeOut::totalIsSet() const
{
    return m_TotalIsSet;
}

void ComputeOut::unsetTotal()
{
    m_TotalIsSet = false;
}

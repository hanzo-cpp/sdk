...
O11y_O11yRulesOut::O11y_O11yRulesOut()
{
    m_DataIsSet = false;
...
void O11y_O11yRulesOut::validate()
{
    // TODO: implement validation
}

web::json::value O11y_O11yRulesOut::toJson() const
{
...
bool O11y_O11yRulesOut::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void O11y_O11yRulesOut::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool O11y_O11yRulesOut::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::vector<std::shared_ptr<AnyType>> O11y_O11yRulesOut::getData() const
{
    return m_Data;
}


void O11y_O11yRulesOut::setData(const std::vector<std::shared_ptr<AnyType>>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool O11y_O11yRulesOut::dataIsSet() const
{
    return m_DataIsSet;
}

void O11y_O11yRulesOut::unsetData()
{
    m_DataIsSet = false;
}
utility::string_t O11y_O11yRulesOut::getStatus() const
{
    return m_Status;
}


void O11y_O11yRulesOut::setStatus(const utility::string_t& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool O11y_O11yRulesOut::statusIsSet() const
{
    return m_StatusIsSet;
}

void O11y_O11yRulesOut::unsetStatus()
{
    m_StatusIsSet = false;
}

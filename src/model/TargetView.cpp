...
void TargetView::validate()
{
    // TODO: implement validation
}

web::json::value TargetView::toJson() const
{
...
bool TargetView::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void TargetView::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool TargetView::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t TargetView::getCapacity() const
{
    return m_Capacity;
}


void TargetView::setCapacity(const utility::string_t& value)
{
    m_Capacity = value;
    m_CapacityIsSet = true;
}

bool TargetView::capacityIsSet() const
{
    return m_CapacityIsSet;
}

void TargetView::unsetCapacity()
{
    m_CapacityIsSet = false;
}
utility::string_t TargetView::getCreatedAt() const
{
    return m_CreatedAt;
}


void TargetView::setCreatedAt(const utility::string_t& value)
{
    m_CreatedAt = value;
    m_CreatedAtIsSet = true;
}

bool TargetView::createdAtIsSet() const
{
    return m_CreatedAtIsSet;
}

void TargetView::unsetCreatedAt()
{
    m_CreatedAtIsSet = false;
}
utility::string_t TargetView::getHost() const
{
    return m_Host;
}


void TargetView::setHost(const utility::string_t& value)
{
    m_Host = value;
    m_HostIsSet = true;
}

bool TargetView::hostIsSet() const
{
    return m_HostIsSet;
}

void TargetView::unsetHost()
{
    m_HostIsSet = false;
}
utility::string_t TargetView::getId() const
{
    return m_Id;
}


void TargetView::setId(const utility::string_t& value)
{
    m_Id = value;
    m_IdIsSet = true;
}

bool TargetView::idIsSet() const
{
    return m_IdIsSet;
}

void TargetView::unsetId()
{
    m_IdIsSet = false;
}
utility::string_t TargetView::getKind() const
{
    return m_Kind;
}


void TargetView::setKind(const utility::string_t& value)
{
    m_Kind = value;
    m_KindIsSet = true;
}

bool TargetView::kindIsSet() const
{
    return m_KindIsSet;
}

void TargetView::unsetKind()
{
    m_KindIsSet = false;
}
utility::string_t TargetView::getLabel() const
{
    return m_Label;
}


void TargetView::setLabel(const utility::string_t& value)
{
    m_Label = value;
    m_LabelIsSet = true;
}

bool TargetView::labelIsSet() const
{
    return m_LabelIsSet;
}

void TargetView::unsetLabel()
{
    m_LabelIsSet = false;
}
std::shared_ptr<Metrics> TargetView::getMetrics() const
{
    return m_Metrics;
}


void TargetView::setMetrics(const std::shared_ptr<Metrics>& value)
{
    m_Metrics = value;
    m_MetricsIsSet = true;
}

bool TargetView::metricsIsSet() const
{
    return m_MetricsIsSet;
}

void TargetView::unsetMetrics()
{
    m_MetricsIsSet = false;
}
utility::string_t TargetView::getMetricsAt() const
{
    return m_MetricsAt;
}


void TargetView::setMetricsAt(const utility::string_t& value)
{
    m_MetricsAt = value;
    m_MetricsAtIsSet = true;
}

bool TargetView::metricsAtIsSet() const
{
    return m_MetricsAtIsSet;
}

void TargetView::unsetMetricsAt()
{
    m_MetricsAtIsSet = false;
}
...
bool TargetView::runningIsSet() const
{
    return m_RunningIsSet;
}

void TargetView::unsetRunning()
{
    m_RunningIsSet = false;
}
...
bool TargetView::sessionsIsSet() const
{
    return m_SessionsIsSet;
}

void TargetView::unsetSessions()
{
    m_SessionsIsSet = false;
}
std::shared_ptr<Spec> TargetView::getSpec() const
{
    return m_Spec;
}


void TargetView::setSpec(const std::shared_ptr<Spec>& value)
{
    m_Spec = value;
    m_SpecIsSet = true;
}

bool TargetView::specIsSet() const
{
    return m_SpecIsSet;
}

void TargetView::unsetSpec()
{
    m_SpecIsSet = false;
}
utility::string_t TargetView::getStatus() const
{
    return m_Status;
}


void TargetView::setStatus(const utility::string_t& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool TargetView::statusIsSet() const
{
    return m_StatusIsSet;
}

void TargetView::unsetStatus()
{
    m_StatusIsSet = false;
}
utility::string_t TargetView::getUpdatedAt() const
{
    return m_UpdatedAt;
}


void TargetView::setUpdatedAt(const utility::string_t& value)
{
    m_UpdatedAt = value;
    m_UpdatedAtIsSet = true;
}

bool TargetView::updatedAtIsSet() const
{
    return m_UpdatedAtIsSet;
}

void TargetView::unsetUpdatedAt()
{
    m_UpdatedAtIsSet = false;
}

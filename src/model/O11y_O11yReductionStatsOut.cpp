...
O11y_O11yReductionStatsOut::O11y_O11yReductionStatsOut()
{
    m_DataIsSet = false;
...
void O11y_O11yReductionStatsOut::validate()
{
    // TODO: implement validation
}

web::json::value O11y_O11yReductionStatsOut::toJson() const
{
...
bool O11y_O11yReductionStatsOut::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("data"))))
    {
        ...
        {
            std::shared_ptr<O11y_O11yReductionStats> refVal_setData;
...
void O11y_O11yReductionStatsOut::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool O11y_O11yReductionStatsOut::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<O11y_O11yReductionStats> O11y_O11yReductionStatsOut::getData() const
{
    return m_Data;
}


void O11y_O11yReductionStatsOut::setData(const std::shared_ptr<O11y_O11yReductionStats>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool O11y_O11yReductionStatsOut::dataIsSet() const
{
    return m_DataIsSet;
}

void O11y_O11yReductionStatsOut::unsetData()
{
    m_DataIsSet = false;
}
utility::string_t O11y_O11yReductionStatsOut::getStatus() const
{
    return m_Status;
}


void O11y_O11yReductionStatsOut::setStatus(const utility::string_t& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool O11y_O11yReductionStatsOut::statusIsSet() const
{
    return m_StatusIsSet;
}

void O11y_O11yReductionStatsOut::unsetStatus()
{
    m_StatusIsSet = false;
}

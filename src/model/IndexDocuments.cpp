...
int64_t IndexDocuments::getLimit() const
{
    return m_Limit;
}


void IndexDocuments::setLimit(int64_t value)
{
    m_Limit = value;
    m_LimitIsSet = true;
}
...
int64_t IndexDocuments::getOffset() const
{
    return m_Offset;
}


void IndexDocuments::setOffset(int64_t value)
{
    m_Offset = value;
    m_OffsetIsSet = true;
}
...
int64_t IndexDocuments::getTotal() const
{
    return m_Total;
}


void IndexDocuments::setTotal(int64_t value)
{
    m_Total = value;
    m_TotalIsSet = true;
}

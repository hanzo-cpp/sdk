...
void OppList::validate()
{
    // TODO: implement validation
}

web::json::value OppList::toJson() const
{
...
bool OppList::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("data"))))
    {
        ...
        {
            std::vector<std::shared_ptr<Opportunity>> refVal_setData;
...
void OppList::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool OppList::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::vector<std::shared_ptr<Opportunity>> OppList::getData() const
{
    return m_Data;
}


void OppList::setData(const std::vector<std::shared_ptr<Opportunity>>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool OppList::dataIsSet() const
{
    return m_DataIsSet;
}

void OppList::unsetData()
{
    m_DataIsSet = false;
}

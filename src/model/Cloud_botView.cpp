...
void Cloud_botView::validate()
{
    // TODO: implement validation
}

web::json::value Cloud_botView::toJson() const
{
...
bool Cloud_botView::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("binding"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<Cloud_agentBinding> refVal_setBinding;
...
void Cloud_botView::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Cloud_botView::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t Cloud_botView::getAgent() const
{
    return m_Agent;
}


void Cloud_botView::setAgent(const utility::string_t& value)
{
    m_Agent = value;
    m_AgentIsSet = true;
}

bool Cloud_botView::agentIsSet() const
{
    return m_AgentIsSet;
}

void Cloud_botView::unsetAgent()
{
    m_AgentIsSet = false;
}
std::shared_ptr<Cloud_agentBinding> Cloud_botView::getBinding() const
{
    return m_Binding;
}


void Cloud_botView::setBinding(const std::shared_ptr<Cloud_agentBinding>& value)
{
    m_Binding = value;
    m_BindingIsSet = true;
}

bool Cloud_botView::bindingIsSet() const
{
    return m_BindingIsSet;
}

void Cloud_botView::unsetBinding()
{
    m_BindingIsSet = false;
}
utility::string_t Cloud_botView::getCreatedTime() const
{
    return m_CreatedTime;
}


void Cloud_botView::setCreatedTime(const utility::string_t& value)
{
    m_CreatedTime = value;
    m_CreatedTimeIsSet = true;
}

bool Cloud_botView::createdTimeIsSet() const
{
    return m_CreatedTimeIsSet;
}

void Cloud_botView::unsetCreatedTime()
{
    m_CreatedTimeIsSet = false;
}
utility::string_t Cloud_botView::getGpu() const
{
    return m_Gpu;
}


void Cloud_botView::setGpu(const utility::string_t& value)
{
    m_Gpu = value;
    m_GpuIsSet = true;
}

bool Cloud_botView::gpuIsSet() const
{
    return m_GpuIsSet;
}

void Cloud_botView::unsetGpu()
{
    m_GpuIsSet = false;
}
utility::string_t Cloud_botView::getId() const
{
    return m_Id;
}


void Cloud_botView::setId(const utility::string_t& value)
{
    m_Id = value;
    m_IdIsSet = true;
}

bool Cloud_botView::idIsSet() const
{
    return m_IdIsSet;
}

void Cloud_botView::unsetId()
{
    m_IdIsSet = false;
}
utility::string_t Cloud_botView::getImage() const
{
    return m_Image;
}


void Cloud_botView::setImage(const utility::string_t& value)
{
    m_Image = value;
    m_ImageIsSet = true;
}

bool Cloud_botView::imageIsSet() const
{
    return m_ImageIsSet;
}

void Cloud_botView::unsetImage()
{
    m_ImageIsSet = false;
}
utility::string_t Cloud_botView::getMem() const
{
    return m_Mem;
}


void Cloud_botView::setMem(const utility::string_t& value)
{
    m_Mem = value;
    m_MemIsSet = true;
}

bool Cloud_botView::memIsSet() const
{
    return m_MemIsSet;
}

void Cloud_botView::unsetMem()
{
    m_MemIsSet = false;
}
utility::string_t Cloud_botView::getName() const
{
    return m_Name;
}


void Cloud_botView::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool Cloud_botView::nameIsSet() const
{
    return m_NameIsSet;
}

void Cloud_botView::unsetName()
{
    m_NameIsSet = false;
}
utility::string_t Cloud_botView::getOs() const
{
    return m_Os;
}


void Cloud_botView::setOs(const utility::string_t& value)
{
    m_Os = value;
    m_OsIsSet = true;
}

bool Cloud_botView::osIsSet() const
{
    return m_OsIsSet;
}

void Cloud_botView::unsetOs()
{
    m_OsIsSet = false;
}
utility::string_t Cloud_botView::getPrivateIp() const
{
    return m_PrivateIp;
}


void Cloud_botView::setPrivateIp(const utility::string_t& value)
{
    m_PrivateIp = value;
    m_PrivateIpIsSet = true;
}

bool Cloud_botView::privateIpIsSet() const
{
    return m_PrivateIpIsSet;
}

void Cloud_botView::unsetPrivateIp()
{
    m_PrivateIpIsSet = false;
}
utility::string_t Cloud_botView::getProvider() const
{
    return m_Provider;
}


void Cloud_botView::setProvider(const utility::string_t& value)
{
    m_Provider = value;
    m_ProviderIsSet = true;
}

bool Cloud_botView::providerIsSet() const
{
    return m_ProviderIsSet;
}

void Cloud_botView::unsetProvider()
{
    m_ProviderIsSet = false;
}
utility::string_t Cloud_botView::getPublicIp() const
{
    return m_PublicIp;
}


void Cloud_botView::setPublicIp(const utility::string_t& value)
{
    m_PublicIp = value;
    m_PublicIpIsSet = true;
}

bool Cloud_botView::publicIpIsSet() const
{
    return m_PublicIpIsSet;
}

void Cloud_botView::unsetPublicIp()
{
    m_PublicIpIsSet = false;
}
utility::string_t Cloud_botView::getRegion() const
{
    return m_Region;
}


void Cloud_botView::setRegion(const utility::string_t& value)
{
    m_Region = value;
    m_RegionIsSet = true;
}

bool Cloud_botView::regionIsSet() const
{
    return m_RegionIsSet;
}

void Cloud_botView::unsetRegion()
{
    m_RegionIsSet = false;
}
utility::string_t Cloud_botView::getStatus() const
{
    return m_Status;
}


void Cloud_botView::setStatus(const utility::string_t& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool Cloud_botView::statusIsSet() const
{
    return m_StatusIsSet;
}

void Cloud_botView::unsetStatus()
{
    m_StatusIsSet = false;
}
utility::string_t Cloud_botView::getType() const
{
    return m_Type;
}


void Cloud_botView::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool Cloud_botView::typeIsSet() const
{
    return m_TypeIsSet;
}

void Cloud_botView::unsetType()
{
    m_TypeIsSet = false;
}
int32_t Cloud_botView::getVcpu() const
{
    return m_Vcpu;
}


void Cloud_botView::setVcpu(int32_t value)
{
    m_Vcpu = value;
    m_VcpuIsSet = true;
}

bool Cloud_botView::vcpuIsSet() const
{
    return m_VcpuIsSet;
}

void Cloud_botView::unsetVcpu()
{
    m_VcpuIsSet = false;
}

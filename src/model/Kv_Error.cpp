...
void Kv_Error::validate()
{
    // TODO: implement validation
}

web::json::value Kv_Error::toJson() const
{
...
bool Kv_Error::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Kv_Error::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Kv_Error::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t Kv_Error::getError() const
{
    return m_Error;
}


void Kv_Error::setError(const utility::string_t& value)
{
    m_Error = value;
    m_ErrorIsSet = true;
}

bool Kv_Error::errorIsSet() const
{
    return m_ErrorIsSet;
}

void Kv_Error::unsetError()
{
    m_ErrorIsSet = false;
}
int32_t Kv_Error::getCode() const
{
    return m_Code;
}


void Kv_Error::setCode(int32_t value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool Kv_Error::codeIsSet() const
{
    return m_CodeIsSet;
}

void Kv_Error::unsetCode()
{
    m_CodeIsSet = false;
}

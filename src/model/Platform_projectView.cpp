...
#include "hanzo/model/Platform_projectView.h"

namespace hanzo {
namespace model {

Platform_projectView::Platform_projectView()
{
    m_Applications = 0;
...
void Platform_projectView::validate()
{
    // TODO: implement validation
}

web::json::value Platform_projectView::toJson() const
{
...
bool Platform_projectView::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Platform_projectView::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Platform_projectView::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
int32_t Platform_projectView::getApplications() const
{
    return m_Applications;
}


void Platform_projectView::setApplications(int32_t value)
{
    m_Applications = value;
    m_ApplicationsIsSet = true;
}

bool Platform_projectView::applicationsIsSet() const
{
    return m_ApplicationsIsSet;
}

void Platform_projectView::unsetApplications()
{
    m_ApplicationsIsSet = false;
}
int32_t Platform_projectView::getCreatedAt() const
{
    return m_CreatedAt;
}


void Platform_projectView::setCreatedAt(int32_t value)
{
    m_CreatedAt = value;
    m_CreatedAtIsSet = true;
}

bool Platform_projectView::createdAtIsSet() const
{
    return m_CreatedAtIsSet;
}

void Platform_projectView::unsetCreatedAt()
{
    m_CreatedAtIsSet = false;
}
utility::string_t Platform_projectView::getDescription() const
{
    return m_Description;
}


void Platform_projectView::setDescription(const utility::string_t& value)
{
    m_Description = value;
    m_DescriptionIsSet = true;
}

bool Platform_projectView::descriptionIsSet() const
{
    return m_DescriptionIsSet;
}

void Platform_projectView::unsetDescription()
{
    m_DescriptionIsSet = false;
}
utility::string_t Platform_projectView::getName() const
{
    return m_Name;
}


void Platform_projectView::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool Platform_projectView::nameIsSet() const
{
    return m_NameIsSet;
}

void Platform_projectView::unsetName()
{
    m_NameIsSet = false;
}
utility::string_t Platform_projectView::getOrg() const
{
    return m_Org;
}


void Platform_projectView::setOrg(const utility::string_t& value)
{
    m_Org = value;
    m_OrgIsSet = true;
}

bool Platform_projectView::orgIsSet() const
{
    return m_OrgIsSet;
}

void Platform_projectView::unsetOrg()
{
    m_OrgIsSet = false;
}
utility::string_t Platform_projectView::getSlug() const
{
    return m_Slug;
}


void Platform_projectView::setSlug(const utility::string_t& value)
{
    m_Slug = value;
    m_SlugIsSet = true;
}

bool Platform_projectView::slugIsSet() const
{
    return m_SlugIsSet;
}

void Platform_projectView::unsetSlug()
{
    m_SlugIsSet = false;
}

...
void RevenueOut::validate()
{
    // TODO: implement validation
}

web::json::value RevenueOut::toJson() const
{
...
bool RevenueOut::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("data"))))
    {
        ...
        {
            std::shared_ptr<RevenueData> refVal_setData;
...
void RevenueOut::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool RevenueOut::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<RevenueData> RevenueOut::getData() const
{
    return m_Data;
}


void RevenueOut::setData(const std::shared_ptr<RevenueData>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool RevenueOut::dataIsSet() const
{
    return m_DataIsSet;
}

void RevenueOut::unsetData()
{
    m_DataIsSet = false;
}
utility::string_t RevenueOut::getMsg() const
{
    return m_Msg;
}


void RevenueOut::setMsg(const utility::string_t& value)
{
    m_Msg = value;
    m_MsgIsSet = true;
}

bool RevenueOut::msgIsSet() const
{
    return m_MsgIsSet;
}

void RevenueOut::unsetMsg()
{
    m_MsgIsSet = false;
}
utility::string_t RevenueOut::getStatus() const
{
    return m_Status;
}


void RevenueOut::setStatus(const utility::string_t& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool RevenueOut::statusIsSet() const
{
    return m_StatusIsSet;
}

void RevenueOut::unsetStatus()
{
    m_StatusIsSet = false;
}

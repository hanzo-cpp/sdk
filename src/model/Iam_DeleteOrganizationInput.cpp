...
Iam_DeleteOrganizationInput::Iam_DeleteOrganizationInput()
{
...
void Iam_DeleteOrganizationInput::validate()
{
    // TODO: implement validation
}

web::json::value Iam_DeleteOrganizationInput::toJson() const
{
...
bool Iam_DeleteOrganizationInput::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Iam_DeleteOrganizationInput::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Iam_DeleteOrganizationInput::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t Iam_DeleteOrganizationInput::getName() const
{
    return m_Name;
}


void Iam_DeleteOrganizationInput::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool Iam_DeleteOrganizationInput::nameIsSet() const
{
    return m_NameIsSet;
}

void Iam_DeleteOrganizationInput::unsetName()
{
    m_NameIsSet = false;
}
utility::string_t Iam_DeleteOrganizationInput::getOwner() const
{
    return m_Owner;
}


void Iam_DeleteOrganizationInput::setOwner(const utility::string_t& value)
{
    m_Owner = value;
    m_OwnerIsSet = true;
}

bool Iam_DeleteOrganizationInput::ownerIsSet() const
{
    return m_OwnerIsSet;
}

void Iam_DeleteOrganizationInput::unsetOwner()
{
    m_OwnerIsSet = false;
}

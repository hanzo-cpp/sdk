...
void Iam_tokenKey::validate()
{
    // TODO: implement validation
}

web::json::value Iam_tokenKey::toJson() const
{
...
bool Iam_tokenKey::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Iam_tokenKey::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Iam_tokenKey::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t Iam_tokenKey::getName() const
{
    return m_Name;
}


void Iam_tokenKey::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool Iam_tokenKey::nameIsSet() const
{
    return m_NameIsSet;
}

void Iam_tokenKey::unsetName()
{
    m_NameIsSet = false;
}
utility::string_t Iam_tokenKey::getOwner() const
{
    return m_Owner;
}


void Iam_tokenKey::setOwner(const utility::string_t& value)
{
    m_Owner = value;
    m_OwnerIsSet = true;
}

bool Iam_tokenKey::ownerIsSet() const
{
    return m_OwnerIsSet;
}

void Iam_tokenKey::unsetOwner()
{
    m_OwnerIsSet = false;
}

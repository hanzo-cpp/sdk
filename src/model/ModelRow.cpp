...
void ModelRow::validate()
{
    // TODO: implement validation
}

web::json::value ModelRow::toJson() const
{
...
bool ModelRow::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void ModelRow::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ModelRow::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t ModelRow::getModel() const
{
    return m_Model;
}


void ModelRow::setModel(const utility::string_t& value)
{
    m_Model = value;
    m_ModelIsSet = true;
}

bool ModelRow::modelIsSet() const
{
    return m_ModelIsSet;
}

void ModelRow::unsetModel()
{
    m_ModelIsSet = false;
}
double ModelRow::getPct() const
{
    return m_Pct;
}


void ModelRow::setPct(double value)
{
    m_Pct = value;
    m_PctIsSet = true;
}

bool ModelRow::pctIsSet() const
{
    return m_PctIsSet;
}

void ModelRow::unsetPct()
{
    m_PctIsSet = false;
}
utility::string_t ModelRow::getProvider() const
{
    return m_Provider;
}


void ModelRow::setProvider(const utility::string_t& value)
{
    m_Provider = value;
    m_ProviderIsSet = true;
}

bool ModelRow::providerIsSet() const
{
    return m_ProviderIsSet;
}

void ModelRow::unsetProvider()
{
    m_ProviderIsSet = false;
}
...
bool ModelRow::requestsIsSet() const
{
    return m_RequestsIsSet;
}

void ModelRow::unsetRequests()
{
    m_RequestsIsSet = false;
}
...
bool ModelRow::spendCentsIsSet() const
{
    return m_SpendCentsIsSet;
}

void ModelRow::unsetSpendCents()
{
    m_SpendCentsIsSet = false;
}
...
bool ModelRow::tokensIsSet() const
{
    return m_TokensIsSet;
}

void ModelRow::unsetTokens()
{
    m_TokensIsSet = false;
}

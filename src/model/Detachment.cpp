...
void Detachment::validate()
{
    // TODO: implement validation
}

web::json::value Detachment::toJson() const
{
...
bool Detachment::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Detachment::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Detachment::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
bool Detachment::isDeleted() const
{
    return m_Deleted;
}


void Detachment::setDeleted(bool value)
{
    m_Deleted = value;
    m_DeletedIsSet = true;
}

bool Detachment::deletedIsSet() const
{
    return m_DeletedIsSet;
}

void Detachment::unsetDeleted()
{
    m_DeletedIsSet = false;
}
utility::string_t Detachment::getId() const
{
    return m_Id;
}


void Detachment::setId(const utility::string_t& value)
{
    m_Id = value;
    m_IdIsSet = true;
}

bool Detachment::idIsSet() const
{
    return m_IdIsSet;
}

void Detachment::unsetId()
{
    m_IdIsSet = false;
}

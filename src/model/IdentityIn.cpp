...
void IdentityIn::validate()
{
    // TODO: implement validation
}

web::json::value IdentityIn::toJson() const
{
...
bool IdentityIn::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void IdentityIn::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool IdentityIn::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t IdentityIn::getName() const
{
    return m_Name;
}


void IdentityIn::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool IdentityIn::nameIsSet() const
{
    return m_NameIsSet;
}

void IdentityIn::unsetName()
{
    m_NameIsSet = false;
}
std::vector<utility::string_t> IdentityIn::getRoles() const
{
    return m_Roles;
}


void IdentityIn::setRoles(const std::vector<utility::string_t>& value)
{
    m_Roles = value;
    m_RolesIsSet = true;
}

bool IdentityIn::rolesIsSet() const
{
    return m_RolesIsSet;
}

void IdentityIn::unsetRoles()
{
    m_RolesIsSet = false;
}

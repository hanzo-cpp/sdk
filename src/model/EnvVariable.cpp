...
void EnvVariable::validate()
{
    // TODO: implement validation
}

web::json::value EnvVariable::toJson() const
{
...
bool EnvVariable::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void EnvVariable::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool EnvVariable::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t EnvVariable::getName() const
{
    return m_Name;
}


void EnvVariable::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool EnvVariable::nameIsSet() const
{
    return m_NameIsSet;
}

void EnvVariable::unsetName()
{
    m_NameIsSet = false;
}
utility::string_t EnvVariable::getValue() const
{
    return m_Value;
}


void EnvVariable::setValue(const utility::string_t& value)
{
    m_Value = value;
    m_ValueIsSet = true;
}

bool EnvVariable::valueIsSet() const
{
    return m_ValueIsSet;
}

void EnvVariable::unsetValue()
{
    m_ValueIsSet = false;
}

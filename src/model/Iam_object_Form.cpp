...
void Iam_object_Form::validate()
{
    // TODO: implement validation
}

web::json::value Iam_object_Form::toJson() const
{
...
bool Iam_object_Form::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("formItems"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<Iam_object_FormItem>> refVal_setFormItems;
...
void Iam_object_Form::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Iam_object_Form::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t Iam_object_Form::getCreatedTime() const
{
    return m_CreatedTime;
}


void Iam_object_Form::setCreatedTime(const utility::string_t& value)
{
    m_CreatedTime = value;
    m_CreatedTimeIsSet = true;
}

bool Iam_object_Form::createdTimeIsSet() const
{
    return m_CreatedTimeIsSet;
}

void Iam_object_Form::unsetCreatedTime()
{
    m_CreatedTimeIsSet = false;
}
utility::string_t Iam_object_Form::getDisplayName() const
{
    return m_DisplayName;
}


void Iam_object_Form::setDisplayName(const utility::string_t& value)
{
    m_DisplayName = value;
    m_DisplayNameIsSet = true;
}

bool Iam_object_Form::displayNameIsSet() const
{
    return m_DisplayNameIsSet;
}

void Iam_object_Form::unsetDisplayName()
{
    m_DisplayNameIsSet = false;
}
std::vector<std::shared_ptr<Iam_object_FormItem>> Iam_object_Form::getFormItems() const
{
    return m_FormItems;
}


void Iam_object_Form::setFormItems(const std::vector<std::shared_ptr<Iam_object_FormItem>>& value)
{
    m_FormItems = value;
    m_FormItemsIsSet = true;
}

bool Iam_object_Form::formItemsIsSet() const
{
    return m_FormItemsIsSet;
}

void Iam_object_Form::unsetFormItems()
{
    m_FormItemsIsSet = false;
}
utility::string_t Iam_object_Form::getName() const
{
    return m_Name;
}


void Iam_object_Form::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool Iam_object_Form::nameIsSet() const
{
    return m_NameIsSet;
}

void Iam_object_Form::unsetName()
{
    m_NameIsSet = false;
}
utility::string_t Iam_object_Form::getOwner() const
{
    return m_Owner;
}


void Iam_object_Form::setOwner(const utility::string_t& value)
{
    m_Owner = value;
    m_OwnerIsSet = true;
}

bool Iam_object_Form::ownerIsSet() const
{
    return m_OwnerIsSet;
}

void Iam_object_Form::unsetOwner()
{
    m_OwnerIsSet = false;
}
utility::string_t Iam_object_Form::getTag() const
{
    return m_Tag;
}


void Iam_object_Form::setTag(const utility::string_t& value)
{
    m_Tag = value;
    m_TagIsSet = true;
}

bool Iam_object_Form::tagIsSet() const
{
    return m_TagIsSet;
}

void Iam_object_Form::unsetTag()
{
    m_TagIsSet = false;
}
utility::string_t Iam_object_Form::getType() const
{
    return m_Type;
}


void Iam_object_Form::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool Iam_object_Form::typeIsSet() const
{
    return m_TypeIsSet;
}

void Iam_object_Form::unsetType()
{
    m_TypeIsSet = false;
}

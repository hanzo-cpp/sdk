...
void IssueEdit::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool IssueEdit::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
void IssueEdit::setDescription(const utility::string_t& value)
{
    m_Description = value;
    m_DescriptionIsSet = true;
}

bool IssueEdit::descriptionIsSet() const
{
    return m_DescriptionIsSet;
}

void IssueEdit::unsetDescription()
{
    m_DescriptionIsSet = false;
}
utility::string_t IssueEdit::getKey() const
{
    return m_Key;
}


void IssueEdit::setKey(const utility::string_t& value)
{
    m_Key = value;
    m_KeyIsSet = true;
}

bool IssueEdit::keyIsSet() const
{
    return m_KeyIsSet;
}

void IssueEdit::unsetKey()
{
    m_KeyIsSet = false;
}
...
bool IssueEdit::numIsSet() const
{
    return m_NumIsSet;
}

void IssueEdit::unsetNum()
{
    m_NumIsSet = false;
}
utility::string_t IssueEdit::getPriority() const
{
    return m_Priority;
}


void IssueEdit::setPriority(const utility::string_t& value)
{
    m_Priority = value;
    m_PriorityIsSet = true;
}

bool IssueEdit::priorityIsSet() const
{
    return m_PriorityIsSet;
}

void IssueEdit::unsetPriority()
{
    m_PriorityIsSet = false;
}
utility::string_t IssueEdit::getStatus() const
{
    return m_Status;
}


void IssueEdit::setStatus(const utility::string_t& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool IssueEdit::statusIsSet() const
{
    return m_StatusIsSet;
}

void IssueEdit::unsetStatus()
{
    m_StatusIsSet = false;
}
utility::string_t IssueEdit::getTitle() const
{
    return m_Title;
}


void IssueEdit::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool IssueEdit::titleIsSet() const
{
    return m_TitleIsSet;
}

void IssueEdit::unsetTitle()
{
    m_TitleIsSet = false;
}

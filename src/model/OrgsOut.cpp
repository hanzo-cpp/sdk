...
void OrgsOut::validate()
{
    // TODO: implement validation
}

web::json::value OrgsOut::toJson() const
{
...
bool OrgsOut::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("data"))))
    {
        ...
        {
            std::vector<std::shared_ptr<OrgRow>> refVal_setData;
...
void OrgsOut::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool OrgsOut::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::vector<std::shared_ptr<OrgRow>> OrgsOut::getData() const
{
    return m_Data;
}


void OrgsOut::setData(const std::vector<std::shared_ptr<OrgRow>>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool OrgsOut::dataIsSet() const
{
    return m_DataIsSet;
}

void OrgsOut::unsetData()
{
    m_DataIsSet = false;
}
utility::string_t OrgsOut::getMsg() const
{
    return m_Msg;
}


void OrgsOut::setMsg(const utility::string_t& value)
{
    m_Msg = value;
    m_MsgIsSet = true;
}

bool OrgsOut::msgIsSet() const
{
    return m_MsgIsSet;
}

void OrgsOut::unsetMsg()
{
    m_MsgIsSet = false;
}
utility::string_t OrgsOut::getStatus() const
{
    return m_Status;
}


void OrgsOut::setStatus(const utility::string_t& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool OrgsOut::statusIsSet() const
{
    return m_StatusIsSet;
}

void OrgsOut::unsetStatus()
{
    m_StatusIsSet = false;
}
int32_t OrgsOut::getTotal() const
{
    return m_Total;
}


void OrgsOut::setTotal(int32_t value)
{
    m_Total = value;
    m_TotalIsSet = true;
}

bool OrgsOut::totalIsSet() const
{
    return m_TotalIsSet;
}

void OrgsOut::unsetTotal()
{
    m_TotalIsSet = false;
}

...
O11y_O11yRegisterOut::O11y_O11yRegisterOut()
{
    m_DataIsSet = false;
...
void O11y_O11yRegisterOut::validate()
{
    // TODO: implement validation
}

web::json::value O11y_O11yRegisterOut::toJson() const
{
...
bool O11y_O11yRegisterOut::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("data"))))
    {
        ...
        {
            std::shared_ptr<O11y_O11yUser> refVal_setData;
...
void O11y_O11yRegisterOut::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool O11y_O11yRegisterOut::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<O11y_O11yUser> O11y_O11yRegisterOut::getData() const
{
    return m_Data;
}


void O11y_O11yRegisterOut::setData(const std::shared_ptr<O11y_O11yUser>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool O11y_O11yRegisterOut::dataIsSet() const
{
    return m_DataIsSet;
}

void O11y_O11yRegisterOut::unsetData()
{
    m_DataIsSet = false;
}
utility::string_t O11y_O11yRegisterOut::getStatus() const
{
    return m_Status;
}


void O11y_O11yRegisterOut::setStatus(const utility::string_t& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool O11y_O11yRegisterOut::statusIsSet() const
{
    return m_StatusIsSet;
}

void O11y_O11yRegisterOut::unsetStatus()
{
    m_StatusIsSet = false;
}

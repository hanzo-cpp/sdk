...
O11y_CollectedLogAttribute::O11y_CollectedLogAttribute()
{
...
void O11y_CollectedLogAttribute::validate()
{
    // TODO: implement validation
}

web::json::value O11y_CollectedLogAttribute::toJson() const
{
...
bool O11y_CollectedLogAttribute::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void O11y_CollectedLogAttribute::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool O11y_CollectedLogAttribute::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t O11y_CollectedLogAttribute::getName() const
{
    return m_Name;
}


void O11y_CollectedLogAttribute::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool O11y_CollectedLogAttribute::nameIsSet() const
{
    return m_NameIsSet;
}

void O11y_CollectedLogAttribute::unsetName()
{
    m_NameIsSet = false;
}
utility::string_t O11y_CollectedLogAttribute::getPath() const
{
    return m_Path;
}


void O11y_CollectedLogAttribute::setPath(const utility::string_t& value)
{
    m_Path = value;
    m_PathIsSet = true;
}

bool O11y_CollectedLogAttribute::pathIsSet() const
{
    return m_PathIsSet;
}

void O11y_CollectedLogAttribute::unsetPath()
{
    m_PathIsSet = false;
}
utility::string_t O11y_CollectedLogAttribute::getType() const
{
    return m_Type;
}


void O11y_CollectedLogAttribute::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool O11y_CollectedLogAttribute::typeIsSet() const
{
    return m_TypeIsSet;
}

void O11y_CollectedLogAttribute::unsetType()
{
    m_TypeIsSet = false;
}

...
void MetricsOut::validate()
{
    // TODO: implement validation
}

web::json::value MetricsOut::toJson() const
{
...
bool MetricsOut::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("data"))))
    {
        ...
        {
            std::shared_ptr<MetricsData> refVal_setData;
...
void MetricsOut::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool MetricsOut::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<MetricsData> MetricsOut::getData() const
{
    return m_Data;
}


void MetricsOut::setData(const std::shared_ptr<MetricsData>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool MetricsOut::dataIsSet() const
{
    return m_DataIsSet;
}

void MetricsOut::unsetData()
{
    m_DataIsSet = false;
}
utility::string_t MetricsOut::getMsg() const
{
    return m_Msg;
}


void MetricsOut::setMsg(const utility::string_t& value)
{
    m_Msg = value;
    m_MsgIsSet = true;
}

bool MetricsOut::msgIsSet() const
{
    return m_MsgIsSet;
}

void MetricsOut::unsetMsg()
{
    m_MsgIsSet = false;
}
utility::string_t MetricsOut::getStatus() const
{
    return m_Status;
}


void MetricsOut::setStatus(const utility::string_t& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool MetricsOut::statusIsSet() const
{
    return m_StatusIsSet;
}

void MetricsOut::unsetStatus()
{
    m_StatusIsSet = false;
}

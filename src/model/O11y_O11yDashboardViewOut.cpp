...
O11y_O11yDashboardViewOut::O11y_O11yDashboardViewOut()
{
    m_DataIsSet = false;
...
void O11y_O11yDashboardViewOut::validate()
{
    // TODO: implement validation
}

web::json::value O11y_O11yDashboardViewOut::toJson() const
{
...
bool O11y_O11yDashboardViewOut::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("data"))))
    {
        ...
        {
            std::shared_ptr<O11y_O11yDashboardView> refVal_setData;
...
void O11y_O11yDashboardViewOut::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool O11y_O11yDashboardViewOut::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<O11y_O11yDashboardView> O11y_O11yDashboardViewOut::getData() const
{
    return m_Data;
}


void O11y_O11yDashboardViewOut::setData(const std::shared_ptr<O11y_O11yDashboardView>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool O11y_O11yDashboardViewOut::dataIsSet() const
{
    return m_DataIsSet;
}

void O11y_O11yDashboardViewOut::unsetData()
{
    m_DataIsSet = false;
}
utility::string_t O11y_O11yDashboardViewOut::getStatus() const
{
    return m_Status;
}


void O11y_O11yDashboardViewOut::setStatus(const utility::string_t& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool O11y_O11yDashboardViewOut::statusIsSet() const
{
    return m_StatusIsSet;
}

void O11y_O11yDashboardViewOut::unsetStatus()
{
    m_StatusIsSet = false;
}

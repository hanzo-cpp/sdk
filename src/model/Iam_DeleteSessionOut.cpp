...
Iam_DeleteSessionOut::Iam_DeleteSessionOut()
{
    m_Deleted = false;
...
void Iam_DeleteSessionOut::validate()
{
    // TODO: implement validation
}

web::json::value Iam_DeleteSessionOut::toJson() const
{
...
bool Iam_DeleteSessionOut::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Iam_DeleteSessionOut::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Iam_DeleteSessionOut::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
bool Iam_DeleteSessionOut::isDeleted() const
{
    return m_Deleted;
}


void Iam_DeleteSessionOut::setDeleted(bool value)
{
    m_Deleted = value;
    m_DeletedIsSet = true;
}

bool Iam_DeleteSessionOut::deletedIsSet() const
{
    return m_DeletedIsSet;
}

void Iam_DeleteSessionOut::unsetDeleted()
{
    m_DeletedIsSet = false;
}

...
O11y_O11yAttributeKeysOut::O11y_O11yAttributeKeysOut()
{
    m_DataIsSet = false;
...
void O11y_O11yAttributeKeysOut::validate()
{
    // TODO: implement validation
}

web::json::value O11y_O11yAttributeKeysOut::toJson() const
{
...
bool O11y_O11yAttributeKeysOut::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void O11y_O11yAttributeKeysOut::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool O11y_O11yAttributeKeysOut::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<O11y_FilterAttributeKeyResponse> O11y_O11yAttributeKeysOut::getData() const
{
    return m_Data;
}


void O11y_O11yAttributeKeysOut::setData(const std::shared_ptr<O11y_FilterAttributeKeyResponse>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool O11y_O11yAttributeKeysOut::dataIsSet() const
{
    return m_DataIsSet;
}

void O11y_O11yAttributeKeysOut::unsetData()
{
    m_DataIsSet = false;
}
utility::string_t O11y_O11yAttributeKeysOut::getStatus() const
{
    return m_Status;
}


void O11y_O11yAttributeKeysOut::setStatus(const utility::string_t& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool O11y_O11yAttributeKeysOut::statusIsSet() const
{
    return m_StatusIsSet;
}

void O11y_O11yAttributeKeysOut::unsetStatus()
{
    m_StatusIsSet = false;
}

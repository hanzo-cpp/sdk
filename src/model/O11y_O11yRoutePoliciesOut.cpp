...
O11y_O11yRoutePoliciesOut::O11y_O11yRoutePoliciesOut()
{
    m_DataIsSet = false;
...
void O11y_O11yRoutePoliciesOut::validate()
{
    // TODO: implement validation
}

web::json::value O11y_O11yRoutePoliciesOut::toJson() const
{
...
bool O11y_O11yRoutePoliciesOut::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("data"))))
    {
        ...
        {
            std::vector<std::shared_ptr<O11y_GettableRoutePolicy>> refVal_setData;
...
void O11y_O11yRoutePoliciesOut::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool O11y_O11yRoutePoliciesOut::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::vector<std::shared_ptr<O11y_GettableRoutePolicy>> O11y_O11yRoutePoliciesOut::getData() const
{
    return m_Data;
}


void O11y_O11yRoutePoliciesOut::setData(const std::vector<std::shared_ptr<O11y_GettableRoutePolicy>>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool O11y_O11yRoutePoliciesOut::dataIsSet() const
{
    return m_DataIsSet;
}

void O11y_O11yRoutePoliciesOut::unsetData()
{
    m_DataIsSet = false;
}
utility::string_t O11y_O11yRoutePoliciesOut::getStatus() const
{
    return m_Status;
}


void O11y_O11yRoutePoliciesOut::setStatus(const utility::string_t& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool O11y_O11yRoutePoliciesOut::statusIsSet() const
{
    return m_StatusIsSet;
}

void O11y_O11yRoutePoliciesOut::unsetStatus()
{
    m_StatusIsSet = false;
}

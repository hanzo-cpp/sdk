...
void AdminReportOut::validate()
{
    // TODO: implement validation
}

web::json::value AdminReportOut::toJson() const
{
...
bool AdminReportOut::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("data"))))
    {
        ...
        {
            std::shared_ptr<AdminReportData> refVal_setData;
...
void AdminReportOut::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool AdminReportOut::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<AdminReportData> AdminReportOut::getData() const
{
    return m_Data;
}


void AdminReportOut::setData(const std::shared_ptr<AdminReportData>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool AdminReportOut::dataIsSet() const
{
    return m_DataIsSet;
}

void AdminReportOut::unsetData()
{
    m_DataIsSet = false;
}
utility::string_t AdminReportOut::getMsg() const
{
    return m_Msg;
}


void AdminReportOut::setMsg(const utility::string_t& value)
{
    m_Msg = value;
    m_MsgIsSet = true;
}

bool AdminReportOut::msgIsSet() const
{
    return m_MsgIsSet;
}

void AdminReportOut::unsetMsg()
{
    m_MsgIsSet = false;
}
utility::string_t AdminReportOut::getStatus() const
{
    return m_Status;
}


void AdminReportOut::setStatus(const utility::string_t& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool AdminReportOut::statusIsSet() const
{
    return m_StatusIsSet;
}

void AdminReportOut::unsetStatus()
{
    m_StatusIsSet = false;
}

...
Cloud_trailPage::Cloud_trailPage()
{
    m_DataIsSet = false;
...
void Cloud_trailPage::validate()
{
    // TODO: implement validation
}

web::json::value Cloud_trailPage::toJson() const
{
...
bool Cloud_trailPage::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Cloud_trailPage::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Cloud_trailPage::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::vector<std::shared_ptr<Cloud_Wire>> Cloud_trailPage::getData() const
{
    return m_Data;
}


void Cloud_trailPage::setData(const std::vector<std::shared_ptr<Cloud_Wire>>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool Cloud_trailPage::dataIsSet() const
{
    return m_DataIsSet;
}

void Cloud_trailPage::unsetData()
{
    m_DataIsSet = false;
}
utility::string_t Cloud_trailPage::getMsg() const
{
    return m_Msg;
}


void Cloud_trailPage::setMsg(const utility::string_t& value)
{
    m_Msg = value;
    m_MsgIsSet = true;
}

bool Cloud_trailPage::msgIsSet() const
{
    return m_MsgIsSet;
}

void Cloud_trailPage::unsetMsg()
{
    m_MsgIsSet = false;
}
utility::string_t Cloud_trailPage::getStatus() const
{
    return m_Status;
}


void Cloud_trailPage::setStatus(const utility::string_t& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool Cloud_trailPage::statusIsSet() const
{
    return m_StatusIsSet;
}

void Cloud_trailPage::unsetStatus()
{
    m_StatusIsSet = false;
}
int32_t Cloud_trailPage::getTotal() const
{
    return m_Total;
}


void Cloud_trailPage::setTotal(int32_t value)
{
    m_Total = value;
    m_TotalIsSet = true;
}

bool Cloud_trailPage::totalIsSet() const
{
    return m_TotalIsSet;
}

void Cloud_trailPage::unsetTotal()
{
    m_TotalIsSet = false;
}

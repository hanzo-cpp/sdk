...
void DayCount::validate()
{
    // TODO: implement validation
}

web::json::value DayCount::toJson() const
{
...
bool DayCount::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void DayCount::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool DayCount::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
int32_t DayCount::getCount() const
{
    return m_Count;
}


void DayCount::setCount(int32_t value)
{
    m_Count = value;
    m_CountIsSet = true;
}

bool DayCount::countIsSet() const
{
    return m_CountIsSet;
}

void DayCount::unsetCount()
{
    m_CountIsSet = false;
}
utility::string_t DayCount::getDate() const
{
    return m_date;
}


void DayCount::setDate(const utility::string_t& value)
{
    m_date = value;
    m_dateIsSet = true;
}

bool DayCount::dateIsSet() const
{
    return m_dateIsSet;
}

void DayCount::unsetdate()
{
    m_dateIsSet = false;
}

...
#include "hanzo/model/O11y_O11yLLMUsersPage.h"

namespace hanzo {
namespace model {

O11y_O11yLLMUsersPage::O11y_O11yLLMUsersPage()
{
    m_ItemsIsSet = false;
    m_Limit = 0;
    m_LimitIsSet = false;
...
void O11y_O11yLLMUsersPage::validate()
{
    // TODO: implement validation
}

web::json::value O11y_O11yLLMUsersPage::toJson() const
{
...
bool O11y_O11yLLMUsersPage::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("items"))))
    {
        ...
        {
            std::vector<std::shared_ptr<O11y_O11yLLMUser>> refVal_setItems;
...
void O11y_O11yLLMUsersPage::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool O11y_O11yLLMUsersPage::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::vector<std::shared_ptr<O11y_O11yLLMUser>> O11y_O11yLLMUsersPage::getItems() const
{
    return m_Items;
}


void O11y_O11yLLMUsersPage::setItems(const std::vector<std::shared_ptr<O11y_O11yLLMUser>>& value)
{
    m_Items = value;
    m_ItemsIsSet = true;
}

bool O11y_O11yLLMUsersPage::itemsIsSet() const
{
    return m_ItemsIsSet;
}

void O11y_O11yLLMUsersPage::unsetItems()
{
    m_ItemsIsSet = false;
}
int32_t O11y_O11yLLMUsersPage::getLimit() const
{
    return m_Limit;
}


void O11y_O11yLLMUsersPage::setLimit(int32_t value)
{
    m_Limit = value;
    m_LimitIsSet = true;
}

bool O11y_O11yLLMUsersPage::limitIsSet() const
{
    return m_LimitIsSet;
}

void O11y_O11yLLMUsersPage::unsetLimit()
{
    m_LimitIsSet = false;
}
int32_t O11y_O11yLLMUsersPage::getOffset() const
{
    return m_Offset;
}


void O11y_O11yLLMUsersPage::setOffset(int32_t value)
{
    m_Offset = value;
    m_OffsetIsSet = true;
}

bool O11y_O11yLLMUsersPage::offsetIsSet() const
{
    return m_OffsetIsSet;
}

void O11y_O11yLLMUsersPage::unsetOffset()
{
    m_OffsetIsSet = false;
}

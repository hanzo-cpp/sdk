...
void Iam_object_Role::validate()
{
    // TODO: implement validation
}

web::json::value Iam_object_Role::toJson() const
{
...
bool Iam_object_Role::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Iam_object_Role::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Iam_object_Role::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t Iam_object_Role::getCreatedTime() const
{
    return m_CreatedTime;
}


void Iam_object_Role::setCreatedTime(const utility::string_t& value)
{
    m_CreatedTime = value;
    m_CreatedTimeIsSet = true;
}

bool Iam_object_Role::createdTimeIsSet() const
{
    return m_CreatedTimeIsSet;
}

void Iam_object_Role::unsetCreatedTime()
{
    m_CreatedTimeIsSet = false;
}
utility::string_t Iam_object_Role::getDescription() const
{
    return m_Description;
}


void Iam_object_Role::setDescription(const utility::string_t& value)
{
    m_Description = value;
    m_DescriptionIsSet = true;
}

bool Iam_object_Role::descriptionIsSet() const
{
    return m_DescriptionIsSet;
}

void Iam_object_Role::unsetDescription()
{
    m_DescriptionIsSet = false;
}
utility::string_t Iam_object_Role::getDisplayName() const
{
    return m_DisplayName;
}


void Iam_object_Role::setDisplayName(const utility::string_t& value)
{
    m_DisplayName = value;
    m_DisplayNameIsSet = true;
}

bool Iam_object_Role::displayNameIsSet() const
{
    return m_DisplayNameIsSet;
}

void Iam_object_Role::unsetDisplayName()
{
    m_DisplayNameIsSet = false;
}
std::vector<utility::string_t> Iam_object_Role::getDomains() const
{
    return m_Domains;
}


void Iam_object_Role::setDomains(const std::vector<utility::string_t>& value)
{
    m_Domains = value;
    m_DomainsIsSet = true;
}

bool Iam_object_Role::domainsIsSet() const
{
    return m_DomainsIsSet;
}

void Iam_object_Role::unsetDomains()
{
    m_DomainsIsSet = false;
}
std::vector<utility::string_t> Iam_object_Role::getGroups() const
{
    return m_Groups;
}


void Iam_object_Role::setGroups(const std::vector<utility::string_t>& value)
{
    m_Groups = value;
    m_GroupsIsSet = true;
}

bool Iam_object_Role::groupsIsSet() const
{
    return m_GroupsIsSet;
}

void Iam_object_Role::unsetGroups()
{
    m_GroupsIsSet = false;
}
bool Iam_object_Role::isIsEnabled() const
{
    return m_IsEnabled;
}


void Iam_object_Role::setIsEnabled(bool value)
{
    m_IsEnabled = value;
    m_IsEnabledIsSet = true;
}

bool Iam_object_Role::isEnabledIsSet() const
{
    return m_IsEnabledIsSet;
}

void Iam_object_Role::unsetIsEnabled()
{
    m_IsEnabledIsSet = false;
}
utility::string_t Iam_object_Role::getName() const
{
    return m_Name;
}


void Iam_object_Role::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool Iam_object_Role::nameIsSet() const
{
    return m_NameIsSet;
}

void Iam_object_Role::unsetName()
{
    m_NameIsSet = false;
}
utility::string_t Iam_object_Role::getOwner() const
{
    return m_Owner;
}


void Iam_object_Role::setOwner(const utility::string_t& value)
{
    m_Owner = value;
    m_OwnerIsSet = true;
}

bool Iam_object_Role::ownerIsSet() const
{
    return m_OwnerIsSet;
}

void Iam_object_Role::unsetOwner()
{
    m_OwnerIsSet = false;
}
std::vector<utility::string_t> Iam_object_Role::getRoles() const
{
    return m_Roles;
}


void Iam_object_Role::setRoles(const std::vector<utility::string_t>& value)
{
    m_Roles = value;
    m_RolesIsSet = true;
}

bool Iam_object_Role::rolesIsSet() const
{
    return m_RolesIsSet;
}

void Iam_object_Role::unsetRoles()
{
    m_RolesIsSet = false;
}
std::vector<utility::string_t> Iam_object_Role::getUsers() const
{
    return m_Users;
}


void Iam_object_Role::setUsers(const std::vector<utility::string_t>& value)
{
    m_Users = value;
    m_UsersIsSet = true;
}

bool Iam_object_Role::usersIsSet() const
{
    return m_UsersIsSet;
}

void Iam_object_Role::unsetUsers()
{
    m_UsersIsSet = false;
}

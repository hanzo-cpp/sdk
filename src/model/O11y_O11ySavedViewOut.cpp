...
O11y_O11ySavedViewOut::O11y_O11ySavedViewOut()
{
    m_DataIsSet = false;
...
void O11y_O11ySavedViewOut::validate()
{
    // TODO: implement validation
}

web::json::value O11y_O11ySavedViewOut::toJson() const
{
...
bool O11y_O11ySavedViewOut::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("data"))))
    {
        ...
        {
            std::shared_ptr<O11y_SavedView> refVal_setData;
...
void O11y_O11ySavedViewOut::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool O11y_O11ySavedViewOut::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<O11y_SavedView> O11y_O11ySavedViewOut::getData() const
{
    return m_Data;
}


void O11y_O11ySavedViewOut::setData(const std::shared_ptr<O11y_SavedView>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool O11y_O11ySavedViewOut::dataIsSet() const
{
    return m_DataIsSet;
}

void O11y_O11ySavedViewOut::unsetData()
{
    m_DataIsSet = false;
}
utility::string_t O11y_O11ySavedViewOut::getStatus() const
{
    return m_Status;
}


void O11y_O11ySavedViewOut::setStatus(const utility::string_t& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool O11y_O11ySavedViewOut::statusIsSet() const
{
    return m_StatusIsSet;
}

void O11y_O11ySavedViewOut::unsetStatus()
{
    m_StatusIsSet = false;
}

...
Openai_FunctionCall::Openai_FunctionCall()
{
...
void Openai_FunctionCall::validate()
{
    // TODO: implement validation
}

web::json::value Openai_FunctionCall::toJson() const
{
...
bool Openai_FunctionCall::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Openai_FunctionCall::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Openai_FunctionCall::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t Openai_FunctionCall::getArguments() const
{
    return m_Arguments;
}


void Openai_FunctionCall::setArguments(const utility::string_t& value)
{
    m_Arguments = value;
    m_ArgumentsIsSet = true;
}

bool Openai_FunctionCall::argumentsIsSet() const
{
    return m_ArgumentsIsSet;
}

void Openai_FunctionCall::unsetArguments()
{
    m_ArgumentsIsSet = false;
}
utility::string_t Openai_FunctionCall::getName() const
{
    return m_Name;
}


void Openai_FunctionCall::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool Openai_FunctionCall::nameIsSet() const
{
    return m_NameIsSet;
}

void Openai_FunctionCall::unsetName()
{
    m_NameIsSet = false;
}

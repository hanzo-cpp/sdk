...
void DataroomRoomDetail::validate()
{
    // TODO: implement validation
}

web::json::value DataroomRoomDetail::toJson() const
{
...
bool DataroomRoomDetail::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("documents"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<DataroomMember>> refVal_setDocuments;
...
void DataroomRoomDetail::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool DataroomRoomDetail::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
bool DataroomRoomDetail::createdAtIsSet() const
{
    return m_CreatedAtIsSet;
}

void DataroomRoomDetail::unsetCreatedAt()
{
    m_CreatedAtIsSet = false;
}
utility::string_t DataroomRoomDetail::getDescription() const
{
    return m_Description;
}


void DataroomRoomDetail::setDescription(const utility::string_t& value)
{
    m_Description = value;
    m_DescriptionIsSet = true;
}

bool DataroomRoomDetail::descriptionIsSet() const
{
    return m_DescriptionIsSet;
}

void DataroomRoomDetail::unsetDescription()
{
    m_DescriptionIsSet = false;
}
std::vector<std::shared_ptr<DataroomMember>> DataroomRoomDetail::getDocuments() const
{
    return m_Documents;
}


void DataroomRoomDetail::setDocuments(const std::vector<std::shared_ptr<DataroomMember>>& value)
{
    m_Documents = value;
    m_DocumentsIsSet = true;
}

bool DataroomRoomDetail::documentsIsSet() const
{
    return m_DocumentsIsSet;
}

void DataroomRoomDetail::unsetDocuments()
{
    m_DocumentsIsSet = false;
}
utility::string_t DataroomRoomDetail::getId() const
{
    return m_Id;
}


void DataroomRoomDetail::setId(const utility::string_t& value)
{
    m_Id = value;
    m_IdIsSet = true;
}

bool DataroomRoomDetail::idIsSet() const
{
    return m_IdIsSet;
}

void DataroomRoomDetail::unsetId()
{
    m_IdIsSet = false;
}
utility::string_t DataroomRoomDetail::getName() const
{
    return m_Name;
}


void DataroomRoomDetail::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool DataroomRoomDetail::nameIsSet() const
{
    return m_NameIsSet;
}

void DataroomRoomDetail::unsetName()
{
    m_NameIsSet = false;
}
utility::string_t DataroomRoomDetail::getPId() const
{
    return m_PId;
}


void DataroomRoomDetail::setPId(const utility::string_t& value)
{
    m_PId = value;
    m_PIdIsSet = true;
}

bool DataroomRoomDetail::pIdIsSet() const
{
    return m_PIdIsSet;
}

void DataroomRoomDetail::unsetPId()
{
    m_PIdIsSet = false;
}
...
bool DataroomRoomDetail::updatedAtIsSet() const
{
    return m_UpdatedAtIsSet;
}

void DataroomRoomDetail::unsetUpdatedAt()
{
    m_UpdatedAtIsSet = false;
}

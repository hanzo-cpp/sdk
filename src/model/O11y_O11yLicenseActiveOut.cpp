...
O11y_O11yLicenseActiveOut::O11y_O11yLicenseActiveOut()
{
    m_DataIsSet = false;
...
void O11y_O11yLicenseActiveOut::validate()
{
    // TODO: implement validation
}

web::json::value O11y_O11yLicenseActiveOut::toJson() const
{
...
bool O11y_O11yLicenseActiveOut::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void O11y_O11yLicenseActiveOut::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool O11y_O11yLicenseActiveOut::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<Object> O11y_O11yLicenseActiveOut::getData() const
{
    return m_Data;
}


void O11y_O11yLicenseActiveOut::setData(const std::shared_ptr<Object>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool O11y_O11yLicenseActiveOut::dataIsSet() const
{
    return m_DataIsSet;
}

void O11y_O11yLicenseActiveOut::unsetData()
{
    m_DataIsSet = false;
}
utility::string_t O11y_O11yLicenseActiveOut::getStatus() const
{
    return m_Status;
}


void O11y_O11yLicenseActiveOut::setStatus(const utility::string_t& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool O11y_O11yLicenseActiveOut::statusIsSet() const
{
    return m_StatusIsSet;
}

void O11y_O11yLicenseActiveOut::unsetStatus()
{
    m_StatusIsSet = false;
}

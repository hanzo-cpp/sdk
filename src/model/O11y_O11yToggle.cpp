...
O11y_O11yToggle::O11y_O11yToggle()
{
    m_Enabled = false;
...
void O11y_O11yToggle::validate()
{
    // TODO: implement validation
}

web::json::value O11y_O11yToggle::toJson() const
{
...
bool O11y_O11yToggle::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void O11y_O11yToggle::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool O11y_O11yToggle::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
bool O11y_O11yToggle::isEnabled() const
{
    return m_Enabled;
}


void O11y_O11yToggle::setEnabled(bool value)
{
    m_Enabled = value;
    m_EnabledIsSet = true;
}

bool O11y_O11yToggle::enabledIsSet() const
{
    return m_EnabledIsSet;
}

void O11y_O11yToggle::unsetEnabled()
{
    m_EnabledIsSet = false;
}

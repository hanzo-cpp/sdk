...
void Cloud_rawOut::validate()
{
    // TODO: implement validation
}

web::json::value Cloud_rawOut::toJson() const
{
...
bool Cloud_rawOut::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Cloud_rawOut::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Cloud_rawOut::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<Object> Cloud_rawOut::getData() const
{
    return m_Data;
}


void Cloud_rawOut::setData(const std::shared_ptr<Object>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool Cloud_rawOut::dataIsSet() const
{
    return m_DataIsSet;
}

void Cloud_rawOut::unsetData()
{
    m_DataIsSet = false;
}
utility::string_t Cloud_rawOut::getMsg() const
{
    return m_Msg;
}


void Cloud_rawOut::setMsg(const utility::string_t& value)
{
    m_Msg = value;
    m_MsgIsSet = true;
}

bool Cloud_rawOut::msgIsSet() const
{
    return m_MsgIsSet;
}

void Cloud_rawOut::unsetMsg()
{
    m_MsgIsSet = false;
}
utility::string_t Cloud_rawOut::getStatus() const
{
    return m_Status;
}


void Cloud_rawOut::setStatus(const utility::string_t& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool Cloud_rawOut::statusIsSet() const
{
    return m_StatusIsSet;
}

void Cloud_rawOut::unsetStatus()
{
    m_StatusIsSet = false;
}
int32_t Cloud_rawOut::getTotal() const
{
    return m_Total;
}


void Cloud_rawOut::setTotal(int32_t value)
{
    m_Total = value;
    m_TotalIsSet = true;
}

bool Cloud_rawOut::totalIsSet() const
{
    return m_TotalIsSet;
}

void Cloud_rawOut::unsetTotal()
{
    m_TotalIsSet = false;
}

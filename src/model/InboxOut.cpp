...
void InboxOut::validate()
{
    // TODO: implement validation
}

web::json::value InboxOut::toJson() const
{
...
bool InboxOut::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("items"))))
    {
        ...
        {
            std::vector<std::shared_ptr<InboxItem>> refVal_setItems;
...
void InboxOut::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool InboxOut::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::vector<std::shared_ptr<InboxItem>> InboxOut::getItems() const
{
    return m_Items;
}


void InboxOut::setItems(const std::vector<std::shared_ptr<InboxItem>>& value)
{
    m_Items = value;
    m_ItemsIsSet = true;
}

bool InboxOut::itemsIsSet() const
{
    return m_ItemsIsSet;
}

void InboxOut::unsetItems()
{
    m_ItemsIsSet = false;
}

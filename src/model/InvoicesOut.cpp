...
void InvoicesOut::validate()
{
    // TODO: implement validation
}

web::json::value InvoicesOut::toJson() const
{
...
bool InvoicesOut::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("data"))))
    {
        ...
        {
            std::vector<std::shared_ptr<InvoiceRow>> refVal_setData;
...
void InvoicesOut::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool InvoicesOut::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::vector<std::shared_ptr<InvoiceRow>> InvoicesOut::getData() const
{
    return m_Data;
}


void InvoicesOut::setData(const std::vector<std::shared_ptr<InvoiceRow>>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool InvoicesOut::dataIsSet() const
{
    return m_DataIsSet;
}

void InvoicesOut::unsetData()
{
    m_DataIsSet = false;
}
utility::string_t InvoicesOut::getMsg() const
{
    return m_Msg;
}


void InvoicesOut::setMsg(const utility::string_t& value)
{
    m_Msg = value;
    m_MsgIsSet = true;
}

bool InvoicesOut::msgIsSet() const
{
    return m_MsgIsSet;
}

void InvoicesOut::unsetMsg()
{
    m_MsgIsSet = false;
}
utility::string_t InvoicesOut::getStatus() const
{
    return m_Status;
}


void InvoicesOut::setStatus(const utility::string_t& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool InvoicesOut::statusIsSet() const
{
    return m_StatusIsSet;
}

void InvoicesOut::unsetStatus()
{
    m_StatusIsSet = false;
}
int32_t InvoicesOut::getTotal() const
{
    return m_Total;
}


void InvoicesOut::setTotal(int32_t value)
{
    m_Total = value;
    m_TotalIsSet = true;
}

bool InvoicesOut::totalIsSet() const
{
    return m_TotalIsSet;
}

void InvoicesOut::unsetTotal()
{
    m_TotalIsSet = false;
}

...
O11y_O11yMetricAlertsOut::O11y_O11yMetricAlertsOut()
{
    m_DataIsSet = false;
...
void O11y_O11yMetricAlertsOut::validate()
{
    // TODO: implement validation
}

web::json::value O11y_O11yMetricAlertsOut::toJson() const
{
...
bool O11y_O11yMetricAlertsOut::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("data"))))
    {
        ...
        {
            std::shared_ptr<O11y_O11yMetricAlerts> refVal_setData;
...
void O11y_O11yMetricAlertsOut::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool O11y_O11yMetricAlertsOut::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<O11y_O11yMetricAlerts> O11y_O11yMetricAlertsOut::getData() const
{
    return m_Data;
}


void O11y_O11yMetricAlertsOut::setData(const std::shared_ptr<O11y_O11yMetricAlerts>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool O11y_O11yMetricAlertsOut::dataIsSet() const
{
    return m_DataIsSet;
}

void O11y_O11yMetricAlertsOut::unsetData()
{
    m_DataIsSet = false;
}
utility::string_t O11y_O11yMetricAlertsOut::getStatus() const
{
    return m_Status;
}


void O11y_O11yMetricAlertsOut::setStatus(const utility::string_t& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool O11y_O11yMetricAlertsOut::statusIsSet() const
{
    return m_StatusIsSet;
}

void O11y_O11yMetricAlertsOut::unsetStatus()
{
    m_StatusIsSet = false;
}

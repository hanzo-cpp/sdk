...
void Cloud_Breakdown::validate()
{
    // TODO: implement validation
}

web::json::value Cloud_Breakdown::toJson() const
{
...
bool Cloud_Breakdown::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("items"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<Cloud_BreakdownRow>> refVal_setItems;
...
void Cloud_Breakdown::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Cloud_Breakdown::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
bool Cloud_Breakdown::isAvailable() const
{
    return m_Available;
}


void Cloud_Breakdown::setAvailable(bool value)
{
    m_Available = value;
    m_AvailableIsSet = true;
}

bool Cloud_Breakdown::availableIsSet() const
{
    return m_AvailableIsSet;
}

void Cloud_Breakdown::unsetAvailable()
{
    m_AvailableIsSet = false;
}
std::vector<std::shared_ptr<Cloud_BreakdownRow>> Cloud_Breakdown::getItems() const
{
    return m_Items;
}


void Cloud_Breakdown::setItems(const std::vector<std::shared_ptr<Cloud_BreakdownRow>>& value)
{
    m_Items = value;
    m_ItemsIsSet = true;
}

bool Cloud_Breakdown::itemsIsSet() const
{
    return m_ItemsIsSet;
}

void Cloud_Breakdown::unsetItems()
{
    m_ItemsIsSet = false;
}
utility::string_t Cloud_Breakdown::getReason() const
{
    return m_Reason;
}


void Cloud_Breakdown::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool Cloud_Breakdown::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void Cloud_Breakdown::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t Cloud_Breakdown::getSource() const
{
    return m_Source;
}


void Cloud_Breakdown::setSource(const utility::string_t& value)
{
    m_Source = value;
    m_SourceIsSet = true;
}

bool Cloud_Breakdown::sourceIsSet() const
{
    return m_SourceIsSet;
}

void Cloud_Breakdown::unsetSource()
{
    m_SourceIsSet = false;
}

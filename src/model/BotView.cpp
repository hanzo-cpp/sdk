...
void BotView::validate()
{
    // TODO: implement validation
}

web::json::value BotView::toJson() const
{
...
bool BotView::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void BotView::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool BotView::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t BotView::getAgent() const
{
    return m_Agent;
}


void BotView::setAgent(const utility::string_t& value)
{
    m_Agent = value;
    m_AgentIsSet = true;
}

bool BotView::agentIsSet() const
{
    return m_AgentIsSet;
}

void BotView::unsetAgent()
{
    m_AgentIsSet = false;
}
std::shared_ptr<AgentBinding> BotView::getBinding() const
{
    return m_Binding;
}


void BotView::setBinding(const std::shared_ptr<AgentBinding>& value)
{
    m_Binding = value;
    m_BindingIsSet = true;
}

bool BotView::bindingIsSet() const
{
    return m_BindingIsSet;
}

void BotView::unsetBinding()
{
    m_BindingIsSet = false;
}
utility::string_t BotView::getCreatedTime() const
{
    return m_CreatedTime;
}


void BotView::setCreatedTime(const utility::string_t& value)
{
    m_CreatedTime = value;
    m_CreatedTimeIsSet = true;
}

bool BotView::createdTimeIsSet() const
{
    return m_CreatedTimeIsSet;
}

void BotView::unsetCreatedTime()
{
    m_CreatedTimeIsSet = false;
}
utility::string_t BotView::getGpu() const
{
    return m_Gpu;
}


void BotView::setGpu(const utility::string_t& value)
{
    m_Gpu = value;
    m_GpuIsSet = true;
}

bool BotView::gpuIsSet() const
{
    return m_GpuIsSet;
}

void BotView::unsetGpu()
{
    m_GpuIsSet = false;
}
utility::string_t BotView::getId() const
{
    return m_Id;
}


void BotView::setId(const utility::string_t& value)
{
    m_Id = value;
    m_IdIsSet = true;
}

bool BotView::idIsSet() const
{
    return m_IdIsSet;
}

void BotView::unsetId()
{
    m_IdIsSet = false;
}
utility::string_t BotView::getImage() const
{
    return m_Image;
}


void BotView::setImage(const utility::string_t& value)
{
    m_Image = value;
    m_ImageIsSet = true;
}

bool BotView::imageIsSet() const
{
    return m_ImageIsSet;
}

void BotView::unsetImage()
{
    m_ImageIsSet = false;
}
utility::string_t BotView::getMem() const
{
    return m_Mem;
}


void BotView::setMem(const utility::string_t& value)
{
    m_Mem = value;
    m_MemIsSet = true;
}

bool BotView::memIsSet() const
{
    return m_MemIsSet;
}

void BotView::unsetMem()
{
    m_MemIsSet = false;
}
utility::string_t BotView::getName() const
{
    return m_Name;
}


void BotView::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool BotView::nameIsSet() const
{
    return m_NameIsSet;
}

void BotView::unsetName()
{
    m_NameIsSet = false;
}
utility::string_t BotView::getOs() const
{
    return m_Os;
}


void BotView::setOs(const utility::string_t& value)
{
    m_Os = value;
    m_OsIsSet = true;
}

bool BotView::osIsSet() const
{
    return m_OsIsSet;
}

void BotView::unsetOs()
{
    m_OsIsSet = false;
}
utility::string_t BotView::getPrivateIp() const
{
    return m_PrivateIp;
}


void BotView::setPrivateIp(const utility::string_t& value)
{
    m_PrivateIp = value;
    m_PrivateIpIsSet = true;
}

bool BotView::privateIpIsSet() const
{
    return m_PrivateIpIsSet;
}

void BotView::unsetPrivateIp()
{
    m_PrivateIpIsSet = false;
}
utility::string_t BotView::getProvider() const
{
    return m_Provider;
}


void BotView::setProvider(const utility::string_t& value)
{
    m_Provider = value;
    m_ProviderIsSet = true;
}

bool BotView::providerIsSet() const
{
    return m_ProviderIsSet;
}

void BotView::unsetProvider()
{
    m_ProviderIsSet = false;
}
utility::string_t BotView::getPublicIp() const
{
    return m_PublicIp;
}


void BotView::setPublicIp(const utility::string_t& value)
{
    m_PublicIp = value;
    m_PublicIpIsSet = true;
}

bool BotView::publicIpIsSet() const
{
    return m_PublicIpIsSet;
}

void BotView::unsetPublicIp()
{
    m_PublicIpIsSet = false;
}
utility::string_t BotView::getRegion() const
{
    return m_Region;
}


void BotView::setRegion(const utility::string_t& value)
{
    m_Region = value;
    m_RegionIsSet = true;
}

bool BotView::regionIsSet() const
{
    return m_RegionIsSet;
}

void BotView::unsetRegion()
{
    m_RegionIsSet = false;
}
utility::string_t BotView::getStatus() const
{
    return m_Status;
}


void BotView::setStatus(const utility::string_t& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool BotView::statusIsSet() const
{
    return m_StatusIsSet;
}

void BotView::unsetStatus()
{
    m_StatusIsSet = false;
}
utility::string_t BotView::getType() const
{
    return m_Type;
}


void BotView::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool BotView::typeIsSet() const
{
    return m_TypeIsSet;
}

void BotView::unsetType()
{
    m_TypeIsSet = false;
}
int32_t BotView::getVcpu() const
{
    return m_Vcpu;
}


void BotView::setVcpu(int32_t value)
{
    m_Vcpu = value;
    m_VcpuIsSet = true;
}

bool BotView::vcpuIsSet() const
{
    return m_VcpuIsSet;
}

void BotView::unsetVcpu()
{
    m_VcpuIsSet = false;
}

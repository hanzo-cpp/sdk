...
void EventView::validate()
{
    // TODO: implement validation
}

web::json::value EventView::toJson() const
{
...
bool EventView::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void EventView::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool EventView::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t EventView::getActor() const
{
    return m_Actor;
}


void EventView::setActor(const utility::string_t& value)
{
    m_Actor = value;
    m_ActorIsSet = true;
}

bool EventView::actorIsSet() const
{
    return m_ActorIsSet;
}

void EventView::unsetActor()
{
    m_ActorIsSet = false;
}
utility::string_t EventView::getCreatedAt() const
{
    return m_CreatedAt;
}


void EventView::setCreatedAt(const utility::string_t& value)
{
    m_CreatedAt = value;
    m_CreatedAtIsSet = true;
}

bool EventView::createdAtIsSet() const
{
    return m_CreatedAtIsSet;
}

void EventView::unsetCreatedAt()
{
    m_CreatedAtIsSet = false;
}
utility::string_t EventView::getId() const
{
    return m_Id;
}


void EventView::setId(const utility::string_t& value)
{
    m_Id = value;
    m_IdIsSet = true;
}

bool EventView::idIsSet() const
{
    return m_IdIsSet;
}

void EventView::unsetId()
{
    m_IdIsSet = false;
}
utility::string_t EventView::getKind() const
{
    return m_Kind;
}


void EventView::setKind(const utility::string_t& value)
{
    m_Kind = value;
    m_KindIsSet = true;
}

bool EventView::kindIsSet() const
{
    return m_KindIsSet;
}

void EventView::unsetKind()
{
    m_KindIsSet = false;
}
std::shared_ptr<AnyType> EventView::getPayload() const
{
    return m_Payload.get();
}


void EventView::setPayload(const std::shared_ptr<AnyType>& value)
{
    m_Payload = value;
}

bool EventView::payloadIsSet() const
{
    return m_Payload.has_value();
}

void EventView::unsetPayload()
{
    m_Payload.reset();
}
...
bool EventView::seqIsSet() const
{
    return m_SeqIsSet;
}

void EventView::unsetSeq()
{
    m_SeqIsSet = false;
}
utility::string_t EventView::getSessionId() const
{
    return m_SessionId;
}


void EventView::setSessionId(const utility::string_t& value)
{
    m_SessionId = value;
    m_SessionIdIsSet = true;
}

bool EventView::sessionIdIsSet() const
{
    return m_SessionIdIsSet;
}

void EventView::unsetSessionId()
{
    m_SessionIdIsSet = false;
}

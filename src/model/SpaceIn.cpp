...
void SpaceIn::validate()
{
    // TODO: implement validation
}

web::json::value SpaceIn::toJson() const
{
...
bool SpaceIn::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void SpaceIn::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool SpaceIn::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t SpaceIn::getName() const
{
    return m_Name;
}


void SpaceIn::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool SpaceIn::nameIsSet() const
{
    return m_NameIsSet;
}

void SpaceIn::unsetName()
{
    m_NameIsSet = false;
}

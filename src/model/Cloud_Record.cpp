...
void Cloud_Record::validate()
{
    // TODO: implement validation
}

web::json::value Cloud_Record::toJson() const
{
...
bool Cloud_Record::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Cloud_Record::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Cloud_Record::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t Cloud_Record::getName() const
{
    return m_Name;
}


void Cloud_Record::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool Cloud_Record::nameIsSet() const
{
    return m_NameIsSet;
}

void Cloud_Record::unsetName()
{
    m_NameIsSet = false;
}
utility::string_t Cloud_Record::getType() const
{
    return m_Type;
}


void Cloud_Record::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool Cloud_Record::typeIsSet() const
{
    return m_TypeIsSet;
}

void Cloud_Record::unsetType()
{
    m_TypeIsSet = false;
}
utility::string_t Cloud_Record::getValue() const
{
    return m_Value;
}


void Cloud_Record::setValue(const utility::string_t& value)
{
    m_Value = value;
    m_ValueIsSet = true;
}

bool Cloud_Record::valueIsSet() const
{
    return m_ValueIsSet;
}

void Cloud_Record::unsetValue()
{
    m_ValueIsSet = false;
}

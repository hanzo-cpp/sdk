...
O11y_O11yFieldKeysOut::O11y_O11yFieldKeysOut()
{
    m_DataIsSet = false;
...
void O11y_O11yFieldKeysOut::validate()
{
    // TODO: implement validation
}

web::json::value O11y_O11yFieldKeysOut::toJson() const
{
...
bool O11y_O11yFieldKeysOut::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void O11y_O11yFieldKeysOut::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool O11y_O11yFieldKeysOut::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<O11y_GettableFieldKeys> O11y_O11yFieldKeysOut::getData() const
{
    return m_Data;
}


void O11y_O11yFieldKeysOut::setData(const std::shared_ptr<O11y_GettableFieldKeys>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool O11y_O11yFieldKeysOut::dataIsSet() const
{
    return m_DataIsSet;
}

void O11y_O11yFieldKeysOut::unsetData()
{
    m_DataIsSet = false;
}
utility::string_t O11y_O11yFieldKeysOut::getStatus() const
{
    return m_Status;
}


void O11y_O11yFieldKeysOut::setStatus(const utility::string_t& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool O11y_O11yFieldKeysOut::statusIsSet() const
{
    return m_StatusIsSet;
}

void O11y_O11yFieldKeysOut::unsetStatus()
{
    m_StatusIsSet = false;
}

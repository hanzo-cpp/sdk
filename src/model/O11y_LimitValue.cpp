...
void O11y_LimitValue::validate()
{
    // TODO: implement validation
}

web::json::value O11y_LimitValue::toJson() const
{
...
bool O11y_LimitValue::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void O11y_LimitValue::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool O11y_LimitValue::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
bool O11y_LimitValue::countIsSet() const
{
    return m_CountIsSet;
}

void O11y_LimitValue::unsetCount()
{
    m_CountIsSet = false;
}
...
bool O11y_LimitValue::sizeIsSet() const
{
    return m_SizeIsSet;
}

void O11y_LimitValue::unsetSize()
{
    m_SizeIsSet = false;
}

...
void PluginDeleted::validate()
{
    // TODO: implement validation
}

web::json::value PluginDeleted::toJson() const
{
...
bool PluginDeleted::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void PluginDeleted::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool PluginDeleted::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t PluginDeleted::getDeleted() const
{
    return m_Deleted;
}


void PluginDeleted::setDeleted(const utility::string_t& value)
{
    m_Deleted = value;
    m_DeletedIsSet = true;
}

bool PluginDeleted::deletedIsSet() const
{
    return m_DeletedIsSet;
}

void PluginDeleted::unsetDeleted()
{
    m_DeletedIsSet = false;
}

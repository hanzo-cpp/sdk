...
void EnablementOptRef::validate()
{
    // TODO: implement validation
}

web::json::value EnablementOptRef::toJson() const
{
...
bool EnablementOptRef::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void EnablementOptRef::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool EnablementOptRef::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t EnablementOptRef::getId() const
{
    return m_Id;
}


void EnablementOptRef::setId(const utility::string_t& value)
{
    m_Id = value;
    m_IdIsSet = true;
}

bool EnablementOptRef::idIsSet() const
{
    return m_IdIsSet;
}

void EnablementOptRef::unsetId()
{
    m_IdIsSet = false;
}
utility::string_t EnablementOptRef::getKind() const
{
    return m_Kind;
}


void EnablementOptRef::setKind(const utility::string_t& value)
{
    m_Kind = value;
    m_KindIsSet = true;
}

bool EnablementOptRef::kindIsSet() const
{
    return m_KindIsSet;
}

void EnablementOptRef::unsetKind()
{
    m_KindIsSet = false;
}

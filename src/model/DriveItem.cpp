...
void DriveItem::validate()
{
    // TODO: implement validation
}

web::json::value DriveItem::toJson() const
{
...
bool DriveItem::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void DriveItem::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool DriveItem::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t DriveItem::getName() const
{
    return m_Name;
}


void DriveItem::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool DriveItem::nameIsSet() const
{
    return m_NameIsSet;
}

void DriveItem::unsetName()
{
    m_NameIsSet = false;
}

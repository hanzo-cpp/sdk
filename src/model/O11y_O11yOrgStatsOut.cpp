...
O11y_O11yOrgStatsOut::O11y_O11yOrgStatsOut()
{
    m_DataIsSet = false;
...
void O11y_O11yOrgStatsOut::validate()
{
    // TODO: implement validation
}

web::json::value O11y_O11yOrgStatsOut::toJson() const
{
...
bool O11y_O11yOrgStatsOut::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void O11y_O11yOrgStatsOut::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool O11y_O11yOrgStatsOut::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::map<utility::string_t, std::shared_ptr<Object>> O11y_O11yOrgStatsOut::getData() const
{
    return m_Data;
}


void O11y_O11yOrgStatsOut::setData(const std::map<utility::string_t, std::shared_ptr<Object>>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool O11y_O11yOrgStatsOut::dataIsSet() const
{
    return m_DataIsSet;
}

void O11y_O11yOrgStatsOut::unsetData()
{
    m_DataIsSet = false;
}
utility::string_t O11y_O11yOrgStatsOut::getStatus() const
{
    return m_Status;
}


void O11y_O11yOrgStatsOut::setStatus(const utility::string_t& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool O11y_O11yOrgStatsOut::statusIsSet() const
{
    return m_StatusIsSet;
}

void O11y_O11yOrgStatsOut::unsetStatus()
{
    m_StatusIsSet = false;
}

...
void RoleList::validate()
{
    // TODO: implement validation
}

web::json::value RoleList::toJson() const
{
...
bool RoleList::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("data"))))
    {
        ...
        {
            std::vector<std::shared_ptr<RoleAssignment>> refVal_setData;
...
void RoleList::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool RoleList::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::vector<std::shared_ptr<RoleAssignment>> RoleList::getData() const
{
    return m_Data;
}


void RoleList::setData(const std::vector<std::shared_ptr<RoleAssignment>>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool RoleList::dataIsSet() const
{
    return m_DataIsSet;
}

void RoleList::unsetData()
{
    m_DataIsSet = false;
}

...
Iam_DeleteOutput::Iam_DeleteOutput()
{
    m_Deleted = false;
...
void Iam_DeleteOutput::validate()
{
    // TODO: implement validation
}

web::json::value Iam_DeleteOutput::toJson() const
{
...
bool Iam_DeleteOutput::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Iam_DeleteOutput::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Iam_DeleteOutput::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
bool Iam_DeleteOutput::isDeleted() const
{
    return m_Deleted;
}


void Iam_DeleteOutput::setDeleted(bool value)
{
    m_Deleted = value;
    m_DeletedIsSet = true;
}

bool Iam_DeleteOutput::deletedIsSet() const
{
    return m_DeletedIsSet;
}

void Iam_DeleteOutput::unsetDeleted()
{
    m_DeletedIsSet = false;
}

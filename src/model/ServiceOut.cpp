...
void ServiceOut::validate()
{
    // TODO: implement validation
}

web::json::value ServiceOut::toJson() const
{
...
bool ServiceOut::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("data"))))
    {
        ...
        {
            std::shared_ptr<ServiceOne> refVal_setData;
...
void ServiceOut::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ServiceOut::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<ServiceOne> ServiceOut::getData() const
{
    return m_Data;
}


void ServiceOut::setData(const std::shared_ptr<ServiceOne>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool ServiceOut::dataIsSet() const
{
    return m_DataIsSet;
}

void ServiceOut::unsetData()
{
    m_DataIsSet = false;
}
utility::string_t ServiceOut::getMsg() const
{
    return m_Msg;
}


void ServiceOut::setMsg(const utility::string_t& value)
{
    m_Msg = value;
    m_MsgIsSet = true;
}

bool ServiceOut::msgIsSet() const
{
    return m_MsgIsSet;
}

void ServiceOut::unsetMsg()
{
    m_MsgIsSet = false;
}
utility::string_t ServiceOut::getStatus() const
{
    return m_Status;
}


void ServiceOut::setStatus(const utility::string_t& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool ServiceOut::statusIsSet() const
{
    return m_StatusIsSet;
}

void ServiceOut::unsetStatus()
{
    m_StatusIsSet = false;
}

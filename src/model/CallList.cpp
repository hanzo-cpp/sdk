...
void CallList::validate()
{
    // TODO: implement validation
}

web::json::value CallList::toJson() const
{
...
bool CallList::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("data"))))
    {
        ...
        {
            std::vector<std::shared_ptr<Call>> refVal_setData;
...
void CallList::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CallList::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::vector<std::shared_ptr<Call>> CallList::getData() const
{
    return m_Data;
}


void CallList::setData(const std::vector<std::shared_ptr<Call>>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool CallList::dataIsSet() const
{
    return m_DataIsSet;
}

void CallList::unsetData()
{
    m_DataIsSet = false;
}

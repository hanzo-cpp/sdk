...
void KvPage::validate()
{
    // TODO: implement validation
}

web::json::value KvPage::toJson() const
{
...
bool KvPage::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("data"))))
    {
        ...
        {
            std::vector<std::shared_ptr<KvEntry>> refVal_setData;
...
void KvPage::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool KvPage::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::vector<std::shared_ptr<KvEntry>> KvPage::getData() const
{
    return m_Data;
}


void KvPage::setData(const std::vector<std::shared_ptr<KvEntry>>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool KvPage::dataIsSet() const
{
    return m_DataIsSet;
}

void KvPage::unsetData()
{
    m_DataIsSet = false;
}

...
void ReferralsOut::validate()
{
    // TODO: implement validation
}

web::json::value ReferralsOut::toJson() const
{
...
bool ReferralsOut::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("data"))))
    {
        ...
        {
            std::shared_ptr<ReferralBoard> refVal_setData;
...
void ReferralsOut::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ReferralsOut::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<ReferralBoard> ReferralsOut::getData() const
{
    return m_Data;
}


void ReferralsOut::setData(const std::shared_ptr<ReferralBoard>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool ReferralsOut::dataIsSet() const
{
    return m_DataIsSet;
}

void ReferralsOut::unsetData()
{
    m_DataIsSet = false;
}
utility::string_t ReferralsOut::getMsg() const
{
    return m_Msg;
}


void ReferralsOut::setMsg(const utility::string_t& value)
{
    m_Msg = value;
    m_MsgIsSet = true;
}

bool ReferralsOut::msgIsSet() const
{
    return m_MsgIsSet;
}

void ReferralsOut::unsetMsg()
{
    m_MsgIsSet = false;
}
utility::string_t ReferralsOut::getStatus() const
{
    return m_Status;
}


void ReferralsOut::setStatus(const utility::string_t& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool ReferralsOut::statusIsSet() const
{
    return m_StatusIsSet;
}

void ReferralsOut::unsetStatus()
{
    m_StatusIsSet = false;
}

...
UsageFundingOut::UsageFundingOut()
{
    m_DataIsSet = false;
...
void UsageFundingOut::validate()
{
    // TODO: implement validation
}

web::json::value UsageFundingOut::toJson() const
{
...
bool UsageFundingOut::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("data"))))
    {
        ...
        {
            std::vector<std::shared_ptr<UsageFundingRow>> refVal_setData;
...
void UsageFundingOut::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool UsageFundingOut::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::vector<std::shared_ptr<UsageFundingRow>> UsageFundingOut::getData() const
{
    return m_Data;
}


void UsageFundingOut::setData(const std::vector<std::shared_ptr<UsageFundingRow>>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool UsageFundingOut::dataIsSet() const
{
    return m_DataIsSet;
}

void UsageFundingOut::unsetData()
{
    m_DataIsSet = false;
}
utility::string_t UsageFundingOut::getMsg() const
{
    return m_Msg;
}


void UsageFundingOut::setMsg(const utility::string_t& value)
{
    m_Msg = value;
    m_MsgIsSet = true;
}

bool UsageFundingOut::msgIsSet() const
{
    return m_MsgIsSet;
}

void UsageFundingOut::unsetMsg()
{
    m_MsgIsSet = false;
}
utility::string_t UsageFundingOut::getStatus() const
{
    return m_Status;
}


void UsageFundingOut::setStatus(const utility::string_t& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool UsageFundingOut::statusIsSet() const
{
    return m_StatusIsSet;
}

void UsageFundingOut::unsetStatus()
{
    m_StatusIsSet = false;
}

...
O11y_O11yAccountOut::O11y_O11yAccountOut()
{
    m_DataIsSet = false;
...
void O11y_O11yAccountOut::validate()
{
    // TODO: implement validation
}

web::json::value O11y_O11yAccountOut::toJson() const
{
...
bool O11y_O11yAccountOut::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("data"))))
    {
        ...
        {
            std::shared_ptr<O11y_Account> refVal_setData;
...
void O11y_O11yAccountOut::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool O11y_O11yAccountOut::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<O11y_Account> O11y_O11yAccountOut::getData() const
{
    return m_Data;
}


void O11y_O11yAccountOut::setData(const std::shared_ptr<O11y_Account>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool O11y_O11yAccountOut::dataIsSet() const
{
    return m_DataIsSet;
}

void O11y_O11yAccountOut::unsetData()
{
    m_DataIsSet = false;
}
utility::string_t O11y_O11yAccountOut::getStatus() const
{
    return m_Status;
}


void O11y_O11yAccountOut::setStatus(const utility::string_t& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool O11y_O11yAccountOut::statusIsSet() const
{
    return m_StatusIsSet;
}

void O11y_O11yAccountOut::unsetStatus()
{
    m_StatusIsSet = false;
}

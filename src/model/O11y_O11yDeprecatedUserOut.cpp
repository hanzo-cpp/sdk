...
O11y_O11yDeprecatedUserOut::O11y_O11yDeprecatedUserOut()
{
    m_DataIsSet = false;
...
void O11y_O11yDeprecatedUserOut::validate()
{
    // TODO: implement validation
}

web::json::value O11y_O11yDeprecatedUserOut::toJson() const
{
...
bool O11y_O11yDeprecatedUserOut::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("data"))))
    {
        ...
        {
            std::shared_ptr<O11y_O11yDeprecatedUser> refVal_setData;
...
void O11y_O11yDeprecatedUserOut::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool O11y_O11yDeprecatedUserOut::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<O11y_O11yDeprecatedUser> O11y_O11yDeprecatedUserOut::getData() const
{
    return m_Data;
}


void O11y_O11yDeprecatedUserOut::setData(const std::shared_ptr<O11y_O11yDeprecatedUser>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool O11y_O11yDeprecatedUserOut::dataIsSet() const
{
    return m_DataIsSet;
}

void O11y_O11yDeprecatedUserOut::unsetData()
{
    m_DataIsSet = false;
}
utility::string_t O11y_O11yDeprecatedUserOut::getStatus() const
{
    return m_Status;
}


void O11y_O11yDeprecatedUserOut::setStatus(const utility::string_t& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool O11y_O11yDeprecatedUserOut::statusIsSet() const
{
    return m_StatusIsSet;
}

void O11y_O11yDeprecatedUserOut::unsetStatus()
{
    m_StatusIsSet = false;
}

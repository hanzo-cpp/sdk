...
AuthorSweepResult::AuthorSweepResult()
{
    m_DataIsSet = false;
...
void AuthorSweepResult::validate()
{
    // TODO: implement validation
}

web::json::value AuthorSweepResult::toJson() const
{
...
bool AuthorSweepResult::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("data"))))
    {
        ...
        {
            std::shared_ptr<SweepCounts> refVal_setData;
...
void AuthorSweepResult::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool AuthorSweepResult::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<SweepCounts> AuthorSweepResult::getData() const
{
    return m_Data;
}


void AuthorSweepResult::setData(const std::shared_ptr<SweepCounts>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool AuthorSweepResult::dataIsSet() const
{
    return m_DataIsSet;
}

void AuthorSweepResult::unsetData()
{
    m_DataIsSet = false;
}
utility::string_t AuthorSweepResult::getMsg() const
{
    return m_Msg;
}


void AuthorSweepResult::setMsg(const utility::string_t& value)
{
    m_Msg = value;
    m_MsgIsSet = true;
}

bool AuthorSweepResult::msgIsSet() const
{
    return m_MsgIsSet;
}

void AuthorSweepResult::unsetMsg()
{
    m_MsgIsSet = false;
}
utility::string_t AuthorSweepResult::getStatus() const
{
    return m_Status;
}


void AuthorSweepResult::setStatus(const utility::string_t& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool AuthorSweepResult::statusIsSet() const
{
    return m_StatusIsSet;
}

void AuthorSweepResult::unsetStatus()
{
    m_StatusIsSet = false;
}

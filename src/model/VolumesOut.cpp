...
void VolumesOut::validate()
{
    // TODO: implement validation
}

web::json::value VolumesOut::toJson() const
{
...
bool VolumesOut::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("data"))))
    {
        ...
        {
            std::shared_ptr<StorageSnapshot> refVal_setData;
...
void VolumesOut::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool VolumesOut::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<StorageSnapshot> VolumesOut::getData() const
{
    return m_Data;
}


void VolumesOut::setData(const std::shared_ptr<StorageSnapshot>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool VolumesOut::dataIsSet() const
{
    return m_DataIsSet;
}

void VolumesOut::unsetData()
{
    m_DataIsSet = false;
}
utility::string_t VolumesOut::getMsg() const
{
    return m_Msg;
}


void VolumesOut::setMsg(const utility::string_t& value)
{
    m_Msg = value;
    m_MsgIsSet = true;
}

bool VolumesOut::msgIsSet() const
{
    return m_MsgIsSet;
}

void VolumesOut::unsetMsg()
{
    m_MsgIsSet = false;
}
utility::string_t VolumesOut::getStatus() const
{
    return m_Status;
}


void VolumesOut::setStatus(const utility::string_t& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool VolumesOut::statusIsSet() const
{
    return m_StatusIsSet;
}

void VolumesOut::unsetStatus()
{
    m_StatusIsSet = false;
}

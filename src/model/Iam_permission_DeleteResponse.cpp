...
Iam_permission_DeleteResponse::Iam_permission_DeleteResponse()
{
    m_Deleted = false;
...
void Iam_permission_DeleteResponse::validate()
{
    // TODO: implement validation
}

web::json::value Iam_permission_DeleteResponse::toJson() const
{
...
bool Iam_permission_DeleteResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Iam_permission_DeleteResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Iam_permission_DeleteResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
bool Iam_permission_DeleteResponse::isDeleted() const
{
    return m_Deleted;
}


void Iam_permission_DeleteResponse::setDeleted(bool value)
{
    m_Deleted = value;
    m_DeletedIsSet = true;
}

bool Iam_permission_DeleteResponse::deletedIsSet() const
{
    return m_DeletedIsSet;
}

void Iam_permission_DeleteResponse::unsetDeleted()
{
    m_DeletedIsSet = false;
}

...
void TrustPage::validate()
{
    // TODO: implement validation
}

web::json::value TrustPage::toJson() const
{
...
bool TrustPage::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("items"))))
    {
        ...
        {
            std::vector<std::shared_ptr<TrustItem>> refVal_setItems;
...
void TrustPage::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool TrustPage::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::vector<std::shared_ptr<TrustItem>> TrustPage::getItems() const
{
    return m_Items;
}


void TrustPage::setItems(const std::vector<std::shared_ptr<TrustItem>>& value)
{
    m_Items = value;
    m_ItemsIsSet = true;
}

bool TrustPage::itemsIsSet() const
{
    return m_ItemsIsSet;
}

void TrustPage::unsetItems()
{
    m_ItemsIsSet = false;
}
utility::string_t TrustPage::getName() const
{
    return m_Name;
}


void TrustPage::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool TrustPage::nameIsSet() const
{
    return m_NameIsSet;
}

void TrustPage::unsetName()
{
    m_NameIsSet = false;
}
utility::string_t TrustPage::getNda() const
{
    return m_Nda;
}


void TrustPage::setNda(const utility::string_t& value)
{
    m_Nda = value;
    m_NdaIsSet = true;
}

bool TrustPage::ndaIsSet() const
{
    return m_NdaIsSet;
}

void TrustPage::unsetNda()
{
    m_NdaIsSet = false;
}
utility::string_t TrustPage::getSlug() const
{
    return m_Slug;
}


void TrustPage::setSlug(const utility::string_t& value)
{
    m_Slug = value;
    m_SlugIsSet = true;
}

bool TrustPage::slugIsSet() const
{
    return m_SlugIsSet;
}

void TrustPage::unsetSlug()
{
    m_SlugIsSet = false;
}

...
void SweepOut::validate()
{
    // TODO: implement validation
}

web::json::value SweepOut::toJson() const
{
...
bool SweepOut::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("data"))))
    {
        ...
        {
            std::shared_ptr<SweepData> refVal_setData;
...
void SweepOut::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool SweepOut::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<SweepData> SweepOut::getData() const
{
    return m_Data;
}


void SweepOut::setData(const std::shared_ptr<SweepData>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool SweepOut::dataIsSet() const
{
    return m_DataIsSet;
}

void SweepOut::unsetData()
{
    m_DataIsSet = false;
}
utility::string_t SweepOut::getMsg() const
{
    return m_Msg;
}


void SweepOut::setMsg(const utility::string_t& value)
{
    m_Msg = value;
    m_MsgIsSet = true;
}

bool SweepOut::msgIsSet() const
{
    return m_MsgIsSet;
}

void SweepOut::unsetMsg()
{
    m_MsgIsSet = false;
}
utility::string_t SweepOut::getStatus() const
{
    return m_Status;
}


void SweepOut::setStatus(const utility::string_t& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool SweepOut::statusIsSet() const
{
    return m_StatusIsSet;
}

void SweepOut::unsetStatus()
{
    m_StatusIsSet = false;
}

...
void SeedOut::validate()
{
    // TODO: implement validation
}

web::json::value SeedOut::toJson() const
{
...
bool SeedOut::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("data"))))
    {
        ...
        {
            std::shared_ptr<SeedData> refVal_setData;
...
void SeedOut::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool SeedOut::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<SeedData> SeedOut::getData() const
{
    return m_Data;
}


void SeedOut::setData(const std::shared_ptr<SeedData>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool SeedOut::dataIsSet() const
{
    return m_DataIsSet;
}

void SeedOut::unsetData()
{
    m_DataIsSet = false;
}
utility::string_t SeedOut::getMsg() const
{
    return m_Msg;
}


void SeedOut::setMsg(const utility::string_t& value)
{
    m_Msg = value;
    m_MsgIsSet = true;
}

bool SeedOut::msgIsSet() const
{
    return m_MsgIsSet;
}

void SeedOut::unsetMsg()
{
    m_MsgIsSet = false;
}
utility::string_t SeedOut::getStatus() const
{
    return m_Status;
}


void SeedOut::setStatus(const utility::string_t& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool SeedOut::statusIsSet() const
{
    return m_StatusIsSet;
}

void SeedOut::unsetStatus()
{
    m_StatusIsSet = false;
}

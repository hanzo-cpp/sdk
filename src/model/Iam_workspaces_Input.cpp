...
void Iam_workspaces_Input::validate()
{
    // TODO: implement validation
}

web::json::value Iam_workspaces_Input::toJson() const
{
...
bool Iam_workspaces_Input::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Iam_workspaces_Input::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Iam_workspaces_Input::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t Iam_workspaces_Input::getBucket() const
{
    return m_Bucket;
}


void Iam_workspaces_Input::setBucket(const utility::string_t& value)
{
    m_Bucket = value;
    m_BucketIsSet = true;
}

bool Iam_workspaces_Input::bucketIsSet() const
{
    return m_BucketIsSet;
}

void Iam_workspaces_Input::unsetBucket()
{
    m_BucketIsSet = false;
}
utility::string_t Iam_workspaces_Input::getCreatedTime() const
{
    return m_CreatedTime;
}


void Iam_workspaces_Input::setCreatedTime(const utility::string_t& value)
{
    m_CreatedTime = value;
    m_CreatedTimeIsSet = true;
}

bool Iam_workspaces_Input::createdTimeIsSet() const
{
    return m_CreatedTimeIsSet;
}

void Iam_workspaces_Input::unsetCreatedTime()
{
    m_CreatedTimeIsSet = false;
}
utility::string_t Iam_workspaces_Input::getDescription() const
{
    return m_Description;
}


void Iam_workspaces_Input::setDescription(const utility::string_t& value)
{
    m_Description = value;
    m_DescriptionIsSet = true;
}

bool Iam_workspaces_Input::descriptionIsSet() const
{
    return m_DescriptionIsSet;
}

void Iam_workspaces_Input::unsetDescription()
{
    m_DescriptionIsSet = false;
}
utility::string_t Iam_workspaces_Input::getDisplayName() const
{
    return m_DisplayName;
}


void Iam_workspaces_Input::setDisplayName(const utility::string_t& value)
{
    m_DisplayName = value;
    m_DisplayNameIsSet = true;
}

bool Iam_workspaces_Input::displayNameIsSet() const
{
    return m_DisplayNameIsSet;
}

void Iam_workspaces_Input::unsetDisplayName()
{
    m_DisplayNameIsSet = false;
}
bool Iam_workspaces_Input::isIsDefault() const
{
    return m_IsDefault;
}


void Iam_workspaces_Input::setIsDefault(bool value)
{
    m_IsDefault = value;
    m_IsDefaultIsSet = true;
}

bool Iam_workspaces_Input::isDefaultIsSet() const
{
    return m_IsDefaultIsSet;
}

void Iam_workspaces_Input::unsetIsDefault()
{
    m_IsDefaultIsSet = false;
}
utility::string_t Iam_workspaces_Input::getMetadata() const
{
    return m_Metadata;
}


void Iam_workspaces_Input::setMetadata(const utility::string_t& value)
{
    m_Metadata = value;
    m_MetadataIsSet = true;
}

bool Iam_workspaces_Input::metadataIsSet() const
{
    return m_MetadataIsSet;
}

void Iam_workspaces_Input::unsetMetadata()
{
    m_MetadataIsSet = false;
}
utility::string_t Iam_workspaces_Input::getName() const
{
    return m_Name;
}


void Iam_workspaces_Input::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool Iam_workspaces_Input::nameIsSet() const
{
    return m_NameIsSet;
}

void Iam_workspaces_Input::unsetName()
{
    m_NameIsSet = false;
}
utility::string_t Iam_workspaces_Input::getOrganization() const
{
    return m_Organization;
}


void Iam_workspaces_Input::setOrganization(const utility::string_t& value)
{
    m_Organization = value;
    m_OrganizationIsSet = true;
}

bool Iam_workspaces_Input::organizationIsSet() const
{
    return m_OrganizationIsSet;
}

void Iam_workspaces_Input::unsetOrganization()
{
    m_OrganizationIsSet = false;
}
utility::string_t Iam_workspaces_Input::getOwner() const
{
    return m_Owner;
}


void Iam_workspaces_Input::setOwner(const utility::string_t& value)
{
    m_Owner = value;
    m_OwnerIsSet = true;
}

bool Iam_workspaces_Input::ownerIsSet() const
{
    return m_OwnerIsSet;
}

void Iam_workspaces_Input::unsetOwner()
{
    m_OwnerIsSet = false;
}
std::vector<utility::string_t> Iam_workspaces_Input::getTags() const
{
    return m_Tags;
}


void Iam_workspaces_Input::setTags(const std::vector<utility::string_t>& value)
{
    m_Tags = value;
    m_TagsIsSet = true;
}

bool Iam_workspaces_Input::tagsIsSet() const
{
    return m_TagsIsSet;
}

void Iam_workspaces_Input::unsetTags()
{
    m_TagsIsSet = false;
}

...
void KitList::validate()
{
    // TODO: implement validation
}

web::json::value KitList::toJson() const
{
...
bool KitList::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("data"))))
    {
        ...
        {
            std::vector<std::shared_ptr<StarterKit>> refVal_setData;
...
void KitList::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool KitList::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::vector<std::shared_ptr<StarterKit>> KitList::getData() const
{
    return m_Data;
}


void KitList::setData(const std::vector<std::shared_ptr<StarterKit>>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool KitList::dataIsSet() const
{
    return m_DataIsSet;
}

void KitList::unsetData()
{
    m_DataIsSet = false;
}

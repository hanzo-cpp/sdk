...
O11y_ClusterListResponse::O11y_ClusterListResponse()
{
...
void O11y_ClusterListResponse::validate()
{
    // TODO: implement validation
}

web::json::value O11y_ClusterListResponse::toJson() const
{
...
bool O11y_ClusterListResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("records"))))
    {
        ...
        {
            std::vector<std::shared_ptr<O11y_ClusterListRecord>> refVal_setRecords;
...
void O11y_ClusterListResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool O11y_ClusterListResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::vector<std::shared_ptr<O11y_ClusterListRecord>> O11y_ClusterListResponse::getRecords() const
{
    return m_Records;
}


void O11y_ClusterListResponse::setRecords(const std::vector<std::shared_ptr<O11y_ClusterListRecord>>& value)
{
    m_Records = value;
    m_RecordsIsSet = true;
}

bool O11y_ClusterListResponse::recordsIsSet() const
{
    return m_RecordsIsSet;
}

void O11y_ClusterListResponse::unsetRecords()
{
    m_RecordsIsSet = false;
}
int32_t O11y_ClusterListResponse::getTotal() const
{
    return m_Total;
}


void O11y_ClusterListResponse::setTotal(int32_t value)
{
    m_Total = value;
    m_TotalIsSet = true;
}

bool O11y_ClusterListResponse::totalIsSet() const
{
    return m_TotalIsSet;
}

void O11y_ClusterListResponse::unsetTotal()
{
    m_TotalIsSet = false;
}
utility::string_t O11y_ClusterListResponse::getType() const
{
    return m_Type;
}


void O11y_ClusterListResponse::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool O11y_ClusterListResponse::typeIsSet() const
{
    return m_TypeIsSet;
}

void O11y_ClusterListResponse::unsetType()
{
    m_TypeIsSet = false;
}

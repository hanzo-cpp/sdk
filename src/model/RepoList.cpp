...
void RepoList::validate()
{
    // TODO: implement validation
}

web::json::value RepoList::toJson() const
{
...
bool RepoList::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("data"))))
    {
        ...
        {
            std::vector<std::shared_ptr<RepoView>> refVal_setData;
...
void RepoList::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool RepoList::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::vector<std::shared_ptr<RepoView>> RepoList::getData() const
{
    return m_Data;
}


void RepoList::setData(const std::vector<std::shared_ptr<RepoView>>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool RepoList::dataIsSet() const
{
    return m_DataIsSet;
}

void RepoList::unsetData()
{
    m_DataIsSet = false;
}

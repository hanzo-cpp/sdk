...
void BucketItem::validate()
{
    // TODO: implement validation
}

web::json::value BucketItem::toJson() const
{
...
bool BucketItem::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void BucketItem::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool BucketItem::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
bool BucketItem::createdAtIsSet() const
{
    return m_CreatedAtIsSet;
}

void BucketItem::unsetCreatedAt()
{
    m_CreatedAtIsSet = false;
}
utility::string_t BucketItem::getName() const
{
    return m_Name;
}


void BucketItem::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool BucketItem::nameIsSet() const
{
    return m_NameIsSet;
}

void BucketItem::unsetName()
{
    m_NameIsSet = false;
}

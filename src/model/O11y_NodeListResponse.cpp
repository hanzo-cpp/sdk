...
#include "hanzo/model/O11y_NodeListResponse.h"

namespace hanzo {
namespace model {

O11y_NodeListResponse::O11y_NodeListResponse()
{
...
void O11y_NodeListResponse::validate()
{
    // TODO: implement validation
}

web::json::value O11y_NodeListResponse::toJson() const
{
...
bool O11y_NodeListResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("records"))))
    {
        ...
        {
            std::vector<std::shared_ptr<O11y_NodeListRecord>> refVal_setRecords;
...
void O11y_NodeListResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool O11y_NodeListResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::vector<std::shared_ptr<O11y_NodeListRecord>> O11y_NodeListResponse::getRecords() const
{
    return m_Records;
}


void O11y_NodeListResponse::setRecords(const std::vector<std::shared_ptr<O11y_NodeListRecord>>& value)
{
    m_Records = value;
    m_RecordsIsSet = true;
}

bool O11y_NodeListResponse::recordsIsSet() const
{
    return m_RecordsIsSet;
}

void O11y_NodeListResponse::unsetRecords()
{
    m_RecordsIsSet = false;
}
int32_t O11y_NodeListResponse::getTotal() const
{
    return m_Total;
}


void O11y_NodeListResponse::setTotal(int32_t value)
{
    m_Total = value;
    m_TotalIsSet = true;
}

bool O11y_NodeListResponse::totalIsSet() const
{
    return m_TotalIsSet;
}

void O11y_NodeListResponse::unsetTotal()
{
    m_TotalIsSet = false;
}
utility::string_t O11y_NodeListResponse::getType() const
{
    return m_Type;
}


void O11y_NodeListResponse::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool O11y_NodeListResponse::typeIsSet() const
{
    return m_TypeIsSet;
}

void O11y_NodeListResponse::unsetType()
{
    m_TypeIsSet = false;
}

...
#include "hanzo/model/Cloud_inboxOut.h"
#include "hanzo/model/Cloud_rulesOut.h"
#include "hanzo/model/Cloud_syncTally.h"
#include "hanzo/model/Cloud_transactionsOut.h"
...
public:
    ...
    pplx::task<std::vector<std::shared_ptr<Cloud_Account>>> cloudGetV1BooksAccounts(
    ...
    pplx::task<std::shared_ptr<Cloud_BalanceSheet>> cloudGetV1BooksBalanceSheet(
        boost::optional<utility::string_t> sandbox,
    ...
    pplx::task<std::vector<std::shared_ptr<Cloud_BankTxnRow>>> cloudGetV1BooksBankTransactions(
        boost::optional<utility::string_t> sandbox,
    ...
    /// </remarks>
    /// <param name="sandbox">Sandbox reads the org&#39;s SANDBOX ledger when it is exactly \&quot;true\&quot;; anything else reads the live one. (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    pplx::task<std::shared_ptr<Cloud_unreconciledOut>> cloudGetV1BooksBankUnreconciled(
        boost::optional<utility::string_t> sandbox
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<Cloud_FinancialPackage>> cloudGetV1BooksExport(
        boost::optional<utility::string_t> sandbox,
    ...
    /// <param name="sandbox">Sandbox reads the org&#39;s SANDBOX ledger when it is exactly \&quot;true\&quot;. (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    /// <param name="limit">Limit caps how many rows come back; 500 when absent or not positive. (optional, default to 0)</param>
    pplx::task<std::vector<std::shared_ptr<Cloud_GLRow>>> cloudGetV1BooksGl(
        boost::optional<utility::string_t> sandbox,
        boost::optional<int32_t> limit
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="sandbox">Sandbox reads the org&#39;s SANDBOX ledger when it is exactly \&quot;true\&quot;; anything else reads the live one. (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    pplx::task<std::shared_ptr<Cloud_inboxOut>> cloudGetV1BooksInbox(
        boost::optional<utility::string_t> sandbox
    ) const;
    /// <summary>
    ...
    /// <param name="from">From is the RFC3339 start of the window, exclusive. Empty means all time. (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    /// <param name="to">To is the RFC3339 end of the window, inclusive. Empty means up to now. (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    pplx::task<std::shared_ptr<Cloud_MetricsResponse>> cloudGetV1BooksMetrics(
        boost::optional<utility::string_t> sandbox,
        boost::optional<utility::string_t> from,
        boost::optional<utility::string_t> to
    ) const;
    ...
    /// <param name="from">From is the RFC3339 start of the window, exclusive. Empty means all time. (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    /// <param name="to">To is the RFC3339 end of the window, inclusive. Empty means up to now. (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    pplx::task<std::shared_ptr<Cloud_PnL>> cloudGetV1BooksPnl(
        boost::optional<utility::string_t> sandbox,
        boost::optional<utility::string_t> from,
        boost::optional<utility::string_t> to
    ) const;
    ...
    /// </remarks>
    /// <param name="sandbox">Sandbox reads the org&#39;s SANDBOX ledger when it is exactly \&quot;true\&quot;; anything else reads the live one. (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    pplx::task<std::shared_ptr<Cloud_QuestionsResponse>> cloudGetV1BooksQuestions(
        boost::optional<utility::string_t> sandbox
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="sandbox">Sandbox reads the org&#39;s SANDBOX ledger when it is exactly \&quot;true\&quot;; anything else reads the live one. (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    pplx::task<std::shared_ptr<Cloud_rulesOut>> cloudGetV1BooksRules(
        boost::optional<utility::string_t> sandbox
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<Cloud_transactionsOut>> cloudGetV1BooksTransactions(
        boost::optional<utility::string_t> sandbox,
        boost::optional<utility::string_t> from,
        boost::optional<utility::string_t> to,
    ...
    /// <param name="from">From is the RFC3339 start of the window, exclusive. Empty means all time. (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    /// <param name="to">To is the RFC3339 end of the window, inclusive. Empty means up to now. (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    pplx::task<std::shared_ptr<Cloud_TrialBalance>> cloudGetV1BooksTrialBalance(
        boost::optional<utility::string_t> sandbox,
        boost::optional<utility::string_t> from,
        boost::optional<utility::string_t> to
    ) const;
    ...
    /// </remarks>
    /// <param name="sandbox">Sandbox reads the org&#39;s SANDBOX ledger when it is exactly \&quot;true\&quot;; anything else reads the live one. (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    pplx::task<std::shared_ptr<Cloud_vendorsOut>> cloudGetV1BooksVendors(
        boost::optional<utility::string_t> sandbox
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="cloudAskRequest"></param>
    pplx::task<std::shared_ptr<Cloud_AskResponse>> cloudPostV1BooksAsk(
        std::shared_ptr<Cloud_AskRequest> cloudAskRequest
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<void> cloudPostV1BooksBankExchange(
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<Cloud_BankTally>> cloudPostV1BooksBankImport(
    ...
    /// </remarks>
    pplx::task<void> cloudPostV1BooksBankLinkToken(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<std::shared_ptr<Cloud_BankTally>> cloudPostV1BooksBankSync(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="body"> (optional)</param>
    pplx::task<std::shared_ptr<Cloud_InboxItem>> cloudPostV1BooksInbox(
        boost::optional<std::shared_ptr<HttpContent>> body
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="cloudRule"></param>
    pplx::task<std::shared_ptr<Cloud_Rule>> cloudPostV1BooksRules(
        std::shared_ptr<Cloud_Rule> cloudRule
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="body"> (optional)</param>
    pplx::task<std::shared_ptr<Cloud_ScanDraft>> cloudPostV1BooksScan(
        boost::optional<std::shared_ptr<HttpContent>> body
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="cloudBookRequest"></param>
    pplx::task<std::shared_ptr<Cloud_BookResponse>> cloudPostV1BooksScanBook(
        std::shared_ptr<Cloud_BookRequest> cloudBookRequest
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<std::shared_ptr<Cloud_syncTally>> cloudPostV1BooksSync(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="cloudVendorRow"></param>
    pplx::task<std::shared_ptr<Cloud_VendorRow>> cloudPostV1BooksVendors(
        std::shared_ptr<Cloud_VendorRow> cloudVendorRow
    ) const;

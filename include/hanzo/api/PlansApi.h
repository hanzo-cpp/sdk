...
public:
    ...
    pplx::task<void> deletePlansEntriesBySlug(
    ...
    /// </remarks>
    pplx::task<std::shared_ptr<PlanList>> getPlans(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<std::shared_ptr<PlanList>> getPlansBlockchain(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<std::shared_ptr<PlanList>> getPlansCloud(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<std::shared_ptr<PlanList>> getPlansDns(
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<PlanEntitlements>> getPlansEntitlementsById(
        utility::string_t id
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<void> getPlansEntries(
    ) const;
    /// <summary>
    ...
    /// ListGPUTiers returns the rentable GPU configurations, each with its accelerator count and model, VRAM, vCPUs, host memory and hourly price.
    /// </remarks>
    pplx::task<std::shared_ptr<PlanTierList>> getPlansGpu(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<std::shared_ptr<PlanHealth>> getPlansHealth(
    ) const;
    /// <summary>
    ...
    /// Returns the published pricing policy: whether pricing is transparent, the revenue-sharing terms (idle compute resale and the open-source share) and the principles the catalog is priced by.
    /// </remarks>
    pplx::task<std::map<utility::string_t, std::shared_ptr<AnyType>>> getPlansPolicy(
    ) const;
    /// <summary>
    ...
    /// Returns the regions cloud capacity is offered in, each with its display name and physical location.
    /// </remarks>
    pplx::task<std::shared_ptr<PlanRegionList>> getPlansRegions(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="id">ID is the plan&#39;s catalog id or slug — \&quot;pro\&quot;, \&quot;team\&quot;, \&quot;world-enterprise\&quot;, \&quot;rpc-growth\&quot;. Both are matched, so a slug resolves the plan it names.</param>
    pplx::task<std::shared_ptr<PlanResolution>> getPlansResolveById(
        utility::string_t id
    ) const;
    /// <summary>
    ...
    /// Returns the two JSON Schema documents this surface speaks: entitlements.schema.json, which declares every entitlement key with its type, unit and enum, and plan.schema.json, which a catalog plan record conforms to.
    /// </remarks>
    pplx::task<std::shared_ptr<PlanSchemas>> getPlansSchema(
    ) const;
    /// <summary>
    ...
    /// Returns the block-storage price block: the price per GB per month and the volume size bounds a cloud plan may attach.
    /// </remarks>
    pplx::task<std::map<utility::string_t, std::shared_ptr<AnyType>>> getPlansStorage(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<std::shared_ptr<PlanList>> getPlansSubscriptions(
    ) const;
    /// <summary>
    ...
    /// Returns the per-use price of every metered tool — web search, code interpreter, image generation, speech — each with the unit it is billed in.
    /// </remarks>
    pplx::task<std::shared_ptr<PlanToolList>> getPlansTools(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<std::shared_ptr<PlanVocab>> getPlansVocab(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<void> postPlansEntries(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="slug"></param>
    pplx::task<void> putPlansEntriesBySlug(
        utility::string_t slug
    ) const;

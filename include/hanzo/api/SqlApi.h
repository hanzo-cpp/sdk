...
public:
    ...
    pplx::task<void> cloudDeleteV1SqlName(
    ...
    /// </remarks>
    pplx::task<std::vector<std::shared_ptr<Cloud_provisionedSummary>>> cloudGetV1Sql(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="name">The user-supplied resource name (slug). Lowercased and trimmed server-side; must match &#x60;^[a-z0-9]([a-z0-9-]{0,38}[a-z0-9])?$&#x60;. </param>
    pplx::task<std::shared_ptr<Cloud_provisionedResource>> cloudGetV1SqlName(
        utility::string_t name
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<Cloud_provisionResult>> cloudPostV1Sql(

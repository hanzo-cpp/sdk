...
#ifndef HANZO_API_IntegrationApi_H_
#define HANZO_API_IntegrationApi_H_
...
public:
    ...
    explicit IntegrationApi( std::shared_ptr<const ApiClient> apiClient );

    virtual ~IntegrationApi();
    ...
    pplx::task<std::shared_ptr<DisconnectOut>> deleteIntegrationConnectorsById(
        utility::string_t id
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<GithubPagesDisabledOut>> deleteIntegrationGithubReposByRepoPages(
    ...
    /// </remarks>
    pplx::task<std::shared_ptr<ListOut>> getIntegration(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="provider">Provider is the registry id of the connector — \&quot;slack\&quot;, \&quot;github\&quot;, \&quot;cloudflare\&quot;. Unknown ids are 404, as are the user-plane (/v1/integration/connectors) providers, which this surface never resolves.</param>
    pplx::task<std::shared_ptr<ProviderView>> getIntegrationByProvider(
    ...
    pplx::task<void> getIntegrationByProviderCallback(
        utility::string_t provider
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<std::shared_ptr<ConnectorsOut>> getIntegrationConnectors(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="id">ID is the connector id, provider + \&quot;:\&quot; + label (\&quot;openai:default\&quot;) — the auth-profile-id shape. Another user&#39;s id is simply no row, so 404.</param>
    pplx::task<std::shared_ptr<ConnectorTokenOut>> getIntegrationConnectorsByIdToken(
        utility::string_t id
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<std::shared_ptr<ConnectorProvidersOut>> getIntegrationConnectorsProviders(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<void> getIntegrationDiscordLink(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<void> getIntegrationDiscordLinkCallback(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<void> getIntegrationDiscordLinkDiscord(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<std::shared_ptr<GithubInstallationsOut>> getIntegrationGithubInstallations(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<std::shared_ptr<GithubReposOut>> getIntegrationGithubRepos(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="repo">Repo is the repository&#39;s short name within the org&#39;s installation, with no owner prefix (the owner is server-derived from the grant). A trailing \&quot;.git\&quot; is stripped.</param>
    pplx::task<std::shared_ptr<GithubPagesView>> getIntegrationGithubReposByRepoPages(
        utility::string_t repo
    ) const;
    /// <summary>
    ...
    /// Lists the projects the org&#39;s GitLab connection can reach — membership projects, most recently active first.
    /// </remarks>
    pplx::task<std::shared_ptr<GitlabProjectsOut>> getIntegrationGitlabProjects(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<void> getIntegrationSlackInstall(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<void> getIntegrationSlackLink(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<void> getIntegrationSlackLinkCallback(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<void> getIntegrationSlackLinkSlack(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<void> getIntegrationTeamsLink(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<void> getIntegrationTeamsLinkAad(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<void> getIntegrationTeamsLinkCallback(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<void> getIntegrationTelegramLink(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<void> getIntegrationTelegramLinkAuth(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<void> getIntegrationTelegramLinkCallback(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<void> getIntegrationWhatsappWebhook(
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<ConnectOut>> postIntegrationByProviderConnect(
        utility::string_t provider,
    ...
    /// </remarks>
    /// <param name="provider">Provider is the registry id of the connector — \&quot;slack\&quot;, \&quot;github\&quot;, \&quot;cloudflare\&quot;. Unknown ids are 404, as are the user-plane (/v1/integration/connectors) providers, which this surface never resolves.</param>
    pplx::task<std::shared_ptr<DisconnectOut>> postIntegrationByProviderDisconnect(
        utility::string_t provider
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="provider">Provider is the registry id of the connector — \&quot;slack\&quot;, \&quot;github\&quot;, \&quot;cloudflare\&quot;. Unknown ids are 404, as are the user-plane (/v1/integration/connectors) providers, which this surface never resolves.</param>
    pplx::task<std::shared_ptr<VerifyOut>> postIntegrationByProviderVerify(
        utility::string_t provider
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="id">ID is the connector id, provider + \&quot;:\&quot; + label (\&quot;openai:default\&quot;) — the auth-profile-id shape. Another user&#39;s id is simply no row, so 404.</param>
    pplx::task<std::shared_ptr<RefreshOut>> postIntegrationConnectorsByIdRefresh(
        utility::string_t id
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<CredentialOut>> postIntegrationConnectorsByProviderCredential(
        utility::string_t provider,
    ...
    pplx::task<std::shared_ptr<DeviceStartOut>> postIntegrationConnectorsByProviderDevice(
        utility::string_t provider,
    ...
    pplx::task<std::shared_ptr<DevicePollOut>> postIntegrationConnectorsByProviderDeviceByFlowPoll(
        utility::string_t provider,
    ...
    /// </remarks>
    pplx::task<void> postIntegrationDiscordInteractions(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="forgeJob"> (optional)</param>
    pplx::task<std::shared_ptr<ForgeLaunched>> postIntegrationForgeWebhook(
        boost::optional<std::shared_ptr<ForgeJob>> forgeJob
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<GithubClaimOut>> postIntegrationGithubClaim(
    ...
    pplx::task<std::shared_ptr<GithubForkOut>> postIntegrationGithubFork(
    ...
    pplx::task<std::shared_ptr<GithubBackfillResult>> postIntegrationGithubIssuesBackfill(
    ...
    pplx::task<std::shared_ptr<GithubPagesView>> postIntegrationGithubReposByRepoPages(
        utility::string_t repo,
    ...
    /// </remarks>
    /// <param name="repo">Repo is the repository&#39;s short name within the org&#39;s installation, with no owner prefix (the owner is server-derived from the grant). A trailing \&quot;.git\&quot; is stripped.</param>
    pplx::task<std::shared_ptr<GithubPagesBuildOut>> postIntegrationGithubReposByRepoPagesBuilds(
        utility::string_t repo
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<GithubImportOut>> postIntegrationGithubReposImport(
    ...
    pplx::task<std::shared_ptr<GithubSearchOut>> postIntegrationGithubSearch(
    ...
    /// </remarks>
    pplx::task<void> postIntegrationGithubWebhook(
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<LinearClaimOut>> postIntegrationLinearClaim(
    ...
    pplx::task<std::shared_ptr<LinearCommentOut>> postIntegrationLinearComments(
    ...
    pplx::task<std::shared_ptr<LinearBackfillResult>> postIntegrationLinearIssuesBackfill(
    ...
    /// </remarks>
    pplx::task<void> postIntegrationLinearWebhook(
    ) const;
    /// <summary>
    ...
    pplx::task<std::map<utility::string_t, std::shared_ptr<AnyType>>> postIntegrationOpenrouterWebhook(
    ...
    /// </remarks>
    pplx::task<void> postIntegrationSlackCommands(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<void> postIntegrationSlackEvents(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<std::shared_ptr<SlackJoinOut>> postIntegrationSlackJoin(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<void> postIntegrationTeamsEvents(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<std::shared_ptr<AuthorizeOut>> postIntegrationTelegramConnect(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<void> postIntegrationTelegramWebhook(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<void> postIntegrationWhatsappWebhook(
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<GithubPagesUpdatedOut>> putIntegrationGithubReposByRepoPages(
        utility::string_t repo,
...
#endif /* HANZO_API_IntegrationApi_H_ */

...
public:
    ...
    pplx::task<void> cloudGetV1SbomByWildcard1(
    ...
    /// </remarks>
    pplx::task<std::shared_ptr<Cloud_SbomHealth>> cloudGetV1SbomHealth(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="cloudSbomIngest"></param>
    pplx::task<std::shared_ptr<Cloud_SbomIngested>> cloudPostV1Sbom(
        std::shared_ptr<Cloud_SbomIngest> cloudSbomIngest
    ) const;

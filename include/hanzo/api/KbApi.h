...
public:
    ...
    pplx::task<std::shared_ptr<Cloud_connectionOut>> cloudDeleteV1KbConnectorsProvider(
    ...
    /// </remarks>
    pplx::task<std::shared_ptr<Cloud_kbConnectorsOut>> cloudGetV1KbConnectors(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<std::shared_ptr<Cloud_catalogOut>> cloudGetV1KbConnectorsCatalog(
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<Cloud_connectionOut>> cloudGetV1KbConnectorsProviderCallback(
        utility::string_t provider,
    ...
    /// </remarks>
    /// <param name="provider"></param>
    pplx::task<std::shared_ptr<Cloud_kbAuthorizeOut>> cloudGetV1KbConnectorsProviderConnect(
        utility::string_t provider
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<Cloud_graphOut>> cloudGetV1KbGraph(
    ...
    /// </remarks>
    /// <param name="provider"></param>
    pplx::task<std::shared_ptr<Cloud_kbSyncOut>> cloudPostV1KbConnectorsProviderSync(
        utility::string_t provider
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<void> cloudPostV1KbImport(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="cloudSearchIn"></param>
    pplx::task<std::shared_ptr<Cloud_searchOut>> cloudPostV1KbSearch(
        std::shared_ptr<Cloud_searchIn> cloudSearchIn
    ) const;

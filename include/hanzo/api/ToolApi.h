...
#ifndef HANZO_API_ToolApi_H_
#define HANZO_API_ToolApi_H_
...
public:
    ...
    explicit ToolApi( std::shared_ptr<const ApiClient> apiClient );
    ...
    pplx::task<void> deleteToolMcpServersById(
        utility::string_t id
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<PluginDeleted>> deleteToolPluginsAuthoredById(
        utility::string_t id
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<SkillDeleted>> deleteToolSkillsById(
        utility::string_t id
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<ToolList>> getTool(
    ...
    /// </remarks>
    pplx::task<std::shared_ptr<ActivationSet>> getToolActivation(
    ) const;
    /// <summary>
    ...
    /// <param name="limit">Limit bounds the page: default 50, maximum 200. A value that is not a positive integer reads as the default. (optional, default to 0L)</param>
    /// <param name="offset">Offset skips that many listings. (optional, default to 0L)</param>
    pplx::task<std::shared_ptr<McpCatalog>> getToolCatalog(
    ...
    pplx::task<std::shared_ptr<MCPListing>> getToolCatalogById(
        utility::string_t id
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<std::shared_ptr<McpServerList>> getToolMcpServers(
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<PluginMountList>> getToolPlugins(
    ...
    /// </remarks>
    pplx::task<std::shared_ptr<AuthoredPluginList>> getToolPluginsAuthored(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="activated">Activated keeps only the tools activated for the caller&#39;s org and project, and only when it is exactly the string \&quot;true\&quot;. (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    pplx::task<std::shared_ptr<SourceToolList>> getToolSkills(
        boost::optional<utility::string_t> activated
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<std::shared_ptr<AuthoredSkillList>> getToolSkillsAuthored(
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<MCPListing>> patchToolCatalogById(
        utility::string_t id,
    ...
    pplx::task<std::shared_ptr<ToolResult>> postToolCall(
    ...
    /// </remarks>
    pplx::task<std::shared_ptr<McpCatalogSync>> postToolCatalogSync(
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<MCPServer>> postToolMcpServers(
    ...
    pplx::task<std::shared_ptr<BuildOut>> postToolPluginsBuild(
    ...
    pplx::task<std::shared_ptr<SkillWritten>> postToolSkills(
    ...
    pplx::task<std::shared_ptr<ActivationSet>> putToolActivation(

...
public:
    ...
    /// </remarks>
    pplx::task<std::shared_ptr<AnyType>> getComputeRegions(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<std::shared_ptr<AnyType>> getComputeSizes(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<void> postComputeMachines(
    ) const;
    /// <summary>
    ...
    pplx::task<void> postComputeMachinesByIdByAction(
        utility::string_t id,

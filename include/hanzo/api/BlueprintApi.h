...
public:
    ...
    /// </remarks>
    pplx::task<std::shared_ptr<Cloud_blueprintIndex>> cloudGetV1Blueprint(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<std::shared_ptr<Cloud_blueprintHealth>> cloudGetV1BlueprintHealth(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<void> cloudGetV1BlueprintSbom(
    ) const;

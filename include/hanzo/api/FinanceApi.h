...
public:
    ...
    pplx::task<std::shared_ptr<AccountsOut>> getFinanceAccounts(
    ...
    /// </remarks>
    pplx::task<std::shared_ptr<FinanceBalanceView>> getFinanceBalance(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<std::vector<std::shared_ptr<FinanceCredit>>> getFinanceCredits(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<std::vector<std::shared_ptr<FinanceInvoice>>> getFinanceInvoices(
    ) const;
    /// <summary>
    ...
    pplx::task<std::vector<std::shared_ptr<FinanceLedgerEntry>>> getFinanceLedger(
    ...
    /// </remarks>
    pplx::task<std::vector<std::shared_ptr<FinancePaymentMethod>>> getFinancePaymentMethods(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<std::shared_ptr<TreasuryReport>> getFinanceTreasury(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="range">Range is the window: 24h, 7d, 30d or 90d. Anything else — including absent — is 30d, so a typo silently widens the window to a month rather than failing. (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    pplx::task<std::shared_ptr<FinanceUsageView>> getFinanceUsage(
        boost::optional<utility::string_t> range
    ) const;

...
#ifndef HANZO_API_FinanceApi_H_
#define HANZO_API_FinanceApi_H_
...
public:
    ...
    explicit FinanceApi( std::shared_ptr<const ApiClient> apiClient );
    ...
    pplx::task<std::shared_ptr<Cloud_accountsOut>> cloudGetV1FinanceAccounts(
    ...
    /// </remarks>
    pplx::task<void> cloudGetV1FinanceBalance(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<void> cloudGetV1FinanceCredits(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<void> cloudGetV1FinanceInvoices(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<void> cloudGetV1FinanceLedger(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<void> cloudGetV1FinancePaymentMethods(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<std::shared_ptr<Cloud_TreasuryReport>> cloudGetV1FinanceTreasury(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<void> cloudGetV1FinanceUsage(
    ) const;

...
#ifndef HANZO_API_PrefApi_H_
#define HANZO_API_PrefApi_H_
...
public:
    ...
    explicit PrefApi( std::shared_ptr<const ApiClient> apiClient );
    ...
    /// </remarks>
    pplx::task<std::shared_ptr<PrefsView>> getPref(
    ) const;
    /// <summary>

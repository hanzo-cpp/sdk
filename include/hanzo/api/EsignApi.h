...
public:
    ...
    /// </remarks>
    pplx::task<void> cloudGetV1EsignDocuments(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="id"></param>
    pplx::task<void> cloudGetV1EsignDocumentsById(
        utility::string_t id
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="id"></param>
    pplx::task<void> cloudGetV1EsignDocumentsByIdAudit(
        utility::string_t id
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="id"></param>
    pplx::task<void> cloudGetV1EsignDocumentsByIdDownload(
        utility::string_t id
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<void> cloudGetV1EsignHealth(
    ) const;
    /// <summary>
    ...
    pplx::task<void> cloudGetV1EsignOByOrgSignByToken(
    ...
    /// </remarks>
    pplx::task<void> cloudPostV1EsignDocuments(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="id"></param>
    pplx::task<void> cloudPostV1EsignDocumentsByIdFields(
        utility::string_t id
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="id"></param>
    pplx::task<void> cloudPostV1EsignDocumentsByIdRecipients(
        utility::string_t id
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="id"></param>
    pplx::task<void> cloudPostV1EsignDocumentsByIdSend(
        utility::string_t id
    ) const;
    /// <summary>
    ...
    /// <param name="org"></param>
    /// <param name="token"></param>
    pplx::task<void> cloudPostV1EsignOByOrgSignByTokenComplete(
        utility::string_t org,
        utility::string_t token
    ) const;
    /// <summary>
    ...
    pplx::task<void> cloudPostV1EsignOByOrgSignByTokenFieldsByFieldid(
        utility::string_t org,
        utility::string_t token,
    ...
    /// <param name="org"></param>
    /// <param name="token"></param>
    pplx::task<void> cloudPostV1EsignOByOrgSignByTokenReject(
        utility::string_t org,
        utility::string_t token
    ) const;

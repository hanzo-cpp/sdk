...
public:
    ...
    /// </remarks>
    pplx::task<std::shared_ptr<ExperimentList>> getExperiments(
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<Trial>> getExperimentsById(
        utility::string_t id
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<Assignment>> getExperimentsByIdAssign(
        utility::string_t id,
    ...
    /// </remarks>
    pplx::task<std::shared_ptr<Health>> getExperimentsHealth(
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<Trial>> postExperiments(
    ...
    pplx::task<std::shared_ptr<Analysis>> postExperimentsByIdAnalyze(
        utility::string_t id,
    ...
    pplx::task<std::shared_ptr<Trial>> postExperimentsByIdDecide(
        utility::string_t id,

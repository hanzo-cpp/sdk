...
public:
    ...
    pplx::task<void> deleteAutomationsFlowsById(
        utility::string_t id
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<std::shared_ptr<Catalog>> getAutomationsConnectors(
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<FlowPage>> getAutomationsFlows(
    ...
    /// </remarks>
    /// <param name="id">ID is the flow to act on, from the path.</param>
    pplx::task<std::shared_ptr<PopulatedFlow>> getAutomationsFlowsById(
        utility::string_t id
    ) const;
    /// <summary>
    ...
    /// <param name="limit">Limit bounds the page (default 200, maximum 1000). (optional, default to 0)</param>
    pplx::task<std::shared_ptr<VersionPage>> getAutomationsFlowsByIdVersions(
        utility::string_t id,
        boost::optional<int32_t> limit
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<std::shared_ptr<Catalog>> getAutomationsPieces(
    ) const;
    /// <summary>
    ...
    /// <param name="limit">Limit bounds the page (default 200, maximum 1000). (optional, default to 0)</param>
    pplx::task<std::shared_ptr<RunPage>> getAutomationsRuns(
    ...
    pplx::task<std::shared_ptr<FlowRun>> getAutomationsRunsById(
        utility::string_t id
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<Flow>> patchAutomationsFlowsById(
        utility::string_t id,
    ...
    pplx::task<std::shared_ptr<RunResp>> postAutomationsConnectorsByIdRun(
        utility::string_t id,
    ...
    pplx::task<std::shared_ptr<PopulatedFlow>> postAutomationsFlows(
    ...
    /// </remarks>
    /// <param name="id">ID is the flow to act on, from the path.</param>
    pplx::task<std::shared_ptr<Flow>> postAutomationsFlowsByIdDisable(
        utility::string_t id
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="id">ID is the flow to act on, from the path.</param>
    pplx::task<std::shared_ptr<Flow>> postAutomationsFlowsByIdEnable(
        utility::string_t id
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="id"></param>
    pplx::task<void> postAutomationsFlowsByIdOperations(
        utility::string_t id
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="id">ID is the flow to act on, from the path.</param>
    pplx::task<std::shared_ptr<FlowRun>> postAutomationsFlowsByIdRun(
        utility::string_t id
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<FlowVersion>> postAutomationsFlowsByIdVersions(
        utility::string_t id,
    ...
    pplx::task<void> postAutomationsHooksBySourceByEvent(
    ...
    /// </remarks>
    /// <param name="id"></param>
    pplx::task<void> postAutomationsRunsByIdResume(
        utility::string_t id
    ) const;

...
public:
    ...
    /// </remarks>
    /// <param name="id"></param>
    pplx::task<void> deleteAdsCampaignsById(
        utility::string_t id
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<CampaignList>> getAdsCampaigns(
    ...
    /// </remarks>
    /// <param name="id"></param>
    pplx::task<std::shared_ptr<AdCampaign>> getAdsCampaignsById(
        utility::string_t id
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<std::shared_ptr<AdSummary>> getAdsSummary(
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<AdCampaign>> postAdsCampaigns(
    ...
    /// </remarks>
    /// <param name="id"></param>
    pplx::task<void> postAdsCampaignsByIdLaunch(
        utility::string_t id
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<AdCampaign>> putAdsCampaignsById(
        utility::string_t id,

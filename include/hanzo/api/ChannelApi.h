...
#ifndef HANZO_API_ChannelApi_H_
#define HANZO_API_ChannelApi_H_
...
public:
    ...
    /// </remarks>
    pplx::task<std::shared_ptr<ChatChannels>> getChannel(
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<ChannelAgents>> getChannelAgent(
    ...
    pplx::task<std::shared_ptr<AllowlistView>> getChannelAllowlist(
        boost::optional<utility::string_t> channel
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<InboxPage>> getChannelInbox(
    ...
    /// </remarks>
    pplx::task<std::shared_ptr<PairingQueue>> getChannelPairing(
    ) const;
    /// <summary>
    ...
    pplx::task<void> postChannelByChannelSend(
    ...
    pplx::task<std::shared_ptr<PairingApproved>> postChannelPairingApprove(
    ...
    pplx::task<std::shared_ptr<ChannelAgents>> putChannelAgent(
    ...
    pplx::task<std::shared_ptr<AllowlistView>> putChannelAllowlist(

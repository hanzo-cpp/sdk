...
public:
    ...
    pplx::task<std::shared_ptr<DestinationDisconnected>> deleteDestinationsByPlatform(
    ...
    /// Reports every destination this deployment can forward to, each with the caller org&#39;s connection state: whether it is connected, whether it is enabled, whether a credential resolves right now, and the config fields the console renders for it.
    /// </remarks>
    pplx::task<std::shared_ptr<DestinationList>> getDestinations(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="platform">Platform is the destination to act on, from the path: ga4 | meta | tiktok | linkedin | x | reddit | posthog | umami.</param>
    pplx::task<std::shared_ptr<DestinationStatus>> getDestinationsByPlatform(
        utility::string_t platform
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<DestinationStatus>> postDestinationsByPlatform(
        utility::string_t platform,
    ...
    /// </remarks>
    /// <param name="platform">Platform is the destination to act on, from the path: ga4 | meta | tiktok | linkedin | x | reddit | posthog | umami.</param>
    pplx::task<std::shared_ptr<DestinationTest>> postDestinationsByPlatformTest(
        utility::string_t platform
    ) const;

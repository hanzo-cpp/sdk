...
public:
    ...
    pplx::task<std::shared_ptr<DisconnectOut>> deleteConnectorsById(
        utility::string_t id
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<std::shared_ptr<ConnectorsOut>> getConnectors(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="id">ID is the connector id, provider + \&quot;:\&quot; + label (\&quot;openai:default\&quot;) — the auth-profile-id shape. Another user&#39;s id is simply no row, so 404.</param>
    pplx::task<std::shared_ptr<ConnectorTokenOut>> getConnectorsByIdToken(
        utility::string_t id
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<std::shared_ptr<ConnectorProvidersOut>> getConnectorsProviders(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="id">ID is the connector id, provider + \&quot;:\&quot; + label (\&quot;openai:default\&quot;) — the auth-profile-id shape. Another user&#39;s id is simply no row, so 404.</param>
    pplx::task<std::shared_ptr<RefreshOut>> postConnectorsByIdRefresh(
        utility::string_t id
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<CredentialOut>> postConnectorsByProviderCredential(
    ...
    pplx::task<std::shared_ptr<DeviceStartOut>> postConnectorsByProviderDevice(
        utility::string_t provider,
    ...
    pplx::task<std::shared_ptr<DevicePollOut>> postConnectorsByProviderDeviceByFlowPoll(
        utility::string_t provider,

...
#ifndef HANZO_API_EvalApi_H_
#define HANZO_API_EvalApi_H_
...
public:
    ...
    explicit EvalApi( std::shared_ptr<const ApiClient> apiClient );
    ...
    /// </remarks>
    /// <param name="name">Name is the dataset the URL names.</param>
    pplx::task<std::shared_ptr<DatasetView>> getEvalDatasetsByName(
        utility::string_t name
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<Board>> getEvalMetrics(
    ...
    pplx::task<std::shared_ptr<DatasetView>> postEvalDatasets(
    ...
    pplx::task<std::shared_ptr<ItemView>> postEvalDatasetsByNameItems(
        utility::string_t name,
    ...
    pplx::task<std::shared_ptr<EvaluatorView>> postEvalEvaluators(
    ...
    pplx::task<std::shared_ptr<ScoreConfigView>> postEvalRubrics(
    ...
    pplx::task<std::shared_ptr<RunSummary>> postEvalRuns(
    ...
    pplx::task<std::shared_ptr<ScoreView>> postEvalScores(

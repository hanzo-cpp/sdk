...
public:
    ...
    pplx::task<std::shared_ptr<WalletList>> getWallets(
    ...
    /// </remarks>
    pplx::task<std::shared_ptr<AccountList>> getWalletsAccounts(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="id"></param>
    pplx::task<std::shared_ptr<Wallet>> getWalletsById(
        utility::string_t id
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<Wallet>> postWallets(
    ...
    pplx::task<std::shared_ptr<WalletAccount>> postWalletsAccounts(
    ...
    /// </remarks>
    /// <param name="id"></param>
    pplx::task<std::shared_ptr<Wallet>> postWalletsByIdKeys(
        utility::string_t id
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<Signature>> postWalletsByIdSign(
        utility::string_t id,
    ...
    pplx::task<std::shared_ptr<SafeProposal>> postWalletsByIdTransactions(
        utility::string_t id,

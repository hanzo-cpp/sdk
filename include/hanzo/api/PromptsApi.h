...
public:
    ...
    pplx::task<void> deletePromptsByName(
    ...
    /// </remarks>
    pplx::task<std::shared_ptr<PromptList>> getPrompts(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="name">Name is the prompt to act on, from the path.</param>
    pplx::task<std::shared_ptr<PromptDetail>> getPromptsByName(
        utility::string_t name
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<std::shared_ptr<CatalogList>> getPromptsCatalog(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<std::shared_ptr<MetricList>> getPromptsMetrics(
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<PromptDetail>> postPrompts(

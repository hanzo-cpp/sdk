...
public:
    ...
    pplx::task<void> deleteAgentByRef(
    ...
    pplx::task<std::shared_ptr<TargetDeleted>> deleteAgentTargetsById(
        utility::string_t id
    ) const;
    /// <summary>
    ...
    /// Returns every agent defined in the caller&#39;s org, each with the number of runs recorded against it.
    /// </remarks>
    pplx::task<std::shared_ptr<AgentList>> getAgent(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<std::shared_ptr<ActivityFeed>> getAgentActivity(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="limit">Limit caps the page. Absent, zero or over 500 reads as 100. (optional, default to 0L)</param>
    pplx::task<std::shared_ptr<BuildList>> getAgentBuilds(
    ...
    pplx::task<std::shared_ptr<BuildView>> getAgentBuildsByOrgByProject(
    ...
    /// </remarks>
    /// <param name="ref">Ref is the agent&#39;s public id (the agent_… handle create and list return) or its org-unique name, from the path. Either resolves the same agent.</param>
    pplx::task<std::shared_ptr<AgentDetail>> getAgentByRef(
        utility::string_t ref
    ) const;
    /// <summary>
    ...
    /// <param name="limit">Limit caps how many runs come back, newest first. Absent, zero or out of range (1..200) reads as 50. (optional, default to 0L)</param>
    pplx::task<std::shared_ptr<RunList>> getAgentByRefRuns(
        utility::string_t ref,
        boost::optional<int64_t> limit
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<void> getAgentChatConversations(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="id"></param>
    pplx::task<void> getAgentChatConversationsById(
        utility::string_t id
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<void> getAgentChatPresets(
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<MetricsView>> getAgentMetrics(
    ...
    pplx::task<std::shared_ptr<RunList>> getAgentRuns(
        boost::optional<int64_t> limit,
    ...
    /// <param name="limit">Limit caps the page. Absent, zero or over 500 reads as 100. (optional, default to 0L)</param>
    pplx::task<std::shared_ptr<SessionList>> getAgentSessions(
    ...
    pplx::task<std::shared_ptr<SessionDetail>> getAgentSessionsById(
        utility::string_t id
    ) const;
    /// <summary>
    ...
    /// <param name="after">After is the last seq this poller applied; only commands newer than it come back. Absent or negative reads as 0, which drains from the beginning. (optional, default to 0L)</param>
    pplx::task<std::shared_ptr<ControlDrain>> getAgentSessionsByIdControl(
        utility::string_t id,
    ...
    /// </remarks>
    /// <param name="id">ID is the session to act on, from the path.</param>
    pplx::task<std::shared_ptr<SessionProgress>> getAgentSessionsByIdProgress(
        utility::string_t id
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="id">ID is the session to act on, from the path.</param>
    pplx::task<std::shared_ptr<TreeNode>> getAgentSessionsByIdTree(
        utility::string_t id
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<void> getAgentSessionsStream(
    ) const;
    /// <summary>
    ...
    /// Returns every machine registered to the caller&#39;s org, newest first, each with its live session load.
    /// </remarks>
    pplx::task<std::shared_ptr<TargetList>> getAgentTargets(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="id">ID is the target to act on, from the path.</param>
    pplx::task<std::shared_ptr<TargetView>> getAgentTargetsById(
        utility::string_t id
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<AgentView>> patchAgentByRef(
        utility::string_t ref,
    ...
    pplx::task<std::shared_ptr<SessionView>> patchAgentSessionsById(
        utility::string_t id,
    ...
    pplx::task<std::shared_ptr<TargetView>> patchAgentTargetsById(
        utility::string_t id,
    ...
    pplx::task<std::shared_ptr<AgentView>> postAgent(
    ...
    pplx::task<void> postAgentByRefRun(
        utility::string_t ref
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<void> postAgentChatConversations(
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<CodingStarted>> postAgentCoding(
    ...
    pplx::task<std::shared_ptr<SessionView>> postAgentSessions(
    ...
    pplx::task<std::shared_ptr<EventView>> postAgentSessionsByIdEvents(
        utility::string_t id,
    ...
    pplx::task<std::shared_ptr<ControlResult>> postAgentSessionsByIdMessage(
        utility::string_t id,
    ...
    /// <param name="id">ID is the session to steer, from the path.</param>
    /// <param name="controlIn"></param>
    pplx::task<std::shared_ptr<ControlResult>> postAgentSessionsByIdPause(
        utility::string_t id,
        std::shared_ptr<ControlIn> controlIn
    ) const;
    /// <summary>
    ...
    /// <param name="id">ID is the session to steer, from the path.</param>
    /// <param name="controlIn"></param>
    pplx::task<std::shared_ptr<ControlResult>> postAgentSessionsByIdResume(
        utility::string_t id,
        std::shared_ptr<ControlIn> controlIn
    ) const;
    /// <summary>
    ...
    /// <param name="id">ID is the session to steer, from the path.</param>
    /// <param name="controlIn"></param>
    pplx::task<std::shared_ptr<ControlResult>> postAgentSessionsByIdStop(
        utility::string_t id,
        std::shared_ptr<ControlIn> controlIn
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<TargetView>> postAgentTargets(
    ...
    /// </remarks>
    /// <param name="id">ID is the target to act on, from the path.</param>
    pplx::task<std::shared_ptr<RoutedRunOut>> postAgentTargetsByIdClaim(
        utility::string_t id
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="id">ID is the target to act on, from the path.</param>
    pplx::task<std::shared_ptr<ClaimKeyOut>> postAgentTargetsByIdKey(
        utility::string_t id
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<ReportOut>> postAgentTargetsByIdRunsByRunidReport(
        utility::string_t id,

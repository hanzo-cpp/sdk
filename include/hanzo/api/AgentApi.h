...
public:
    ...
    /// </remarks>
    pplx::task<void> cloudGetV1AgentConversations(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="id"></param>
    pplx::task<void> cloudGetV1AgentConversationsById(
        utility::string_t id
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<void> cloudGetV1AgentPresets(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<void> cloudPostV1Agent(
    ) const;

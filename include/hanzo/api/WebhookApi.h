...
#ifndef HANZO_API_WebhookApi_H_
#define HANZO_API_WebhookApi_H_
...
public:
    ...
    explicit WebhookApi( std::shared_ptr<const ApiClient> apiClient );
    ...
    /// </remarks>
    pplx::task<std::shared_ptr<EndpointList>> getWebhook(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="id"></param>
    pplx::task<std::shared_ptr<Endpoint>> getWebhookById(
        utility::string_t id
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<Endpoint>> postWebhook(
    ...
    /// </remarks>
    /// <param name="id"></param>
    pplx::task<std::shared_ptr<Endpoint>> postWebhookByIdSecret(
        utility::string_t id
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="id"></param>
    pplx::task<std::shared_ptr<TestResult>> postWebhookByIdTest(
        utility::string_t id
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<Endpoint>> putWebhookById(
        utility::string_t id,

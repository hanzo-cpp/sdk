...
#ifndef HANZO_API_FlagApi_H_
#define HANZO_API_FlagApi_H_
...
public:
    ...
    pplx::task<std::shared_ptr<DeletedOut>> deleteFlagDefsByKey(
    ...
    /// Returns the caller&#39;s flag change log newest-first: every create, update and delete, with the actor and the time.
    /// </remarks>
    /// <param name="limit">Limit caps the rows returned. 1–500; anything else takes the default 100. (optional, default to 0L)</param>
    pplx::task<std::shared_ptr<ActivityOut>> getFlagActivity(
    ...
    /// Returns every flag definition in the caller&#39;s (org, project) store, by key, with its version and who last changed it.
    /// </remarks>
    pplx::task<std::shared_ptr<DefsOut>> getFlagDefs(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="key">Key is the flag key to act on, from the path.</param>
    pplx::task<std::shared_ptr<DefRow>> getFlagDefsByKey(
        utility::string_t key
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<std::shared_ptr<HealthOut>> getFlagHealth(
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<AnyType>> postFlag(
    ...
    /// </remarks>
    /// <param name="evaluateIn"></param>
    pplx::task<std::shared_ptr<AnyType>> postFlagDecide(
        std::shared_ptr<EvaluateIn> evaluateIn
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<DefRow>> putFlagDefsByKey(
        utility::string_t key,

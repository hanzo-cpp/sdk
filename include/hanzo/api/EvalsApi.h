...
#include "hanzo/model/DatasetList.h"
#include "hanzo/model/DatasetReq.h"
#include "hanzo/model/DatasetView.h"
#include "hanzo/model/EvaluatorList.h"
...
public:
    ...
    pplx::task<std::shared_ptr<Object>> deleteEvalsDatasetsByName(
    ...
    pplx::task<std::shared_ptr<DatasetList>> getEvalsDatasets(
    ...
    /// </remarks>
    /// <param name="name">Name is the dataset the URL names.</param>
    pplx::task<std::shared_ptr<DatasetView>> getEvalsDatasetsByName(
        utility::string_t name
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<ItemList>> getEvalsDatasetsByNameItems(
        utility::string_t name,
        boost::optional<int32_t> limit
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="limit">Limit caps the rows returned. It defaults to 100 and is capped at 500; a non-positive or unparseable value falls back to the default rather than failing, because a typo about paging is not a reason to refuse a read. (optional, default to 0)</param>
    pplx::task<std::shared_ptr<EvaluatorList>> getEvalsEvaluators(
        boost::optional<int32_t> limit
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="range">Range is 24h (the default), 7d or 30d. Anything else normalises to 24h rather than failing, so the board always has a valid window. (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    /// <param name="interval">Interval overrides the bucket the series is grouped into: \&quot;hour\&quot; or \&quot;day\&quot;. Any other value leaves the range&#39;s own default in place. (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    pplx::task<std::shared_ptr<Board>> getEvalsMetrics(
        boost::optional<utility::string_t> range,
        boost::optional<utility::string_t> interval
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="limit">Limit caps the rows returned. It defaults to 100 and is capped at 500; a non-positive or unparseable value falls back to the default rather than failing, because a typo about paging is not a reason to refuse a read. (optional, default to 0)</param>
    pplx::task<std::shared_ptr<ScoreConfigList>> getEvalsRubrics(
        boost::optional<int32_t> limit
    ) const;
    /// <summary>
    ...
    /// <param name="limit"> (optional, default to 0)</param>
    pplx::task<std::shared_ptr<Runs>> getEvalsRuns(
    ...
    /// <param name="limit"> (optional, default to 0)</param>
    pplx::task<std::shared_ptr<ScoreList>> getEvalsScores(
    ...
    /// <param name="limit"> (optional, default to 0)</param>
    pplx::task<std::shared_ptr<TraceList>> getEvalsTraces(
    ...
    /// </remarks>
    /// <param name="datasetReq"></param>
    pplx::task<std::shared_ptr<DatasetView>> postEvalsDatasets(
        std::shared_ptr<DatasetReq> datasetReq
    ) const;
    /// <summary>
    ...
    /// <param name="itemReq"></param>
    pplx::task<std::shared_ptr<ItemView>> postEvalsDatasetsByNameItems(
        utility::string_t name,
        std::shared_ptr<ItemReq> itemReq
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="evaluatorReq"></param>
    pplx::task<std::shared_ptr<EvaluatorView>> postEvalsEvaluators(
        std::shared_ptr<EvaluatorReq> evaluatorReq
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="scoreConfigReq"></param>
    pplx::task<std::shared_ptr<ScoreConfigView>> postEvalsRubrics(
        std::shared_ptr<ScoreConfigReq> scoreConfigReq
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<RunSummary>> postEvalsRuns(
    ...
    /// </remarks>
    /// <param name="scoreReq"></param>
    pplx::task<std::shared_ptr<ScoreView>> postEvalsScores(
        std::shared_ptr<ScoreReq> scoreReq
    ) const;

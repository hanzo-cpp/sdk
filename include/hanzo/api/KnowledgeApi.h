...
#ifndef HANZO_API_KnowledgeApi_H_
#define HANZO_API_KnowledgeApi_H_
...
public:
    ...
    explicit KnowledgeApi( std::shared_ptr<const ApiClient> apiClient );

    virtual ~KnowledgeApi();
    ...
    pplx::task<std::shared_ptr<ConnectionOut>> deleteKnowledgeConnectorsByProvider(
    ...
    /// </remarks>
    pplx::task<std::shared_ptr<KbConnectorsOut>> getKnowledgeConnectors(
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<ConnectionOut>> getKnowledgeConnectorsByProviderCallback(
        utility::string_t provider,
    ...
    /// </remarks>
    /// <param name="provider">Provider is the connector to act on: github, slack, google or notion.</param>
    pplx::task<std::shared_ptr<KbAuthorizeOut>> getKnowledgeConnectorsByProviderConnect(
        utility::string_t provider
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<std::shared_ptr<CatalogOut>> getKnowledgeConnectorsCatalog(
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<GraphOut>> getKnowledgeGraph(
    ...
    /// </remarks>
    /// <param name="provider">Provider is the connector to act on: github, slack, google or notion.</param>
    pplx::task<std::shared_ptr<KbSyncOut>> postKnowledgeConnectorsByProviderSync(
        utility::string_t provider
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<SearchOut>> postKnowledgeSearch(
...
#endif /* HANZO_API_KnowledgeApi_H_ */

...
public:
    ...
    pplx::task<void> cloudDeleteV1S3BucketsByBucket(
    ...
    pplx::task<void> cloudDeleteV1S3BucketsByBucketObjectsByWildcard1(
        utility::string_t bucket,
    ...
    pplx::task<void> cloudDeleteV1S3Name(
    ...
    /// </remarks>
    pplx::task<std::vector<std::shared_ptr<Cloud_provisionedSummary>>> cloudGetV1S3(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<void> cloudGetV1S3Buckets(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="bucket"></param>
    pplx::task<void> cloudGetV1S3BucketsByBucketObjects(
        utility::string_t bucket
    ) const;
    /// <summary>
    ...
    /// <param name="bucket"></param>
    /// <param name="wildcard1"></param>
    pplx::task<void> cloudGetV1S3BucketsByBucketObjectsByWildcard1(
        utility::string_t bucket,
        utility::string_t wildcard1
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<void> cloudGetV1S3Health(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="name">The user-supplied resource name (slug). Lowercased and trimmed server-side; must match &#x60;^[a-z0-9]([a-z0-9-]{0,38}[a-z0-9])?$&#x60;. </param>
    pplx::task<std::shared_ptr<Cloud_provisionedResource>> cloudGetV1S3Name(
        utility::string_t name
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<Cloud_provisionResult>> cloudPostV1S3(
    ...
    /// </remarks>
    pplx::task<void> cloudPostV1S3Buckets(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="bucket"></param>
    pplx::task<void> cloudPostV1S3BucketsByBucketObjects(
        utility::string_t bucket
    ) const;

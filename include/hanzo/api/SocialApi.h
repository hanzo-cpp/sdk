...
public:
    ...
    /// </remarks>
    /// <param name="id"></param>
    pplx::task<void> cloudDeleteV1SocialAccountsById(
        utility::string_t id
    ) const;
    /// <summary>
    /// Delete one post
    ...
    /// </remarks>
    /// <param name="id"></param>
    pplx::task<void> cloudDeleteV1SocialPostsById(
        utility::string_t id
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<void> cloudGetV1SocialAccounts(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="id"></param>
    pplx::task<void> cloudGetV1SocialAccountsById(
        utility::string_t id
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<void> cloudGetV1SocialPosts(
    ) const;
    /// <summary>
    /// Read one post
    /// </summary>
    ...
    /// </remarks>
    /// <param name="id"></param>
    pplx::task<void> cloudGetV1SocialPostsById(
        utility::string_t id
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<void> cloudGetV1SocialProviders(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<void> cloudGetV1SocialSummary(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<void> cloudPostV1SocialAccounts(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<void> cloudPostV1SocialPosts(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="id"></param>
    pplx::task<void> cloudPostV1SocialPostsByIdPublish(
        utility::string_t id
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="id"></param>
    pplx::task<void> cloudPutV1SocialAccountsById(
        utility::string_t id
    ) const;
    /// <summary>
    /// Replace one post
    ...
    /// </remarks>
    /// <param name="id"></param>
    pplx::task<void> cloudPutV1SocialPostsById(
        utility::string_t id
    ) const;

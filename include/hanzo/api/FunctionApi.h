...
#ifndef HANZO_API_FunctionApi_H_
#define HANZO_API_FunctionApi_H_
...
public:
    ...
    explicit FunctionApi( std::shared_ptr<const ApiClient> apiClient );
    ...
    pplx::task<void> deleteFunctionByName(
    ...
    /// </remarks>
    pplx::task<std::shared_ptr<FnList>> getFunction(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="name">Name is the function the URL names.</param>
    pplx::task<std::shared_ptr<FunctionDetail>> getFunctionByName(
        utility::string_t name
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="name">Name is the function the URL names.</param>
    /// <param name="limit">Limit caps the page, defaulting to 100. (optional, default to 0L)</param>
    pplx::task<std::shared_ptr<InvocationList>> getFunctionByNameInvocations(
        utility::string_t name,
    ...
    /// </remarks>
    /// <param name="name">Name is the function the URL names.</param>
    pplx::task<std::shared_ptr<LogLines>> getFunctionByNameLogs(
        utility::string_t name
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<std::shared_ptr<FnList>> getFunctionDeployments(
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<Usage>> getFunctionMetrics(
    ...
    /// </remarks>
    pplx::task<std::shared_ptr<SecretList>> getFunctionSecrets(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<std::shared_ptr<TriggerList>> getFunctionTriggers(
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<FunctionView>> postFunction(
    ...
    pplx::task<std::shared_ptr<InvocationView>> postFunctionByNameInvoke(
        utility::string_t name,
...
#endif /* HANZO_API_FunctionApi_H_ */

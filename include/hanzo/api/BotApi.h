...
public:
    ...
    pplx::task<void> cloudDeleteV1BotByWildcard1(
    ...
    /// </remarks>
    /// <param name="wildcard1"></param>
    pplx::task<void> cloudGetV1BotByWildcard1(
        utility::string_t wildcard1
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<void> cloudGetV1BotConnect(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<std::shared_ptr<Cloud_nodesView>> cloudGetV1BotNodes(
    ) const;
    /// <summary>
    /// Relay one of the bot runtime&#39;s own operational paths
    /// </summary>
    ...
    /// </remarks>
    /// <param name="wildcard1"></param>
    pplx::task<void> cloudOptionsV1BotByWildcard1(
        utility::string_t wildcard1
    ) const;
    /// <summary>
    /// Relay one of the bot runtime&#39;s own operational paths
    ...
    /// </remarks>
    /// <param name="wildcard1"></param>
    pplx::task<void> cloudPatchV1BotByWildcard1(
        utility::string_t wildcard1
    ) const;
    /// <summary>
    /// Relay one of the bot runtime&#39;s own operational paths
    ...
    /// </remarks>
    /// <param name="wildcard1"></param>
    pplx::task<void> cloudPostV1BotByWildcard1(
        utility::string_t wildcard1
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="id"></param>
    pplx::task<void> cloudPostV1BotNodesByIdInvoke(
        utility::string_t id
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<void> cloudPostV1BotPeerInvoke(
    ) const;
    /// <summary>
    /// Relay one of the bot runtime&#39;s own operational paths
    /// </summary>
    ...
    /// </remarks>
    /// <param name="wildcard1"></param>
    pplx::task<void> cloudPutV1BotByWildcard1(
        utility::string_t wildcard1
    ) const;

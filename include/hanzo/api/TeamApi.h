...
public:
    ...
    /// </remarks>
    pplx::task<std::shared_ptr<Cloud_cookieAck>> cloudDeleteV1TeamAccountCookie(
    ) const;
    /// <summary>
    ...
    pplx::task<void> cloudDeleteV1TeamFilesWorkspaceFilename(
    ...
    pplx::task<void> cloudGetV1TeamAccountAuthByProvider(
    ...
    /// </remarks>
    /// <param name="provider"></param>
    pplx::task<void> cloudGetV1TeamAccountAuthByProviderCallback(
        utility::string_t provider
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<std::vector<std::shared_ptr<Cloud_ProviderInfo>>> cloudGetV1TeamAccountProviders(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<std::shared_ptr<Cloud_planInfo>> cloudGetV1TeamBillingPlan(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<void> cloudGetV1TeamBillingUi(
    ) const;
    /// <summary>
    ...
    pplx::task<void> cloudGetV1TeamBillingUiByWildcard1(
    ...
    /// </remarks>
    pplx::task<std::shared_ptr<Cloud_botRoster>> cloudGetV1TeamBots(
    ) const;
    /// <summary>
    ...
    pplx::task<void> cloudGetV1TeamFilesByWorkspaceByFilename(
        utility::string_t workspace,
        utility::string_t filename
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<Cloud_statsOut>> cloudGetV1TeamTransactorApiV1Statistics(
    ...
    pplx::task<void> cloudGetV1TeamTransactorByToken(
    ...
    /// </remarks>
    /// <param name="token">Token is the workspace token minted by selectWorkspace. (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    pplx::task<std::shared_ptr<Cloud_statsOut>> cloudGetV1TeamTransactorStatistics(
        boost::optional<utility::string_t> token
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<void> cloudPostV1TeamAccount(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<std::shared_ptr<Cloud_botSync>> cloudPostV1TeamBotsSync(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="workspace"></param>
    pplx::task<void> cloudPostV1TeamFilesByWorkspace(
        utility::string_t workspace
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<void> cloudPutV1TeamAccountCookie(
    ) const;

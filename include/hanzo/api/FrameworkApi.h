...
#include "hanzo/model/Cloud_docTypeList.h"
#include "hanzo/model/Cloud_documentList.h"
#include "hanzo/model/Cloud_moduleList.h"
#include "hanzo/model/Cloud_roleList.h"
...
public:
    ...
    pplx::task<void> cloudDeleteV1FrameworkDoctypeName(
    ...
    /// </remarks>
    /// <param name="name"></param>
    pplx::task<void> cloudDeleteV1FrameworkDoctypesName(
        utility::string_t name
    ) const;
    /// <summary>
    ...
    pplx::task<void> cloudDeleteV1FrameworkRolesUserRole(
    ...
    pplx::task<std::shared_ptr<Cloud_documentList>> cloudGetV1FrameworkDoctype(
        utility::string_t doctype,
    ...
    /// <param name="doctype"></param>
    /// <param name="name"></param>
    pplx::task<std::map<utility::string_t, std::shared_ptr<Object>>> cloudGetV1FrameworkDoctypeName(
        utility::string_t doctype,
        utility::string_t name
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<std::shared_ptr<Cloud_docTypeList>> cloudGetV1FrameworkDoctypes(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="name"></param>
    pplx::task<std::shared_ptr<Cloud_DocType>> cloudGetV1FrameworkDoctypesName(
        utility::string_t name
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<std::shared_ptr<Cloud_moduleList>> cloudGetV1FrameworkModules(
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<Cloud_ModuleState>> cloudGetV1FrameworkModulesModule(
    ...
    /// </remarks>
    pplx::task<std::shared_ptr<Cloud_roleList>> cloudGetV1FrameworkRoles(
    ) const;
    /// <summary>
    ...
    /// Reports how much of the DocType surface the caller&#39;s org uses: how many DocTypes it has defined, and how many documents exist across them.
    /// </remarks>
    pplx::task<std::shared_ptr<Cloud_summaryView>> cloudGetV1FrameworkSummary(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="doctype"></param>
    /// <param name="frameworkDocument"></param>
    pplx::task<std::shared_ptr<Framework_Document>> cloudPostV1FrameworkByDoctype(
        utility::string_t doctype,
        std::shared_ptr<Framework_Document> frameworkDocument
    ) const;
    /// <summary>
    ...
    /// <param name="doctype"></param>
    /// <param name="name"></param>
    pplx::task<std::map<utility::string_t, std::shared_ptr<Object>>> cloudPostV1FrameworkDoctypeNameCancel(
        utility::string_t doctype,
        utility::string_t name
    ) const;
    /// <summary>
    ...
    /// <param name="doctype"></param>
    /// <param name="name"></param>
    pplx::task<std::map<utility::string_t, std::shared_ptr<Object>>> cloudPostV1FrameworkDoctypeNameSubmit(
        utility::string_t doctype,
        utility::string_t name
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="cloudDocType"></param>
    pplx::task<std::shared_ptr<Cloud_DocType>> cloudPostV1FrameworkDoctypes(
        std::shared_ptr<Cloud_DocType> cloudDocType
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="module"></param>
    pplx::task<std::shared_ptr<Cloud_Install>> cloudPostV1FrameworkModulesModuleInstall(
        utility::string_t module
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="cloudRole"></param>
    pplx::task<std::shared_ptr<Cloud_Role>> cloudPostV1FrameworkRoles(
        std::shared_ptr<Cloud_Role> cloudRole
    ) const;
    /// <summary>
    ...
    /// <param name="name"></param>
    /// <param name="frameworkDocument"></param>
    pplx::task<std::shared_ptr<Framework_Document>> cloudPutV1FrameworkByDoctypeByName(
        utility::string_t doctype,
        utility::string_t name,
        std::shared_ptr<Framework_Document> frameworkDocument
    ) const;
    ...
    /// <param name="name"></param>
    /// <param name="cloudDocType"></param>
    pplx::task<std::shared_ptr<Cloud_DocType>> cloudPutV1FrameworkDoctypesName(
        utility::string_t name,
        std::shared_ptr<Cloud_DocType> cloudDocType
    ) const;

...
#ifndef HANZO_API_RiskApi_H_
#define HANZO_API_RiskApi_H_
...
public:
    ...
    explicit RiskApi( std::shared_ptr<const ApiClient> apiClient );
    ...
    /// </remarks>
    /// <param name="riskAdoptIn"></param>
    pplx::task<std::shared_ptr<RiskModelState>> riskAdoptModel(
    ...
    /// </remarks>
    pplx::task<std::shared_ptr<RiskPolicyOut>> riskPolicy(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="riskScoreIn"></param>
    pplx::task<std::shared_ptr<RiskScoreOut>> riskScore(
        std::shared_ptr<RiskScoreIn> riskScoreIn
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="riskSearchIn"></param>
    pplx::task<std::shared_ptr<RiskSearchRun>> riskSearch(
        std::shared_ptr<RiskSearchIn> riskSearchIn
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="id">ID is the run, taken from the path. A run another organisation started is simply not there — the same answer an unknown id gives.</param>
    pplx::task<std::shared_ptr<RiskSearchReport>> riskSearchResult(
        utility::string_t id
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<std::shared_ptr<RiskModelState>> riskState(
    ) const;

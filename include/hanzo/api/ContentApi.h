...
public:
    ...
    /// </remarks>
    pplx::task<std::shared_ptr<ChannelList>> getContentChannels(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<std::shared_ptr<StateGraph>> getContentLifecycle(
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<TransitionResult>> postContentByDoctypeByNameTransition(
        utility::string_t doctype,
        utility::string_t name,
        std::shared_ptr<TransitionIn> transitionIn
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="generateInput"></param>
    pplx::task<std::shared_ptr<GenerateResult>> postContentGenerate(
        std::shared_ptr<GenerateInput> generateInput
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="publishInput"></param>
    pplx::task<std::shared_ptr<PublishResult>> postContentPublish(
        std::shared_ptr<PublishInput> publishInput
    ) const;

...
#ifndef HANZO_API_AuthorApi_H_
#define HANZO_API_AuthorApi_H_
...
public:
    ...
    explicit AuthorApi( std::shared_ptr<const ApiClient> apiClient );
    ...
    /// </remarks>
    pplx::task<std::map<utility::string_t, std::shared_ptr<Object>>> getAuthor(
    ) const;
    /// <summary>
    ...
    pplx::task<std::map<utility::string_t, std::shared_ptr<Object>>> getAuthorBasis(
    ...
    pplx::task<std::shared_ptr<Enrolment>> postAuthorConnect(
    ...
    pplx::task<std::shared_ptr<DeployRecord>> postAuthorDeploysRecord(
    ...
    pplx::task<std::shared_ptr<Claim>> postAuthorReposVerify(

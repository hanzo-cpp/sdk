...
#ifndef HANZO_API_NodeApi_H_
#define HANZO_API_NodeApi_H_
...
public:
    ...
    explicit NodeApi( std::shared_ptr<const ApiClient> apiClient );
    ...
    /// </remarks>
    pplx::task<std::shared_ptr<NodesView>> getNode(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="id"></param>
    pplx::task<void> postNodeByIdInvoke(
        utility::string_t id
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<void> postNodePeerInvoke(
    ) const;

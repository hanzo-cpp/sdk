...
#ifndef HANZO_API_ProjectApi_H_
#define HANZO_API_ProjectApi_H_
...
public:
    ...
    pplx::task<void> deleteProjectBySlug(
    ...
    pplx::task<void> deleteProjectBySlugDomainsByHost(
        utility::string_t slug,
    ...
    /// </remarks>
    /// <param name="slug">Slug is the project to act on, from the path. It is unique within the caller&#39;s org and nowhere else, so another tenant&#39;s slug is a 404.</param>
    pplx::task<std::shared_ptr<ProjectsStar>> deleteProjectBySlugStar(
        utility::string_t slug
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<std::vector<std::shared_ptr<ProjectsProject>>> getProject(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="slug">Slug is the project to act on, from the path. It is unique within the caller&#39;s org and nowhere else, so another tenant&#39;s slug is a 404.</param>
    pplx::task<std::shared_ptr<ProjectsProject>> getProjectBySlug(
        utility::string_t slug
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="slug">Slug is the project to act on, from the path. It is unique within the caller&#39;s org and nowhere else, so another tenant&#39;s slug is a 404.</param>
    pplx::task<std::vector<std::shared_ptr<ProjectsDeployment>>> getProjectBySlugDeployments(
        utility::string_t slug
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<ProjectsDeployment>> getProjectBySlugDeploymentsById(
        utility::string_t slug,
        utility::string_t id
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="slug">Slug is the project to act on, from the path. It is unique within the caller&#39;s org and nowhere else, so another tenant&#39;s slug is a 404.</param>
    pplx::task<std::shared_ptr<ProjectsDomains>> getProjectBySlugDomains(
        utility::string_t slug
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="slug">Slug is the project to act on, from the path. It is unique within the caller&#39;s org and nowhere else, so another tenant&#39;s slug is a 404.</param>
    pplx::task<std::vector<std::shared_ptr<ProjectsRelease>>> getProjectBySlugReleases(
        utility::string_t slug
    ) const;
    /// <summary>
    ...
    pplx::task<void> getProjectBySlugShot(
        utility::string_t slug
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<std::shared_ptr<EdgeState>> getProjectEdge(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<std::vector<std::shared_ptr<ProjectsSite>>> getProjectSites(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="slug">Slug is the project to act on, from the path. It is unique within the caller&#39;s org and nowhere else, so another tenant&#39;s slug is a 404.</param>
    pplx::task<std::shared_ptr<ProjectsSite>> getProjectSitesBySlug(
        utility::string_t slug
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<std::shared_ptr<TagConfig>> getProjectTags(
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<ProjectsProject>> patchProjectBySlug(
        utility::string_t slug,
    ...
    pplx::task<std::shared_ptr<ProjectsProject>> postProject(
    ...
    pplx::task<std::shared_ptr<ProjectsDeployment>> postProjectBySlugDeploy(
        utility::string_t slug,
    ...
    pplx::task<std::shared_ptr<ProjectsDeployment>> postProjectBySlugDeployments(
        utility::string_t slug,
    ...
    pplx::task<std::shared_ptr<ProjectsDeployment>> postProjectBySlugDeploymentsByIdComplete(
        utility::string_t slug,
        utility::string_t id,
    ...
    pplx::task<std::shared_ptr<ProjectsBoundDomains>> postProjectBySlugDomains(
        utility::string_t slug,
    ...
    /// <param name="slug">Slug is the project the host is attached to, from the path.</param>
    /// <param name="host">Host is the custom hostname, from the path. It is cleaned to its canonical form (lowercased, trailing dot dropped) before anything is looked up.</param>
    pplx::task<std::shared_ptr<ProjectsDomain>> postProjectBySlugDomainsByHostVerify(
        utility::string_t slug,
        utility::string_t host
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<ProjectsRelease>> postProjectBySlugPublish(
        utility::string_t slug,
    ...
    /// </remarks>
    /// <param name="slug">Slug is the project to act on, from the path. It is unique within the caller&#39;s org and nowhere else, so another tenant&#39;s slug is a 404.</param>
    pplx::task<std::shared_ptr<ProjectsProject>> postProjectBySlugPurge(
        utility::string_t slug
    ) const;
    /// <summary>
    ...
    /// <param name="slug">Slug is the site to publish, from the path.</param>
    /// <param name="projectsPublish"></param>
    pplx::task<std::shared_ptr<ProjectsRelease>> postProjectBySlugReleases(
        utility::string_t slug,
        std::shared_ptr<ProjectsPublish> projectsPublish
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<ProjectsRelease>> postProjectBySlugReleasesByReleaseActivate(
        utility::string_t slug,
    ...
    pplx::task<std::shared_ptr<ProjectsProject>> postProjectFork(
    ...
    pplx::task<std::shared_ptr<ProjectsSiteDeploy>> postProjectSites(
    ...
    pplx::task<std::shared_ptr<ProjectsSiteDeploy>> postProjectSitesDeploy(
    ...
    /// </remarks>
    /// <param name="slug">Slug is the project to act on, from the path. It is unique within the caller&#39;s org and nowhere else, so another tenant&#39;s slug is a 404.</param>
    pplx::task<std::shared_ptr<ProjectsStar>> putProjectBySlugStar(
        utility::string_t slug
    ) const;

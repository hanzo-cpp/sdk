...
public:
    ...
    pplx::task<void> cloudDeleteV1IndexIndexesByUid(
    ...
    /// <param name="uid"></param>
    /// <param name="id"></param>
    pplx::task<void> cloudDeleteV1IndexIndexesByUidDocumentsById(
        utility::string_t uid,
        utility::string_t id
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<void> cloudGetV1IndexHealth(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<void> cloudGetV1IndexIndexes(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="uid"></param>
    pplx::task<void> cloudGetV1IndexIndexesByUid(
        utility::string_t uid
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="uid"></param>
    pplx::task<void> cloudGetV1IndexIndexesByUidDocuments(
        utility::string_t uid
    ) const;
    /// <summary>
    ...
    /// <param name="uid"></param>
    /// <param name="id"></param>
    pplx::task<void> cloudGetV1IndexIndexesByUidDocumentsById(
        utility::string_t uid,
        utility::string_t id
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="uid"></param>
    pplx::task<void> cloudGetV1IndexIndexesByUidSettings(
        utility::string_t uid
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<void> cloudGetV1IndexStats(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="uid"></param>
    pplx::task<void> cloudGetV1IndexTasksByUid(
        utility::string_t uid
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<void> cloudGetV1IndexVersion(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="uid"></param>
    pplx::task<void> cloudPatchV1IndexIndexesByUidSettings(
        utility::string_t uid
    ) const;
    /// <summary>
    /// Create an index
    ...
    /// </remarks>
    pplx::task<void> cloudPostV1IndexIndexes(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="uid"></param>
    pplx::task<void> cloudPostV1IndexIndexesByUidDocuments(
        utility::string_t uid
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="uid"></param>
    pplx::task<void> cloudPostV1IndexIndexesByUidDocumentsDeleteBatch(
        utility::string_t uid
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="uid"></param>
    pplx::task<void> cloudPostV1IndexIndexesByUidSearch(
        utility::string_t uid
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="uid"></param>
    pplx::task<void> cloudPutV1IndexIndexesByUidDocuments(
        utility::string_t uid
    ) const;

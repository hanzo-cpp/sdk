...
public:
    ...
    pplx::task<std::shared_ptr<RevokeResp>> deleteLinksById(
        utility::string_t id
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<std::shared_ptr<LinkList>> getLinks(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="id">ID is the link to act on, from the path. It is scoped to the caller, so another user&#39;s or org&#39;s id is a 404.</param>
    pplx::task<std::shared_ptr<LinkView>> getLinksById(
        utility::string_t id
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<DeviceView>> getLinksDevicesByMachine(
    ...
    /// </remarks>
    pplx::task<std::shared_ptr<RoutePlan>> getLinksRoute(
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<BoardResp>> getLinksUsage(
    ...
    /// </remarks>
    pplx::task<std::shared_ptr<AccountsUsage>> getLinksUsageAccounts(
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<SummaryResp>> getLinksUsageSummary(
        boost::optional<utility::string_t> range
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<LinkView>> postLinks(
    ...
    /// </remarks>
    /// <param name="machine">Machine is the machine to act on, from the path. It is scoped to the caller, so a machine with none of the caller&#39;s accounts is a 404.</param>
    pplx::task<std::shared_ptr<RevokeResp>> postLinksDevicesByMachineRevoke(
        utility::string_t machine
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<IngestResp>> postLinksUsage(

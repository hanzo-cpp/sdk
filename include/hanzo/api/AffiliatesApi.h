...
public:
    ...
    /// </remarks>
    pplx::task<std::shared_ptr<AffiliateStanding>> getAffiliates(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<std::shared_ptr<AffiliateBoard>> getAffiliatesLeaderboard(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<std::shared_ptr<AffiliateSelf>> getAffiliatesMe(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<std::shared_ptr<AffiliateEarnings>> getAffiliatesMeEarnings(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<std::shared_ptr<AffiliateLinks>> getAffiliatesMeLinks(
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<Application>> postAffiliatesApply(
    ...
    pplx::task<std::shared_ptr<Attribution>> postAffiliatesAttribute(
    ...
    pplx::task<std::shared_ptr<ClickCount>> postAffiliatesClick(
    ...
    pplx::task<std::shared_ptr<HandleSet>> postAffiliatesMeHandle(
    ...
    pplx::task<std::shared_ptr<LinkMint>> postAffiliatesMeLinks(

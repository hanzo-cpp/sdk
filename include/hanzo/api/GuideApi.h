...
#include "hanzo/model/Cloud_actionsView.h"
...
public:
    ...
    /// </remarks>
    pplx::task<std::shared_ptr<Cloud_curriculumView>> cloudDeleteV1GuideCurriculum(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<std::shared_ptr<Cloud_overviewView>> cloudGetV1Guide(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<std::shared_ptr<Cloud_actionsView>> cloudGetV1GuideActions(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<std::shared_ptr<Cloud_analyticsView>> cloudGetV1GuideAnalytics(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<std::shared_ptr<Cloud_blueprintView>> cloudGetV1GuideBlueprint(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<std::shared_ptr<Cloud_blueprintVersionsView>> cloudGetV1GuideBlueprintVersions(
    ) const;
    /// <summary>
    ...
    /// GetCurriculum returns the journey the caller&#39;s org is actually running, and whether it comes from the org&#39;s OWN override (custom) or from the platform default — the brand blueprint, else the embedded fixture.
    /// </remarks>
    pplx::task<std::shared_ptr<Cloud_curriculumView>> cloudGetV1GuideCurriculum(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<std::shared_ptr<Cloud_profileResponse>> cloudGetV1GuideProfile(
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<Cloud_corpusView>> cloudGetV1GuideStrategies(
    ...
    /// </remarks>
    pplx::task<std::shared_ptr<Cloud_suggestResponse>> cloudGetV1GuideSuggest(
    ) const;
    /// <summary>
    ...
    /// <param name="id"></param>
    pplx::task<void> cloudPatchV1GuideBlueprintByCollectionById(
    ...
    /// </remarks>
    /// <param name="cloudChatRequest"></param>
    pplx::task<std::shared_ptr<Cloud_chatResponse>> cloudPostV1GuideChat(
        std::shared_ptr<Cloud_chatRequest> cloudChatRequest
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="id"></param>
    pplx::task<void> cloudPostV1GuideStepsByIdDo(
        utility::string_t id
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="id"></param>
    pplx::task<void> cloudPostV1GuideStepsByIdDone(
        utility::string_t id
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="id"></param>
    pplx::task<void> cloudPostV1GuideStepsByIdStart(
        utility::string_t id
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<Cloud_overviewView>> cloudPostV1GuideStepsIdReset(
        utility::string_t id
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="id">ID is the step&#39;s id, as it appears in the journey (e.g. \&quot;gsuite\&quot;).</param>
    pplx::task<std::shared_ptr<Cloud_overviewView>> cloudPostV1GuideStepsIdSkip(
        utility::string_t id
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<void> cloudPutV1GuideBlueprint(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<void> cloudPutV1GuideCurriculum(
    ) const;

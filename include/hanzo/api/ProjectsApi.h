...
public:
    ...
    pplx::task<void> deleteProjectsBySlug(
    ...
    /// </remarks>
    pplx::task<std::vector<std::shared_ptr<ProjectsProject>>> getProjects(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="slug">Slug is the project to act on, from the path. It is unique within the caller&#39;s org and nowhere else, so another tenant&#39;s slug is a 404.</param>
    pplx::task<std::shared_ptr<ProjectsProject>> getProjectsBySlug(
        utility::string_t slug
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="slug">Slug is the project to act on, from the path. It is unique within the caller&#39;s org and nowhere else, so another tenant&#39;s slug is a 404.</param>
    pplx::task<std::vector<std::shared_ptr<ProjectsDeployment>>> getProjectsBySlugDeployments(
        utility::string_t slug
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<ProjectsDeployment>> getProjectsBySlugDeploymentsById(
        utility::string_t slug,
        utility::string_t id
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="slug">Slug is the project to act on, from the path. It is unique within the caller&#39;s org and nowhere else, so another tenant&#39;s slug is a 404.</param>
    pplx::task<std::shared_ptr<ProjectsDomains>> getProjectsBySlugDomains(
        utility::string_t slug
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<ProjectsProject>> patchProjectsBySlug(
        utility::string_t slug,
    ...
    pplx::task<std::shared_ptr<ProjectsProject>> postProjects(
    ...
    pplx::task<std::shared_ptr<ProjectsDeployment>> postProjectsBySlugDeploy(
        utility::string_t slug,
    ...
    pplx::task<std::shared_ptr<ProjectsDeployment>> postProjectsBySlugDeployments(
        utility::string_t slug,
    ...
    pplx::task<std::shared_ptr<ProjectsDeployment>> postProjectsBySlugDeploymentsByIdComplete(
        utility::string_t slug,
        utility::string_t id,
    ...
    pplx::task<std::shared_ptr<ProjectsBoundDomains>> postProjectsBySlugDomains(
        utility::string_t slug,
    ...
    /// <param name="slug">Slug is the project the host is attached to, from the path.</param>
    /// <param name="host">Host is the custom hostname, from the path. It is cleaned to its canonical form (lowercased, trailing dot dropped) before anything is looked up.</param>
    pplx::task<std::shared_ptr<ProjectsDomain>> postProjectsBySlugDomainsByHostVerify(
        utility::string_t slug,
        utility::string_t host
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="slug">Slug is the project to act on, from the path. It is unique within the caller&#39;s org and nowhere else, so another tenant&#39;s slug is a 404.</param>
    pplx::task<std::shared_ptr<ProjectsProject>> postProjectsBySlugPurge(
        utility::string_t slug
    ) const;
    /// <summary>

...
#ifndef HANZO_API_ValidatorApi_H_
#define HANZO_API_ValidatorApi_H_
...
public:
    ...
    explicit ValidatorApi( std::shared_ptr<const ApiClient> apiClient );

    virtual ~ValidatorApi();
    ...
    pplx::task<std::shared_ptr<ValidatorList>> getValidator(
    ...
    pplx::task<std::shared_ptr<SlotView>> getValidatorByTokenid(
    ...
    pplx::task<std::shared_ptr<ChallengeView>> getValidatorChallenge(
    ...
    pplx::task<std::shared_ptr<SlotView>> postValidator(
...
#endif /* HANZO_API_ValidatorApi_H_ */

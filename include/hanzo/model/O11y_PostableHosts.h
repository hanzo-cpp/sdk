...
/*
 * O11y_PostableHosts.h
 *
 * 
 */

#ifndef HANZO_MODEL_O11y_PostableHosts_H_
#define HANZO_MODEL_O11y_PostableHosts_H_
...
class  O11y_PostableHosts
    : public ModelBase
{
public:
    O11y_PostableHosts();
    virtual ~O11y_PostableHosts();
    ...
    void unsetFilter();
    void setFilter(const std::shared_ptr<O11y_HostFilter>& value);
...
#endif /* HANZO_MODEL_O11y_PostableHosts_H_ */

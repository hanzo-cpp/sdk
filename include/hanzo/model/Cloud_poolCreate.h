...
#ifndef HANZO_MODEL_Cloud_poolCreate_H_
#define HANZO_MODEL_Cloud_poolCreate_H_
...
class  Cloud_poolCreate
    : public ModelBase
{
public:
    Cloud_poolCreate();
    virtual ~Cloud_poolCreate();
...
#endif /* HANZO_MODEL_Cloud_poolCreate_H_ */

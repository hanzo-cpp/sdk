...
#ifndef HANZO_MODEL_Cloud_issueView_H_
#define HANZO_MODEL_Cloud_issueView_H_
...
class  Cloud_issueView
    : public ModelBase
{
public:
    Cloud_issueView();
    virtual ~Cloud_issueView();
...
#endif /* HANZO_MODEL_Cloud_issueView_H_ */

...
#ifndef HANZO_MODEL_SourceToolList_H_
#define HANZO_MODEL_SourceToolList_H_
...
class  SourceToolList
    : public ModelBase
{
public:
    SourceToolList();
    virtual ~SourceToolList();
...
#endif /* HANZO_MODEL_SourceToolList_H_ */

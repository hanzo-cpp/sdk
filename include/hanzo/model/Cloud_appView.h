...
#ifndef HANZO_MODEL_Cloud_appView_H_
#define HANZO_MODEL_Cloud_appView_H_
...
public:
    ...
    std::shared_ptr<Cloud_imageView> getImage() const;
    bool imageIsSet() const;
    void unsetImage();
    void setImage(const std::shared_ptr<Cloud_imageView>& value);
    ...
    std::shared_ptr<Cloud_gitSource> getRepo() const;
    bool repoIsSet() const;
    void unsetRepo();
    void setRepo(const std::shared_ptr<Cloud_gitSource>& value);
...
protected:
    ...
    std::shared_ptr<Cloud_imageView> m_Image;
    bool m_ImageIsSet;
    ...
    std::shared_ptr<Cloud_gitSource> m_Repo;
    bool m_RepoIsSet;
...
#endif /* HANZO_MODEL_Cloud_appView_H_ */

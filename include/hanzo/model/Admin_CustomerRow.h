...
#ifndef HANZO_MODEL_Admin_CustomerRow_H_
#define HANZO_MODEL_Admin_CustomerRow_H_
...
class  Admin_CustomerRow
    : public ModelBase
{
public:
    Admin_CustomerRow();
    virtual ~Admin_CustomerRow();
...
#endif /* HANZO_MODEL_Admin_CustomerRow_H_ */

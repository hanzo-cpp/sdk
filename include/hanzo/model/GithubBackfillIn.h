...
#ifndef HANZO_MODEL_GithubBackfillIn_H_
#define HANZO_MODEL_GithubBackfillIn_H_
...
class  GithubBackfillIn
    : public ModelBase
{
public:
    GithubBackfillIn();
    virtual ~GithubBackfillIn();
...
#endif /* HANZO_MODEL_GithubBackfillIn_H_ */

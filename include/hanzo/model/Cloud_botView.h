...
#ifndef HANZO_MODEL_Cloud_botView_H_
#define HANZO_MODEL_Cloud_botView_H_
...
public:
    ...
    std::shared_ptr<Cloud_agentBinding> getBinding() const;
    bool bindingIsSet() const;
    void unsetBinding();
    void setBinding(const std::shared_ptr<Cloud_agentBinding>& value);
...
protected:
    ...
    std::shared_ptr<Cloud_agentBinding> m_Binding;
    bool m_BindingIsSet;
...
#endif /* HANZO_MODEL_Cloud_botView_H_ */

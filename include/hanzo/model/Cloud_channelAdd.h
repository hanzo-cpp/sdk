...
#ifndef HANZO_MODEL_Cloud_channelAdd_H_
#define HANZO_MODEL_Cloud_channelAdd_H_
...
class  Cloud_channelAdd
    : public ModelBase
{
public:
    Cloud_channelAdd();
    virtual ~Cloud_channelAdd();
...
#endif /* HANZO_MODEL_Cloud_channelAdd_H_ */

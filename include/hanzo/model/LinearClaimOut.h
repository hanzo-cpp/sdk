...
#ifndef HANZO_MODEL_LinearClaimOut_H_
#define HANZO_MODEL_LinearClaimOut_H_
...
class  LinearClaimOut
    : public ModelBase
{
public:
    LinearClaimOut();
    virtual ~LinearClaimOut();
...
#endif /* HANZO_MODEL_LinearClaimOut_H_ */

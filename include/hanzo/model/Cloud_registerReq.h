...
#ifndef HANZO_MODEL_Cloud_registerReq_H_
#define HANZO_MODEL_Cloud_registerReq_H_
...
class  Cloud_registerReq
    : public ModelBase
{
public:
    Cloud_registerReq();
    virtual ~Cloud_registerReq();
...
#endif /* HANZO_MODEL_Cloud_registerReq_H_ */

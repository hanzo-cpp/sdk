...
#ifndef HANZO_MODEL_Cloud_MCPListing_H_
#define HANZO_MODEL_Cloud_MCPListing_H_
...
public:
    ...
    /// </summary>
    std::vector<std::shared_ptr<Cloud_MCPPackage>> getPackages() const;
    bool packagesIsSet() const;
    void unsetPackages();
    void setPackages(const std::vector<std::shared_ptr<Cloud_MCPPackage>>& value);
    ...
    /// </summary>
    std::vector<std::shared_ptr<Cloud_MCPRemote>> getRemotes() const;
    bool remotesIsSet() const;
    void unsetRemotes();
    void setRemotes(const std::vector<std::shared_ptr<Cloud_MCPRemote>>& value);
...
protected:
    ...
    std::vector<std::shared_ptr<Cloud_MCPPackage>> m_Packages;
    bool m_PackagesIsSet;

    utility::string_t m_Registry;
    bool m_RegistryIsSet;

    std::vector<std::shared_ptr<Cloud_MCPRemote>> m_Remotes;
    bool m_RemotesIsSet;
...
#endif /* HANZO_MODEL_Cloud_MCPListing_H_ */

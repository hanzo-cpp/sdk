 ...
 */
/*
 * Cloud_sessionDetail.h
 *
 * 
 */

#ifndef HANZO_MODEL_Cloud_sessionDetail_H_
#define HANZO_MODEL_Cloud_sessionDetail_H_
...
class Cloud_sessionView;
class Cloud_lastEventView;
class Cloud_eventView;


class  Cloud_sessionDetail
    : public ModelBase
{
public:
    Cloud_sessionDetail();
    virtual ~Cloud_sessionDetail();
    ...
    std::vector<std::shared_ptr<Cloud_sessionView>> getChildSessions() const;
    bool childSessionsIsSet() const;
    void unsetChildSessions();
    void setChildSessions(const std::vector<std::shared_ptr<Cloud_sessionView>>& value);
    ...
    std::shared_ptr<Cloud_lastEventView> getLastEvent() const;
    bool lastEventIsSet() const;
    void unsetLastEvent();
    void setLastEvent(const std::shared_ptr<Cloud_lastEventView>& value);
    ...
    std::vector<std::shared_ptr<Cloud_eventView>> getRecentEvents() const;
    bool recentEventsIsSet() const;
    void unsetRecentEvents();
    void setRecentEvents(const std::vector<std::shared_ptr<Cloud_eventView>>& value);
...
protected:
    ...
    std::vector<std::shared_ptr<Cloud_sessionView>> m_ChildSessions;
    ...
    std::shared_ptr<Cloud_lastEventView> m_LastEvent;
    ...
    std::vector<std::shared_ptr<Cloud_eventView>> m_RecentEvents;
...
#endif /* HANZO_MODEL_Cloud_sessionDetail_H_ */

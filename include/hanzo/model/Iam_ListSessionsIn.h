...
/*
 * Iam_ListSessionsIn.h
 *
 * 
 */

#ifndef HANZO_MODEL_Iam_ListSessionsIn_H_
#define HANZO_MODEL_Iam_ListSessionsIn_H_
...
class  Iam_ListSessionsIn
    : public ModelBase
{
public:
    Iam_ListSessionsIn();
    virtual ~Iam_ListSessionsIn();
...
#endif /* HANZO_MODEL_Iam_ListSessionsIn_H_ */

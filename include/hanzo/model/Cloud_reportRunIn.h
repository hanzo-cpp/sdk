...
#ifndef HANZO_MODEL_Cloud_reportRunIn_H_
#define HANZO_MODEL_Cloud_reportRunIn_H_
...
class  Cloud_reportRunIn
    : public ModelBase
{
public:
    Cloud_reportRunIn();
    virtual ~Cloud_reportRunIn();
...
#endif /* HANZO_MODEL_Cloud_reportRunIn_H_ */

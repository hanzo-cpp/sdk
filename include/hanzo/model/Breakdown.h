...
#ifndef HANZO_MODEL_Breakdown_H_
#define HANZO_MODEL_Breakdown_H_
...
public:
    ...
    /// </summary>
    std::vector<std::shared_ptr<BreakdownRow>> getItems() const;
    bool itemsIsSet() const;
    void unsetItems();
    void setItems(const std::vector<std::shared_ptr<BreakdownRow>>& value);
...
protected:
    ...
    std::vector<std::shared_ptr<BreakdownRow>> m_Items;
    bool m_ItemsIsSet;
...
#endif /* HANZO_MODEL_Breakdown_H_ */

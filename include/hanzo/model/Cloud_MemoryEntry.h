...
#ifndef HANZO_MODEL_Cloud_MemoryEntry_H_
#define HANZO_MODEL_Cloud_MemoryEntry_H_
...
class  Cloud_MemoryEntry
    : public ModelBase
{
public:
    Cloud_MemoryEntry();
    virtual ~Cloud_MemoryEntry();
...
#endif /* HANZO_MODEL_Cloud_MemoryEntry_H_ */

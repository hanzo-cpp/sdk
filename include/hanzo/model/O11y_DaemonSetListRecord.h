...
/*
 * O11y_DaemonSetListRecord.h
 *
 * 
 */

#ifndef HANZO_MODEL_O11y_DaemonSetListRecord_H_
#define HANZO_MODEL_O11y_DaemonSetListRecord_H_
...
class  O11y_DaemonSetListRecord
    : public ModelBase
{
public:
    O11y_DaemonSetListRecord();
    virtual ~O11y_DaemonSetListRecord();
    ...
    /////////////////////////////////////////////
    /// O11y_DaemonSetListRecord members


    int32_t getAvailableNodes() const;
    bool availableNodesIsSet() const;
    void unsetAvailableNodes();
    void setAvailableNodes(int32_t value);
...
protected:
    int32_t m_AvailableNodes;
    bool m_AvailableNodesIsSet;
...
#endif /* HANZO_MODEL_O11y_DaemonSetListRecord_H_ */

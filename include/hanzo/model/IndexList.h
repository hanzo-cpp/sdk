...
#ifndef HANZO_MODEL_IndexList_H_
#define HANZO_MODEL_IndexList_H_
...
public:
    ...
    /// </summary>
    std::vector<std::shared_ptr<IndexView>> getResults() const;
    bool resultsIsSet() const;
    void unsetResults();
    void setResults(const std::vector<std::shared_ptr<IndexView>>& value);
...
#endif /* HANZO_MODEL_IndexList_H_ */

...
#ifndef HANZO_MODEL_Cloud_Status_H_
#define HANZO_MODEL_Cloud_Status_H_
...
public:
    ...
    /// </summary>
    std::shared_ptr<Cloud_Usage> getUsage() const;
    bool usageIsSet() const;
    void unsetUsage();
    void setUsage(const std::shared_ptr<Cloud_Usage>& value);
...
protected:
    ...
    std::shared_ptr<Cloud_Usage> m_Usage;
    bool m_UsageIsSet;
...
#endif /* HANZO_MODEL_Cloud_Status_H_ */

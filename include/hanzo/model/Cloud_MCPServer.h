...
#ifndef HANZO_MODEL_Cloud_MCPServer_H_
#define HANZO_MODEL_Cloud_MCPServer_H_
...
class  Cloud_MCPServer
    : public ModelBase
{
public:
    Cloud_MCPServer();
    virtual ~Cloud_MCPServer();
...
#endif /* HANZO_MODEL_Cloud_MCPServer_H_ */

...
#ifndef HANZO_MODEL_Iam_roles_Input_H_
#define HANZO_MODEL_Iam_roles_Input_H_
...
class  Iam_roles_Input
    : public ModelBase
{
public:
    Iam_roles_Input();
    virtual ~Iam_roles_Input();
...
#endif /* HANZO_MODEL_Iam_roles_Input_H_ */

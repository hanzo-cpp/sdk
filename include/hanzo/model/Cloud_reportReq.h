...
#ifndef HANZO_MODEL_Cloud_reportReq_H_
#define HANZO_MODEL_Cloud_reportReq_H_
...
class Cloud_sampleReq;


class  Cloud_reportReq
    : public ModelBase
{
public:
    Cloud_reportReq();
    virtual ~Cloud_reportReq();
    ...
    /// </summary>
    std::vector<std::shared_ptr<Cloud_sampleReq>> getSamples() const;
    bool samplesIsSet() const;
    void unsetSamples();
    void setSamples(const std::vector<std::shared_ptr<Cloud_sampleReq>>& value);
...
protected:
    ...
    std::vector<std::shared_ptr<Cloud_sampleReq>> m_Samples;
    bool m_SamplesIsSet;
...
#endif /* HANZO_MODEL_Cloud_reportReq_H_ */

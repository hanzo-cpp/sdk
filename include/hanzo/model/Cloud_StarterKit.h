...
#ifndef HANZO_MODEL_Cloud_StarterKit_H_
#define HANZO_MODEL_Cloud_StarterKit_H_
...
class  Cloud_StarterKit
    : public ModelBase
{
public:
    Cloud_StarterKit();
    virtual ~Cloud_StarterKit();
...
#endif /* HANZO_MODEL_Cloud_StarterKit_H_ */

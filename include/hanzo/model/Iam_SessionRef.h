...
#ifndef HANZO_MODEL_Iam_SessionRef_H_
#define HANZO_MODEL_Iam_SessionRef_H_
...
class  Iam_SessionRef
    : public ModelBase
{
public:
    Iam_SessionRef();
    virtual ~Iam_SessionRef();
...
#endif /* HANZO_MODEL_Iam_SessionRef_H_ */

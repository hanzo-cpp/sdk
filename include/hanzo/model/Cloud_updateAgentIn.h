 ...
 */
/*
 * Cloud_updateAgentIn.h
 *
 * 
 */

#ifndef HANZO_MODEL_Cloud_updateAgentIn_H_
#define HANZO_MODEL_Cloud_updateAgentIn_H_
...
class  Cloud_updateAgentIn
    : public ModelBase
{
public:
    Cloud_updateAgentIn();
    virtual ~Cloud_updateAgentIn();
...
#endif /* HANZO_MODEL_Cloud_updateAgentIn_H_ */

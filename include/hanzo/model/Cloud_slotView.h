...
#ifndef HANZO_MODEL_Cloud_slotView_H_
#define HANZO_MODEL_Cloud_slotView_H_
...
class Cloud_registrationView;


class  Cloud_slotView
    : public ModelBase
{
public:
    Cloud_slotView();
    virtual ~Cloud_slotView();
    ...
    /// </summary>
    std::shared_ptr<Cloud_registrationView> getRegistration() const;
    bool registrationIsSet() const;
    void unsetRegistration();
    void setRegistration(const std::shared_ptr<Cloud_registrationView>& value);
...
protected:
    ...
    std::shared_ptr<Cloud_registrationView> m_Registration;
...
#endif /* HANZO_MODEL_Cloud_slotView_H_ */
